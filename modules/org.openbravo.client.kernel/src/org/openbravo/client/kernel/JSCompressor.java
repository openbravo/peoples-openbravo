...
/**
 * Compresses javascript using the <a href="http://developer.yahoo.com/yui/compressor/">YUI
 * Compressor</a>.
 * 
 * @author mtaal
 */
public class JSCompressor {
  ...
  public String compress(String javascript) {

    try {
      final ByteArrayInputStream bais = new ByteArrayInputStream(javascript.getBytes("UTF-8"));
