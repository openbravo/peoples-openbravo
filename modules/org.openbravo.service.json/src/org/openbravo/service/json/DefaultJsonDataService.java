  ...
  public String fetch(Map<String, String> parameters) {
    try {
      ...
      if (endRowStr != null && endRowStr != null) {
        final int endRow = Integer.parseInt(endRowStr);
        queryService.setMaxResults(endRow - startRow + 1);
        doCount = true;
      }
      ...
      final List<BaseOBObject> bobs = queryService.list();
      ...
      jsonResponse.put(JsonConstants.RESPONSE_ENDROW, bobs.size() + startRow - 1);
