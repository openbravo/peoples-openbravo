...
public class JSONWriterToCSVFile {
    ...
    try {
      ...
      Window window = JsonUtils.isValueEmpty(parameters.get(JsonConstants.TAB_PARAMETER)) ? null
          : OBDal.getInstance()
              ...
              .getWindow();
      Tab tab = parameters.get(JsonConstants.TAB_PARAMETER) != null
      ...
      if (entity != null) {
        ...
        for (Entry<String, Property> propEntry : properties.entrySet()) {
          ...
          if (prop.isAuditInfo()) {
            ...
            loadTabNiceFieldProperty(propKey, col, tab, userLanguageId);
          } else {
  ...
  private void loadTabNiceFieldProperty(String propKey, Column col, Tab tab,
