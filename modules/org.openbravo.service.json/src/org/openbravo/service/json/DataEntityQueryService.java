...
public class DataEntityQueryService {
  ...
  public int count() {
    ...
    if (OBContext.getOBContext().isInAdministratorMode()) {
      ...
      log.debug("Super user, disable all org/client/active filters");
    }
    obq.setParameters(queryBuilder.getTypedParameters());
  ...
  public void setTextMatching(String textMatchingName) {
    ...
    for (TextMatching textMatching : TextMatching.values()) {
      if (textMatching.name().equals(textMatchingName)) {
