...
import org.openbravo.userinterface.smartclient.ApplicationComponent;
...
/**
 * Test the {@link ApplicationComponent}.
 * 
 * @author mtaal
 */

public class GenerateApplicationJSTest extends BaseTest {
  ...
  public void testComponentGeneration() throws Exception {
    ...
    final Component component = new SmartClientComponentProvider().getComponent(
        SmartClientConstants.SC_APPLICATION_COMPONENT_ID, new HashMap<String, Object>());
