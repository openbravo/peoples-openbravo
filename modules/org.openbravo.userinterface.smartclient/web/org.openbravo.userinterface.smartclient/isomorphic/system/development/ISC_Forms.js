...
if(this.errors[_1])return this.errors[_1];if(_2!=null&&this.errors[_2])return this.errors[_2];return null}
...
,isc.A.getPrintChildren=function isc_DynamicForm_getPrintChildren(){return null}
...
);isc.evalBoundary;isc.B.push(isc.A.getErrorsHTML=function isc_DynamicForm_getErrorsHTML(_1){if(!_1||isc.isAn.emptyObject(_1))return isc.emptyString;var _2=this.errorsPreamble;_2+="<UL>";for(var _3 in _1){var _4=this.getItem(_3),_5;if(_4)_5=_4.getErrorMessage(_1[_3])
...
,isc.A.getEventItemInfo=function isc_DynamicForm_getEventItemInfo(){var _1=this.$ne();if(_1==null||_1.inactiveContext)return null;return{item:_1.item,overItem:(_1.overElement||_1.overTextBox||_1.overControlTable),overTitle:_1.overTitle,icon:itemInfo.overIcon}}
...
);isc.B._maxIndex=isc.C+224;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$77j="section";isc.A.$77k="SectionItem";isc.A.$77l="button";isc.A.$77m="ButtonItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
...
,isc.A.getErrorPromptString=function isc_c_FormItem_getErrorPromptString(_1,_2){var _3="";if(!isc.isAn.Array(_1))_1=[_1];for(var i=0;i<_1.length;i++){_3+=(i>0?(isc.Browser.isMoz?"  ":"\n"):"")+_1[i]};if(_2)_3=_3.replace(/'/g,"&#39;");return _3}
...
var _2=isc.SB.create();for(var i=0;i<this.icons.length;i++){var _4=this.icons[i];if(!this.$16f(_4)||this.$16e(_4))continue;var _5=_1&&this.$54o(_4,true);_2.append(this.getIconHTML(_4,null,this.iconIsDisabled(_4),!!_5))}
return _2.release()}
...
return isc.Time.toTime(_1,this.timeFormatter);if(this.$62&&isc.isA.Function(this.$62.normalDisplayFormatter)&&this.applyStaticTypeFormat)
...
,isc.A.$17l=function isc_FormItem__handleChangeWithCompletion(_1){var _2=this.$17k,_3=isc.EH.lastEvent.keyName;if(this.$14m[_3]){this.acceptCompletion(_3==this.$10j);return _2}
...
,isc.A.$17y=function isc_FormItem__handleErrorIconMouseOver(){}
,isc.A.$171=function isc_FormItem__handleErrorIconMouseOut(){}
...
);isc.evalBoundary;isc.B.push(isc.A.handleKeyUp=function isc_FormItem_handleKeyUp(_1,_2){if(!this.form)return;var _3=this,_4=this.form,_5=_1.keyName;if(this.keyUp!=null&&this.keyUp(_3,_4,_5)==false)return false}
...
,isc.A.propertyChanged=function isc_FormItem_propertyChanged(_1,_2){if(this.$14s[_1])this.$18m=true;if(this.$59q[_1])this.updateState();if(_1==this.$59r&&this.items){for(var i=0;i<this.items.length;i++){this.items[i].updateState()}}}
...
this.$19r(this.pickListWidth!=null?this.pickListWidth:this.getElementWidth(),_5,(_5==this.pickListHeight));_1.placeNear(_3,_4)},pickValue:function(_1){}});isc.A=isc.PickList;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.optionsFromValueMap=function isc_c_PickList_optionsFromValueMap(_1){var _2=_1.getValueMap(),_3=[];if(_2==null)_2=[];var _4=_1.getValueFieldName();if(isc.isAn.Array(_2)){for(var i=0;i<_2.length;i++){_3[i]={}
...
var _5={};if(this.useMask){var _6=this.getInputFormat();if(!_6)_6="MDY";var _7=this.$73c[_6];var _8=this.maskDateSeparator||this.$73e;if(_8!=this.$73e){_7=_7.replace(this.$73f,_8)}
if(isc.isA.DateTimeItem(this)){_7+=" "+this.$73d}
_5.mask=_7;_5.maskSaveLiterals=true;_5.maskOverwriteMode=true;if(this.inputFormat)
this.displayFormat=this.$73r[_6]}
var _9=isc.addProperties(_4,_2.TEXT_FIELD,this.textFieldProperties,_5);if(this.height&&(!this.textFieldProperties||!this.textFieldProperties.height))
{_9.height=this.getTextBoxHeight()}
_1.add(_9);var _10;this.daySelector=this.yearSelector=this.monthSelector=_10}else{for(var i=0;i<_3.length;i++){var _12=_3.charAt(i);var _13,_14,_15;if(_12=="D"){var _13;if(this.daySelectorProperties!=null){_13=isc.addProperties({},this.daySelectorDefaults,_2.DAY_SELECTOR,this.daySelectorProperties)}else{_13=isc.addProperties({},this.daySelectorDefaults,_2.DAY_SELECTOR)}
_1.add(_13)}else if(_12=="M"){var _14;if(this.monthSelectorProperties!=null){_14=isc.addProperties({},this.monthSelectorDefaults,_2.MONTH_SELECTOR,this.monthSelectorProperties)}else{_14=isc.addProperties({},this.monthSelectorDefaults,_2.MONTH_SELECTOR)}
_1.add(_14)}else if(_12=="Y"){var _15;if(this.yearSelectorProperties!=null){_15=isc.addProperties({},this.yearSelectorDefaults,_2.YEAR_SELECTOR,this.yearSelectorProperties)}else{_15=isc.addProperties({},this.yearSelectorDefaults,_2.YEAR_SELECTOR)}
_1.add(_15)}}}
...
,isc.A.getValue=function isc_DateRangeItem_getValue(){if(!this.fromField||!this.toField)return;var _1=this.allowRelativeDates,_2=_1&&this.fromField.getRelativeDate()?this.fromField.getRelativeDate():this.fromField.getValue(),_3=_1&&this.toField.getRelativeDate()?this.toField.getRelativeDate():this.toField.getValue(),_4={};if(_2==null&&_3==null)return null;if(_2!=null)_4.start=_2;if(_3!=null)_4.end=_3;return _4}
