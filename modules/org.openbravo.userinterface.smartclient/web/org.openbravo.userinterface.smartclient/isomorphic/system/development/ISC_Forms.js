...
return(_1?_2:null)}
,isc.A.showFieldErrors=function isc_DynamicForm_showFieldErrors(_1,_2){return this.showErrors(null,null,_2)}
...
,isc.A.$10y=function isc_ComboBoxItem__updateValue(_1,_2){var _3=this.getElementValue(),_4=(_1==_3&&this.mapValueToDisplay(this.getValue())==_3);this.$80p=(!_4&&!this.$201);if(this.addUnknownValues||_2)return this.Super("$10y",arguments);if(_4)return;var _5=this.mapValueToDisplay(_1);if(_5==_1){this.saveValue(null);this.refreshPickList(_1);return}
