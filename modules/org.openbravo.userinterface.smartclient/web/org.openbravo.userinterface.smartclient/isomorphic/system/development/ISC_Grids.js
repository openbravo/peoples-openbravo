...
/*
  ...
  Version SC_SNAPSHOT-2010-01-12/LGPL Development Only (2010-01-12)
...
this.$q7=false}
,isc.A.setSelected=function(_1,_2,_3){if(_1==null)return false;if(_1[this.enabledProperty]==false)return false;if(_1[this.canSelectProperty]==false)return false;var _4=this.selectionProperty,_5=this.partialSelectionProperty,_6=isc.isAn.XMLNode(_1);if(_2==null)_2=true;if(this.cascadeSelection&&!this.useRemoteSelection){if(_3==this.$74f){var _7=false,_8=_1.children.length;for(var i=0;i<_8;i++){var _10=_1.children.get(i);if((_2&&!this.isSelected(_10))||(!_2&&this.isSelected(_10)))
{_7=true;break}}
if(_6){_1.setAttribute(_5,_7+"")}else{_1[_5]=_7}
if(_2!=_7)_2=true}else if(_1.children&&_1.children.length>0){if(_6){_1.removeAttribute(_5)}else{delete _1[_5]}}}
var _11=_6?_1.getAttribute(_4):_1[_4];if(_11==null)_11=false;if(_6){_1.setAttribute(_4,(_2==true)+"")}else{_1[_4]=_2}
this.lastSelectionItem=_1;this.lastSelectionState=_2;if(_2==_11)return false;this.markForRedraw();if(this.target&&this.target.selectionChange)this.target.selectionChange(_1,_2);if(this.cascadeSelection&&!this.useRemoteSelection)
{var _12=_1,_13=_2;if(_3!=this.$74f&&!_6&&_1.children&&_1.children.length>0)
...
this.lastSelectionItem=_12;this.lastSelectionState=_13}
return true}
...
{_4+=1}
if(this.showSelectedStyle&&this.selectionEnabled()){var _6=(this.canSelectCells?this.selection.cellIsSelected(_2,_3):this.selection.isSelected(_1));if(_6)_4+=2}}
return _4}
...
if(_2&&_2.getTreeFieldNum){var _5=_2.getTreeFieldNum();if(!_2.$67j)this.refreshCell(_1,_5)}}
...
delete this.$74b;this.removeEmbeddedComponent(_1,0);this.$74a--}
...
delete this.$74b;this.$25a("setData")}
...
if(this.$52y&&!this.$31o){this.$52y=false;this.regroup()}
...
if(this.shouldShowCheckboxField()){var _14=this.getCurrentCheckboxField(),_15=this.getCheckboxFieldPosition(),_11=!_14,_12=this.completeFields.findAll("frozen",true),_13=_12&&(_12.length>1||(_12.length==1&&_12[0][this.fieldIdProperty]!="$63n"));if(_11)_14=this.getCheckboxField();if(_13&&!_14.frozen){_14.frozen=true;_14.$74j=true}
else if(_14.frozen&&_14.$74j==true)_14.frozen=false;if(_11)this.completeFields.addAt(_14,_15);else this.completeFields.slideList([_14],_15)}
...
,isc.A.getCheckboxFieldPosition=function(){if(this.selectionAppearance!="checkbox"||isc.isA.TreeGrid(this))return-1;return this.canExpandRecords?1:0}
...
);isc.evalBoundary;isc.B.push(isc.A.getFieldWidths=function(_1){var _2=this.header;if(isc.isA.Layout(_2)&&_2.isDrawn()){var _3=_2.getMemberSizes();if(this.allowMismatchedHeaderBodyBorder&&_3.length>0){var _4=_2.getLeftBorderSize()+_2.getLeftMargin(),_5=_2.getRightBorderSize()+_2.getRightMargin();if(_4!=0){_3[0]+=_4}
...
_1=this.$300(_2,_3)}
if(_1&&_1[this.isSeparatorProperty])return this.$302;if(_1&&_1.$52e)return this.getGroupNodeHTML(_1,_4);var _5=this.fields[_3],_6=null;if(_5==null)return"";if(this.isCheckboxField(_5)){var _7;if(!this.body.canSelectRecord(_1)){_7="[SKINIMG]/blank.gif"}else{var _8=this.selection.isSelected(_1)?true:false;_7=_8?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage)}
...
);isc.evalBoundary;isc.B.push(isc.A.getFocusRow=function(_1){if(this.body.$31p!=null&&((this.body.$31p==this.body.lastOverRow)||(this.body.$31p==this.$31q)))
...
);isc.evalBoundary;isc.B.push(isc.A.getEditItem=function(_1,_2,_3,_4,_5,_6,_7){var _8={};_8.width=_6;_8.record=_2;_8.rowNum=_4;_8.colNum=_5;var _9=this.getEditorName(_4,_1);_8[this.fieldIdProperty]=_9;_8.valueMap=this.getEditorValueMap(_1,_3);if(_1.valueField!=null)_8.valueField=_1.valueField
...
);isc.evalBoundary;isc.B.push(isc.A.clearNewEditCell=function(){this.$330=null}
...
,isc.A.deriveFrozenFields=function(){var _1=this.frozenFields=this.fields.findAll("frozen",true);if(_1&&_1.length==1&&this.isCheckboxField(_1[0])){var _2=_1[0];if(_2.$74j==true){_2.frozen=false;delete _2.$74j;_1=this.frozenFields=null;this.completeFields.slideList([_2],this.getCheckboxFieldPosition())}}
var _3=this.completeFields.findAll("frozen",true);if(_1&&_1.length==this.fields.length){_1=this.frozenFields=null;this.$54d=true}else this.$54d=false;if(_1){var _2=this.getCurrentCheckboxField();if(_2&&!_2.frozen){_2.frozen=true;_2.$74j=true;_1.addAt(_2,this.freezeLeft()?0:this.fields.length);_3.addAt(_2,this.freezeLeft()?0:this.completeFields.length)}
...
);isc.evalBoundary;isc.B.push(isc.A.getRowHeight=function(_1,_2){var _3=this.cellHeight;if(this.frozenFields&&this.getEditRow()==_2){var _4=this.getEditForm(),_5=_4?_4.getItems():[];for(var i=0;i<_5.length;i++){var _7=(_5[i].getHeight()+2*this.cellPadding);if(_7>_3)_3=_7}}
...
);isc.evalBoundary;isc.B.push(isc.A.isSortField=function(_1){return this.getSortSpecifier(_1)?true:false}
...
,isc.A.getEditFormItemFieldWidths=function(_1){var _2=this.data.getLevel(_1);if(!this.showRoot)_2--;var _3=_2*this.indentSize;_3+=this.iconSize+this.getOpenerIconSize(_1);if(this.$739(_1))_3+=this.$738;else if(this.getExtraIcon(_1))_3+=this.iconSize;var _4=this.Super("getEditFormItemFieldWidths",arguments),_5=this.getTreeFieldNum();_4[_5]-=_3;return _4}
...
,isc.A.recordDoubleClick=function(_1,_2,_3,_4,_5,_6,_7){if(this.clickInOpenArea(_2)||this.clickInCheckboxArea(_2))return false;if(this.data.isFolder(_2)){return this.toggleFolder(_2)}else
...
,isc.A.clickInCheckboxArea=function(_1){if(this.selectionAppearance!=this.$12c)return false;var _2=this.getTreeFieldNum(),_3=this.getFieldBody(_2),_4=this.getLocalFieldNum(_2),_5=_3.getColumnLeft(_4),_6=_3.getColumnWidth(_4),_7=this.getOpenAreaWidth(_1),_8=this.$738,x=_3.getOffsetX();if(this.isRTL()){var _10=_5+_6;return(x>=(_10-_7-_8)&&x<=(_10-_7))}else{return(x>=(_5+_7)&&x<(_5+_7+_8))}}
...
);isc.B._maxIndex=isc.C+5;isc.defineClass("HiliteEditor","VLayout");isc.A=isc.HiliteEditor.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.mainLayoutDefaults={_constructor:"HLayout",width:"100%",padding:8};isc.A.fieldLayoutDefaults={_constructor:"VLayout",width:150,autoParent:"mainLayout",showResizeBar:true};isc.A.addAdvancedRuleButtonDefaults={_constructor:"IButton",title:"Add Advanced Rule",align:"center",width:"100%",height:22,autoParent:"fieldLayout",click:function(){this.creator.addAdvancedRule()}};isc.A.fieldListDefaults={_constructor:"ListGrid",width:"100%",height:"*",autoParent:"fieldLayout",fields:[{name:"fieldName",showIf:"false"},{name:"fieldTitle",title:"Available Fields"}],recordClick:function(_1,_2){this.creator.addRule(_2)}};isc.A.ruleLayoutDefaults={_constructor:"VLayout",top:22,membersMargin:1,padding:1,autoParent:"mainLayout",border:"1px solid blue",width:"100%",height:"100%"};isc.A.hiliteRuleDefaults={_constructor:"HiliteRule"};isc.A.hiliteButtonsDefaults={_constructor:"HLayout",membersMargin:8,height:1};isc.A.saveButtonDefaults={_constructor:"IButton",autoParent:"hiliteButtons",title:"Save",click:function(){this.creator.saveHilites()}};isc.A.doneButtonDefaults={_constructor:"IButton",autoParent:"hiliteButtons",title:"Cancel",click:function(){this.creator.completeEditing()}};isc.A.defaultWidth=800;isc.A.defaultHeight=300;isc.B.push(isc.A.initWidget=function(){this.Super("initWidget",arguments);this.addAutoChildren(["mainLayout","fieldLayout","addAdvancedRuleButton","fieldList","ruleLayout","hiliteButtons","saveButton","doneButton"]);var _1=this.getDataSource();var _2=this.fieldNames||_1.getFieldNames(),_3=this.fieldListData=[];for(var i=0;i<_2.length;i++){var _5=_2[i],_6=_1.getField(_5),_7=_6.title;if(_6.hidden)continue;_7=_7?_7:_5;_3.add({fieldName:_5,fieldTitle:_7})}
this.fieldListData=_3;this.fieldList.setData(this.fieldListData);this.fieldList.markForRedraw();this.setHilites()}
,isc.A.addRule=function(_1){var _2=this.createAutoChild("hiliteRule",{width:"100%",fieldName:_1.fieldName,dataSource:this.dataSource});this.showNewRule(_2)}
,isc.A.showNewRule=function(_1){this.ruleLayout.addMember(_1)}
,isc.A.addAdvancedRule=function(){var _1=this.getID()+".addAdvancedRuleReply(criteria)";this.advancedHiliteDialog=isc.Window.create({title:"Advanced Hilite Editor",width:isc.Page.getWidth()/2,height:300,isModal:true,showModalMask:true,showResizer:true,canDragResize:true,autoCenter:true,items:[isc.AdvancedHiliteEditor.create({width:"100%",height:"100%",dataSource:this.dataSource,callback:_1})]});this.advancedHiliteDialog.show()}
,isc.A.addAdvancedRuleReply=function(_1){this.advancedHiliteDialog.hide();this.advancedHiliteDialog.markForDestroy();if(!_1)return;var _2=this.createAutoChild("hiliteRule",{width:"100%",isAdvanced:true,dataSource:this.dataSource,fieldName:_1.fieldName,criteria:_1,criterion:_1});this.showNewRule(_2)}
,isc.A.setHilites=function(_1){_1=_1||this.hilites||[];for(var i=0;i<_1.length;i++){var _3=_1[i],_4=this.createAutoChild("hiliteRule",{fieldName:_3.fieldName,criterion:_3,dataSource:this.dataSource});this.showNewRule(_4)}}
...
,isc.A.saveHilite=function(){this.hiliteForm.setValue("criteria",this.filterBuilder.getCriteria());var _1=this.hiliteForm.getValues();if(_1.criteria.criteria==null||_1.criteria.criteria.length==0){isc.say("Either enter valid criteria or hit 'Cancel' to abandon changes");return}
this.completeEditing(_1)}
