...
/*
  ...
  Version SC_SNAPSHOT-2010-12-08/LGPL Development Only (2010-12-08)
...
_5.updateEditRow(_5.getEditRow());if(_5.$30d!=null){var _11=isc.isAn.Array(_5.$30d)?_5.$30d[0]:_5.$30d,_12=isc.isAn.Array(_5.$30d)?_5.$30d[1]||0:0;_5.scrollCellIntoView(_11,_12);delete _5.$30d}
...
,isc.A.updateRecordComponents=function isc_ListGrid_updateRecordComponents(){if(this.$81r)return;var _1=this.body,_2=this.frozenBody;if(_1==null)return;if(_1.$28c!=null){return}
if((_1.$26a==null||(_1.$26a.length==0&&_1.fields.length>0))||(_2&&(_2.$26a==null||(_2.$26a.length==0&&_2.fields.length>0))))return;this.$81r=true;var _3=this.$81s||[],_4=this.$81t||{};this.$81t={};this.$81s=[];if(this.showRecordComponents||this.showBackgroundComponents){var _5=this.body.getDrawArea(),_6=this.showRecordComponentsByCell,_7=this.body.getID(),_8=this.frozenBody?this.frozenBody.getID():null;for(var _9=_5[0];_9<=_5[1];_9++){var _10=this.getRecord(_9);if(_10==null||Array.isLoading(_10))continue;if(this.showRecordComponents){if(!_6){var _11=this.shouldShowRecordComponent(_10),_12;if(_11){_12=this.$81u(_10,null,_7);if(_12!=null){if(_12.isNullMarker){_12=null}else{var _13=_12.getID();_4[_13]=null}}else{_12=this.$81v(_10,null,this.body,_9)}}
if(_12!=null){var _13=_12.getID();this.$81t[_13]=true;this.$81s[this.$81s.length]=_12}}else{if(this.frozenBody!=null){for(var _14=0;_14<this.frozenBody.fields.length;_14++){var _15=this.frozenBody.fields[_14],_16=_15.name;var _11=this.shouldShowRecordComponent(_10,_15.masterIndex),_12;if(_11){_12=this.$81u(_10,_16,_8);if(_12!=null){if(!_12.isNullMarker){var _13=_12.getID();_4[_13]=null}else{_12=null}}else{_12=this.$81v(_10,_16,this.frozenBody,_9,_14)}}
if(_12!=null){var _13=_12.getID();this.$81t[_13]=true;this.$81s[this.$81s.length]=_12}}}
for(var _17=_5[2];_17<=_5[3];_17++){var _15=this.body.fields[_17],_16=_15.name;var _11=this.shouldShowRecordComponent(_10,_15.masterIndex),_12;if(_11){var _12=this.$81u(_10,_16,_7);if(_12!=null){if(!_12.isNullMarker){var _13=_12.getID();_4[_13]=null}else{_12=null}}else{_12=this.$81v(_10,_16,this.body,_9,_17)}}
if(_12!=null){var _13=_12.getID();this.$81t[_13]=true;this.$81s[this.$81s.length]=_12}}}}
if(this.showBackgroundComponents){if(_10&&_10.backgroundComponent){var _18=_10.$29a?_10.$29a.find("isBackgroundComponent",true):null;if(!_18){if(isc.isA.Canvas(_10.backgroundComponent)){var _19=_10.backgroundComponent.addProperties(this.backgroundComponentProperties,{isBackgroundComponent:true})}else{var _20=isc.addProperties({isBackgroundComponent:true},this.backgroundComponentProperties,_10.backgroundComponent);var _19=this.createAutoChild("backgroundComponent",_20)}
var _21=_1.getTableZIndex();_19.setZIndex(_21-49);_19.setWidth("100%");_19.setHeight("100%");_19.setOverflow("hidden");this.addEmbeddedComponent(_10.backgroundComponent,_10,_9,null,"within")}}}}}
if(this.logIsInfoEnabled("recordComponents")){this.logInfo("updateRecordComponents - new recordComponents:"+this.echo(this.$81t)+", old record components (will be cleaned up if value is 'true'):"+this.echo(_4),"recordComponents")}
for(var i=0;i<_3.length;i++){var _13=_3[i].getID();if(_4[_13]!=true){continue}
this.$81w(_3[i])}
delete this.$81r}
...
var _6=_3.getID();var _7=this.recordComponentPoolingMode=="recycle",_8,_9=_2==null?null:this.getColNum(_2);if(_7)_8=this.getFromRecordComponentPool(_1,_2);if(!_8){if(this.createRecordComponent&&isc.isA.Function(this.createRecordComponent)){_8=this.createRecordComponent(_1,this.getColNum(_2))}}else{if(this.updateRecordComponent&&isc.isA.Function(this.updateRecordComponent)){var _10=(_8.$289==_4);_8=this.updateRecordComponent(_1,_9,_8,!_10);if(_8==null){if(this.logIsInfoEnabled("recordComponents")){this.logInfo("showRecordComponents: updateRecordComponent() method "+"failed to return an updated component.","recordComponents")}}}}
var _11=_8==null;if(_11){_8={isNullMarker:true,$669:_6,$81x:this.$81o}}
if(_1.$81y==null){_1.$81y={}}
if(_2==null)_2=this.$81m;_1.$81y[_2]=_8;_8.$81k=_2;if(!_11){return _3.addEmbeddedComponent(_8,_1,_4,_5,this.getRecordComponentPosition())}}
,isc.A.$81w=function isc_ListGrid__cleanUpRecordComponent(_1,_2){if(this.logIsDebugEnabled("recordComponents")){this.logDebug("cleaning up recordComponent which has been lost from viewport:"+_1,"recordComponents")}
...
{return false}
if(this.showRecordComponent!=null)return this.showRecordComponent(_1,_2);return true}
...
);isc.evalBoundary;isc.B.push(isc.A.setFocus=function isc_ListGrid_setFocus(_1){if(this.body!=null)this.body.setFocus(_1)}
...
);isc.evalBoundary;isc.B.push(isc.A.rebuildForFreeze=function isc_ListGrid_rebuildForFreeze(_1){if(!this.body)return;if(this.filterEditor){this.filterEditor.deriveVisibleFields();this.filterEditor.updateBody(_1);this.filterEditor.remapEditFieldsForFreeze();this.filterEditor.layoutChildren(this.$60m)}
...
);isc.evalBoundary;isc.B.push(isc.A.getToggleFreezeText=function isc_ListGrid_getToggleFreezeText(_1){var _2={field:_1,viewer:this,title:this.getSummaryTitle(_1)}
...
,isc.A.makeTile=function isc_TileGrid_makeTile(_1,_2){var _3={ID:this.$57t(_2),tileNum:_2,canHover:true,handleHover:function(){if(this.creator.itemHover)this.creator.fireCallback("itemHover","item",[this])},mouseDown:function(){this.creator.$673(this);this.creator.focus()},rightMouseDown:function(){this.creator.$673(this);this.creator.focus()},mouseUp:function(){this.creator.$674(this)},doubleClick:function(){var _4=this.creator.getTileRecord(this);return this.creator.recordDoubleClick(this.creator,this,_4)}};if(this.canDragTiles()){_3.canDrag=true;_3.canDrop=true;_3.dragAppearance=this.tileDragAppearance;_3.dragTrackerMode="title";_3.getDragTrackerTitle=function(_1){return this.creator.getDragTrackerTitle(_1)};_3.getSelectedRecord=function(){return this.creator.getTileRecord(this)}}
if(_1.tileProperties)isc.addProperties(_3,_1.tileProperties);var _5=_1.tileConstructor?_1.tileConstructor:this.tileConstructor;var _6=this.createAutoChild("tile",_3,_5);this.detailViewer.setWidth(_6.getInnerWidth());this.detailViewer.setHeight(_6.getInnerHeight());return _6}
...
return false}}else{return true}}
,isc.A.canDragTiles=function isc_TileGrid_canDragTiles(){if((this.canReorderTiles||this.canDragTilesOut)&&!this.canDrag)return true;else return false}
...
,isc.A.drop=function isc_TileGrid_drop(){var _1=this.$610||0;if(_1>this.data.getLength())_1=0;var _2=this.ns.EH.dragTarget;if(_2.tileNum!=null)_2=_2.creator;var _3=this.$66f;this.$66f=null;var _4=_2.getDataSource(),_5=_2.cloneDragData();var _6=this.data.get(_1);this.transferRecords(_5,_6,_1,_2)}
