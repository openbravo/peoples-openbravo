...
return _11}
);isc.B._maxIndex=isc.C+23;isc.A=Date.prototype;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$em=[,,,,"/",,,,,"/",,,,null];isc.A.$en="MDY";isc.A.$eo="DMY";isc.A.$ep="YMD";isc.A.$en="MDY";isc.A.$w0="0";isc.A.$68f=[null,null];isc.B.push(isc.A.duplicate=function isc_Dat_duplicate(){var _1=new Date();_1.setTime(this.getTime());_1.logicalDate=this.logicalDate;_1.logicalTime=this.logicalTime;return _1}
...
if(_2!=null)_5[_5.length]=("width="+_2);if(_3!=null)_5[_5.length]=("height="+_3);if(_4!=null)_5[_5.length]=("user-scalable="+(_4==false?"no":"yes"));_5=_5.join(", ");var _6=document.getElementsByTagName("meta"),_7;for(var i=_6.length-1;i>=0;i--){if(_6[i].name=="viewport"){_7=_6[i];_7.parentNode.removeChild(_7);_7=null}}
...
if(_4)return}
this.$78p()}
,isc.A.$78p=function isc_c_EventHandler__fireResizeEvent(){isc.Page.handleEvent(null,isc.EH.RESIZE);var _1=isc.Page.getOrientation();if(_1!=this.currentOrientation){this.currentOrientation=_1;isc.Page.handleEvent(null,isc.EH.ORIENTATION_CHANGE)}}
...
this.captureEvent(_1,"onresize",_2.RESIZE,_2.handleResize);if(isc.Browser.isSafari&&_4.body){this.captureEvent(_4.body,"onorientationchange","orientationChange",_2.handleOrientationChange)}
this.captureEvent(_4,"onmousedown",_2.MOUSE_DOWN,_2.handleMouseDown);this.captureEvent(_4,"onmousemove",_2.MOUSE_MOVE,_2.handleMouseMove);this.captureEvent(_4,"onmouseup",_2.MOUSE_UP,_2.handleMouseUp);this.captureEvent(_4,"onclick",_2.CLICK,_2.handleNativeClick);this.captureEvent(_4,"ondblclick",_2.DOUBLE_CLICK,_2.handleNativeClick);this.captureEvent(_4,"onscroll","scroll",_2.handleScroll);this.captureEvent(_4,"onmousewheel",_2.MOUSE_WHEEL,_2.handleMouseWheel);if(isc.Browser.isMoz){_1.addEventListener("DOMMouseScroll",_2.handleDOMMouseScroll,true)}
...
);isc.evalBoundary;isc.B.push(isc.A.getCanvasLeft=function isc_Canvas_getCanvasLeft(){if(!this.isDrawn()){if(this.position==isc.Canvas.RELATIVE){this.logWarn("getCanvasLeft(): Called on undrawn relatively-position widget '"+this.getID()+"'.  The drawn coordinates can not be reliably "+"calculated until the widget has drawn - returning estimated position")}
return this.left}
...
return this.$s4()}
,isc.A.$s4=function isc_Canvas__getLeftOffsetFromElement(_1){if(_1==null)_1=this.getDocumentBody();var _2=this.ns.Element.$s4(this.getClipHandle(),_1,this.isRTL());if(this.getScrollingMechanism()==isc.Canvas.CLIP)_2+=this.scrollLeft;return _2}
...
);isc.evalBoundary;isc.B.push(isc.A.peerResized=function isc_Canvas_peerResized(_1,_2,_3,_4){}
...
);isc.evalBoundary;isc.B.push(isc.A.handleKeyPress=function isc_Canvas_handleKeyPress(_1,_2){var _3;if(this.convertToMethod("keyPress")){_3=this.keyPress(_1,_2)}
...
);isc.evalBoundary;isc.B.push(isc.A.handleDrop=function isc_Canvas_handleDrop(_1,_2){if(this.onDrop!=null&&(this.onDrop()==false))return false;return this.drop(_1,_2)}
...
{_4=_3;_3=null}
_4=this.buildRequest(_4,_1,_3);var _5=this.getAllFields();if(_5!=null){for(var i=0;i<_5.length;i++){if(_5[i].includeFrom!=null&&this.getDataSource().getField(_5[i].name)==null)
...
,isc.A.getClientExportData=function isc_Canvas_getClientExportData(_1,_2){var _3=this.originalData||this.data,_4=[],_5=this.getClientExportFields(_1),_6,_7,_8,_9;if(isc.isA.Object(_1)){_6=_1.includeHiddenFields;_7=_1.allowedProperties;_8=_1.includeCollapsedNodes;_9=_1.alwaysExportExpandedStyles;if(_1&&_1.exportFields){if(_6!==false)_6=true}}
...
_1.hide();if(this.showingHoverComponent){if(!_1)return;this.hoverCanvas.markForDestroy();this.hoverCanvas=null;delete this.hoverCanvas;this.showingHoverComponent=false}else{var _2=this.hoverCanvasDefaults;_1.setRect(0,-1000)}}}
...
return _2}
,isc.A.$362=function isc_c_Comm__cloneObject(_1){var _2={},_3="__ref";for(var _4 in _1){var _5=_1[_4];if(_4==_3)continue;_2[_4]=isc.Comm.$360(_5)}
return _2}
...
var _34=isc.AutoTest.locStrategyNames[_159];if(_34==null){var _41=_159;if(this.$558[_159])_41=this.$558[_159];_34=isc.AutoTest.locStrategyNames[_159]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"By"}
...
var _34=isc.AutoTest.locStrategyTypes[_159];if(_34==null){var _41=_159;if(this.$558[_159])_41=this.$558[_159];_34=isc.AutoTest.locStrategyTypes[_159]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"Type"}
...
var _111=_159[1],_112=isc.AutoTest.parseLocatorFallbackPath(_111),_80=this.getRowNumFromLocatorConfig(_112.config);if(isc.isA.Number(_80)&&isc.isA.Number(_110)){if(_107.$29p())return null;return _107.getTableElement(_80,_110)}}
