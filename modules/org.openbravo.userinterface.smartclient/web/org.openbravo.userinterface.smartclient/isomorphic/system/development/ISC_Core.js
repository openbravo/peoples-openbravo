...
);isc.evalBoundary;isc.B.push(isc.A.addFormulaField=function(){this.editFormulaField()}
...
,isc.A.$zo=function(_1,_2,_3,_4){var _5=isc.SB.create(),_6;_1=isc.JSONEncoder.$42b(_1);_5.append("{");for(var _7 in _1){if(_7==null)continue;var _8=_1[_7];if(isc.isA.Function(_8))continue;var _9=_7.toString();if(!isc.Comm.$zk.test(_9)||this.strictQuoting)_9='"'+_9+'"';var _2=isc.JSONEncoder.$zp(_2,_7);var _10;if(_7==isc.gwtRef){if(this.omitGwtRef)continue;_10="{GWT Java Obj}"}else{_10=this.$eu(_8,(_4!=null?_4+isc.Comm.indent:null),_2)}
