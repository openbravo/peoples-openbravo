...
_16[54]=(_16[54]||"")+";padding-right:"+this.rightPadding+"px";_16[55]=(this.border?";BORDER:"+this.border:null);if(isc.Browser.isIE){if(!isc.Canvas.neverUseFilters){if(!isc.Canvas.neverUseOpacityFilter){_16[56]=(_11==null?null:";filter:progid:DXImageTransform.Microsoft.Alpha(opacity="+_11+")")}
if(this.$r9){_16[57]=";filter:progid:DXImageTransform.Microsoft.iris(irisStyle=circle)"}else{_16[57]=null}}}else{if(_11!=null){_16[56]=(this.$65q?";-moz-opacity:":";opacity:")+_11}else{_16[56]=null}}
...
return true}
);isc.evalBoundary;isc.B.push(isc.A.isDragScrolling=function isc_Canvas_isDragScrolling(){if(this.vscrollOn&&this.vscrollbar&&this.vscrollbar.isDragScrolling())return true;if(this.hscrollOn&&this.hscrollbar&&this.hscrollbar.isDragScrolling())return true;return false}
...
);isc.evalBoundary;isc.B.push(isc.A.firePartEvent=function isc_Canvas_firePartEvent(_1,_2){if(!this.useEventParts||!_1)return;var _3=this.getEventPart(_1);if(!_3.part)return;if(!_2)_2=_1.eventType;return this.$wd(_3.part,_2,_3.element,_3.ID,_1)}
...
,isc.A.exportClientData=function isc_Canvas_exportClientData(_1,_2){var _3=isc.addProperties({},_1);_3.exportSettings=_2;this.getClientExportData(_3,this.getID()+".exportClientDataReply(data,context)");return}
,isc.A.exportClientDataReply=function isc_Canvas_exportClientDataReply(_1,_2){var _3=_2,_4=_3&&_3.exportAs?_3.exportAs:"csv",_5=_3&&_3.exportFilename?_3.exportFilename:"export",_6=_3&&_3.exportDisplay?_3.exportDisplay:"download";var _7={showPrompt:false,transport:"hiddenFrame",exportResults:true,downloadResult:true,downloadToNewWindow:(_6=="window"),download_filename:(_6=="window"?_5:null)};var _8=_2.exportSettings?_2.exportSettings:{};isc.DMI.callBuiltin({methodName:"downloadClientExport",arguments:[_1,_4,_5,_6,_8],requestParams:_7})}
