...
);isc.evalBoundary;isc.B.push(isc.A.$625=function(){if(!this.$626)this.$626=[this.getID(),"$627"];this.$626[2]=isc.DataSource.$625();return this.$626.join(isc.emptyString)}
...
,isc.A.combineFieldData=function(_1,_2){var _3=this.getField(_2||_1.name);return isc.DataSource.combineFieldData(_1,_3)}
...
if(_2==null)_2={};_2.oldValues=this.$10s;if(this.validationURL&&!_3){var _5={};isc.addProperties(_5,_2);isc.addProperties(_5,{actionURL:this.validationURL,valuesAsParams:true,sendNoQueue:true});_5.$40b=_2;_5.$40c=_1;this.performingServerValidation=true;this.validateData(this.getID()+".$40d(rpcRequest,rpcResponse,data)",_5);return}
...
);isc.B._maxIndex=isc.C+2;isc.defineClass("FilterClause","HStack");isc.A=isc.FilterClause.getPrototype();isc.A.height=1;isc.A.showFieldTitles=true;isc.A.validateOnChange=true;isc.A.fieldItemWidth=150;isc.A.operatorItemWidth=150;isc.A.valueItemWidth=150;isc.A.filterRow=[{type:"select",name:"fieldName",showTitle:false,changed:function(){this.form.creator.fieldNameChanged(this.form)}},{name:"operator",type:"select",showTitle:false,addUnknownValues:false,defaultToFirstOption:true,changed:function(){this.form.creator.operatorChanged(this.form)}}];isc.A.clauseConstructor=isc.DynamicFilterForm;isc.A.showRemoveButton=true;isc.A.removeButtonPrompt="Remove";isc.A.removeButtonDefaults={_constructor:isc.ImgButton,width:18,height:18,layoutAlign:"center",src:"[SKIN]/actions/remove.png",showRollOver:false,showDown:false,showDisabled:false,click:function(){this.creator.remove()}};isc.A.flattenItems=true;isc.A=isc.FilterClause.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){var _1=isc.clone(this.filterRow),_2=this.getDataSource().getFieldNames(true),_3=this.criterion,_4;_1[0].width=this.fieldItemWidth;_1[1].width=this.operatorItemWidth;if(this.fieldName){var _5=this.fieldName,_6=this.getDataSource().getField(_5),_7;_1[0].type="staticText";if(!_6||_6.canFilter==false)_5=_2[0];else if(this.showFieldTitles){_7=_6.title?_6.title:_5}
_1[0].defaultValue=_7||_5;_4=_5}else{var _8={};for(var i=0;i<_2.length;i++){var _5=_2[i],_6=this.getDataSource().getField(_5);if(_6.canFilter==false)continue;if(this.showFieldTitles){var _7=_6.title;_7=_7?_7:_5;_8[_5]=_7}else{_8[_5]=_5}}
_1[0].valueMap=_8;if(_3&&_3.fieldName){if(_2.contains(_3.fieldName)){_1[0].defaultValue=_3.fieldName}else{isc.logWarn("Criterion specified field "+_3.fieldName+", which is not"+" in the record. Using the first record field ("+_2[0]+") instead");_1[0].defaultValue=_2[0]}}else{_1[0].defaultValue=_2[0]}
_4=_1[0].defaultValue}
var _10=this.getDataSource().getFieldOperatorMap(_4,false,"criteria",true);_1[1].valueMap=_10;if(_3&&_3.operator){_1[1].defaultValue=_3.operator}else{_1[1].defaultValue=isc.firstKey(_10)}
var _11=this.getDataSource().getSearchOperator(_1[1].defaultValue),_6=this.getDataSource().getField(_4);if(!_11){isc.logWarn("Criterion specified unknown operator "+(_3?_3.operator:"[null criterion]")+". Using the first valid operator ("+isc.firstKey(_10)+") instead");_1[1].defaultValue=isc.firstKey(_10);_11=this.getDataSource().getSearchOperator(_1[1].defaultValue)}
var _12=this.buildValueItemList(_6,_11);if(_3){if(_3.value!=null&&_12.containsProperty("name","value")){_12.find("name","value").defaultValue=_3.value;_12.find("name","value").width=this.valueFieldWidth}
if(_3.start!=null&&_12.containsProperty("name","start")){_12.find("name","start").defaultValue=_3.start;_12.find("name","start").width=this.valueFieldWidth}
if(_3.end!=null&&_12.containsProperty("name","end")){_12.find("name","end").defaultValue=_3.end;_12.find("name","end").width=this.valueFieldWidth}}
_1.addList(_12);this.addAutoChild("removeButton");this.addAutoChild("clause",{flattenItems:this.flattenItems,items:_1});this.addMembers([this.removeButton,this.clause])}
...
_6.add(isc.addProperties({type:"select",name:"value",showTitle:false,width:150,valueMap:_10,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)))}else if(_4=="valueRange"){var _13=this.getDataSource().combineFieldData(isc.addProperties({type:_5,showTitle:false,width:150,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)),_1.name);_6.addList([isc.addProperties({},_13,{name:"start"}),isc.addProperties({type:"staticText",name:"rangeSeparator",showTitle:false,width:1,defaultValue:this.rangeSeparator,shouldSaveValue:false,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)),isc.addProperties({},_13,{name:"end"})])}
if(this.validateOnChange){for(var i=0;i<_6.length;i++){isc.addProperties(_6[i],{blur:function(_14,_15){if(!_14.creator.itemsInError)_14.creator.itemsInError=[];if(!_14.validate(null,null,true)){_15.focusInItem();if(!_14.creator.itemsInError.contains(_15)){_14.creator.itemsInError.add(_15)}}else{if(!_14.creator.itemsInError.contains(_15)){_14.creator.itemsInError.remove(_15)}}}})}}
return _6}
,isc.A.getValueFieldProperties=function(_1,_2){}
,isc.A.remove=function(){this.markForDestroy()}
,isc.A.getValues=function(){return this.clause.getValues()}
,isc.A.getCriterion=function(){var _1=this.clause,_2;_2=_1.getValues();if(this.fieldName)_2.fieldName=this.fieldName;if(isc.isA.Date(_2.value))_2.value.logicalDate=true;var _3=_2.operator;if(isc.isA.String(_3))_3=this.getDataSource().getSearchOperator(_3);if(_3.valueType!="none"&&_3.valueType!="valueRange"&&(_2.value==null||(isc.isA.String(_2.value)&&_2.value=="")))
{return null}
return _2}
,isc.A.validate=function(){return this.clause.validate(null,null,true)}
...
,isc.A.removeValueFields=function(){var _1=this.clause;if(_1.getItem("value"))_1.removeItem("value");if(_1.getItem("rangeSeparator"))_1.removeItem("rangeSeparator");if(_1.getItem("start"))_1.removeItem("start");if(_1.getItem("end"))_1.removeItem("end")}
,isc.A.operatorChanged=function(){var _1=this.clause,_2=this.fieldName||_1.getValue("fieldName");if(_2==null)return;var _3=this.getDataSource().getField(_2);var _4=this.getDataSource().getSearchOperator(_1.getValue("operator"));this.removeValueFields();var _5=this.buildValueItemList(_3,_4)
_1.addItems(_5)}
,isc.A.updateFields=function(){var _1=this.clause,_2=this.fieldName||_1.getValue("fieldName");if(_2==null)return;var _3=this.getDataSource().getField(_2);var _4=_1.getValue("operator");_1.getItem("operator").setValueMap(this.getDataSource().getFieldOperatorMap(_3,false,"criteria",true));if(_4==null||_1.getValue("operator")!=_4){if(_1.getValue("operator")==null){_1.getItem("operator").setValue(_1.getItem("operator").getFirstOptionValue())}
...
this.removeValueFields();_1.addItems(this.buildValueItemList(_3,_4));if(_5)_1.clearValue("value");else{var _8=_1.getItem("value");if(_8&&_8.getValueMap()&&_8.$193&&!_8.$193(_8.getValue()))
{_8.clearValue()}}
...
,isc.A.addNewClause=function(_1){var _2=this.createAutoChild("clause",{visibility:"hidden",flattenItems:true,criterion:_1,dataSource:this.dataSource,validateOnChange:this.validateOnChange,showFieldTitles:this.showFieldTitles,showRemoveButton:this.showRemoveButton,removeButtonPrompt:this.removeButtonPrompt,remove:function(){this.creator.removeClause(this)}});this.$74e(_2)}
,isc.A.addClause=function(_1){if(!_1)return;var _2=this;_1.remove=function(){_2.removeClause(this)};this.$74e(_1)}
,isc.A.$74e=function(_1){this.clauses.add(_1);var _2=this.clauseStack;var _3=Math.max(0,_2.getMemberNumber(this.buttonBar));_2.addMember(_1,_3);_2.showMember(_1,function(){_1.clause.focusInItem("fieldName")});this.updateFirstRemoveButton()}
...
,isc.A.initWidget=function(){this.Super("initWidget",arguments);this.addAutoChildren(this.topAutoChildren);this.addAutoChild("optionsGrid");this.setSortFields();this.setSortDirections();this.setButtonTitles();this.addMember(this.topLayout);this.addMember(this.optionsGrid);this.setButtonStates();if(this.initialSort)this.setSortSpecifiers(this.initialSort);else this.addLevel()}
...
this.optionsGrid.getField("property").title=this.propertyFieldTitle;this.optionsGrid.getField("property").valueMap=_2;if(!this.maxLevels||this.maxLevels>_3)this.maxLevels=_3}
...
);isc.B._maxIndex=isc.C+22;isc.defineClass("MultiSortDialog","Window");isc.A=isc.MultiSortDialog;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.askForSort=function(_1,_2,_3){var _4=isc.isAn.Array(_1)?_1:isc.isA.DataSource(_1)?isc.getValues(_1.getFields()):isc.isA.DataBoundComponent(_1)?_1.getFields():null;if(!_4)return;isc.MultiSortDialog.create({autoDraw:true,fields:_4,initialSort:_2,callback:_3})}
