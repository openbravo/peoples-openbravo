...
if(_3){var _6=(_5.getTime()-_4.getTime());var _7=Math.floor(_6/(1000*60*60*24));var _8=Math.floor(_7/ 7);var _9=Date.getWeekendDays();var _10=_7%7,_11=0;var _12=_5.duplicate();_12.setDate(_12.getDate()-_10);for(var i=0;i<_10;i++){if(_9.contains(_12.getDay())){_11++}
_12.setDate(_12.getDate()+1)}
_7-=((_8*2)+_11);return _7}else{var _6=(_5.getTime()-_4.getTime());var _7=Math.floor(_6/(1000*60*60*24));return _7}}
...
var _8=this;var _9=function(_11,_12,_13){var _10;if(isc.isAn.Array(_12))_10=_12[0];else _10=_12;if(!_10)_10=_7;if(_8.$53b(_10[_8.startDateField],_10[_8.endDateField])){_8.dayView.addEvent(_10)}
...
if(_6)this.$53e=true;if(this.dataSource){isc.DataSource.get(this.dataSource).addData(_7,_9,{componentId:this.ID});return}else{this.data.add(_7);_9()}}
...
if(this.showMonthView!=false){this.monthView=this.createAutoChild("monthView",{baseStyle:this.baseStyle,viewName:"month"});_1.add({title:this.monthViewTitle,pane:this.monthView,viewName:"month"})}
...
);isc.B._maxIndex=isc.C+15;isc.ClassFactory.defineClass("EventWindow","Window");isc.EventWindow.changeDefaults("resizerDefaults",{overflow:"hidden",height:3,snapTo:"B",canDragResize:true})
...
,isc.A.dragResizeStart=function(){var _1=(this.getTop()+this.getVisibleHeight())%this.parentElement.snapVGap;this.parentElement.VSnapOrigin=_1}
,isc.A.dragResizeStop=function(){var _1=this.calendar,_2,_3,_4=this.ns.EH,_5,_6=this.getPageLeft()-this.getLeft(),_7=_4.dragMoveTarget.getLeft()-_6;if(_7==this.getLeft()){_2=this.event[_1.startDateField].duplicate();var _8=(_7+_4.dragMoveTarget.getVisibleWidth());_3=_1.timelineView.getDateFromPoint(_8)}else{_2=_1.timelineView.getDateFromPoint(_7);_3=this.event[_1.endDateField].duplicate()}
if(!_1.timelineEventResized(this,this.event,_2,_3))return false;_1.updateEvent(this.event,_2,_3,this.event[_1.nameField],this.event[_1.descriptionField],null,true)}
...
this.addEvent(_4,i)}
this.clearEvents(_2)}
,isc.A.tagDataForOverlap=function(_1,_2){if(_1.getLength()==0)return;var _3=this.creator,_4=[],_5=0,_6=0,_7=0,_8=_1.get(0)[_3.eventTypeField];_1.sort(function(_18,_19){var _9;if(_18[_3.leadingDateField]&&_19[_3.leadingDateField])_9=_3.leadingDateField;else _9=_3.startDateField;if(_18[_3.eventTypeField]<_19[_3.eventTypeField])return-1;else if(_18[_3.eventTypeField]>_19[_3.eventTypeField])return 1;else{if(_18[_9]<_19[_9])return-1;else if(_18[_9]>_19[_9])return 1;else return 0}});var _10=0,_11=[];if(_2){while(_1.get(_10)[_3.eventTypeField]!=_2&&_10<_1.getLength()){_10++}}
...
var _14=true;var _15=[];for(var j=0;j<_4.length;j++){var _17=_4[j];if(this.eventsOverlap(_13,_17)){_15.add(_17)}else{_5--;if(_5==0)_6=1;_14=false}}
_4=_15;_4.add(_13);_5++;if(_14&&_4.length>_6){_6++}
for(var j=0;j<_4.length;j++){var _17=_4[j];if(!_17.$646)_17.$646={};if(!_17.$646.visited){_17.$646.slotNum=null;_17.$646.slotNum=this.nextAvailSlot(_4);_17.$646.visited=true}
_17.$646.totalSlots=_6}
if(_6>_7)_7++}
return _11}
,isc.A.nextAvailSlot=function(_1){var _2=1;for(var i=0;i<_1.length;i++){var _4=_1[i];if(!_4.$646)continue;if(_4.$646.slotNum==_2){_2++}
else return _2}
return _2}
,isc.A.eventsOverlap=function(_1,_2){var _3,_4,_5=this.creator;if(_1[_5.leadingDateField]&&_2[_5.leadingDateField])_3=_5.leadingDateField;else _3=_5.startDateField;if(_1[_5.trailingDateField]&&_2[_5.trailingDateField])_4=_5.trailingDateField;else _4=_5.endDateField;if((_1[_3]>_2[_3]&&_1[_3]<_2[_4])||(_1[_4]<_2[_4]&&_1[_4]>_2[_3])||(_1[_3]<_2[_3]&&_1[_4]>_2[_4])){return true}else{return false}}
...
return 0}
,isc.A.getDateFromPoint=function(_1){var _2=this.startDate.duplicate();var _3=this.eventWidth;var _4=this.$731();var _5=0;_5+=Math.floor(_1/ _3)*_4;_5+=((_1%_3)/_3)*_4;_2.setMinutes(_2.getMinutes()+_5);return _2}
...
return _3}
,isc.A.$732=function(_1){var _2=_1.getEventLength();var _3=this.eventWidth;var _4=this.$731();var _5=0;var _6=Math.floor(_2/ _4);if(this.creator.sizeEventsToGrid){if(_6==0)_6=1}
_5+=_6*_3;if(this.creator.sizeEventsToGrid==false){_5+=Math.floor(((_2%_4)/_4)*_3)}
return _5}
...
return _5}
,isc.A.sizeEventWindow=function(_1,_2){var _3=this.creator,_4=_1.event,_5=this.eventWidth,_6=this.eventHeight;var _7=_4[_3.eventWindowStyleField];if(_7)_1.setStyleName(_7);if(_4.eventWindowBackgroundColor)_1.setBackgroundColor(_4.eventWindowBackgroundColor);else _1.setBackgroundColor(null);_5=this.$732(_1);var _8=this.getEventLeft(_4);_1.setTitle(_3.getEventTitle(_4));if(_2)_1.redraw();var _9=this.data.findIndex(this.eventTypeField,_4[this.eventTypeField]);var _10=_9*_6;this.adjustDimensionsForOverlap(_1,_8,_10,_5,_6);if(_3.showDescription!=false){_1.setDescriptionText(_4[_3.descriptionField])}
...
,isc.A.clearEvents=function(_1){if(!this.body||!this.body.children)return;if(!_1)_1=0;for(var i=_1;i<this.$65u.length;i++){this.$65u[i].hide()}}
...
var _1=this.body.getScrollLeft();var _2=_1+this.body.getVisibleWidth();var _3=this.getDateFromPoint(_1);var _4=this.getDateFromPoint(_2);return[_3,_4]}
