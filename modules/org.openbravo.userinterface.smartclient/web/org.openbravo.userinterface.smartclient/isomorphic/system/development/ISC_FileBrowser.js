...
parentID:{foreignKey:"Filesystem.path",hidden:true,name:"parentID",required:true,rootValue:"/",
type:"text"},
name:{name:"name",type:"text"},
isFolder:{name:"isFolder",type:"boolean"},
size:{name:"size",type:"long"},
lastModified:{name:"lastModified",type:"lastModified"},
mimeType:{name:"mimeType",type:"text"},
contents:{name:"contents",size:"1000000",type:"text"}
}
})
