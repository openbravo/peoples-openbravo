...
,isc.A.addPortlet=function(_1,_2){var _3=this.getMembers();if(_3==null)_2=0;else if(_2>_3.length)_2=_3.length;var _4=this.createAutoChild("row",{showResizeBar:this.canResizeRows});this.addMember(_4,_2);_4.addMember(_1)}
