...
isc.Date.shortMonthNames = [
    getLabel('OBUISC_Date.shortMonthNames.Jan'),
    getLabel('OBUISC_Date.shortMonthNames.Feb'),
    getLabel('OBUISC_Date.shortMonthNames.Mar'),
    getLabel('OBUISC_Date.shortMonthNames.Apr'),
    getLabel('OBUISC_Date.shortMonthNames.May'),
    getLabel('OBUISC_Date.shortMonthNames.Jun'),
    getLabel('OBUISC_Date.shortMonthNames.Jul'),
    getLabel('OBUISC_Date.shortMonthNames.Aug'),
    getLabel('OBUISC_Date.shortMonthNames.Sep'),
    getLabel('OBUISC_Date.shortMonthNames.Oct'),
    getLabel('OBUISC_Date.shortMonthNames.Nov'),
    getLabel('OBUISC_Date.shortMonthNames.Dec')
];
...
isc.ListGrid.addProperties({removeFieldTitle: getLabel('OBUISC_ListGrid.removeFieldTitle')});
isc.ListGrid.addProperties({cancelEditingConfirmationMessage: getLabel('OBUISC_ListGrid.cancelEditingConfirmationMessage')});
isc.ListGrid.addProperties({confirmDiscardEditsMessage: getLabel('OBUISC_ListGrid.confirmDiscardEditsMessage')});
isc.ListGrid.addProperties({discardEditsSaveButtonTitle: getLabel('OBUISC_ListGrid.discardEditsSaveButtonTitle')});
isc.ListGrid.addProperties({freezeOnRightText: getLabel('OBUISC_ListGrid.freezeOnRightText')});
isc.ListGrid.addProperties({freezeOnLeftText: getLabel('OBUISC_ListGrid.freezeOnLeftText')});
isc.ListGrid.addProperties({sortFieldAscendingText: getLabel('OBUISC_ListGrid.sortFieldAscendingText')});
isc.ListGrid.addProperties({sortFieldDescendingText: getLabel('OBUISC_ListGrid.sortFieldDescendingText')});
isc.ListGrid.addProperties({fieldVisibilitySubmenuTitle: getLabel('OBUISC_ListGrid.fieldVisibilitySubmenuTitle')});
isc.ListGrid.addProperties({freezeFieldText: getLabel('OBUISC_ListGrid.freezeFieldText')});
isc.ListGrid.addProperties({unfreezeFieldText: getLabel('OBUISC_ListGrid.unfreezeFieldText')});
isc.ListGrid.addProperties({groupByText: getLabel('OBUISC_ListGrid.groupByText')});
isc.ListGrid.addProperties({ungroupText: getLabel('OBUISC_ListGrid.ungroupText')});
isc.ListGrid.addProperties({fieldVisibilitySubmenuTitle: getLabel('OBUISC_ListGrid.fieldVisibilitySubmenuTitle')});
isc.ListGrid.addProperties({clearSortFieldText: getLabel('OBUISC_ListGrid.clearSortFieldText')});
