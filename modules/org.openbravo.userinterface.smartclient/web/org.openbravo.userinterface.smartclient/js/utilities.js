...
//
OB.Utilities.getDataSource = function(/* String */dataSourceId, /* Object */
...
OB.Utilities.applyDefaultValues = function(/* Object */fields, /* Object */
    defaultValues) {
...
OB.Utilities.updateSmartClientComponentValue = function(/* Object */input, /* Object */
    component) {
...
OB.Utilities.Date.OBToJS = function(/* String */OBDate, /* String */
    dateFormat) {
  if (!OBDate) {
    return null;
  }
  ...
  var fullYear = dateFormat.indexOf("%Y") !== -1 ? OBDate.substring(dateFormat
      .indexOf("%Y"), dateFormat.indexOf("%Y") + 4) : 0;
...
// Return:
// * The plain OB number
OB.Utilities.Number.OBMaskedToOBPlain = function(/* String */number, /* String */
    decSeparator, /* String */groupSeparator) {
  ...
  while (plainNumber.substring(0, 1) === "0"
      && plainNumber.substring(1, 2) !== decSeparator && plainNumber.length > 1) {
...
OB.Utilities.Number.OBPlainToOBMasked = function(/* Number */number, /* String */
    maskNumeric, /* String */decSeparator, /* String */groupSeparator, /* String */
    groupInterval) {
...
// Return:
// * The JS number.
OB.Utilities.Number.OBMaskedToJS = function(number, decSeparator,
    groupSeparator) {
  var calcNumber = number;
  calcNumber = OB.Utilities.Number.OBMaskedToOBPlain(calcNumber, decSeparator,
      groupSeparator);
