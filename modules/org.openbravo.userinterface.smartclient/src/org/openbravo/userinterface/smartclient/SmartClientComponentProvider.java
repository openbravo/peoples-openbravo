...
public class SmartClientComponentProvider extends BaseComponentProvider {
  ...
  public Component getComponent(String componentId, Map<String, Object> parameters) {
    if (componentId.equals(SmartClientConstants.SC_APPLICATION_COMPONENT_ID)) {
      final ApplicationComponent component = new ApplicationComponent();
      component.setId(componentId);
      component.setParameters(parameters);
      return component;
    }
    if (componentId.equals(SmartClientConstants.SC_TYPES_COMPONENT_ID)) {
  ...
  public List<String> getGlobalResources() {
    ...
    globalResources.add("org.openbravo.client.kernel/" + SmartClientConstants.SC_COMPONENT_TYPE
        + "/" + SmartClientConstants.SC_APPLICATION_COMPONENT_ID);
    // globalResources
    // .add("web/org.openbravo.userinterface.smartclient/openbravo/skins/2.50_emulation/smartclient/load_skin.js");
    // globalResources
    // .add("web/org.openbravo.userinterface.smartclient/openbravo/skins/3.00/smartclient/load_skin.js");
    globalResources.add("\"+ OB_smartClientSkinLocation + \"load_skin.js");
    globalResources.add("web/org.openbravo.userinterface.smartclient/js/utilities.js");
    globalResources.add("web/org.openbravo.userinterface.smartclient/js/ob_formitem_widgets.js");
    globalResources.add("web/org.openbravo.userinterface.smartclient/js/ob_quickrun_widget.js");
    // types are done after the widgets so that the editor type is available
    globalResources.add("org.openbravo.client.kernel/" + SmartClientConstants.SC_COMPONENT_TYPE
        + "/" + SmartClientConstants.SC_TYPES_COMPONENT_ID);
  ...
  public String getComponentType() {
    return SmartClientConstants.SC_COMPONENT_TYPE;
  }
