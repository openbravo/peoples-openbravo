...
isc.OBSelectorWidget
    .addProperties( {
      ...
      setSelectorValueFromGrid : function() {
        var changed = false, oldValue = this.selector.openbravoField.value, selected = this.selector.selectorGrid
            .getSelectedRecord(), newValue;
        if (selected) {
      ...
      setSelectorValueFromField : function(form, item, value) {
        ...
        var oldValue = item.selector.openbravoField.value, changed = false, selected = item.selector.selectorField
            .getSelectedRecord();
      ...
      openbravoChanged : function(/* Object */selected) {
        ...
        function changeField(field, value) {
          ...
          if (field) {
            ...
            if (inputId) {
              inputId.value = value === undefined || value === null ? ""
                  : value;
    ...
    if (this.selectorField.getDisplayValue()) { // Prevents overriding a default
      // value with empty
      this.defaultFilter[this.defaultPopupFilterField] = this.selectorField
          .getDisplayValue();
    }
      ...
      openSelectorWindow : function(form, field, icon) {
        ...
        OB.RemoteCallManager
            .call(
                ...
                data, data, this.ID
                    + ".fetchDefaultsCallback(rpcResponse, data, rpcRequest)");
      },

      // ** {{{ checkDefaultValidations }}} **
      // checks mandatory constraint
      checkDefaultValidations : function(form, item) {
        var missingSpan = document.getElementById(this.openbravoField.id
            + "missingSpan");
        var invalidSpan = document.getElementById(this.openbravoField.id
            + "invalidSpan");
      ...
      getSelectorContainerHtmlObj : function() {
        ...
        for (;;) {
          for (;;) {
            ...
            if ((childObj.tagName.toLowerCase() === 'div' && childObj
                .getAttribute('id'))
      ...
      setFilterEditorProperties : function(gridFields) {
        ...
        for ( var i = 0; i < gridFields.length; i++) {
          ...
          icons[iconsLength] = {
            ...
            click : (function() {
              return function(form, item, icon) {
                item.setValue(null);
              ...
              dataArrived : function() {
                ...
                if (!this.getSelectedRecord()) {
                  if (this.selector.openbravoField.value !== '') {
                    this.selectSingleRecord(this.data.find(this.selector,
                        this.selector.openbravoField.value));
                  } else {
