...
// filterEditorIcon is shown in the popup grid next to each field.
     ...
     // ** {{{ fieldPicker properties }}} **
        ...
        // ** {{{ ListGrid properties }}} **
        // ListGrid shown inside the modal popup after clicking the field picker icon.
...
isc.OBSelectorWidget
    .addProperties( {
      ...
      // ** {{{ Datasource }}} **
      // the datasource is a mandatory field which must be set when creating the widget.
      dataSource : null,
      ...
      autoDraw : true,
      numCols : 2,
      width : 280, // note is set again in the initialization
      ...
      setSelectorValueFromField : function(form, item, value) {
        ...
        if (selected) {
          changed = (oldValue !== item.selector.selectorField
              .getSelectedRecord()[item.selector.valueField]);
          item.selector.openbravoField.value = item.selector.selectorField
              .getSelectedRecord()[item.selector.valueField];
        } else {
          changed = (oldValue !== '');
      ...
      openbravoChanged : function(/*Object*/ selected) {
        var selectedObj = {},
            fieldsLength = this.outFields.length, i;

        function changeField(field, value) {
          var inputId = document.getElementById(field);
          if(inputId) {
        ...
        var valueSet = this.openbravoField.value !== null &&
      ...
      openSelectorWindow : function(form, field, icon) {
        ...
        // first time
        initialFilter[this.defaultPopupFilterField] = field.getDisplayValue();
        setOBTabBehavior(false);
        form.selectorWindow.show();
        if (field.getSelectedRecord() === null || this.openbravoField.value === '' ||
            this.openbravoField.value === null) {
          // only set the filter if there is not a single
          // selected value
          form.selectorGrid.setFilterEditorCriteria(initialFilter);
        } else {
        ...
        if (this.openbravoField.value !== '') {
          form.selectorGrid.selectSingleRecord(form.selectorGrid.data.find(
              'id', this.openbravoField.value));
        } else {
      ...
      checkDefaultValidations : function(form, item) {
        ...
        if (this.selectorField.getDisplayValue().length > 0 &&
      ...
      getSelectorContainerHtmlObj : function() {
        ...
        for (;;) {
          for (;;) {
            ...
            if ((childObj.tagName.toLowerCase() == 'div' && childObj.getAttribute('id')) ||
      ...
      setFilterEditorProperties : function(gridFields) {
        ...
        for ( var i = 0; i < gridFields.length; i++) {
          ...
          icons[iconsLength] = {
            ...
            hspace : isc.OBSelectorWidget.styling.filterEditorClearIconHSpace, // note
            // unsupported
            // feature:
            // http://forums.smartclient.com/showthread.php?p=34868
            click : function(form, item, icon) {
              item.setValue(null);
              this.selector.selectorGrid.focusInFilterEditor(item);
              this.selector.selectorGrid.filterByEditor();
            }
          };
        }
      },
      ...
      this
          .setFields( [ {
            ...
            icons : [ {
              ...
              hspace : isc.OBSelectorWidget.styling.fieldPickerIconHSpace, // note
              // unsupported
              // feature:
              // http://forums.smartclient.com/showthread.php?p=34868
            ...
            focus : function(form, item) {
              ...
              if (typeof setWindowElementFocus === "function") {
                ...
                setWindowElementFocus(document
                    .getElementById(this.selector.openbravoField.id), 'obj'); 
              }
      ...
      if (this.showSelectorGrid) {
        ...
        this.selectorGrid = isc.ListGrid
            .create( {

              selector : this, // pointer back to the
              // dynamic form
              ...
              // and call the super
              return this.Super("filterData", [ criteria, callback,
                  requestProperties ]);
            },
            ...
            dataArrived : function() {
              ...
              if (!this.getSelectedRecord()) {
                if (this.selector.openbravoField.value !== '') {
                  this.selectSingleRecord(this.data.find('id',
                      this.selector.openbravoField.value));
                } else {
        ...
        this.selectorWindow = isc.Window
            .create( {
              title : this.title,
              selector : this,
              autoSize : false,
                        ...
                        members : [
                            ...
                            isc.IButton
                                .create( {
                                  selector : this,
                                  title : OB.I18N
                                      .getLabel('OBUISC_Dialog.OK_BUTTON_TITLE'),
                                  endRow : false,
                                  startRow : false,
                            ...
                            isc.IButton
                                .create( {
                                  selector : this,
                                  title : OB.I18N
                                      .getLabel('OBUISC_Dialog.CANCEL_BUTTON_TITLE'),
                                  endRow : false,
                                  startRow : false,
