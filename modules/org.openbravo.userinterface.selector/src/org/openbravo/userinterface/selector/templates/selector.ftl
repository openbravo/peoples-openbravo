...
<@compress single_line=true>
    ...
    '${selectorOutField.outFieldName}': {'fieldName':'${selectorOutField.tabFieldName}', 'suffix': '${selectorOutField.outSuffix}', 'numericMask': '${selectorOutField.numericMask}', 'decimalSymbol': '${selectorOutField.decimalSymbol}', 'groupingSymbol': '${selectorOutField.groupingSymbol}', 'groupingSize': '${selectorOutField.groupingSize}'}<#if selectorOutField_has_next>,</#if>
    </#if>
    </#list>
</@compress>
    },
