...
public class SelectorComponentProvider extends BaseComponentProvider {
  ...
  public List<String> getGlobalResources() {
    ...
    resources.add("web/org.openbravo.userinterface.selector/js/ob-selector-widget.js");
    resources.add("web/org.openbravo.userinterface.selector/js/ob-selector-link-widget.js");
    return resources;
  }
