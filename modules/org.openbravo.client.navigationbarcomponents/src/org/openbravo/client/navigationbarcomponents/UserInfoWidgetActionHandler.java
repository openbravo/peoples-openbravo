 ...
 */
@Name("org.openbravo.client.navigationbarcomponents.UserInfoWidgetActionHandler")
...
public class UserInfoWidgetActionHandler extends BaseActionHandler {
  ...
  public String getName() {
    return "org.openbravo.client.navigationbarcomponents.UserInfoWidgetActionHandler";
  }
  ...
  protected JSONObject execute(Map<String, Object> parameters, String content) {
    final String command = (String) parameters.get(MainLayoutConstants.COMMAND);
    OBContext.setAdminMode();
    try {
      if (command == null) {
        throw new IllegalArgumentException("command parameter not specified");
      }
      if (command.equals(MainLayoutConstants.SAVE_COMMAND)) {
        return executeSaveCommand(parameters, content);
      } else if (command.equals(MainLayoutConstants.DATA_COMMAND)) {
        return executeDataCommand(parameters, content);
      } else if (command.equals(MainLayoutConstants.CHANGE_PWD_COMMAND)) {
  ...
  protected JSONObject executeChangePasswordCommand(Map<String, Object> parameters, String content)
    ...
    return MainLayoutConstants.ACTION_RESULT_SUCCESS;
  }
