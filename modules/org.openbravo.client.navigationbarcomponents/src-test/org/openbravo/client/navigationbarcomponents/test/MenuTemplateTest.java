...
import org.openbravo.client.navigationbarcomponents.ApplicationMenuComponent;
...
public class MenuTemplateTest extends BaseTest {
  ...
  public void testApplication() throws Exception {
    ...
    // this means that we don't need to run in Seam Context
    appMenuComponent.setMenuManager(new MenuManager());
