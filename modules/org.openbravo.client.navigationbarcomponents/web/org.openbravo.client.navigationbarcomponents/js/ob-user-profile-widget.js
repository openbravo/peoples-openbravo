...
isc.OBUserProfile
    .addProperties( {
      ...
      iconSpacing : 10,
      icon : {
        src : "[SKINIMG]../../org.openbravo.client.navigationbarcomponents/images/ico-green-arrow-down.gif"
      },
      ...
      prompt : "<b>" + OB.I18N.getLabel('UINAVBA_Role') + "</b>: " +
          OB.User.roleName + "<br/>" + "<b>" +
          OB.I18N.getLabel('UINAVBA_Client') + "</b>: " + OB.User.clientName +
          "<br/>" + "<b>" + OB.I18N.getLabel('UINAVBA_Organization') +
          "</b>: " + OB.User.organizationName,
      hoverWidth : 200,

      showTitle : true,

      // correct for the situation that the focus box is over the log out button
      // as well
      ...
      initWidget : function() {
        ...
        var roleForm = isc.DynamicForm
            .create( {
              ...
              reset : function() {
                ...
                roleForm.setValue("role",
                    roleForm.localFormData.initialValues.role);
              ...
              setValueMaps : function() {
                ...
                for ( var i = 0; i < roleForm.localFormData.role.roles.length; i++) {
                  ...
                  if (role.id === roleId) {
                    ...
                    roleForm.setValueMap("organization",
                        role.organizationValueMap);
              ...
              doSave : function() {
                OB.RemoteCallManager.call(this.formActionHandler, this
                    .getValues(), {
                  "command" : "save"
                }, this.doSaveCallback);
              },
              ...
              doSaveCallback : function(rpcResponse, data, rpcRequest) {
                if (data.result === OB.Constants.SUCCESS) {
                  ...
                  window.location.href = OB.Utilities
                      .getLocationUrlWithoutFragment();
                } else {
              ...
              fields : [ roleField, clientField, orgField, warehouseField,
                  languageField, defaultField ]
            });
        ...
        buttonLayout.addMembers(isc.Button.create( {
          autoFit : true,
          baseStyle : "navBarFormButton",
        ...
        var passwordForm = isc.DynamicForm
            .create( {
              autoFocus : true,
              overflow : "visible",
              width : "100%",
                ...
                if (data.result === OB.Constants.SUCCESS) {
                  ...
                  if (data.fields) {
                    for ( var i = 0; i < data.fields.length; i++) {
                      ...
                      passwordForm.addFieldErrors(field.field, OB.I18N
                          .getLabel(field.messageCode), true);
                    }
                  }
                }
              },
              ...
              itemChanged : function(item, newValue) {
                ...
                if (item.name === "newPwd" || item.name === "confirmPwd") {
                  if (!OB.Utilities.areEqualWithTrim(newPwd, confirmPwd)) {
                    passwordForm.addFieldErrors("confirmPwd", OB.I18N
                        .getLabel("UINAVBA_UnequalPwd"), true);
                  }
                }
        ...
        var pwdSaveButton = isc.Button.create( {
          autoFit : true,
          baseStyle : "navBarFormButton",
          title : OB.I18N.getLabel('UINAVBA_Save'),
        ...
        pwdButtonLayout.addMembers(isc.Button.create( {
          autoFit : true,
          baseStyle : "navBarFormButton",
          title : OB.I18N.getLabel('UINAVBA_Cancel'),
          click : isc.OBQuickRun.hide
