...
OB.Utilities.paymentMethodOnChangeFunction = function (item, view, form, grid) {
...
OB.Utilities.paymentMethodOnLoadFunction = function (view) {
...
OB.Utilities.transactionTypeOnChangeFunction = function (item, view, form, grid) {
