...
class ZeroPaymentamtDepositAmtTransactionsData implements FieldProvider {
static Logger log4j = Logger.getLogger(ZeroPaymentamtDepositAmtTransactionsData.class);
  ...
  public static ZeroPaymentamtDepositAmtTransactionsData[] dummy(ConnectionProvider connectionProvider)    throws ServletException {
    return dummy(connectionProvider, 0, 0);
  }

  public static ZeroPaymentamtDepositAmtTransactionsData[] dummy(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ZeroPaymentamtDepositAmtTransactionsData objectZeroPaymentamtDepositAmtTransactionsData = new ZeroPaymentamtDepositAmtTransactionsData();
        objectZeroPaymentamtDepositAmtTransactionsData.documentno = UtilSql.getValue(result, "documentno");
        objectZeroPaymentamtDepositAmtTransactionsData.finFinaccTransactionId = UtilSql.getValue(result, "fin_finacc_transaction_id");
        objectZeroPaymentamtDepositAmtTransactionsData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectZeroPaymentamtDepositAmtTransactionsData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectZeroPaymentamtDepositAmtTransactionsData.adRoleId = UtilSql.getValue(result, "ad_role_id");
        objectZeroPaymentamtDepositAmtTransactionsData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectZeroPaymentamtDepositAmtTransactionsData);
    ...
    ZeroPaymentamtDepositAmtTransactionsData objectZeroPaymentamtDepositAmtTransactionsData[] = new ZeroPaymentamtDepositAmtTransactionsData[vector.size()];
    vector.copyInto(objectZeroPaymentamtDepositAmtTransactionsData);
    return(objectZeroPaymentamtDepositAmtTransactionsData);
  }

/**
This query returns payments that are wrongly linked to more than one transaction
 */
  public static ZeroPaymentamtDepositAmtTransactionsData[] selectZeroPaymentamtDepositamtTransactions(ConnectionProvider connectionProvider)    throws ServletException {
    return selectZeroPaymentamtDepositamtTransactions(connectionProvider, 0, 0);
  }

/**
This query returns payments that are wrongly linked to more than one transaction
 */
  public static ZeroPaymentamtDepositAmtTransactionsData[] selectZeroPaymentamtDepositamtTransactions(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ZeroPaymentamtDepositAmtTransactionsData[] getRoleId(ConnectionProvider connectionProvider, String window, String clientId)    throws ServletException {
    return getRoleId(connectionProvider, window, clientId, 0, 0);
  }

  public static ZeroPaymentamtDepositAmtTransactionsData[] getRoleId(ConnectionProvider connectionProvider, String window, String clientId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
