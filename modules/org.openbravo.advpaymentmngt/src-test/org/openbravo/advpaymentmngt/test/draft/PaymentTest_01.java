...
public class PaymentTest_01 extends BaseTest {
  ...
  public void testRunPayment_01() {
    ...
    try {
      ...
      payment = TestUtility.addPaymentFromInvoice(invoice, OBDal.getInstance().get(
          FIN_FinancialAccount.class, financialAccountId), invoice.getGrandTotalAmount());
  ...
  private Invoice dataSetup() throws Exception {
    ...
    FIN_PaymentMethod testPaymentMethod = TestUtility.insertPaymentMethod("APRM_PM_PAYMENT_01",
        STANDARD_DESCRIPTION, true, false, false, MANUAL_EXECUTION, null, IN_TRANSIT_ACCOUNT,
        DEPOSIT_ACCOUNT, CLEARED_ACCOUNT, true, false, false, MANUAL_EXECUTION, null,
    ...
    Invoice invoice = TestUtility.createNewInvoice(OBContext.getOBContext().getCurrentClient(),
        ...
        netListPrice, priceLimit, testTaxRate, lineNetAmount);
