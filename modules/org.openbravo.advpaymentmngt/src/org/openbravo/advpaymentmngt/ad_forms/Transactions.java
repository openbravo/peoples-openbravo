...
public class Transactions extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      Boolean hideReconciledTrx = vars.getStringParameter("inpHideReconciled", "Y").equals("Y");
      ...
      Boolean hideReconciledTrx = vars.getStringParameter("inpHideReconciled").equals("Y");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "../FinancialAccount/Transactions5B9941AC1F6A4529A76FCA7CDA0A7D7A", (strCommand
