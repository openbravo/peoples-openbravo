...
public class AddOrderOrInvoice extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        ...
        if (exchangeRate.compareTo(payment.getFinancialTransactionConvertRate()) != 0) {
          payment.setFinancialTransactionConvertRate(exchangeRate);
        }
        if (convertedAmount.compareTo(payment.getFinancialTransactionAmount()) != 0) {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    xmlDocument.setParameter("exchangeRate", Convert.toString(payment.getFinancialTransactionConvertRate()));
    xmlDocument.setParameter("actualConverted", Convert.toString(payment.getFinancialTransactionAmount()));
    xmlDocument.setParameter("expectedConverted", Convert.toString(payment.getFinancialTransactionAmount()));
