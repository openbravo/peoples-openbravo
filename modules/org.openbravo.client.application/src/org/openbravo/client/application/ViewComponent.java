...
public class ViewComponent extends BaseComponent {
  ...
  public String generate() {
    ...
    try {
      ...
      final String correctedViewId = (viewId.startsWith(KernelConstants.ID_PREFIX) ? viewId
          .substring(1) : viewId);
      final Window window = OBDal.getInstance().get(Window.class, correctedViewId);
      if (window != null) {
  ...
  protected String generateWindow(Window window) {
    final StandardWindowComponent standardWindowComponent = new StandardWindowComponent();
