...
public class ApplicationComponentProvider extends BaseComponentProvider {
  ...
  public List<ComponentResource> getGlobalComponentResources() {
    ...
    globalResources.add(createStaticResource(
        "web/org.openbravo.client.application/js/form/formitem/ob-formitem-chvalue-tree-filter.js",
        true));
    globalResources.add(createStaticResource(
    ...
    globalResources.add(createStaticResource("web/js/changeHandlingUnitStatusProcess.js", true));
