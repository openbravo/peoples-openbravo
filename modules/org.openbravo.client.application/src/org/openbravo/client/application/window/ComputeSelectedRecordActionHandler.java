 ...
 */
@Name("org.openbravo.client.application.window.ComputeSelectedRecordActionHandler")
...
public class ComputeSelectedRecordActionHandler extends BaseActionHandler {
  ...
  public String getName() {
    return "org.openbravo.client.application.window.ComputeSelectedRecordActionHandlerActionHandler";
  }
  ...
  public void execute() {
    ...
    try {
      ...
      final List<MenuOption> menuOptions = MenuManager.getMenuManager().getSelectableMenuOptions();
