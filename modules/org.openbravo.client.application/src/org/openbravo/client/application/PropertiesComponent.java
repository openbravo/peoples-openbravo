...
public class PropertiesComponent extends BaseTemplateComponent {
  ...
  protected Template getComponentTemplate() {
    return OBDal.getInstance().get(Template.class, MainLayoutConstants.PROPERTIES_TEMPLATE_ID);
  }
   ...
   */
  public String getId() {
    return MainLayoutConstants.PROPERTIES_COMPONENT_ID;
  }
  ...
  public String getETag() {
    return OBContext.getOBContext().getUser().getId() + "_"
        + OBContext.getOBContext().getLanguage().getId() + "_" + getLastModified().getTime();
  }
