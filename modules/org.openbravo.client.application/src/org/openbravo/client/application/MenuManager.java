 ...
 * @author mtaal
 */
@Name("org.openbravo.client.navigationbarcomponents.MenuManager")
...
public class MenuManager implements Serializable {
  ...
  private void linkMenus() {
    final String menuHql = "select m from ADMenu m left join fetch m.aDMenuTrlList where m.active=true and m.module.enabled=true";
  ...
  private void createInitialMenuList() {
    ...
    for (TreeNode treeNode : tree.getADTreeNodeList()) {
