...
public class MenuManager implements Serializable {
  ...
  private static final String SESSION_PARAM = "_MenuManager";

  public static synchronized MenuManager getMenuManager() {
    // not running in a servlet request, just return a new MenuManager each time
    if (RequestContext.get() == null) {
      return new MenuManager();
    }
    MenuManager instance = (MenuManager) RequestContext.get().getSession().getAttribute(
        SESSION_PARAM);
    if (instance == null) {
      instance = new MenuManager();
      RequestContext.get().getSession().setAttribute(SESSION_PARAM, instance);
    }
    return instance;
  }
  ...
  private void linkForms() {
    ...
    for (MenuOption menuOption : menuOptions) {
      if (menuOption.getMenu() != null && menuOption.getMenu().getSpecialForm() != null) {
        boolean hasAccess = ActivationKey.getInstance().hasLicenseAccess("X",
  ...
  private void linkProcesses() {
    ...
    for (Object processObj : allowedProcessQry.list()) {
      boolean hasAccess = ActivationKey.getInstance().hasLicenseAccess("P",
  ...
  private void linkWindows() {
    ...
    for (MenuOption menuOption : menuOptions) {
      if (menuOption.getMenu() != null && menuOption.getMenu().getWindow() != null) {
        boolean hasAccess = ActivationKey.getInstance().hasLicenseAccess("MW",
