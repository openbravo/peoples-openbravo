 ...
 */
@Name("org.openbravo.client.application.navigationbarcomponents.UserInfoWidgetActionHandler")
@Scope(ScopeType.APPLICATION)
@Startup
@AutoCreate
public class UserInfoWidgetActionHandler extends BaseActionHandler {

  private static String NAME = "org.openbravo.client.application.navigationbarcomponents.UserInfoWidgetActionHandler";
