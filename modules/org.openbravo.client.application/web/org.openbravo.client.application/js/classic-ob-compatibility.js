    ...
    Keyboard : {
      getMDIKS: function() {
        ...
        for (var i=0; i<LKS.list.length; i++) {
          ...
          //Special keys nomenclature adaptation from Smartclient way to classic utils.js way
          ...
          ClassicKeyJSON.push( {"key": key, "auxKey": auxKey, "action": action, "funcParam": funcParam} );
        }
