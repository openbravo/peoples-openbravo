    ...
    .addProperties( {
      ...
      initWidget : function() {
        ...
        if (this.editGrid) {
          ...
          localEditLinkField = isc.addProperties( {},
              this.editLinkFieldProperties);
        ...
        this.checkboxFieldDefaults = isc.addProperties(
            this.checkboxFieldDefaults, {
              canFilter : true,
        ...
        this.noDataEmptyMessage = OB.I18N
            .getLabel('OBUISC_ListGrid.loadingDataMessage'); // OB.I18N.getLabel('OBUIAPP_GridNoRecords')
                                                              // + ' <span
                                                              // onclick="window[\''
                                                              // + this.ID +
                                                              // '\'].createNew();"
      ...
      setFieldProperties : function(field, properties) {
        ...
        if (this.isCheckboxField(localField) && properties) {
          ...
          properties.prompt = OB.I18N
              .getLabel('OBUIAPP_GridSelectAllColumnPrompt');
        }
      ...
      updateRowCountDisplay : function() {
        ...
        if (this.filterEditor && this.filterEditor.getEditForm()) {
          this.filterEditor.getEditForm().setValue(
              isc.OBViewGrid.EDIT_LINK_FIELD_NAME, newValue);
        }
      },
      ...
      delayedHandleTargetRecord : function(startRow, endRow) {
        ...
        if (this.body) {
          ...
          this.delayCall('delayedHandleTargetRecord', [ startRow, endRow ],
              200, this);
        }
      },
      ...
      filterData : function(criteria, callback, requestProperties) {
        ...
        return this.Super('filterData', [ this.convertCriteria(criteria),
            newCallBack, requestProperties ]);
      },
      ...
      recordClick : function(viewer, record, recordNum, field, fieldNum, value,
        ...
        if (this.view.autoSaveForm) {
          ...
          this.handleRecordSelection(viewer, record, recordNum, field,
              fieldNum, value, rawValue, false);
        }
      },
      ...
      resetEmptyMessage : function(criteria) {
        ...
        if (!this.view) {
          ...
          if (selectedValues.length === 0) {
            ...
            this.emptyMessage = OB.I18N
                .getLabel('OBUIAPP_MultipleParentsSelected');
          } else {
            this.emptyMessage = this.noDataEmptyMessage;
          }
        }
      ...
      cellContextClick : function(record, rowNum, colNum) {
        this.handleRecordSelection(null, record, rowNum, null, colNum, null,
            null, true);
        ...
        if (field.foreignKeyField) {
          menuItems.add( {
            ...
            click : function() {
              ...
              OB.Utilities.openDirectView(sourceWindow,
                  field.referencedKeyColumnName, field.targetEntity,
                  record[fldName]);
            }
          });
        }
      ...
      updateSelectedCountDisplay : function() {
        ...
        if (this.filterEditor) {
          this.filterEditor.getEditForm().setValue(
              this.getCheckboxField().name, newValue);
        }
      },
      ...
      selectOnMouseDown : function(record, recordNum, fieldNum) {
        ...
        if (this.view.autoSaveForm) {
          ...
          if (this.getCheckboxFieldPosition() === fieldNum) {
            this
                .setActionAfterAutoSave(this, this.selectOnMouseDown, arguments);
          }
          return;
        }
      ...
      handleRecordSelection : function(viewer, record, recordNum, field,
          fieldNum, value, rawValue, fromSelectOnMouseDown) {
      ...
      editFailed : function(rowNum, colNum, newValues, oldValues,
        ...
        var view = this.view;
        if (dsResponse) {
          view.setErrorMessageFromResponse(dsResponse, dsResponse.data,
              dsRequest);
        }
        if (!view.isVisible()) {
          isc
              .warn(OB.I18N
                  .getLabel('OBUIAPP_AutoSaveError', [ view.tabTitle ]));
        }
        this.view.updateTabTitle();
        this.view.toolBar.updateButtonState();
      },
      ...
      discardEdits : function(rowNum, colNum, dontHideEditor,
        ...
        if (this.getEditForm().valuesHaveChanged()) {
          isc.ask(OB.I18N.getLabel('OBUIAPP_ConfirmCancelEdit'),
              function(value) {
                if (value) {
                  this.view.updateTabTitle();
                  this.view.toolBar.updateButtonState();
      ...
      rowEditorExit : function(editCompletionEvent, record, newValues, rowNum) {
        ...
        if (record && record.editColumnLayout) {
          ...
          isc.Log.logDebug(
              'hideInlineEditor has NO record and editColumnLayout', 'OB');
        }
