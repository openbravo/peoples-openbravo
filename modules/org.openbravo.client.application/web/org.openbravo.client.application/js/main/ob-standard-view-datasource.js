  ...
  transformResponse: function (dsResponse, dsRequest, jsonData) {
    ...
    if (jsonData) {
      ...
      if (errorStatus) {
        ...
        if ((dsRequest.operationType === 'update' || dsRequest.operationType === 'add') && this.view.viewForm && jsonData.response && jsonData.response.data && jsonData.response.data.length === 1 && dsRequest.documentParameters && dsRequest.documentParameters.isNewDocument !== true) {
