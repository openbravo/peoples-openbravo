...
QUnit.test('OB.Utilities.Date.* functions', function () {
  ...
  QUnit.ok((function () {
    ...
    var list = [
      ...
      ['31-12-2010 00:59:58', '%d-%m-%Y %H:%M:%S', new Date(2010, 11, 31, 00, 59, 58, 0)],
      ['31-12-2010 12:59:58 PM', '%d-%m-%Y %H:%M:%S a', new Date(2010, 11, 31, 12, 59, 58, 0)],
      ['31-12-2010 12:59:58 AM', '%d-%m-%Y %H:%M:%S a', new Date(2010, 11, 31, 00, 59, 58, 0)]
    ];
    for (i = 0; i < list.length; i++) {
  ...
  QUnit.ok((function () {
    ...
    var list = [
      ...
      [new Date(2010, 11, 31, 00, 59, 58, 0), '%d-%m-%Y %H:%M:%S', '31-12-2010 00:59:58'],
      [new Date(2010, 11, 31, 12, 59, 58, 0), '%d-%m-%Y %H:%M:%S a', '31-12-2010 12:59:58 PM'],
      [new Date(2010, 11, 31, 00, 59, 58, 0), '%d-%m-%Y %H:%M:%S a', '31-12-2010 12:59:58 AM']
    ];
    for (i = 0; i < list.length; i++) {
