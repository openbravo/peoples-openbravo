...
//
// Calls the remote action on the server. The response is processed by calling the callBack function.
// The callback function gets three parameters: rpcResponse (the original request), data (the resulting content), rpcRequest.
// See the Smartclient RPCCallback type for more information.      
//
// Parameters:
// * {{{actionName}}}: is the unique identifier of the action on the server
// * {{{data}}}: is an Object with the data passed to the action.
// * {{{requestParams}}}: request parameters send to the action.
// * {{{callback}}}: is the function which is called after receiving the result.
//
    call: function (/*String*/ actionName, /*Object*/ data, /*Object*/ requestParams, /*Function*/ callback, /*Object*/ callerContext) {
