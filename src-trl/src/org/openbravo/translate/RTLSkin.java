...
public class RTLSkin {
     ...
     *            modify (LTR folder of the skin). 2- Path to the original skin
     *            files
     * @throws Exception
     */
    public static void main(String argv[]) throws Exception {
        ...
        if (argv.length != 3) {
            log4j
                    .error("Usage: java RTLSkin pathRTLSkinFolder pathLTRSkinFolder pathSourceSkinFiles");
            return;
        }
        ...
        File fileDirOrig = new File(srcDirOrig, "");
        if (!fileDirOrig.exists()) {
            log4j.error("Can´t find directory: " + fileDirOrig);
            return;
        }
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            fImagesToFlip = new File(srcDirOrig + "/" + files[i]
