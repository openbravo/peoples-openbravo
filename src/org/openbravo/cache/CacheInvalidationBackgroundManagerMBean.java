...
public interface CacheInvalidationBackgroundManagerMBean {
    ...
    /*
     * Start the caché invalidation background manager
     * This will reload the caché control table, so all cachés will be invalidated upon startup.
     * The period with which the caché invalidation control table is checked will also be reloaded. 
     */
    public void start();
