...
public class CashMgmtDepositsDrops extends ProcessHQLQuery {
  ...
  protected String getQuery(JSONObject jsonsent) throws JSONException {
    return "select distinct(t.id), t.paymentAmount as drop, t.depositAmount as dep, t.transactionType as type, t.description as des from FIN_Finacc_Transaction t,"
