...
public class TaxZone extends ProcessHQLQuery {
  ...
  protected List<String> getQuery(JSONObject jsonsent) throws JSONException {
    ...
    if (fromCountry != null) {
      hqlTax = hqlTax + "and (country.id = '" + fromCountry.getId() + "' or country is null) ";
    } else {
      hqlTax = hqlTax + "and country is null ";
    }
    if (fromRegion != null) {
      hqlTax = hqlTax + "and (region.id = '" + fromRegion.getId() + "' or region is null) ";
    } else {
      hqlTax = hqlTax + "and region is null ";
    }
