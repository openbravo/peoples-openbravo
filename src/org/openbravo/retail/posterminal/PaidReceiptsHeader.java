...
public class PaidReceiptsHeader extends ProcessHQLQuery {
  ...
  protected List<String> getQuery(JSONObject jsonsent) throws JSONException {
    ...
    if (json.has("isQuotation") && json.getBoolean("isQuotation")) {
      ...
      hqlPaidReceipts += " and (exists( select 1 from ord.orderLineList where deliveredQuantity != 0) and exists( select 1 from ord.orderLineList where orderedQuantity > 0)) ";
    } else {
