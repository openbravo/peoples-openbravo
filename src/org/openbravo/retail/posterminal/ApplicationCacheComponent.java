...
public class ApplicationCacheComponent extends MobileCoreApplicationCacheComponent {
  ...
  public List<String> getAppList() {
    ...
    resources.add("../../web/org.openbravo.retail.posterminal/res/displaytotal.xml" +"?hash="+OBPOSPrintTemplateReader.getInstance().getPrintTemplatesIdentifier());
    resources.add("../../web/org.openbravo.retail.posterminal/res/opendrawer.xml" +"?hash="+OBPOSPrintTemplateReader.getInstance().getPrintTemplatesIdentifier());
    ...
    resources.add("../../web/org.openbravo.retail.posterminal/res/welcome.xml" +"?hash="+OBPOSPrintTemplateReader.getInstance().getPrintTemplatesIdentifier());
    resources.add("../../web/org.openbravo.retail.posterminal/res/goodbye.xml" +"?hash="+OBPOSPrintTemplateReader.getInstance().getPrintTemplatesIdentifier());
    resources.add("../../web/org.openbravo.retail.posterminal/res/checkdrawerstatus.xml" +"?hash="+OBPOSPrintTemplateReader.getInstance().getPrintTemplatesIdentifier());
