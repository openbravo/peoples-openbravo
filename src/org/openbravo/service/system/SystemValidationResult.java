...
public class SystemValidationResult {
  ...
  public enum SystemValidationType {
    NAME_TOO_LONG, MODULE_ERROR, INCORRECT_DEFAULT_VALUE, WRONG_LENGTH, NO_PRIMARY_KEY_COLUMNS, NOT_NULL_IN_DB_NOT_MANDATORY_IN_AD, MANDATORY_IN_AD_NULLABLE_IN_DB, NOT_EXIST_IN_AD, NOT_EXIST_IN_DB, NOT_PART_OF_FOREIGN_KEY, WRONG_TYPE, INCORRECT_CLIENT_ORG_PROPERTY_NAME;
