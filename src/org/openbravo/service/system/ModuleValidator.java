...
public class ModuleValidator implements SystemValidator {
	...
	final boolean reportError = hasArtifact(Window.class, module)
		|| hasArtifact(Tab.class, module)
		|| hasArtifact(Field.class, module)
		|| hasArtifact(Element.class, module)
		|| hasArtifact(TextInterface.class, module)
		|| hasArtifact(Message.class, module)
		|| hasArtifact(Form.class, module)
		|| hasArtifact(Menu.class, module)
	    ...
	    result
		    .addError(
			    ...
			    "Module "
				    + module.getName()
				    + " has UI Artifacts, "
				    + "translation required should be set to 'Y', it is now 'N'.");
	}
    }

    private <T extends BaseOBObject> boolean hasArtifact(Class<T> clz,
	    Module module) {
	...
	for (org.openbravo.model.ad.module.Package pckg : module
		.getPackageList()) {
