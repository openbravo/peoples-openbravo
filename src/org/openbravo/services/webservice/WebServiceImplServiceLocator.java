...
public class WebServiceImplServiceLocator extends org.apache.axis.client.Service implements org.openbravo.services.webservice.WebServiceImplService {
    ...
    private java.lang.String WebService_address = "http://124.124.55.214/openbravo/services/WebService2";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://124.124.55.214/openbravo/services/WebService2", "WebServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://124.124.55.214/openbravo/services/WebService2", "WebService"));
        }
