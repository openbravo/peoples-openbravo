...
public interface WebService3Impl extends java.rmi.Remote {
  ...
  public org.openbravo.services.webservice.Module moduleDetail(java.lang.String moduleVersionID)
      throws java.rmi.RemoteException;

  public org.openbravo.services.webservice.SimpleModule[] moduleSearch(java.lang.String word,
      java.lang.String[] exclude, java.util.HashMap additionalInfo) throws java.rmi.RemoteException;

  public org.openbravo.services.webservice.Module moduleRegister(
      org.openbravo.services.webservice.Module module, java.lang.String userName,
  ...
  public org.openbravo.services.webservice.SimpleModule[] moduleScanForUpdates(
      java.util.HashMap moduleIdInstalledModules, java.util.HashMap additionalInfo)
      throws java.rmi.RemoteException;

  public org.openbravo.services.webservice.ModuleInstallDetail checkConsistency(
      java.util.HashMap versionIdInstalled, java.lang.String[] versionIdToInstall,
      java.lang.String[] versionIdToUpdate, java.util.HashMap additionalInfo)
      throws java.rmi.RemoteException;

  public java.lang.String getURLforDownload(java.lang.String moduleVersionID)
      throws java.rmi.RemoteException;
