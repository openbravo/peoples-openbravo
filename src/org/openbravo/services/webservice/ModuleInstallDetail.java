...
public class ModuleInstallDetail implements java.io.Serializable {
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    boolean _equals;
    _equals = true
        && ((this.dependencyErrors == null && other.getDependencyErrors() == null) || (this.dependencyErrors != null && java.util.Arrays
            .equals(this.dependencyErrors, other.getDependencyErrors())))
        && ((this.modulesToInstall == null && other.getModulesToInstall() == null) || (this.modulesToInstall != null && java.util.Arrays
            .equals(this.modulesToInstall, other.getModulesToInstall())))
        && ((this.modulesToUpdate == null && other.getModulesToUpdate() == null) || (this.modulesToUpdate != null && java.util.Arrays
            .equals(this.modulesToUpdate, other.getModulesToUpdate())))
  ...
  public synchronized int hashCode() {
    ...
    if (getDependencyErrors() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getDependencyErrors()); i++) {
    ...
    if (getModulesToInstall() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getModulesToInstall()); i++) {
    ...
    if (getModulesToUpdate() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getModulesToUpdate()); i++) {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
      ModuleInstallDetail.class, true);

  static {
    typeDesc
        .setXmlType(new javax.xml.namespace.QName("/services/WebService", "ModuleInstallDetail"));
