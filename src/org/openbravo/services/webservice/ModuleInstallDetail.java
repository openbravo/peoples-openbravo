...
public class ModuleInstallDetail implements java.io.Serializable {
     ...
     */
    public void setModulesToInstall(
            org.openbravo.services.webservice.Module[] modulesToInstall) {
        this.modulesToInstall = modulesToInstall;
    }
     ...
     */
    public void setModulesToUpdate(
            org.openbravo.services.webservice.Module[] modulesToUpdate) {
        this.modulesToUpdate = modulesToUpdate;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true
                && ((this.dependencyErrors == null && other
                        .getDependencyErrors() == null) || (this.dependencyErrors != null && java.util.Arrays
                        .equals(this.dependencyErrors, other
                                .getDependencyErrors())))
                && ((this.modulesToInstall == null && other
                        .getModulesToInstall() == null) || (this.modulesToInstall != null && java.util.Arrays
                        .equals(this.modulesToInstall, other
                                .getModulesToInstall())))
                && ((this.modulesToUpdate == null && other.getModulesToUpdate() == null) || (this.modulesToUpdate != null && java.util.Arrays
                        .equals(this.modulesToUpdate, other
                                .getModulesToUpdate())))
    ...
    public synchronized int hashCode() {
        ...
        if (getDependencyErrors() != null) {
            for (int i = 0; i < java.lang.reflect.Array
                    .getLength(getDependencyErrors()); i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(
                        getDependencyErrors(), i);
        ...
        if (getModulesToInstall() != null) {
            for (int i = 0; i < java.lang.reflect.Array
                    .getLength(getModulesToInstall()); i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(
                        getModulesToInstall(), i);
                if (obj != null && !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
            }
        ...
        if (getModulesToUpdate() != null) {
            for (int i = 0; i < java.lang.reflect.Array
                    .getLength(getModulesToUpdate()); i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(
                        getModulesToUpdate(), i);
                if (obj != null && !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
            }
        }
        _hashCode += (isValidConfiguration() ? Boolean.TRUE : Boolean.FALSE)
                .hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
                "/services/WebService", "ModuleInstallDetail"));
