...
public class SE_Expense_BP_Project extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strBPartnerId, strProjectId,
                        strChanged, strTabId, strWindowId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strBPartnerId, String strProjectId, String strChanged,
            String strTabId, String strWindowId) throws IOException,
            ServletException {
        ...
        if (strChanged.equals("inpcProjectId")) {
            ...
            if (strProjectId != null && !strProjectId.equals("")) {
                ...
                String strBPartner = SEExpenseBPProjectData.selectBPId(this,
                        strProjectId);
                if (strBPartner != null && !strBPartner.equals("")) {
                    strBPartnerId = strBPartner;
                    strBPartnerName = SEExpenseBPProjectData.selectBPName(this,
                            strProjectId);
                }
                resultado.append(", new Array(\"inpcBpartnerId\", \""
                        + strBPartnerId + "\")\n");
                resultado.append(", new Array(\"inpcBpartnerId_R\", \""
                        + strBPartnerName + "\")\n");
            }
            ...
            if (strBPartnerId != null && !strBPartnerId.equals("")) {
                ...
                if (strProjectId != null && !strProjectId.equals("")) {
                    ...
                    String strBPartnerProject = SEExpenseBPProjectData
                            .selectBPProject(this, strBPartnerId, strProjectId);
                    // ...if there is no relationship between project and
                    // business partner, take the last project of that business
                    // partner (if any).
                    if (strBPartnerProject == null
                            || strBPartnerProject.equals("")) {
                        strReset = "1";
                        strProject = SEExpenseBPProjectData.selectProjectId(
                                this, strBPartnerId);
                    ...
                    strReset = "1";
                    strProject = SEExpenseBPProjectData.selectProjectId(this,
                            strBPartnerId);
                    if (strProject != null && !strProject.equals("")) {
                        strProjectId = strProject;
                    }
                ...
                if (strReset.equals("1")) {
                    // Reset Project Phase and Project Task fields
                    resultado
                            .append("new Array(\"inpcProjectphaseId\", \"\"),\n");
                    resultado
                            .append("new Array(\"inpcProjecttaskId\", \"\"),\n");
                }
