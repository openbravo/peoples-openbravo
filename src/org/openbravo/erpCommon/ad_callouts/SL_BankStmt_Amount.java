...
public class SL_BankStmt_Amount extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strChanged, strStmAmount, strTrxAmount, strChgAmount, strTabId, strConvChgAmount, strBankStmtLine, strCurrencyId, strDP);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged, String strStmAmount, String strTrxAmount, String strChgAmount, String strTabId, String strConChgAmount, String strBankStmtLine, String strCurrencyId, String strDP) throws IOException, ServletException {
    ...
    if (strChanged.equals("inpstmtamt")) {
      if (isConversion) {
         if (log4j.isDebugEnabled()) log4j.debug("trx: " + TrxAmount.toString()+"chg"+ChgAmount.toString());
        //ConvChgAmount = StmAmount.subtract(TrxAmount).subtract(ChgAmount);
