...
public class SL_Order_DocType extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strBPartner, strDocTypeTarget,
                        strDocType, docNo, strOrder, strDescription, strTabId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strBPartner, String strDocTypeTarget, String strDocType,
            String docNo, String strOrder, String strDescription,
        ...
        if (strDocTypeTarget.equals(""))
            ...
            if (dataNew != null && dataNew.length > 0) {
                ...
                if (DocSubTypeSO == null)
                    DocSubTypeSO = "--";
                String strOldDocTypeTarget = SLOrderDocTypeData
                        .selectOldDocSubType(this, strOrder);
                if (!DocSubTypeSO.equals("OB")
                        && strOldDocTypeTarget.equals("OB")) {
                    String strOldDocNo = SLOrderDocTypeData.selectOldDocNo(
                            this, strOrder);
                    resultado.append("new Array(\"inpdescription\", \""
                            + FormatUtilities.replaceJS("Presupuesto Nº: "
                                    + strOldDocNo + ". " + strDescription)
                            + "\"),\n");
                }
                resultado.append("new Array(\"inpordertype\", \""
                        + DocSubTypeSO + "\")\n");
                PaymentRule = "P";
            ...
            if (!DocSubTypeSO.equalsIgnoreCase("WR")) {
                ...
                if (dataBP != null && dataBP.length > 0) {
                    String s = (IsSOTrx ? dataBP[0].paymentrule
                ...
                try {
                    ComboTableData comboTableData = new ComboTableData(vars,
                            this, "LIST", "", "C_Order InvoiceRule", "",
                            Utility.getContext(this, vars, "#User_Org",
                                    "SLOrderDocType"), Utility.getContext(this,
                                    vars, "#User_Client", "SLOrderDocType"), 0);
                ...
                resultado.append("new Array(\"D\", \"").append(
                        FormatUtilities.replaceJS(ListData.selectName(this,
                                "150", "D"))).append("\", ").append(
                        InvoiceRule.equals("D") ? "true" : "false")
                        .append("),");
                resultado.append("new Array(\"I\", \"").append(
                        FormatUtilities.replaceJS(ListData.selectName(this,
                                "150", "I"))).append("\", ").append(
                        InvoiceRule.equals("I") ? "true" : "false")
                        .append("),");
                resultado.append("new Array(\"O\", \"").append(
                        FormatUtilities.replaceJS(ListData.selectName(this,
                                "150", "O"))).append("\", ").append(
                        InvoiceRule.equals("O") ? "true" : "false").append(
                        ")))\n");
                InvoiceRule = "";
                // End of add
            }
