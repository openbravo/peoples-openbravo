...
public class SL_CreateFromMultiple_Warehouse extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strWarehouse, String strIsSOTrx, String strTabId) throws IOException, ServletException {
    ...
    LocatorComboData [] data = LocatorComboData.select(this,vars.getLanguage(), strWarehouse, vars.getClient());
