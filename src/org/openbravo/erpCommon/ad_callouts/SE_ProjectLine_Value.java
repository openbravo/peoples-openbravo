...
public class SE_ProjectLine_Value extends HttpSecureAppServlet {
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strmProductId, strPriceListVersion,
                        strTabId, strProjectId, strPhaseId, strADOrgID);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strmProductId, String strPriceListId, String strTabId,
            String strProjectId, String strPhaseId, String strADOrgID)
            throws IOException, ServletException {
        ...
        if (strmProductId != null && !strmProductId.equals("")) {
            ...
            if (strPhaseId != null && !strPhaseId.equals("")) {
                if (strProjectId == null || strProjectId.equals("")) {
                    strProjectId = SEProjectLineValueData.selectPhaseProject(
                            this, strPhaseId);
                }
            }
            ...
            if (!strPriceListId.equals("")) {
                String strPriceListVersion = SEProjectLineValueData
                        .selectPriceListVersion(this, strPriceListId, strDate);
                if (!strPriceListVersion.equals("")) {
                    String plannedprice = SEProjectLineValueData
                            .selectPlannedPrice(this, strPriceListVersion,
            ...
            if (!strProjCat.equals("S")) {
                if (strCBPartnerLocationID != null
                        ...
                        && strMWarehouseID != null
                        && !strMWarehouseID.equals("")) {
                    String strIsSOTrx = "Y";
                    String strCTaxID = Tax.get(this, strmProductId, strDate,
                            strADOrgID, strMWarehouseID,
                            strCBPartnerLocationID, strCBPartnerLocationID,
                            strProjectId, strIsSOTrx.equals("Y"));
                ...
                resultado.append("new Array(\"inpproductValue\", \""
                        + data[0].value + "\"),\n");
