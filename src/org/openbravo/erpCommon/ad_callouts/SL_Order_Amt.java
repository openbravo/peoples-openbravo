...
public class SL_Order_Amt extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strAttribute = vars
                    .getStringParameter("inpmAttributesetinstanceId");
            String strTabId = vars.getStringParameter("inpTabId");
            String strQty = vars.getStringParameter("inpqtyordered");

            try {
                printPage(response, vars, strChanged, strQtyOrdered,
                        strPriceActual, strDiscount, strPriceLimit,
                        strPriceList, strCOrderId, strProduct, strUOM,
                        strAttribute, strTabId, strQty, strPriceStd);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strChanged, String strQtyOrdered, String strPriceActual,
            String strDiscount, String strPriceLimit, String strPriceList,
            String strCOrderId, String strProduct, String strUOM,
            String strAttribute, String strTabId, String strQty,
            String strPriceStd) throws IOException, ServletException {
        if (log4j.isDebugEnabled()) {
        ...
        qtyOrdered = (strQtyOrdered.equals("") ? ZERO : new BigDecimal(
                strQtyOrdered));
         ...
         * PriceListVersionComboData.selectActual(this, data[0].mPricelistId,
         * DateTimeData.today(this)); if (data1!=null && data1.length>0)
         * strPriceVersion = data1[0].mPricelistVersionId; BigDecimal lineLimit
         * = new BigDecimal(SLOrderAmtData.selectPriceLimit(this,
         * strPriceVersion, strProduct)); if (lineLimit.floatValue()
         * >priceActual.floatValue()) isUnderLimit=true; }
         */
        ...
        if (strChanged.equals("inppriceactual")) {
            ...
            priceStd = new BigDecimal(SLOrderProductData.getOffersStdPrice(
                    this, dataOrder[0].cBpartnerId, strPriceActual.replace(
                            "\"", ""), strProduct, dataOrder[0].dateordered,
        ...
        /*
         * if
         * (strChanged.equals("inppricelist")||strChanged.equals("inpqtyordered"
         * )) { if (log4j.isDebugEnabled()) log4j.debug("priceList:" +
         ...
         * strPriceList.replace("\"", ""), strQty, dataOrder[0].mPricelistId,
         * dataOrder[0].id));
        ...
        if (strChanged.equals("inppricelist")
            ...
            priceActual = new BigDecimal(SLOrderProductData.getOffersPrice(
                    this, dataOrder[0].dateordered, dataOrder[0].cBpartnerId,
                    strProduct, priceStd.toString(), strQty,
			...
			.divide(new BigDecimal("100"), 12,
                ...
                priceActual = new BigDecimal(SLOrderProductData.getOffersPrice(
                        ...
                        dataOrder[0].cBpartnerId, strProduct, priceStd
                                .toString(), strQty, dataOrder[0].mPricelistId,
                        dataOrder[0].id));
                ...
                if (qtyOrdered.compareTo(BigDecimal.ZERO) != 0) {
                    if (strEnforceAttribute.equals("N")) {
                        ...
                        if (!strAttribute.equals("") && strAttribute != null) {
                            strStockAttribute = SLOrderStockData
