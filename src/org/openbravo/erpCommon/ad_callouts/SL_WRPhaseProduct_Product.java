...
public class SL_WRPhaseProduct_Product extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strTabId, String strMProductID) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        String strProductUom = SLWRPhaseProductProductData.selectProductUom(
                this, strMProductID);
        StringBuffer resultado = new StringBuffer();
        resultado.append("var calloutName='SL_WRPhaseProduct_Product';\n\n");
        resultado.append("var respuesta = new Array(");
        resultado.append("new Array(\"inpcUomId\", \""
                + FormatUtilities.replaceJS((strProductUom.equals("") ? "\"\""
                        : strProductUom)) + "\"),\n");
        String strHasSecondaryUOM = SLWRPhaseProductProductData
                .hasSecondaryUOM(this, strMProductID);
        resultado.append("new Array(\"inphasseconduom\", " + strHasSecondaryUOM
                + "),\n");

        // String strProductUomId =
        // SLProcessPlanProductData.selectProductUomId(this, strMProductID);

        resultado.append("new Array(\"inpmProductUomId\", ");
        String strmProductUOMId = SLWRPhaseProductProductData.strMProductUOMID(
                this, strMProductID, strProductUom);
