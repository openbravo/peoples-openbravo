...
public class Activation_Message extends HttpSecureAppServlet {
 ...
 void printPage(HttpServletResponse response, VariablesSecureApp vars, String strHBActive, String strRegActive) throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: dataSheet");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();

    String msg = (strHBActive.equalsIgnoreCase("Y") || strRegActive.equalsIgnoreCase("Y") ? Utility.messageBD(this, "REG_INFO_MESSAGE", vars.getLanguage()) : "");
