...
public class SL_WRPhase_Sequence extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String strMASequenceID, String strMAWReqID) throws IOException, ServletException {
    ...
    if (!(strMASequenceID == null || strMASequenceID == "")) {
      ...
      resultado.append("new Array(\"inpquantity\", \"" + FormatUtilities.replaceJS((strQuantity.equals("")?"\"\"":strQuantity)) + "\"),\n");
      resultado.append("new Array(\"inpcostcenteruse\", \"" + FormatUtilities.replaceJS((data[0].ccuse.equals("")?"\"\"":data[0].ccuse)) + "\"),\n");
      resultado.append("new Array(\"inppreptime\", \"" + FormatUtilities.replaceJS((data[0].preptime.equals("")?"\"\"":data[0].preptime)) + "\"),\n");
      resultado.append("new Array(\"inpoutsourced\", \"" + FormatUtilities.replaceJS((data[0].outsourced.equals("")?"\"\"":data[0].outsourced)) + "\")\n");
    }
