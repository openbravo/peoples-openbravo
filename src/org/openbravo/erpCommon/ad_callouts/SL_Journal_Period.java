...
public class SL_Journal_Period extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strDateAcct, strDateDoc, strcPeriodId, strWindowId, strChanged, strTabId);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDateAcctNew, String strDateDocNew, String strcPeriodIdNew, String strWindowId, String strChanged, String strTabId) throws IOException, ServletException {
    ...
    if (strChanged.equals("inpdateacct")){
      ...
      if(strcPeriodId.equals("")) strcPeriodId = strcPeriodIdNew;
    }
