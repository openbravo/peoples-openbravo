...
/**
 * This callout checks if this is the only active isDefault checked for the table (with organization) 
 * or, in case it is a tab with parent,
 * it is the only checked taking into account its parent.
 * 
