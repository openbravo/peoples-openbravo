...
public class SL_CreateLines_Conversion_UOM extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (log4j.isDebugEnabled()) log4j.debug("CHANGED: " + strOrderlineId);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strOrderlineId, String strUOM, String strQuantityOrder, String strMProductUOMID) throws IOException, ServletException {
    ...
    if (strMultiplyRate.equals("0")) {
      ...
      resultado.append("new Array(\"inpmovementqty"+strOrderlineId+"\", " + movementQty.toString() + ")");
      }
      if (check) {
