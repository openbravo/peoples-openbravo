...
public class SL_Internal_Consumption_Conversion extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strChanged, strUOM, strMProductUOMID,
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strChanged, String strUOM, String strMProductUOMID,
            String strQuantityOrder, String strTabId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        resultado
                .append("var calloutName='SL_Internal_Consumption_Conversion';\n\n");
