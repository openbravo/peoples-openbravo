...
public class SE_Order_Project extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strProjectId, String strTabId) throws IOException, ServletException {
