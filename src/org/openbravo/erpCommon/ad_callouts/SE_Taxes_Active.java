...
public class SE_Taxes_Active extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strIsActive, String strParentTaxId) throws IOException,
            ServletException {
        ...
        if (strIsActive.equals("")) {
            SETaxesActiveData[] children = SETaxesActiveData
                    .getActiveChildrenTaxes(this, strParentTaxId);
            if (children.length > 0) {
                msg = Utility.messageBD(this, "ChildrenTaxRateActive", vars
                        .getLanguage());
            }
        }
