...
public class SL_RequisitionLine_Conversion extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        int stdPrecision = Integer.valueOf(
                SLRequisitionLineConversionData.stdPrecision(this, strUOM))
                .intValue();
        String strInitUOM = SLRequisitionLineConversionData.initUOMId(this,
                strMProductUOMID);
        String strMultiplyRate;
        boolean check = false;

        strMultiplyRate = SLRequisitionLineConversionData.multiplyRate(this,
                strInitUOM, strUOM);
        if (strInitUOM.equals(strUOM))
            strMultiplyRate = "1";
        if (strMultiplyRate.equals(""))
            strMultiplyRate = SLRequisitionLineConversionData.divideRate(this,
                    strUOM, strInitUOM);
        if (strMultiplyRate.equals("")) {
            strMultiplyRate = "1";
        ...
        resultado
                .append("var calloutName='SL_RequisitionLine_Conversion';\n\n");
