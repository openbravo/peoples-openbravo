...
public class SL_Inventory_Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      printPage(response, vars, strChanged, strProduct, strLocator, strAttribute, strQty, strUOM, strQtyOrder, strPUOM, strTabId);
    } else pageError(response);
  }

  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged, String strProduct, String strLocator, String strAttribute, String strQty, String strUOM, String strQtyOrder, String strPUOM, String strTabId) throws IOException, ServletException {
    ...
    /*resultado.append("new Array(\"inpcUomId\", " + SLInventoryProductData.select(this, strProduct) + "),");*/
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLE", "", "M_Product_UOM", "", Utility.getContext(this, vars, "#User_Org", "SLInventoryProduct"), Utility.getContext(this, vars, "#User_Client", "SLInventoryProduct"), 0);
      ...
      if (tld!=null && tld.length>0) {
        ...
        for (int i=0;i<tld.length;i++) {
          resultado.append("new Array(\"" + tld[i].getField("id") + "\", \"" + FormatUtilities.replaceJS(tld[i].getField("name")) + "\", \"" + (tld[i].getField("id").equalsIgnoreCase(strPUOM)?"true":"false") + "\")");
