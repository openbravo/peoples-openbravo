...
public class SL_GlobalUse_Product extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strTabId, String strMProductID, String strPAttr)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        resultado.append("new Array(\"inpcUomId\", \""
                + FormatUtilities.replaceJS((strProductUom.equals("") ? "\"\""
                        : strProductUom)) + "\"),\n");
        String strHasSecondaryUOM = SLGlobalUseProductData.hasSecondaryUOM(
                this, strMProductID);
        resultado.append("new Array(\"inphasseconduom\", \""
                + strHasSecondaryUOM + "\"),\n");
        ...
        String strmProductUOMId = SLGlobalUseProductData.strMProductUOMID(this,
                strMProductID, strProductUom);
