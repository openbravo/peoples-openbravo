...
public class SE_Project_BPartner extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner, String strIsSOTrx, String strWindowId, String strLocation, String strContact) throws IOException, ServletException {
    ...
    resultado.append("var respuesta = new Array(");
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "M_PriceList_ID", "", "", Utility.getContext(this, vars, "#User_Org", strWindowId), Utility.getContext(this, vars, "#User_Client", strWindowId), 0);
