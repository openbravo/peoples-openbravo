...
public class SL_Invoice_DocType extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDocTypeTarget, String strTabId, String strCInvoiceId) throws IOException, ServletException {
    ...
    if (data==null || data.length==0) resultado.append("var respuesta = null;");
      ...
      if (strDoctypetargetinvoice==null || strDoctypetargetinvoice.equals("") || !strDoctypetargetinvoice.equals(strDocTypeTarget))
      {
      ...
      else if (strDoctypetargetinvoice!=null && !strDoctypetargetinvoice.equals("") && strDoctypetargetinvoice.equals(strDocTypeTarget))
        resultado.append("new Array(\"inpdocumentno\", \"" + SEInOutDocTypeData.selectActualinvoicedocumentno(this, strCInvoiceId) + "\"),");
      //------
