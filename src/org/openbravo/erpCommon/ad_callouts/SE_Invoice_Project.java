...
public class SE_Invoice_Project extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strProjectId, strWindowId,
                        strIsSOTrx, strTabId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strProjectId, String strWindowId, String strIsSOTrx,
        ...
        SEInvoiceProjectData[] data = SEInvoiceProjectData.select(this,
                strProjectId);
