...
public class SE_Invoice_Project extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strProjectId, String strWindowId, String strIsSOTrx, String strTabId) throws IOException, ServletException {
