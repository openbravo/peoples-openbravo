...
public class SL_Order_Product extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strWindowId, String strIsSOTrx, String strCBpartnerID,
            String strTabId, String strQty) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (!strMProductID.equals("")) {
            ...
            if (log4j.isDebugEnabled())
                log4j.debug("get Offers date: " + dataOrder[0].dateordered
                        + " partner:" + dataOrder[0].cBpartnerId + " prod:"
                        + strMProductID + " std:"
                        + strPriceStd.replace("\"", ""));
            strPriceActual = SLOrderProductData.getOffersPrice(this,
                    dataOrder[0].dateordered, dataOrder[0].cBpartnerId,
                    strMProductID, (strPriceStd.equals("undefined") ? "0"
        ...
        BigDecimal priceStd = (strPriceStd.equals("") ? new BigDecimal(0.0)
                : new BigDecimal(strPriceStd));
        BigDecimal discount = new BigDecimal(0.0);
        if (priceList.compareTo(discount) != 0) {
            discount = (((priceList.subtract(priceStd)).divide(priceList, 12,
        ...
        resultado
                .append("new Array(\"inppriceactual\", "
        ...
        resultado.append("new Array(\"inpdiscount\", \"" + discount.toString()
                + "\"),");
        if (!strMProductID.equals("")) {
            PAttributeSetData[] dataPAttr = PAttributeSetData
                    .selectProductAttr(this, strMProductID);
        ...
        if (!strHasSecondaryUOM.equals("0"))
            resultado
                    .append(", new Array(\"CURSOR_FIELD\", \"inpquantityorder\")\n");
