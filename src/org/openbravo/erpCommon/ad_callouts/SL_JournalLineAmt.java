...
public class SL_JournalLineAmt extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strGLJournal, String strCurrencyRate, String strCurrency, String strDateAcct, String strCurrencyRateType, String strWindowId, String strAmtSourceDr, String strAmtSourceCr, String strTabId) throws IOException, ServletException {
    ...
    String CurrencyRate = SLJournalLineAmtData.currencyRate(this, strCurrency, strTargetCurrencyId, strDateAcct, strCurrencyRateType, vars.getClient(), vars.getOrg());
    if (CurrencyRate.equals("")) CurrencyRate = SLJournalLineAmtData.currencyRate2(this, strGLJournal, strCurrency, strCurrencyRateType);
    ...
    AmtAcctDr = (strAmtSourceDr.equals("")?ZERO:AmtSourceDr.multiply(new BigDecimal(CurrencyRate))).setScale(StdPrecision, BigDecimal.ROUND_HALF_UP);
    AmtAcctCr = (strAmtSourceCr.equals("")?ZERO:AmtSourceCr.multiply(new BigDecimal(CurrencyRate))).setScale(StdPrecision, BigDecimal.ROUND_HALF_UP);
