...
public class SE_Expense_Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strDateexpense, strmProductId, strsTimeexpenseId, strqty, strcCurrencyId, strInvPrice, strChanged, strTabId);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDateexpense, String strmProductId, String strsTimeexpenseId, String strqty, String strcCurrencyId, String strInvPrice, String strChanged, String strTabId) throws IOException, ServletException {
