...
public class SL_Proposal_Product extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strPriceStd, String strTabId, String strmProductId) throws IOException, ServletException {
    ...
    if (log4j.isDebugEnabled()) log4j.debug("strPriceStd*******************" + strPriceStd);
