...
public class SL_WorkRequirement_Sequence extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strWorkRequirement = vars
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strWorkRequirement, String strSequence) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                ...
                .createXmlDocument();
        SLWorkRequirementSequence[] data = SLWorkRequirementSequence.select(
                this, strSequence);
        ...
        resultado.append("new Array(\"inppreptime\", \""
                + FormatUtilities.replaceJS(data[0].preptime) + "\"),");
        resultado.append("new Array(\"inpnoqty\", \""
                + FormatUtilities.replaceJS(data[0].noqty) + "\"),");
        resultado.append("new Array(\"inpgroupuse\", \""
                + FormatUtilities.replaceJS(data[0].groupuse) + "\")");
        resultado.append(");");
