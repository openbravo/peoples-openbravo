...
public class SL_WorkRequirement_Sequence extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strWorkRequirement, String strSequence) throws IOException, ServletException {
    ...
    resultado.append("new Array(\"inpcostcenteruse\", \"" + FormatUtilities.replaceJS(data[0].costcenteruse) + "\"),");
