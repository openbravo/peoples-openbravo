...
public class SL_CreateFromMultiple_Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strLocator, strQty, strUOM, strAttribute, strQtyOrder, strPUOM, strMProductID, strIsSOTrx, strWharehouse, strTabId);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strLocator, String strQty, String strUOM, String strAttribute, String strQtyOrder, String strPUOM, String strMProductID, String strIsSOTrx, String strWharehouse, String strTabId) throws IOException, ServletException {
    ...
    /*if (strIsSOTrx.equals("Y")) {
      ...
      resultado.append("new Array(\"inpmLocatorId_R\", \"" + SLInOutLineProductData.locator(this, strLocator, vars.getLanguage()) + "\"),");
      ...
      resultado.append("new Array(\"inpmAttributesetinstanceId_R\", \"" + SLInOutLineProductData.attribute(this, strAttribute) + "\"),");
      resultado.append("new Array(\"inpquantityorder\", " + (strQtyOrder.equals("")?"\"\"":strQtyOrder) + "),");
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLE", "", "M_Product_UOM", "", Utility.getContext(this, vars, "#User_Org", "SLCreateFromMultipleProduct"), Utility.getContext(this, vars, "#User_Client", "SLCreateFromMultipleProduct"), 0);
