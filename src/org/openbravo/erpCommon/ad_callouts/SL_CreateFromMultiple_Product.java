...
public class SL_CreateFromMultiple_Product extends HttpSecureAppServlet {
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strLocator, strQty, strUOM,
                        ...
                        strIsSOTrx, strWharehouse, strTabId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        resultado
                .append("var calloutName='SL_CreateFromMultiple_Product';\n\n");
         ...
         * SLInOutLineProductData.locator(this, strLocator, vars.getLanguage())
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLE", "", "M_Product_UOM", "", Utility.getContext(
                                this, vars, "#User_Org",
                                "SLCreateFromMultipleProduct"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "SLCreateFromMultipleProduct"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "SLCreateFromMultipleProduct", "");
