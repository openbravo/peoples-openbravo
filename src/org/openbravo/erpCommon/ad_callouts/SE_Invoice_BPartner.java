...
public class SE_Invoice_BPartner extends HttpSecureAppServlet {
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strBPartner, strDocType, strIsSOTrx,
                        strWindowId, strLocation, strContact, strProjectId,
                        strTabId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strBPartner, String strDocType, String strIsSOTrx,
        ...
        SEOrderBPartnerData[] data = SEOrderBPartnerData.select(this,
                strBPartner);
        String strUserRep;
        String DocBaseType = SEInvoiceBPartnerData
        ...
        if (data == null || data.length == 0)
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        ...
                        "C_BPartner Location - Bill To", Utility.getContext(
                                this, vars, "#User_Org", strWindowId), Utility
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "AD_User_ID", "",
                        "AD_User C_BPartner User/Contacts", Utility.getContext(
                                this, vars, "#User_Org", strWindowId), Utility
                                .getContext(this, vars, "#User_Client",
                                        strWindowId), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
