...
public class SL_InOutLine_Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strLocator, strQty, strUOM, strAttribute, strQtyOrder, strPUOM, strMProductID, strIsSOTrx, strWharehouse, strTabId,strmInoutlineId);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strLocator, String strQty, String strUOM, String strAttribute, String strQtyOrder, String strPUOM, String strMProductID, String strIsSOTrx, String strWharehouse, String strTabId, String strmInoutlineId) throws IOException, ServletException {
    ...
    //if (strIsSOTrx.equals("Y")) {
      ...
      // This 'if' is used when the delivery note is created based in a sale-order, to make it not ask for the quantity of the delivery-note and to modify it with the quantity of product in the warehouse. However, if the delivery-note doesn't come from an order, it modifies the quantity field with the quantity in the warehouse.
