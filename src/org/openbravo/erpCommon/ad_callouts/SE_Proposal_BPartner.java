...
public class SE_Proposal_BPartner extends HttpSecureAppServlet {
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                printPage(response, vars, strBPartner, strWindowId,
                        strLocation, strContact, strTabId);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strBPartner, String strWindowId, String strLocation,
            String strContact, String strTabId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        String strPaymentRule = SEProposalBPartnerData.selectPaymentRule(this,
                strBPartner);
        resultado.append("new Array(\"inppaymentrule\", \"" + strPaymentRule
                + "\"),");
        String strPaymentTerm = SEProposalBPartnerData.selectPaymentTerm(this,
                strBPartner);
