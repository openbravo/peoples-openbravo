...
public class SL_Inventory_Locator extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            final String strAttribute = vars
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strAttribute, String strUOM, String strTabId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (!strProduct.equals("")) {
            ...
            SLInventoryLocatorData[] data = SLInventoryLocatorData
                    .select(
                            this,
                            strProduct,
                            strLocator,
                            strUOM,
                            ((strAttribute == null || strAttribute.equals("")) ? null
                                    : strAttribute));
            ...
            resultado
                    .append("new Array(\"inpquantityorderbook\", "
                            + ((data[0].qtyorder == null || data[0].qtyorder
                                    .equals("")) ? "\"\"" : data[0].qtyorder)
                            + "), \n");
            resultado.append("new Array(\"inpqtycount\", "
                    + ((data[0].qty == null || data[0].qty.equals("")) ? "\"\""
                            : data[0].qty) + "), \n");
