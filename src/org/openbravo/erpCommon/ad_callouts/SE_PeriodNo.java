...
public class SE_PeriodNo extends HttpSecureAppServlet {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strYearId, String strWindowId) throws IOException, ServletException {
    ...
    if (!strYearId.equals("")){
      ...
      if (tdv!=null && tdv.length>0) {
        ...
        for (int i=0;i<tdv.length;i++) {
          resultado.append("new Array(\"" + tdv[i].getField("id") + "\", \""+ tdv[i].getField("PeriodNo") +"\")");
