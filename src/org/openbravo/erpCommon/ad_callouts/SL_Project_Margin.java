...
public class SL_Project_Margin extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            // Services
            String strServiceRevenue = vars.getStringParameter(
                    "inpservrevenue", "0");
            String strServiceCost = vars.getStringParameter("inpservcost", "0");
            String strServiceMargin = vars.getStringParameter("inpservmargin",
                    "0");
            // Expenses
            String strPlannedExpenses = vars.getStringParameter(
                    "inpexpexpenses", "0");
            String strReinvoicedExpenses = vars.getStringParameter(
                    "inpexpreinvoicing", "0");
            String strPlannedMargin = vars.getStringParameter("inpexpmargin",
                    "0");
            try {
                printPage(response, vars, strTabId, strcProjectId, strChanged,
                        strServiceRevenue, strServiceCost, strServiceMargin,
                        strPlannedExpenses, strReinvoicedExpenses,
                        strPlannedMargin);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strTabId, String strcProjectId, String strChanged,
            String strServiceRevenue, String strServiceCost,
            String strServiceMargin, String strPlannedExpenses,
            String strReinvoicedExpenses, String strPlannedMargin)
            throws IOException, ServletException {
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                ...
                .createXmlDocument();
        SLProjectMarginData[] data = SLProjectMarginData.select(this,
                strcProjectId);
