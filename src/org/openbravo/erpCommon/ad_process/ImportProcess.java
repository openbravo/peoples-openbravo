...
public abstract class ImportProcess {
  ...
  public String getParamData(String paramName, int index) {
    ...
    for (int i=0;i<m_params.size();i++) {
      ...
      if (param[0].equals(paramName)) return param[index];
    }
    return "";
  }
  ...
  public void addParameterString(String parametername, String seqno, String value) throws ServletException {
    ImportProcessData.insertPInstanceParam(getConnection(), getAD_PInstance_ID(), seqno, parametername, value, getAD_Client_ID(), getAD_Org_ID(), getAD_User_ID());
  }

  public void addParameterNumber(String parametername, String seqno, String value) throws ServletException {
    ImportProcessData.insertPInstanceParamNumber(getConnection(), getAD_PInstance_ID(), seqno, parametername, value, getAD_Client_ID(), getAD_Org_ID(), getAD_User_ID());
  }

  public void addParameterDate(String parametername, String seqno, String value) throws ServletException {
    ImportProcessData.insertPInstanceParamDate(getConnection(), getAD_PInstance_ID(), seqno, parametername, value, getAD_Client_ID(), getAD_Org_ID(), getAD_User_ID());
  }

  public void addParameterInfo(String parametername, String seqno, String value) throws ServletException {
    ImportProcessData.insertPInstanceParamInfo(getConnection(), getAD_PInstance_ID(), seqno, parametername, value, getAD_Client_ID(), getAD_Org_ID(), getAD_User_ID());
  }

  private void lock() throws ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("lock");
    try {
