...
public class RequestReOpen extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (!Utility.hasProcessAccess(this, vars, "", "R_Request_ReOpen")) {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      //if (!strMessage.equals("")) vars.setSessionValue("RequestReOpen.message", strMessage);
  ...
  OBError processSave(VariablesSecureApp vars, String strRequest) {
	  ...
	  myMessage.setTitle("");
    if (log4j.isDebugEnabled()) log4j.debug("Save: RequestReOpen");
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars) throws IOException, ServletException {
      if (log4j.isDebugEnabled()) log4j.debug("Output: process RequestReOpen");
      ...
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_process/RequestReOpen").createXmlDocument();
      
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "RequestReOpen", false, "", "", "",false, "ad_process",  strReplaceWith, false,  true);
      ...
      //new message system
      /*String strMessage = vars.getSessionValue("RequestReOpen.message");
      if (!strMessage.equals("")) {
        vars.removeSessionValue("RequestReOpen.message");
