...
public class PriceListCreateAll extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strKey = vars
                    .getRequiredStringParameter("inpmPricelistVersionId");
    ...
    OBError processButton(VariablesSecureApp vars, String strPriceListVersion,
        ...
        try {
            ...
            PriceListCreateAllData[] data = PriceListCreateAllData
                    .selectParent(conn, this, strPriceListVersion, Utility
                            .getContext(this, vars, "#User_Org", windowId),
            ...
            if (data == null || data.length == 0) {
                ...
                myMessage.setMessage(Utility.messageBD(this, "SearchNothing",
                        vars.getLanguage()));
                return myMessage;
            ...
            strMessage = processHijos(conn, vars, windowId,
                    data[0].mPricelistVersionId);
            if (!strMessage.equals("")) {
                releaseRollbackConnection(conn);
                myMessage.setType("Error");
                myMessage.setMessage(strMessage);
                ...
                strMessage = Utility.messageBD(this, "ProcessOK", vars
                        .getLanguage());
    ...
    String processHijos(Connection conn, VariablesSecureApp vars,
            String windowId, String strPriceListVersion)
            throws ServletException {
        String strMessage = "";
        PriceListCreateAllData[] data = PriceListCreateAllData.select(conn,
                this, strPriceListVersion, Utility.getContext(this, vars,
                        "#User_Org", windowId), Utility.getContext(this, vars,
    ...
    String processPL(Connection conn, VariablesSecureApp vars,
            PriceListCreateAllData data) throws ServletException {
        if (data.mPricelistVersionBaseId.equals(""))
            return "";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "800040",
                data.mPricelistVersionId, "N", vars.getUser(),
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars)
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "PriceListCreateAll", false, "", "", "", false, "ad_process",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "PriceListCreateAll.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "PriceListCreateAll.html", strReplaceWith);
            ...
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_PriceList_Version_ID", "", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "PriceListCreateAll"), Utility.getContext(
                            this, vars, "#User_Client", "PriceListCreateAll"),
                    0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "PriceListCreateAll", "");
            xmlDocument.setData("reportM_PriceList_Version_ID",
