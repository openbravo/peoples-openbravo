...
public class SendMailText extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strInterestArea = vars.getGlobalVariable("inpInterestArea", "SendMailText|interestArea", "");
      ...
      String strMailTemplate = vars.getRequiredGlobalVariable("inpMailTemplate", "SendMailText|mailTemplate");
      String strInterestArea = vars.getRequestGlobalVariable("inpInterestArea", "SendMailText|interestArea");
...
//    New message system
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strMailTemplate, String strInterestArea, String strBPGroup, String strUser) throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: SendMailText select page");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_process/SendMailText", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SendMailText", false, "", "", "",false, "ad_process",  strReplaceWith, false,  true);
    ...
    try {
      KeyMap key = new KeyMap(this, vars, "SendMailText.html");
      xmlDocument.setParameter("keyMap", key.getActionButtonKeyMaps());
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    try {
      WindowTabs tabs = new WindowTabs(this, vars, "org.openbravo.erpCommon.ad_process.SendMailText");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SendMailText.html", classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SendMailText.html", strReplaceWith);
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "R_MailText_ID", "", "", Utility.getContext(this, vars, "#User_Org", "SendMailText"), Utility.getContext(this, vars, "#User_Client", "SendMailText"), 0);
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "R_InterestArea_ID", "", "", Utility.getContext(this, vars, "#User_Org", "SendMailText"), Utility.getContext(this, vars, "#User_Client", "SendMailText"), 0);
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_BP_Group_ID", "", "", Utility.getContext(this, vars, "#User_Org", "SendMailText"), Utility.getContext(this, vars, "#User_Client", "SendMailText"), 0);
	...
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLE", "User", "AD_User - Internal", "", Utility.getContext(this, vars, "#User_Org", "SendMailText"), Utility.getContext(this, vars, "#User_Client", "SendMailText"), 0);
  ...
  protected String processSend(VariablesSecureApp vars, String strMailTemplate, String strInterestArea, String strBPGroup, String strUser) throws IOException, ServletException {
    ...
    try {
      ...
      if (log4j.isDebugEnabled()) log4j.debug("processSend - R_MailText_ID=" + strMailTemplate);
      if (strMailTemplate.equals("")) return (Utility.messageBD(this, "NotFound", language)+ " " + Utility.messageBD(this, "R_MailText_ID", language));
      if (log4j.isDebugEnabled()) log4j.debug("processSend - AD_Client_ID=" + client);
      if (client.equals("0")) return (Utility.messageBD(this, "NotFound", language) + " - " + Utility.messageBD(this, "AD_Client_ID", language));
      String smtpHost = RequestActionData.selectSMTPHost(conn, this, client);
      if (log4j.isDebugEnabled()) log4j.debug("processSend - SMTP Host=" + smtpHost);
      if(smtpHost.equals("")) return(Utility.messageBD(this, "NotFound", language) + " " + Utility.messageBD(this, "SMTPHost", language));
      String from = "";
      String fromID = "";
      String fromPW = "";
      SendMailTextData[] mailTextData = SendMailTextData.selectMailData(conn, this, strMailTemplate);
      if (mailTextData==null || mailTextData.length==0) return (Utility.messageBD(this, "NotFound", language) + " " + Utility.messageBD(this, "R_MailText_ID", language) + ": " + strMailTemplate);
