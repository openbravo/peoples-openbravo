      ...
      for (int i = 0; i<data.length; i++){
       ...
       if (strcInvoiceIdOld.equals("")) {
         ...
         if (strPricelistId.equals("")){
           ...
           //Selects the currency of the employee price list, that can be different from the currency of the expense
       ...
       //If there was an invoice price, makes currency conversions, if necessary
       if (data[i].invoiceprice != null && !data[i].invoiceprice.equals("")) {
         ...
         if (!strCCurrencyId.equals(strBPCCurrencyId)){      
           ...
           strPricelimit = ExpenseAPInvoiceData.selectConvertedAmt(this, strPricelimit, strCCurrencyId, strBPCCurrencyId, strDateexpense, vars.getClient(), vars.getOrg());       
         }
       } 
       
       //Recalculates precisions for the employee pricelist currency
       ExpenseAPInvoiceData[] data4 = ExpenseAPInvoiceData.selectPrecisions(this, strBPCCurrencyId);
       ...
       if (strPricestd.equals("")) strPricestd="0";
       if (strPricelist.equals("")) strPricelist="0";
