...
public class ImportOrderServlet extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strProcessOrders = vars.getStringParameter(
                    "inpProcessOrders", "Y");
            printPage(response, vars, process, strWindowId, strTabId, strKey,
                    strDeleteOld, strProcessOrders);
            ...
            ImportOrder io = new ImportOrder(this, process, strRecord,
                    strDeleteOld.equals("Y"), strProcessOrders.equals("Y"));
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strRecordId, String strDeleteOld, String strProcessOrders)
            throws IOException, ServletException {
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_process/ImportOrderServlet")
                .createXmlDocument();
