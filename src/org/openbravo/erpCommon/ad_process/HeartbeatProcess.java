...
public class HeartbeatProcess implements Process {
  ...
  public void logSystemInfo(ConnectionProvider connection, Properties systemInfo) throws ServletException {
    ...
    HeartbeatProcessData.insertHeartbeatLog(connection, id, "0", "0", systemIdentifier, isHeartbeatActive, isProxyRequired, proxyServer, proxyPort, activityRate, complexityRate, os, osVersion, db, dbVersion, servletContainer, servletContainerVersion, webserver, webserverVersion, obVersion, obInstallMode, codeRevision, numRegisteredUsers, javaVersion, antVersion);
  }
