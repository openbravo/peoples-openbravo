...
public class GenerateHelp extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strWindow = vars.getGlobalVariable("inpadWindowId",
                    "GenerateHelp|windowID");
    ...
    OBError processSave(VariablesSecureApp vars, String strWindow,
        ...
        String strMessage = "";
        try {
            GenerateHelpData[] data = GenerateHelpData.select(this, vars
                    .getLanguage(), strWindow);
            ...
            for (i = 0; i < data.length; i++)
                generateFile(strPath, data[i].adWindowId + ".html", HelpWindow
                        .generateWindow(this, xmlEngine, vars, true,
                                data[i].adWindowId));
            strMessage = Utility.messageBD(this, "Created", vars.getLanguage())
                    + ": " + i;
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars)
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "GenerateHelp",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "GenerateHelp.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "GenerateHelp.html", strReplaceWith);
        ...
        /*
         * String strMessage = vars.getSessionValue("GenerateHelp.message"); if
         * (!strMessage.equals("")) {
         * vars.removeSessionValue("GenerateHelp.message"); strMessage =
         * "alert('" + Replace.replace(strMessage, "'", "\'") + "');"; }
         * xmlDocument.setParameter("body", strMessage);
         */
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "AD_Window_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "GenerateHelp"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "GenerateHelp"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "GenerateHelp", "");
            xmlDocument.setData("reportAD_Window_ID", "liststructure",
