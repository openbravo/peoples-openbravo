...
import org.openbravo.erpCommon.ad_help.*;
...
public class GenerateHelp extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (!Utility.hasProcessAccess(this, vars, "", "GenerateHelp")) {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      //if (!strMessage.equals("")) vars.setSessionValue("GenerateHelp.message", strMessage);
  ...
  OBError processSave(VariablesSecureApp vars, String strWindow, String strPath) throws IOException {
	  ...
	  myMessage.setTitle("");
    if (log4j.isDebugEnabled()) log4j.debug("Save: GenerateHelp");
    String strMessage = "";
    try {
      ...
      int i=0;
      for (i=0;i<data.length;i++) generateFile(strPath, data[i].adWindowId + ".html", HelpWindow.generateWindow(this, xmlEngine, vars, true, data[i].adWindowId));
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars) throws IOException, ServletException {
      if (log4j.isDebugEnabled()) log4j.debug("Output: process GenerateHelp");
      ...
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_process/GenerateHelp").createXmlDocument();
      
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "GenerateHelp", false, "", "", "",false, "ad_process",  strReplaceWith, false,  true);
      ...
      try {
        ...
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "GenerateHelp.html", classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "GenerateHelp.html", strReplaceWith);
     ...
     ////----
      ...
      /*String strMessage = vars.getSessionValue("GenerateHelp.message");
      if (!strMessage.equals("")) {
        vars.removeSessionValue("GenerateHelp.message");
        strMessage = "alert('" + Replace.replace(strMessage, "'", "\'") + "');";
      }
      xmlDocument.setParameter("body", strMessage);
      */
	try {
		ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "AD_Window_ID", "", "", Utility.getContext(this, vars, "#User_Org", "GenerateHelp"), Utility.getContext(this, vars, "#User_Client", "GenerateHelp"), 0);
