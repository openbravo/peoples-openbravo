...
public class ImportTaxServlet extends HttpSecureAppServlet { 
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      //String strKey = vars.getGlobalVariable("inpKey", "ImportTaxServlet|key");
      String strKey = "00";
      ...
      String strWindowId = vars.getRequestGlobalVariable("inpwindowId", "ImportTaxServlet|windowId");
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String strWindowId, String strTabId, String strRecordId, String strDeleteOld) throws IOException, ServletException {
      if (log4j.isDebugEnabled()) log4j.debug("Output: process ImportTaxServlet");
      ...
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_process/ImportTaxServlet").createXmlDocument();
