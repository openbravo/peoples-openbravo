...
public class JasperProcess implements Process {
  ...
  public void execute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      DecimalFormat numberFormat = new DecimalFormat(vars.getSessionValue("#AD_ReportNumberFormat"), dfs);
      designParameters.put("NUMBERFORMAT", numberFormat);

      if (log4j.isDebugEnabled()) log4j.debug("creating the format factory: " + vars.getJavaDateFormat());
      ...
      try {
        ...
        if (data != null) {
          ...
          jasperPrint = JasperFillManager.fillReport(jasperReport, designParameters, new JRFieldProviderDataSource(data, vars.getJavaDateFormat()));
        } else {
