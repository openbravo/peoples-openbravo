...
public class ImportModule {
  ...
  public boolean checkDependenciesId(String[] installableModules, String[] updateableModules) throws Exception{
    ...
    final ModuleInstallDetail mid = VersionUtility.checkRemote(vars, installableModules, updateableModules, errors);
  ...
  private void insertDynaModulesInDB(Vector<DynaBean> dModulesToInstall, Vector<DynaBean> dependencies1, Vector<DynaBean> dbPrefix) throws Exception {
    ...
    final String url = obProperties.getProperty("bbdd.url")+(obProperties.getProperty("bbdd.rdbms").equals("POSTGRE")?"/"+obProperties.getProperty("bbdd.sid"):"");
