...
public class ModuleUtiltiy {
    ...
    public static ArrayList<String> orderByDependency(ConnectionProvider conn,
        ...
        try {
            ...
            for (int i = 0; i < roots.size(); i++) {
                if (rt.indexOf(roots.get(i)) == -1
                        && modules.indexOf(roots.get(i)) != -1)
    ...
    private static ArrayList<String> selectRoots(ConnectionProvider conn)
    ...
    private static void checkTree(ConnectionProvider conn, String root,
            ArrayList<String> rt, ArrayList<String> list,
            ArrayList<String> checked) throws ServletException {
        ModuleUtilityData parents[] = ModuleUtilityData.selectParents(conn,
                root);
