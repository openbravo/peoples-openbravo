  ...
  String generateHtml(VariablesSecureApp vars, BuscadorData[] fields, String strTab, String strWindow, StringBuffer script, String strIsSOTrx, Vector<StringBuffer> vecScript) throws IOException, ServletException {
    ...
    for (int i=0;i<fields.length;i++) {
      ...
      if (fields[i].reference.equals("17") || fields[i].reference.equals("18") || fields[i].reference.equals("19")) {//List, Table, TableDir
        ...
        strHtml.append("<table class=\"FieldButton\" onclick=\"showCalendar('frmMain.inpParam").append(FormatUtilities.replace(fields[i].columnname)).append("', ");
        ...
        strHtml.append("return false;\" onmouseout=\"this.className='FieldButton';window.status='';return true;\" onmouseover=\"this.className='FieldButton_hover';window.status='Show Calendar';return true;\" onmousedown=\"this.className='FieldButton_active';return true;\" onmouseup=\"this.className='FieldButton';return true;\">\n");;
        strHtml.append("<tr>\n");
      ...
      if (Utility.isDecimalNumber(fields[i].reference) || Utility.isIntegerNumber(fields[i].reference) || Utility.isDateTime(fields[i].reference)) {
        ...
        if (Utility.isDecimalNumber(fields[i].reference) || Utility.isIntegerNumber(fields[i].reference)) {
          ...
          strHtml.append("</td>\n");
          strHtml.append("<td class=\"FieldButton_ContentCell\">");
          strHtml.append("<table class=\"FieldButton\" onclick=\"showCalendar('frmMain.inpParam").append(FormatUtilities.replace(fields[i].columnname)).append("_f', ");
