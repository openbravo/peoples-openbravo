...
public class CreateFrom extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            final String strKey = vars.getGlobalVariable("inpKey",
                    "CreateFrom|key");
            final String strTableId = vars.getGlobalVariable("inpTableId",
                    "CreateFrom|tableId");
            final String strProcessId = vars.getGlobalVariable("inpProcessId",
                    "CreateFrom|processId", "");
            final String strPath = vars.getGlobalVariable("inpPath",
                    "CreateFrom|path", strDireccion + request.getServletPath());
            final String strWindowId = vars.getGlobalVariable("inpWindowId",
                    "CreateFrom|windowId", "");
            final String strTabName = vars.getGlobalVariable("inpTabName",
                    "CreateFrom|tabName", "");
            final String strDateInvoiced = vars.getGlobalVariable(
                    "inpDateInvoiced", "CreateFrom|dateInvoiced", "");
            final String strBPartnerLocation = vars
                    .getGlobalVariable("inpcBpartnerLocationId",
                            "CreateFrom|bpartnerLocation", "");
            final String strMPriceList = vars.getGlobalVariable(
                    "inpMPricelist", "CreateFrom|pricelist", "");
            final String strBPartner = vars.getGlobalVariable("inpcBpartnerId",
                    "CreateFrom|bpartner", "");
            final String strStatementDate = vars.getGlobalVariable(
                    "inpstatementdate", "CreateFrom|statementDate", "");
            final String strBankAccount = vars.getGlobalVariable(
                    "inpcBankaccountId", "CreateFrom|bankAccount", "");
            final String strOrg = vars.getGlobalVariable("inpadOrgId",
                    "CreateFrom|adOrgId", "");
            final String strIsreceipt = vars.getGlobalVariable("inpisreceipt",
                    "CreateFrom|isreceipt", "");
            ...
            printPage_FS(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strDateInvoiced,
                    strBPartnerLocation, strMPriceList, strBPartner,
                    strStatementDate, strBankAccount, strOrg, strIsreceipt);
        } else if (vars.commandIn("FRAME1")) {
            final String strTableId = vars.getGlobalVariable("inpTableId",
                    "CreateFrom|tableId");
            final String strType = pageType(strTableId);
            final String strKey = vars.getGlobalVariable("inpKey", "CreateFrom"
                    + strType + "|key");
            final String strProcessId = vars.getGlobalVariable("inpProcessId",
                    "CreateFrom" + strType + "|processId", "");
            final String strPath = vars.getGlobalVariable("inpPath",
                    "CreateFrom" + strType + "|path", strDireccion
            ...
            final String strBPartnerLocation = vars.getGlobalVariable(
                    "inpcBpartnerLocationId", "CreateFrom" + strType
                            + "|bpartnerLocation", "");
            ...
            final String strStatementDate = vars.getGlobalVariable(
                    "inpstatementdate", "CreateFrom" + strType
                            + "|statementDate", "");
            final String strBankAccount = vars.getGlobalVariable(
                    "inpcBankaccountId", "CreateFrom" + strType
                            + "|bankAccount", "");
            final String strOrg = vars.getGlobalVariable("inpadOrgId",
            ...
            vars.removeSessionValue("CreateFrom" + strType
                    + "|bpartnerLocation");
            ...
            callPrintPage(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strDateInvoiced,
                    strBPartnerLocation, strPriceList, strBPartner,
                    strStatementDate, strBankAccount, strOrg, strIsreceipt);
        } else if (vars.commandIn("FIND_PO", "FIND_INVOICE", "FIND_SHIPMENT",
                "FIND_BANK", "FIND_SETTLEMENT")) {
            ...
            final String strDateInvoiced = vars
                    .getStringParameter("inpDateInvoiced");
            final String strBPartnerLocation = vars
                    .getStringParameter("inpcBpartnerLocationId");
            final String strPriceList = vars
                    .getStringParameter("inpMPricelist");
            final String strBPartner = vars
                    .getStringParameter("inpcBpartnerId");
            final String strStatementDate = vars
                    .getStringParameter("inpstatementdate");
            final String strBankAccount = vars
                    .getStringParameter("inpcBankaccountId");
            ...
            final String strTableId = vars.getStringParameter("inpTableId");
            final String strWindowId = vars.getStringParameter("inpWindowId");
            final OBError myMessage = saveMethod(vars, strKey, strTableId,
                    strProcessId, strWindowId);
            final String strTabId = vars.getGlobalVariable("inpTabId",
                    "CreateFrom|tabId");
    ...
    void printPage_FS(HttpServletResponse response, VariablesSecureApp vars,
            String strPath, String strKey, String strTableId,
            String strProcessId, String strWindowId, String strTabName,
            String strDateInvoiced, String strBPartnerLocation,
            String strPriceList, String strBPartner, String strStatementDate,
            String strBankAccount, String strOrg, String strIsreceipt)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: FrameSet");
        final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_FS")
                .createXmlDocument();
        final String strType = pageType(strTableId);
        vars.setSessionValue("CreateFrom" + strType + "|path", strPath);
        vars.setSessionValue("CreateFrom" + strType + "|key", strKey);
        vars.setSessionValue("CreateFrom" + strType + "|processId",
                strProcessId);
        vars.setSessionValue("CreateFrom" + strType + "|windowId", strWindowId);
        vars.setSessionValue("CreateFrom" + strType + "|tabName", strTabName);
        vars.setSessionValue("CreateFrom" + strType + "|dateInvoiced",
                strDateInvoiced);
        vars.setSessionValue("CreateFrom" + strType + "|bpartnerLocation",
                strBPartnerLocation);
        vars.setSessionValue("CreateFrom" + strType + "|pricelist",
                strPriceList);
        vars.setSessionValue("CreateFrom" + strType + "|bpartner", strBPartner);
        vars.setSessionValue("CreateFrom" + strType + "|statementDate",
                strStatementDate);
        vars.setSessionValue("CreateFrom" + strType + "|bankAccount",
                strBankAccount);
        vars.setSessionValue("CreateFrom" + strType + "|adOrgId", strOrg);
        vars.setSessionValue("CreateFrom" + strType + "|isreceipt",
                strIsreceipt);
    ...
    void callPrintPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (strTableId.equals("392")) { // C_BankStatement
            printPageBank(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strStatementDate,
                    strBankAccount);
        } else if (strTableId.equals("318")) { // C_Invoice
            printPageInvoice(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strDateInvoiced,
                    strBPartnerLocation, strPriceList, strBPartner);
        } else if (strTableId.equals("319")) { // M_InOut
            printPageShipment(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strBPartner);
        } else if (strTableId.equals("426")) { // C_PaySelection
            printPagePay(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strBPartner);
        } else if (strTableId.equals("800019")) { // C_Settlement
            printPageSettlement(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strBPartner);
        } else if (strTableId.equals("800176")) { // C_DP_Management
            printPageDPManagement(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strBPartner);
        } else if (strTableId.equals("800179")) { // C_Remittance
            printPageCRemittance(response, vars, strPath, strKey, strTableId,
                    strProcessId, strWindowId, strTabName, strBPartner, strOrg,
                    strIsreceipt);
        } else {
            pageError(response);
        }
    ...
    void printPageBank(HttpServletResponse response, VariablesSecureApp vars,
            String strPath, String strKey, String strTableId,
            String strProcessId, String strWindowId, String strTabName,
            String strStatementDate, String strBank) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        final String strPlannedDateFrom = vars
                .getStringParameter("inpplanneddateFrom");
        final String strPlannedDateTo = vars
                .getStringParameter("inpplanneddateTo");
        ...
        final String strPlannedDate = vars.getStringParameter("inpplanneddate",
                strStatementDate);
        final String strCost = vars.getStringParameter("inpcost", "0.00");
        final String strProposed = vars.getStringParameter("inpproposed",
                "0.00");
        final String strDocumentNo = vars.getStringParameter("inpDocumentNo");
        CreateFromBankData[] data = null;
        final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_Bank")
                .createXmlDocument();
        if (strcBPartner.equals("") && strPaymentRule.equals("")
                && strPlannedDateFrom.equals("") && strPlannedDateTo.equals("")
                && strIsReceipt.equals("") && strBankAccount.equals("")
                && strOrg.equals("")) {
            data = new CreateFromBankData[0];
        } else {
            if (vars.commandIn("FRAME1") && strIsReceipt.equals(""))
                strIsReceipt = isSOTrx;

            final int numRows = Integer.valueOf(CreateFromBankData.countRows(
                    this, Utility.getContext(this, vars, "#User_Client",
                            strWindowId), Utility.getContext(this, vars,
                            "#User_Org", strWindowId), strcBPartner,
                    strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                    strAmountFrom, strAmountTo, strIsReceipt, strBank, strOrg,
                    strCharge, strDocumentNo));
            final int maxRows = Integer.valueOf(vars
                    .getSessionValue("#RECORDRANGEINFO"));

            if (numRows > maxRows) {
                final OBError obError = new OBError();
                String strMsg = Utility.messageBD(this, "MAX_RECORDS_REACHED",
                        vars.getLanguage());
                strMsg = strMsg.replaceAll("%returned%", String
                        .valueOf(numRows));
            ...
            if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                data = CreateFromBankData.select(this, vars.getLanguage(),
                        strStatementDate, "ROWNUM", Utility.getContext(this,
                                vars, "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strcBPartner,
                        strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                        strAmountFrom, strAmountTo, strIsReceipt, strBank,
                        strOrg, strCharge, strDocumentNo, String
                                .valueOf(maxRows), null);
            } else {
                data = CreateFromBankData.select(this, vars.getLanguage(),
                        strStatementDate, "1", Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strcBPartner,
                        strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                        strAmountFrom, strAmountTo, strIsReceipt, strBank,
                        strOrg, strCharge, strDocumentNo, null, String
                                .valueOf(maxRows));
            }
        }
        if (vars.commandIn("FRAME1") && strIsReceipt.equals(""))
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "", "All_Payment Rule", "", Utility.getContext(
                            this, vars, "#User_Org", "CreateFrom"), Utility
        ...
        xmlDocument.setParameter("cbpartnerId_DES", CreateFromBankData
                .bpartner(this, strcBPartner));
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    strWindowId, strBank);
            xmlDocument.setData("reportC_BankAccount_ID", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (final Exception ex) {
            throw new ServletException(ex);
    ...
    void printPageInvoice(HttpServletResponse response,
            VariablesSecureApp vars, String strPath, String strKey,
            String strTableId, String strProcessId, String strWindowId,
            String strTabName, String strDateInvoiced,
            String strBPartnerLocation, String strPriceList, String strBPartner)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (strPO.equals("") && strShipment.equals("")) {
            ...
            xmlDocument = xmlEngine
                    .readXmlTemplate(
                            "org/openbravo/erpCommon/ad_actionButton/CreateFrom_Invoice",
            ...
            if (strShipment.equals("")) {
                if (vars.getLanguage().equals("en_US")) {
                    if (isSOTrx.equals("Y"))
                        data = CreateFromInvoiceData.selectFromPOSOTrx(this,
                                vars.getLanguage(), Utility.getContext(this,
                                        vars, "#User_Client", strWindowId),
                                Utility.getContext(this, vars, "#User_Org",
                                        strWindowId), strPO);
                    else
                        data = CreateFromInvoiceData.selectFromPO(this, vars
                    ...
                    if (isSOTrx.equals("Y"))
                        ...
                        data = CreateFromInvoiceData.selectFromPOTrl(this, vars
                                .getLanguage(), Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strPO);
                ...
                if (vars.getLanguage().equals("en_US")) {
                    if (isSOTrx.equals("Y"))
                        data = CreateFromInvoiceData.selectFromShipmentSOTrx(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
                                                strWindowId), strShipment);
                    else
                    ...
                    if (isSOTrx.equals("Y"))
                        data = CreateFromInvoiceData
                                .selectFromShipmentTrlSOTrx(this, vars
                                        .getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
                        ...
                        data = CreateFromInvoiceData.selectFromShipmentTrl(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
        ...
        xmlDocument.setParameter("BPartnerDescription", CreateFromShipmentData
        ...
        if (strBPartner.equals("")) {
            xmlDocument.setData("reportShipmentReciept", "liststructure",
                    new CreateFromInvoiceData[0]);
            xmlDocument.setData("reportPurchaseOrder", "liststructure",
                    new CreateFromInvoiceData[0]);
        } else {
            if (isSOTrx.equals("Y")) {
                xmlDocument.setData("reportShipmentReciept", "liststructure",
                        CreateFromInvoiceData.selectFromShipmentSOTrxCombo(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
                ...
                xmlDocument.setData("reportPurchaseOrder", "liststructure",
                        CreateFromInvoiceData.selectFromPOSOTrxCombo(this, vars
                                .getLanguage(), Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strBPartner));
                ...
                xmlDocument.setData("reportShipmentReciept", "liststructure",
                        CreateFromInvoiceData.selectFromShipmentCombo(this,
                                ...
                                Utility.getContext(this, vars, "#User_Org",
                                        strWindowId), strBPartner));
                xmlDocument.setData("reportPurchaseOrder", "liststructure",
                        CreateFromInvoiceData.selectFromPOCombo(this, vars
                                .getLanguage(), Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strBPartner));
    ...
    void printPageShipment(HttpServletResponse response,
            VariablesSecureApp vars, String strPath, String strKey,
            String strTableId, String strProcessId, String strWindowId,
            String strTabName, String strBPartner) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (strPO.equals("") && strInvoice.equals("")) {
            ...
            if (isSOTrx.equals("Y"))
                xmlDocument = xmlEngine
                        .readXmlTemplate(
                                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_Shipment",
                                discard).createXmlDocument();
            else
                xmlDocument = xmlEngine
                        .readXmlTemplate(
                                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_ShipmentPO",
                                discard).createXmlDocument();
            ...
            if (strInvoice.equals("")) {
                if (vars.getLanguage().equals("en_US")) {
                    if (isSOTrx.equals("Y"))
                        ...
                        data = CreateFromShipmentData.selectFromPO(this, vars
                                .getLanguage(), Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strPO);
                    ...
                    if (isSOTrx.equals("Y"))
                        data = CreateFromShipmentData.selectFromPOTrlSOTrx(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
                ...
                if (vars.getLanguage().equals("en_US")) {
                    if (isSOTrx.equals("Y"))
                        data = CreateFromShipmentData.selectFromInvoiceTrx(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
                                                strWindowId), strInvoice);
                    else
                    ...
                    if (isSOTrx.equals("Y"))
                        ...
                        data = CreateFromShipmentData.selectFromInvoiceTrl(
                                this, vars.getLanguage(), Utility
                                        .getContext(this, vars, "#User_Client",
                                                strWindowId), Utility
                                        .getContext(this, vars, "#User_Org",
        ...
        xmlDocument.setParameter("M_Locator_ID_DES", CreateFromShipmentData
                .selectLocator(this, strLocator));
                ...
                xmlDocument.setData("reportInvoice", "liststructure",
                        CreateFromShipmentData.selectFromInvoiceCombo(this,
                                ...
                                Utility.getContext(this, vars, "#User_Org",
                                        strWindowId), strBPartner));
                xmlDocument.setData("reportPurchaseOrder", "liststructure",
                        CreateFromShipmentData.selectFromPOCombo(this, vars
                                .getLanguage(), Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strBPartner));
        ...
        if (isSOTrx.equals("N")) {
            ...
            for (int i = 0; i < data.length; i++) {
                ...
                dataUOM[i] = CreateFromShipmentData.selectUOM(this,
                        data[i].mProductId);
            ...
            xmlDocument.setDataArray("reportM_Product_Uom_To_ID",
                    "liststructure", dataUOM);
        }
        xmlDocument.setData("structure1", data);
        response.setContentType("text/html; charset=UTF-8");
        final PrintWriter out = response.getWriter();
    ...
    void printPageInvoiceCombo(HttpServletResponse response,
            VariablesSecureApp vars, String strBPartner, String strWindowId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Refresh Invoices");
        final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_F0")
                .createXmlDocument();
        String strArray = "";
        String strArray2 = "";
        final String isSOTrx = Utility.getContext(this, vars, "isSOTrx",
        ...
        if (strBPartner.equals("")) {
            strArray = arrayEntradaSimple("arrDatos",
                    new CreateFromShipmentData[0]);
            strArray2 = arrayEntradaSimple("arrDatos2",
                    new CreateFromShipmentData[0]);
        } else {
            if (vars.commandIn("REFRESH_INVOICES")) { // Loading the combos in
                ...
                if (isSOTrx.equals("Y")) {
                    ...
                    strArray2 = arrayEntradaSimple("arrDatos2",
                            CreateFromShipmentData.selectFromPOSOTrxCombo(this,
                                    vars.getLanguage(), Utility.getContext(
                                            ...
                                            strWindowId), Utility.getContext(
                                            this, vars, "#User_Org",
                                            strWindowId), strBPartner));
                } else {
                    strArray = arrayEntradaSimple("arrDatos",
                    ...
                    strArray2 = arrayEntradaSimple("arrDatos2",
                            CreateFromShipmentData.selectFromPOCombo(this, vars
                                    .getLanguage(), Utility.getContext(this,
                                    vars, "#User_Client", strWindowId), Utility
                                    .getContext(this, vars, "#User_Org",
                                            strWindowId), strBPartner));
                }
    ...
    void printPagePay(HttpServletResponse response, VariablesSecureApp vars,
            String strPath, String strKey, String strTableId,
            String strProcessId, String strWindowId, String strTabName,
        ...
        final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/CreateFrom_Pay")
                .createXmlDocument();
    ...
    void printPageSettlement(HttpServletResponse response,
            VariablesSecureApp vars, String strPath, String strKey,
            String strTableId, String strProcessId, String strWindowId,
            String strTabName, String strBPartner) throws IOException,
            ServletException {
        ...
        final XmlDocument xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_actionButton/CreateFrom_Settlement")
                .createXmlDocument();
        ...
        if (vars.getSessionValue("CreateFrom|default").equals("1")) {
             ...
             * if (strcBPartner.equals("") && strPaymentRule.equals("") &&
             * strPlannedDateFrom.equals("") && strPlannedDateTo.equals("") &&
             * strIsReceipt.equals("") && strTotalAmount.equals("") &&
             * strOrg.equals("")) {
             */
            ...
            final int numRows = Integer.valueOf(CreateFromSettlementData
                    .countRows(this, Utility.getContext(this, vars,
                            "#User_Client", strWindowId), Utility.getContext(
                            this, vars, "#User_Org", strWindowId),
                            strcBPartner, strPaymentRule, strPlannedDateFrom,
                            strPlannedDateTo, strIsReceipt, strAmountFrom,
                            strAmountTo, strTotalAmount, strOrg));
            final int maxRows = Integer.valueOf(vars
                    .getSessionValue("#RECORDRANGEINFO"));
            ...
            if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                data = CreateFromSettlementData.select(this,
                        vars.getLanguage(), strMarcarTodos, "ROWNUM",
                        strAutoCalcSelect, Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strcBPartner,
                        strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                        strIsReceipt, strAmountFrom, strAmountTo,
                        strTotalAmount, strOrg, String.valueOf(maxRows), null);
            } else {
                data = CreateFromSettlementData.select(this,
                        vars.getLanguage(), strMarcarTodos, "1",
                        strAutoCalcSelect, Utility.getContext(this, vars,
                                "#User_Client", strWindowId), Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strcBPartner,
        ...
        xmlDocument.setParameter("inpBpartnerId_DES", CreateFromSettlementData
                .bpartner(this, strcBPartner));
    ...
    void printPageDPManagement(HttpServletResponse response,
            VariablesSecureApp vars, String strPath, String strKey,
            String strTableId, String strProcessId, String strWindowId,
            String strTabName, String strBPartner) throws IOException,
            ServletException {
        ...
        final XmlDocument xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_actionButton/CreateFrom_DPManagement")
                .createXmlDocument();
        ...
        if (strcBPartner.equals("") && strPaymentRule.equals("")
            ...
            final int numRows = Integer
                    .valueOf(CreateFromDPManagementData.countRows(this,
                            Utility.getContext(this, vars, "#User_Client",
                                    strWindowId), Utility.getContext(this,
                                    vars, "#User_Org", strWindowId),
                            strcBPartner, strPaymentRule, strPlannedDateFrom,
                            strPlannedDateTo, strIsReceipt, strAmountFrom,
                            strAmountTo, strTotalAmount, strStatusFrom, strOrg));
            final int maxRows = Integer.valueOf(vars
                    .getSessionValue("#RECORDRANGEINFO"));
            ...
            // different limit/offset syntax in oracle and postgresql
            if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                data = CreateFromDPManagementData.select(this, vars
                        .getLanguage(), "ROWNUM", strMarcarTodos, Utility
                        ...
                        strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                        strIsReceipt, strAmountFrom, strAmountTo,
                        strTotalAmount, strStatusFrom, strOrg, String
                                .valueOf(maxRows), null);
            } else {
                data = CreateFromDPManagementData.select(this, vars
                        .getLanguage(), "1", strMarcarTodos, Utility
                        .getContext(this, vars, "#User_Client", strWindowId),
                        Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strcBPartner,
                        strPaymentRule, strPlannedDateFrom, strPlannedDateTo,
                        strIsReceipt, strAmountFrom, strAmountTo,
                        strTotalAmount, strStatusFrom, strOrg, null, String
                                .valueOf(maxRows));
            }

            if (log4j.isDebugEnabled())
                log4j.debug("DPSelect: lineas"
                        + data.length
                        + "client "
                        + Utility.getContext(this, vars, "#User_Client",
                                strWindowId)
                        + "userOrg "
                        + Utility.getContext(this, vars, "#User_Org",
                                strWindowId) + " partner:" + strcBPartner
                        + " rule:" + strPaymentRule + "df" + strPlannedDateFrom
                        + " dt:" + strPlannedDateTo + " rec:" + strIsReceipt
                        + "amtF:" + strAmountFrom + "amt T:" + strAmountTo
                        + "ttlamt:" + strTotalAmount + "org " + strOrg);
        }
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(
                    ...
                    0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    strWindowId, strStatusFrom);
            xmlDocument.setData("reportStatusFrom", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (final Exception ex) {
            throw new ServletException(ex);
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    strWindowId, strStatusFrom);
            xmlDocument.setData("reportStatusTo", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (final Exception ex) {
            throw new ServletException(ex);
        ...
        xmlDocument.setParameter("cbpartnerId", strcBPartner);
        xmlDocument.setParameter("cbpartnerId_DES", CreateFromDPManagementData
                .bpartner(this, strcBPartner));
        xmlDocument.setParameter("plannedDateFrom", strPlannedDateFrom);
        xmlDocument.setParameter("plannedDateTo", strPlannedDateTo);
    ...
    void printPageCRemittance(HttpServletResponse response,
            VariablesSecureApp vars, String strPath, String strKey,
            String strTableId, String strProcessId, String strWindowId,
            String strTabName, String strBPartner, String stradOrgId,
            String isReceipt) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        final String strAmountTo = vars.getStringParameter("inpamountTo");
        final String strTotalAmount = vars.getStringParameter("inpamount");
        String strIsReceipt = vars
                .getStringParameter("inpisreceipt", isReceipt);
        final String isSOTrx = Utility.getContext(this, vars, "isSOTrx",
                strWindowId);
        ...
        final String strMarcarTodos = vars.getStringParameter("inpTodos", "N");
        final String strTreeOrg = ReportTrialBalanceData.treeOrg(this, vars
                .getClient());
        final String strOrgFamily = Tree.getMembers(this, strTreeOrg, strOrg);

        final XmlDocument xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_actionButton/CreateFrom_CRemittance")
                .createXmlDocument();
        ...
        if (vars.commandIn("FRAME1")) {
            ...
            final int numRows = Integer.valueOf(CreateFromCRemittanceData
                    .countRows(this, Utility.getContext(this, vars,
                            "#User_Client", strWindowId), Utility.getContext(
                            this, vars, "#User_Org", strWindowId),
                            strOrgFamily, strcBPartner, strPaymentRule,
                            strPlannedDateFrom, strPlannedDateTo, strIsReceipt,
                            strAmountFrom, strAmountTo, strTotalAmount,
                            strStatusFrom));
            final int maxRows = Integer.valueOf(vars
                    .getSessionValue("#RECORDRANGEINFO"));
            ...
            if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                data = CreateFromCRemittanceData.select(this, vars
                        .getLanguage(), strMarcarTodos, "ROWNUM", Utility
                        .getContext(this, vars, "#User_Client", strWindowId),
                        Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strOrgFamily,
                        strcBPartner, strPaymentRule, strPlannedDateFrom,
                        strPlannedDateTo, strIsReceipt, strAmountFrom,
                        strAmountTo, strTotalAmount, strStatusFrom, String
                                .valueOf(maxRows), null);
            } else {
                data = CreateFromCRemittanceData.select(this, vars
                        .getLanguage(), strMarcarTodos, "1", Utility
                        .getContext(this, vars, "#User_Client", strWindowId),
                        Utility
                                .getContext(this, vars, "#User_Org",
                                        strWindowId), strOrgFamily,
                        strcBPartner, strPaymentRule, strPlannedDateFrom,
                        strPlannedDateTo, strIsReceipt, strAmountFrom,
                        strAmountTo, strTotalAmount, strStatusFrom, null,
    ...
    OBError saveMethod(VariablesSecureApp vars, String strKey,
        ...
        if (strTableId.equals("392"))
            ...
            return saveInvoice(vars, strKey, strTableId, strProcessId,
                    strWindowId);
        else if (strTableId.equals("319"))
            return saveShipment(vars, strKey, strTableId, strProcessId,
                    strWindowId);
        else if (strTableId.equals("426"))
    ...
    OBError saveBank(VariablesSecureApp vars, String strKey, String strTableId,
        ...
        try {
            ...
            if (!strPayment.equals("")) {
                ...
                final StringTokenizer st = new StringTokenizer(strPayment, ",",
                        false);
                while (st.hasMoreTokens()) {
                    String strDebtPaymentId = st.nextToken().trim();
                    if (!CreateFromBankData.NotIsReconcilied(conn, this,
                            strDebtPaymentId)) {
                        releaseRollbackConnection(conn);
                        log4j.warn("CreateFrom.saveBank - debt_payment "
                                + strDebtPaymentId + " is reconcilied");
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), "DebtPaymentReconcilied");
                        return myMessage;
                    }
                    strDateplanned = vars.getStringParameter("inpplanneddate"
                            + strDebtPaymentId.trim());
                    strChargeamt = vars.getStringParameter("inpcost"
                            + strDebtPaymentId.trim());
                    strProposedAmt = vars.getStringParameter("inpproposed"
                            + strDebtPaymentId.trim());
                    if (strProposedAmt != null && !strProposedAmt.equals("")
                        ...
                        CreateFromBankData.insertSettlement(conn, this,
                                strSettlement, vars.getUser(),
                                strStatementDate, strDebtPaymentId);
                        final String strNewPayment = SequenceIdData.getUUID();
                        CreateFromBankData.insertPayment(conn, this,
                                strNewPayment, vars.getUser(), strSettlement,
                                strProposedAmt, strDebtPaymentId);
                        CreateFromBankData.cancelOriginalPayment(conn, this,
                                strSettlement, strDebtPaymentId);
                        CreateFromBankData.insertSecondPayment(conn, this, vars
                                .getUser(), strSettlement, strProposedAmt,
                                strDebtPaymentId);
                        strDebtPaymentId = strNewPayment;
                        CreateFromBankData.processSettlement(conn, this,
                                strSettlement);
                    }
                    final String strSequence = SequenceIdData.getUUID();
                    try {
                        CreateFromBankData.insert(conn, this, strSequence, vars
                                .getClient(), vars.getUser(), strKey,
                                strDateplanned.equals("") ? strStatementDate
                                        : strDateplanned, strChargeamt,
                                strDebtPaymentId);
    ...
    OBError saveInvoice(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId, String strWindowId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Save: Invoice");
        final String strDateInvoiced = vars
                .getRequiredStringParameter("inpDateInvoiced");
        final String strBPartnerLocation = vars
                .getRequiredStringParameter("inpcBpartnerLocationId");
        final String strBPartner = vars
                .getRequiredStringParameter("inpcBpartnerId");
        final String strPriceList = vars
                .getRequiredStringParameter("inpMPricelist");
        final String strType = vars.getRequiredStringParameter("inpType");
        final String strClaves = Utility.stringList(vars
                .getRequiredInParameter("inpcOrderId"));
        final String isSOTrx = Utility.getContext(this, vars, "isSOTrx",
                strWindowId);
        ...
        try {
            ...
            if (strType.equals("SHIPMENT")) {
                if (isSOTrx.equals("Y"))
                    data = CreateFromInvoiceData.selectFromShipmentUpdateSOTrx(
                            conn, this, strClaves);
                else
                    data = CreateFromInvoiceData.selectFromShipmentUpdate(conn,
                            this, strClaves);
                final CreateFromInvoiceData[] dataAux = CreateFromInvoiceData
                        .selectPriceList(conn, this, strDateInvoiced,
                                strPriceList);
                if (dataAux == null || dataAux.length == 0) {
                    myMessage = Utility.translateError(this, vars, vars
                            .getLanguage(), "PriceListVersionNotFound");
                    return myMessage;
                }
                ...
                if (isSOTrx.equals("Y"))
                    data = CreateFromInvoiceData.selectFromPOUpdateSOTrx(conn,
                            this, strClaves);
                else
            ...
            if (data != null) {
                for (int i = 0; i < data.length; i++) {
                    ...
                    if (data[i].cOrderlineId.equals(""))
                        C_Tax_ID = Tax.get(this, data[i].mProductId,
                                strDateInvoiced, data[i].adOrgId, vars
                                        .getWarehouse(), strBPartnerLocation,
                                strBPartnerLocation, CreateFromInvoiceData
                                        .selectProject(this, strKey), isSOTrx
                                        .equals("Y") ? true : false);
                    else
                        C_Tax_ID = CreateFromInvoiceData.getTax(this,
                                data[i].cOrderlineId);

                    final int stdPrecision = Integer.valueOf(
                            data[i].stdprecision).intValue();
                    if (!data[i].cOrderlineId.equals("")) {
                        price = CreateFromInvoiceData.selectPrices(conn, this,
                                data[i].cOrderlineId);
                    ...
                    try {
                        CreateFromInvoiceData.insert(conn, this, strSequence,
                                strKey, vars.getClient(), data[i].adOrgId, vars
                                        .getUser(), data[i].cOrderlineId,
                                data[i].mInoutlineId, data[i].description,
                                data[i].mProductId, data[i].cUomId, data[i].id,
                                priceList, priceActual, priceLimit, LineNetAmt
                                        .toString(), C_Tax_ID,
                                data[i].quantityorder, data[i].mProductUomId,
                                data[i].mAttributesetinstanceId, priceStd);
                    } catch (final ServletException ex) {
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), ex.getMessage());
                        releaseRollbackConnection(conn);
            ...
            if (!strPO.equals("")) {
                try {
                    final int total = CreateFromInvoiceData.deleteC_Order_ID(
                            conn, this, strKey, strPO);
                    if (total == 0)
                        CreateFromInvoiceData.updateC_Order_ID(conn, this,
                                strPO, strKey);
                } catch (final ServletException ex) {
                    myMessage = Utility.translateError(this, vars, vars
                            .getLanguage(), ex.getMessage());
    ...
    OBError saveShipment(VariablesSecureApp vars, String strKey,
        ...
        final String isSOTrx = Utility.getContext(this, vars, "isSOTrx",
                strWindowId);
        if (isSOTrx.equals("Y"))
            return saveShipmentSO(vars, strKey, strTableId, strProcessId,
                    strWindowId);
        else
            return saveShipmentPO(vars, strKey, strTableId, strProcessId,
                    strWindowId);
    }

    OBError saveShipmentPO(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId, String strWindowId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Save: Shipment");
        final String strLocatorCommon = vars
                .getStringParameter("inpmLocatorId");
        final String strType = vars.getRequiredStringParameter("inpType");
        final String strClaves = Utility.stringList(vars
        ...
        try {
            ...
            if (strType.equals("INVOICE")) {
                ...
                if (!isSOTrx.equals("Y"))
                    data = CreateFromShipmentData.selectFromInvoiceUpdate(conn,
                            this, strClaves);
            } else {
                strPO = vars.getStringParameter("inpPurchaseOrder");
                if (isSOTrx.equals("Y"))
                    data = CreateFromShipmentData.selectFromPOUpdateSOTrx(conn,
                            this, strClaves);
                else
                    data = CreateFromShipmentData.selectFromPOUpdate(conn,
                            this, strClaves);
            }
            if (data != null) {
                for (int i = 0; i < data.length; i++) {
                    ...
                    final String strMovementqty = vars
                            .getRequiredStringParameter("inpmovementqty"
                                    + strLineId);
                    ...
                    if ("".equals(data[i].mProductUomId)) {
                        ...
                        strQuantityorder = vars
                                .getRequiredStringParameter("inpquantityorder"
                                        + strLineId);
                        strProductUomId = vars
                                .getRequiredStringParameter("inpmProductUomId"
                                        + strLineId);
                        dataUomIdConversion = CreateFromShipmentData
                                .selectcUomIdConversion(this, strProductUomId);

                        if (dataUomIdConversion == null
                                || dataUomIdConversion.length == 0) {
                    ...
                    if ("Y".equals(strbreakdown)) {
                        ...
                        if (strInitUOM.equals(strUOM))
                            ...
                            strMultiplyRate = CreateFromShipmentData
                                    .multiplyRate(this, strInitUOM, strUOM);
                        if (strMultiplyRate.equals(""))
                            strMultiplyRate = CreateFromShipmentData
                                    .divideRate(this, strUOM, strInitUOM);
                        if (strMultiplyRate.equals("")) {
                            strMultiplyRate = "1";
                            releaseRollbackConnection(conn);
                            myMessage = Utility.translateError(this, vars, vars
                        ...
                        stdPrecision = Integer.valueOf(
                                dataUomIdConversion[i].stdprecision).intValue();
                        ...
                        while (qty.doubleValue() > ZERO.doubleValue()) {
                            ...
                            final String strSequence = SequenceIdData.getUUID();
                            try {
                                CreateFromShipmentData.insert(conn, this,
                                        strSequence, strKey, vars.getClient(),
                                        data[i].adOrgId, vars.getUser(),
                                        data[i].description,
                                        data[i].mProductId, data[i].cUomId,
                                        (qtyIsNegative ? "-" + strConversion
                                                : strConversion),
                                        data[i].cOrderlineId, strLocator,
                                        CreateFromShipmentData.isInvoiced(conn,
                                                this, data[i].cInvoicelineId),
                                        (qtyIsNegative ? "-" + total : total),
                                        data[i].mProductUomId,
                                        strmAttributesetinstanceId);
                                if (!strInvoice.equals(""))
                                    CreateFromShipmentData.updateInvoice(conn,
                                            this, strSequence,
                                            data[i].cInvoicelineId);
                                else
                                    CreateFromShipmentData.updateInvoiceOrder(
                                            conn, this, strSequence,
                                            data[i].cOrderlineId);
                            } catch (final ServletException ex) {
                        ...
                        try {
                            CreateFromShipmentData.insert(conn, this,
                                    strSequence, strKey, vars.getClient(),
                                    data[i].adOrgId, vars.getUser(),
                                    data[i].description, data[i].mProductId,
                                    data[i].cUomId, strMovementqty,
                                    data[i].cOrderlineId, strLocator,
                                    CreateFromShipmentData.isInvoiced(conn,
                                            this, data[i].cInvoicelineId),
                                    strQuantityorder, strProductUomId,
                                    strmAttributesetinstanceId);
                            if (!strInvoice.equals(""))
                                CreateFromShipmentData.updateInvoice(conn,
                                        this, strSequence,
            ...
            if (!strPO.equals("")) {
                try {
                    final int total = CreateFromShipmentData.deleteC_Order_ID(
                            conn, this, strKey, strPO);
                    if (total == 0)
                        CreateFromShipmentData.updateC_Order_ID(conn, this,
                                strPO, strKey);
                } catch (final ServletException ex) {
                    myMessage = Utility.translateError(this, vars, vars
                            .getLanguage(), ex.getMessage());
            ...
            if (!strInvoice.equals("")) {
                try {
                    final int total = CreateFromShipmentData
                            .deleteC_Invoice_ID(conn, this, strKey, strInvoice);
                    if (total == 0)
                        CreateFromShipmentData.updateC_Invoice_ID(conn, this,
                                strInvoice, strKey);
                } catch (final ServletException ex) {
                    myMessage = Utility.translateError(this, vars, vars
                            .getLanguage(), ex.getMessage());
    ...
    OBError saveShipmentSO(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId, String strWindowId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Save: Shipment");
        final String strLocator = vars
                .getRequiredStringParameter("inpmLocatorId");
        final String strType = vars.getRequiredStringParameter("inpType");
        final String strClaves = Utility.stringList(vars
                .getRequiredInParameter("inpId"));
        final String isSOTrx = Utility.getContext(this, vars, "isSOTrx",
        ...
        try {
            ...
            if (strType.equals("INVOICE")) {
                strInvoice = vars.getStringParameter("inpInvoice");
                if (isSOTrx.equals("Y"))
                    data = CreateFromShipmentData.selectFromInvoiceTrxUpdate(
                            conn, this, strClaves);
                else
                    data = CreateFromShipmentData.selectFromInvoiceUpdate(conn,
                            this, strClaves);
            ...
            if (data != null) {
                for (int i = 0; i < data.length; i++) {
                    ...
                    if (data[i].breakdown.equals("Y")) {
                        ...
                        stdPrecision = Integer.valueOf(data[i].stdprecision)
                                .intValue();
                        BigDecimal quantity, qty, multiplyRate;
    ...
    OBError savePay(VariablesSecureApp vars, String strKey, String strTableId,
            String strProcessId) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
    ...
    OBError saveSettlement(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        try {
            ...
            if (strDebtPayment.startsWith("("))
                strDebtPayment = strDebtPayment.substring(1, strDebtPayment
                        .length() - 1);
            if (!strDebtPayment.equals("")) {
                strDebtPayment = Replace.replace(strDebtPayment, "'", "");
                final StringTokenizer st = new StringTokenizer(strDebtPayment,
                        ",", false);
                while (st.hasMoreTokens()) {
                    final String strDebtPaymentId = st.nextToken().trim();
                    final String strWriteOff = vars
                            .getStringParameter("inpwriteoff"
                                    + strDebtPaymentId);
                    final String strIsPaid = vars.getStringParameter(
                            "inpispaid" + strDebtPaymentId, "N");
                    if (!CreateFromSettlementData.NotIsCancelled(conn, this,
                            strDebtPaymentId)) {
                        releaseRollbackConnection(conn);
                        log4j.warn("CreateFrom.saveSettlement - debt_payment "
                                + strDebtPaymentId + " is cancelled");
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), "DebtPaymentCancelled");
                        return myMessage;
                    }
                    try {
                        CreateFromSettlementData.update(conn, this, vars
                                .getUser(), strKey, strWriteOff, strIsPaid,
                                strDebtPaymentId);
                    } catch (final ServletException ex) {
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), ex.getMessage());
    ...
    OBError saveDPManagement(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        try {
            ...
            if (!strDebtPayment.equals("")) {
                strDebtPayment = Replace.replace(strDebtPayment, "'", "");
                Integer line = new Integer(CreateFromDPManagementData.getLine(
                        this, strKey));
                final StringTokenizer st = new StringTokenizer(strDebtPayment,
                        ",", false);
                while (st.hasMoreTokens()) {
                    final String strDebtPaymentId = st.nextToken().trim();
                    if (!CreateFromDPManagementData.NotIsCancelled(conn, this,
                            strDebtPaymentId)) {
                        releaseRollbackConnection(conn);
                        log4j.warn("CreateFrom.saveSettlement - debt_payment "
                                + strDebtPaymentId + " is cancelled");
                    ...
                    final String strDPManagementLineID = SequenceIdData
                            .getUUID();

                    line += 10;
                    try {
                        CreateFromDPManagementData.insert(conn, this,
                                strDPManagementLineID, vars.getClient(), vars
                                        .getUser(), strKey, strStatusTo, line
                                        .toString(), strDebtPaymentId);
                    } catch (final ServletException ex) {
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), ex.getMessage());
                        releaseRollbackConnection(conn);
    ...
    OBError saveCRemittance(VariablesSecureApp vars, String strKey,
            String strTableId, String strProcessId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        try {
            conn = this.getTransactionConnection();
            Integer lineNo = Integer.valueOf(
                    CreateFromCRemittanceData.selectLineNo(this, strKey))
                    .intValue();
            // String strStatusTo = vars.getStringParameter("inpStatusTo");
            if (strDebtPayment.startsWith("("))
                strDebtPayment = strDebtPayment.substring(1, strDebtPayment
            ...
            if (!strDebtPayment.equals("")) {
                ...
                while (st.hasMoreTokens()) {
                    ...
                    final String strCRemittanceLineID = SequenceIdData
                            .getUUID();
                    lineNo += 10;
                    try {
                        CreateFromCRemittanceData.insert(conn, this,
                                strCRemittanceLineID, vars.getClient(), vars
                                        .getUser(), strKey, lineNo.toString(),
                                strDebtPaymentId);
                    } catch (final ServletException ex) {
                        myMessage = Utility.translateError(this, vars, vars
                                .getLanguage(), ex.getMessage());
