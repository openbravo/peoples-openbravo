...
public class ExpenseSOrder extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strCompleteAuto = vars.getStringParameter(
                    "inpShowNullComplete", "Y");
            ...
            String strCompleteAuto = vars
                    .getStringParameter("inpShowNullComplete");

            OBError myMessage = processButton(vars, strBPartner, strDatefrom,
                    strDateto, strDateOrdered, strOrganization, strCompleteAuto);
            vars.setMessage("ExpenseSOrder", myMessage);

            printPage(response, vars, strDatefrom, strDateto, strDateOrdered,
                    strBPartner, strOrganization, strCompleteAuto);
        } else
            pageErrorPopUp(response);
    }

    OBError processButton(VariablesSecureApp vars, String strBPartner,
            String strDatefrom, String strDateto, String strDateOrdered,
            String strOrganization, String strCompleteAuto) {
        ...
        try {
            ...
            ExpenseSOrderData[] data = ExpenseSOrderData.select(this,
                    strBPartner, strDatefrom, DateTimeData.nDaysAfter(this,
                            strDateto, "1"), Utility.getContext(this, vars,
                            "#User_Client", "ExpenseSOrder"), strOrganization
                            .equals("") ? Utility.getContext(this, vars,
                            "#User_Org", "ExpenseSOrder") : Utility
                            .stringList(strOrganization));
            ...
            for (int i = 0; data != null && i < data.length; i++) {
                docTargetType = ExpenseSOrderData.cDoctypeTarget(conn, this,
                ...
                if (!data[i].cBpartnerId.equals(strOldBPartner)
                    ...
                    if (data[i].mPricelistId.equals("")) {
                        ...
                        // expense
                        strBPCCurrencyId = ExpenseSOrderData.selectCurrency(
                                this, data[i].mPricelistId);
                    }

                    SEOrderBPartnerData[] data1 = SEOrderBPartnerData.select(
                            this, data[i].cBpartnerId);
                    ...
                    String strDocumentNo = Utility.getDocumentNo(this, vars,
                            "", "C_Order", docTargetType, docTargetType, false,
                            true);
                        ...
                        ExpenseSOrderData
                                .insertCOrder(
                                        ...
                                        ExpenseSOrderData.cBPartnerLocationId(
                                                this, data[i].cBpartnerId),
                                        ExpenseSOrderData.billto(this,
                                                data[i].cBpartnerId).equals("") ? ExpenseSOrderData
                                                .cBPartnerLocationId(this,
                                                        data[i].cBpartnerId)
                                                : ExpenseSOrderData.billto(
                                                        this,
                                                        data[i].cBpartnerId),
                                        strBPCCurrencyId,
                                        data1[0].paymentrule,
                                        data1[0].cPaymenttermId.equals("") ? SEOrderBPartnerData
                                                .selectPaymentTerm(this,
                                                        data[i].adClientId)
                                                : data1[0].cPaymenttermId,
                                        data1[0].invoicerule.equals("") ? "I"
                                                : data1[0].invoicerule,
                                        data1[0].deliveryrule.equals("") ? "A"
                                                : data1[0].deliveryrule,
                                        "I",
                                        data1[0].deliveryviarule.equals("") ? "D"
                                                : data1[0].deliveryviarule,
                    ...
                    textoMensaje.append(
                            Utility.messageBD(this, "SalesOrderDocumentno",
                                    vars.getLanguage())).append(" ").append(
                            strDocumentNo).append(" ").append(
                ...
                String strCTaxID = Tax.get(this, data[i].mProductId,
                        strDateOrdered, data[i].adOrgId, data[i].mWarehouseId
                                .equals("") ? vars.getWarehouse()
                                : data[i].mWarehouseId,
                        ExpenseSOrderData.cBPartnerLocationId(this,
                                data[i].cBpartnerId),
                        ExpenseSOrderData.cBPartnerLocationId(this,
                ...
                if (data[i].invoiceprice == null
                    ...
                    ExpenseSOrderData[] data3 = ExpenseSOrderData.selectPrice(
                            this, data[i].mProductId, data[i].mPricelistId,
                            strBPCCurrencyId);
                    ...
                    if (!strCCurrencyId.equals(strBPCCurrencyId)) {
                        ...
                        priceactual = ExpenseSOrderData.selectConvertedAmt(
                                this, priceactual, strCCurrencyId,
                                strBPCCurrencyId, strDateexpense, vars
                                        .getClient(), vars.getOrg());
                        pricelist = ExpenseSOrderData
                                .selectConvertedAmt(this, pricelist,
                                        strCCurrencyId, strBPCCurrencyId,
                                        strDateexpense, vars.getClient(), vars
                                                .getOrg());
                        pricelimit = ExpenseSOrderData
                                .selectConvertedAmt(this, pricelimit,
                                        strCCurrencyId, strBPCCurrencyId,
                                        strDateexpense, vars.getClient(), vars
                                                .getOrg());
                    }
                ...
                // currency
                ExpenseSOrderData[] data4 = ExpenseSOrderData.selectPrecisions(
                ...
                int PricePrecision = Integer.valueOf(strPricePrecision)
                        .intValue();
                priceActual = (priceactual.equals("") ? ZERO : (new BigDecimal(
                        priceactual)));
                priceActual = priceActual.setScale(PricePrecision,
                        BigDecimal.ROUND_HALF_UP);
                priceList = (pricelist.equals("") ? ZERO : (new BigDecimal(
                        pricelist)));
                priceList = priceList.setScale(PricePrecision,
                        BigDecimal.ROUND_HALF_UP);
                priceLimit = (pricelimit.equals("") ? ZERO : (new BigDecimal(
                        pricelimit)));
		...
		if (priceList.compareTo(BigDecimal.ZERO) == 0)
                ...
                // Catch database error message
                try {
                    ExpenseSOrderData.insertCOrderline(conn, this,
                            strCOrderlineID, data[i].adClientId,
                            strOrganization.equals("") ? data[i].adOrgId
                                    : strOrganization, vars.getUser(),
                            strCOrderId, Integer.toString(line),
                            data[i].cBpartnerId, ExpenseSOrderData
                                    .cBPartnerLocationId(this,
                                            data[i].cBpartnerId),
                            strDateOrdered, strDateOrdered,
                            data[i].description, data[i].mProductId,
                            data[i].mWarehouseId.equals("") ? vars
                                    .getWarehouse() : data[i].mWarehouseId,
                            data[i].cUomId.equals("") ? Utility.getContext(
                                    this, vars, "#C_UOM_ID", "ExpenseSOrder")
                                    : data[i].cUomId, data[i].qty,
                            strBPCCurrencyId, pricelist, priceactual,
                            pricelimit, strCTaxID,
                ...
                try {
                    ...
                    ExpenseSOrderData.updateTimeExpenseLine(conn, this,
                            strCOrderlineID, data[i].sTimeexpenselineId);
                } catch (ServletException ex) {
                    myMessage = Utility.translateError(this, vars, vars
                            .getLanguage(), ex.getMessage());
                    releaseRollbackConnection(conn);
            ...
            if (e.getMessage().equals("PricelistNotdefined")) {
                myMessage.setMessage(Utility.messageBD(this, "TheCustomer",
                        vars.getLanguage())
                        + ' '
                        + strCust
                        + ' '
    ...
    OBError processOrder(VariablesSecureApp vars, String strCOrderId)
        ...
        PInstanceProcessData[] pinstanceData = PInstanceProcessData.select(
                this, pinstance);
        myMessage = Utility
                .getProcessInstanceMessage(this, vars, pinstanceData);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strDatefrom, String strDateto, String strDateOrdered,
            String strBPartner, String strOrganization, String strCompleteAuto)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ExpenseSOrder", false, "", "", "", false, "ad_actionButton",
        ...
        xmlDocument.setParameter("Bpartnerdescription", ExpenseSOrderData
        ...
        xmlDocument.setParameter("dateOrddisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateOrdsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("paramShowNullComplete", strCompleteAuto);
        xmlDocument.setData("structureOrganizacion", OrganizationComboData
                .select(this, vars.getRole()));
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ExpenseSOrder.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ExpenseSOrder.html", strReplaceWith);
