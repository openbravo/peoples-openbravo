...
public class Posted extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strPath = vars.getGlobalVariable("inpPath", "Posted|path", strDireccion + request.getServletPath());
      ...
      if (strPosted.equals("N")){
        ...
        if (strEliminar.equals("N")) {
          PostedData [] data = PostedData.select(this, strKey, strTableId);
          if (data==null || data.length==0 || data[0].id.equals("")) {
            //if (log4j.isDebugEnabled()) log4j.debug("***********************" + strWindowId + "|" + strTabName + ".message");
          ...
          if (log4j.isDebugEnabled()) log4j.debug("SAVE, delete");
  ...
  OBError processButtonDelete(VariablesSecureApp vars, String strKey, String strTableId) throws ServletException {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKey, String windowId, String strTab, String strProcessId, String strTableId, String strPath, String strTabName, String strPosted) throws IOException, ServletException {
      if (log4j.isDebugEnabled()) log4j.debug("Output: Button process Posted");
      ...
      if (strPosted.equals("N")) discard[1] = new String("selEliminar");
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Posted", discard).createXmlDocument();
