...
public class Test_In extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strKey = vars.getRequiredGlobalVariable("inpatTestId",
                    strWindow + "|AT_Test_ID");
            printPage(response, vars, strKey, strWindow, strTab, strProcessId);
        } else if (vars.commandIn("SAVE")) {
            TestLine tl = new TestLine(vars, "inpFile", false,
                    "Aplicación de gestión", "", false, this);
            String strWindow = vars.getStringParameter("inpwindowId");
            ...
            OBError myMessage = processButton(vars, tl.getFieldProvider(),
                    strKey, strWindow);
    ...
    OBError processButton(VariablesSecureApp vars, FieldProvider[] dataLineas,
            String strTestId, String windowId) {
        ...
        try {
            ...
            for (int i = 0; i < dataLineas.length; i++) {
                ...
                if (strCommandId != null) {
                    TestInData[] datacomando = TestInData.select(conn, this,
                            strCommandId);
                    strLineId = SequenceIdData.getUUID();
                    try {
                        TestInData.insert(conn, this, strLineId, vars
                                .getClient(), vars.getOrg(), vars.getUser(),
                                strTestId, strCommandId, String
                                        .valueOf(intSeqNo), dataLineas[i]
                                        .getField("arg1"), dataLineas[i]
                                        .getField("arg2"), dataLineas[i]
                                        .getField("arg3"), strType,
                                datacomando[0].argno, datacomando[0].arghelp1,
                                datacomando[0].arghelp2,
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/Test_In", discard)
                .createXmlDocument();
