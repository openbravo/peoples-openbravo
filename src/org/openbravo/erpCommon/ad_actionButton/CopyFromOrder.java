            ...
            if (!strRownum.equals("")) {
                ...
                while (st.hasMoreTokens()) {
                    ...
                    if (orderlineprice == null || orderlineprice.length == 0) {
                        ...
                        CopyFromOrderData[] precisions = CopyFromOrderData
                                .selectPrecisions(this, strKey);
                        strPrecision = precisions[0].stdprecision.equals("") ? "0"
                                : precisions[0].stdprecision;
                        strPricePrecision = precisions[0].priceprecision
                                .equals("") ? "0"
                                : precisions[0].priceprecision;
                    } else {
                        strPrecision = orderlineprice[0].stdprecision
                                .equals("") ? "0"
                                : orderlineprice[0].stdprecision;
                        strPricePrecision = orderlineprice[0].priceprecision
                                .equals("") ? "0"
