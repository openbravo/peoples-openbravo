...
public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      final ActionButtonDefaultData[] tab = ActionButtonDefaultData.windowName(this, strTab);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKey, String windowId, String strProcessId, String strMessage, String strTab)
    throws IOException, ServletException {
      ...
      final XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/InsertAcces", discard).createXmlDocument();
      ...
      if (accesData[i].parentId.equals(indice)) {
        if (accesData[i].issummary.equals("Y")) generateAcces(vars, accesData, roleid, accesData[i].nodeId, strType);
          ...
          if (accesData[i].action.equals("W") && (InsertAccesData.selectWindow(this, roleid, accesData[i].adwindowid)==null || InsertAccesData.selectWindow(this, roleid, accesData[i].adwindowid).equals("")) && (strType.equals("W") || strType.equals(""))){
              ...
              InsertAccesData.insertWindow(this, accesData[i].adwindowid, roleid, vars.getClient(), "0", vars.getUser());
              ...
              InsertAccesData.insertProcess(this, accesData[i].adprocessid, roleid, vars.getClient(), "0", vars.getUser());
              ...
              InsertAccesData.insertForm(this, accesData[i].adformid, roleid, vars.getClient(), "0", vars.getUser());
              ...
              InsertAccesData.insertWorkflow(this, accesData[i].adworkflowid, roleid, vars.getClient(), "0", vars.getUser());
              ...
              InsertAccesData.insertTask(this, accesData[i].adtaskid, roleid, vars.getClient(), "0", vars.getUser());
          }
        }
      }
    }
