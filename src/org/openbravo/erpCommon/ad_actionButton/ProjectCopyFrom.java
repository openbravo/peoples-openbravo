...
public class ProjectCopyFrom extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            printPage(response, vars, strKey, strProject, strWindow, strTab,
                    strProcessId);
            ...
            OBError myMessage = processButton(vars, strKey, strProject,
                    strWindow);
    ...
    OBError processButton(VariablesSecureApp vars, String strKey,
        ...
        try {
            ...
            if (projectCategory.equals("S")) {
                ...
                ProjectCopyFromData[] dataServ = ProjectCopyFromData
                        .selectServ(this, strProject);
                String strProjectLine = "";
                for (int i = 0; dataServ != null && i < dataServ.length; i++) {
                    strProjectLine = SequenceIdData.getUUID();
                    try {
                        ProjectCopyFromData.insertProjectLine(conn, this,
                                strProjectLine, strKey,
                                dataProject[0].adClientId,
                                dataProject[0].adOrgId, vars.getUser(),
                                dataServ[i].line, dataServ[i].description,
                                dataServ[i].plannedqty, dataServ[i].mProductId,
                                dataServ[i].mProductCategoryId,
                                dataServ[i].productDescription,
                                dataServ[i].productName,
            ...
            String strProjectType = ProjectCopyFromData.selectProjectType(this,
                    strProject);
            String strProjectCategory = "";
            if (strProjectType == null || strProjectType.equals("")) {
                strProjectCategory = ProjectCopyFromData.selectProjCategory(
                        this, strProject);
            } else {
                strProjectCategory = ProjectSetTypeData.selectProjectCategory(
                        this, strProjectType);
            }
            try {
            ...
            extracted(myMessage).setTitle(
                    Utility.messageBD(this, "Success", vars.getLanguage()));
            extracted(myMessage).setMessage(
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strKey, String strProject, String windowId, String strTab,
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_actionButton/ProjectCopyFrom",
        ...
        xmlDocument.setData("reportcProjectId", "liststructure",
                ProjectCopyFromData.selectC_Project_ID(this, Utility
                        .getContext(this, vars, "#User_Org", ""), Utility
                        .getContext(this, vars, "#User_Client", ""), strKey,
                        strKey));
