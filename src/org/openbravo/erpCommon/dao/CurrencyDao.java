...
public class CurrencyDao {
   ...
   * Will use the spot conversion rate defined by the system for that date
   * @param fromCurrency
   ...
   * @return A valid conversion rate for the parameters, or null if no conversion rate can
   *         be found
   */
  public ConversionRate getConversionRate(Currency fromCurrency, Currency toCurrency,
    ...
    try {
      ...
      obcConvRate.add(Expression.le(ConversionRate.PROPERTY_VALIDFROMDATE, conversionDate));
      obcConvRate.add(Expression.ge(ConversionRate.PROPERTY_VALIDTODATE, conversionDate));
