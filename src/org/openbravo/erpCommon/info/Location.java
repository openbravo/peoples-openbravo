...
public class Location extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            LocationSearchData[] data = LocationSearchData.select(this, vars
                    .getLanguage(), strcLocationId);
            ...
            String strcLocationId = vars
                    .getSessionValue("Location.inpcLocationId");
            ...
            data.insert(this);
            data.name = LocationSearchData.locationAddress(this, vars
                    .getLanguage(), data.cLocationId);
    ...
    String generateResult(LocationSearchData data) throws IOException,
            ServletException {
    ...
    void printPageFS(HttpServletResponse response, VariablesSecureApp vars)
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/Location_FS").createXmlDocument();
    ...
    void printPageSheet(HttpServletResponse response, VariablesSecureApp vars,
            String strcLocationId, String strWindow) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (strcLocationId.equals("")) {
            ...
            data = LocationSearchData.select(this, vars.getLanguage(),
                    strcLocationId);
        }
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Country_ID", "", "", Utility
                            .getReferenceableOrg(vars, vars.getOrg()), Utility
                            .getContext(this, vars, "#User_Client", strWindow),
                    0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    strWindow, data[0].cCountryId);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getReferenceableOrg(vars, vars.getOrg()), Utility
                            .getContext(this, vars, "#User_Client", strWindow),
                    0);
            Utility.fillSQLParameters(this, vars, data[0], comboTableData,
                    strWindow, data[0].cRegionId);
            xmlDocument.setData("reportRegion", "liststructure", comboTableData
                    .select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
    ...
    void printPageF2(HttpServletResponse response, VariablesSecureApp vars,
            String strcCountryId, String strWindow) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: F2 Locations seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/Location_F2").createXmlDocument();
        // Getcountry; default
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Region_ID", "", "C_Region of Country",
