...
public class BusinessPartnerMultiple extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            if (strBpartner.equals("Y"))
                ...
                strSelected = "all";
            vars.setSessionValue("BusinessPartnerMultiple.bpartner",
                    strSelected);
            if (!strNameValue.equals(""))
                vars.setSessionValue("BusinessPartnerMultiple.name",
                        strNameValue + "%");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (log4j.isDebugEnabled())
            log4j
                    .debug("Output: Frame 1 of the multiple business partners seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/BusinessPartnerMultiple")
                .createXmlDocument();
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "Value", "Name", "SO_CreditAvailable",
                "SO_CreditUsed", "SalesRep", "Url", "Email",
                "ActualLifetimeValue", "C_BPartner_ID", "RowKey" };
        String[] colWidths = { "87", "165", "73", "77", "117", "100", "110",
                "51", "0", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            dataAux.setData("isvisible", (colNames[i].endsWith("_ID")
                    ...
                    : "true"));
            String name = Utility.messageBD(this, "MBPS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("MBPS_") ? colNames[i]
                    : name));
        ...
        if (headers != null) {
            try {
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    strNumRows = vars
                            .getSessionValue("BusinessPartnerMultipleInfo.numrows");
                }
