...
public class SalesOrder extends HttpSecureAppServlet {
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/SalesOrder").createXmlDocument();
    ...
    String generateResult(SalesOrderData[] data) throws IOException,
            ServletException {
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "bpartnername", "dateordered", "documentno",
                "currency", "grandtotal", "converted", "issotrx",
                "description", "poreference", "rowkey" };
        boolean[] colSortable = { true, true, true, true, true, false, true,
                true, true, true };
        String[] colWidths = { "110", "70", "140", "60", "70", "70", "70",
                "75", "100", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "SOS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("SOS_") ? colNames[i]
                    : name));
