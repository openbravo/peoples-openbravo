...
public class ProductComplete extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            printPage(response, vars, "", strNameValue, strWarehouse, strStore,
                    strBpartner, "", "", "paramName");
            ...
            if (strStore.equals("Y")) {
                if (vars.getLanguage().equals("en_US"))
                    data = ProductCompleteData.select(this, "1", strKeyValue,
                            "", strWarehouse, vars.getRole(), strBpartner,
                            strClients, "1", "", "");
                else
                    data = ProductCompleteData.selecttrl(this, "1", vars
                            .getLanguage(), strKeyValue, "", strWarehouse, vars
                            .getRole(), strBpartner, strClients, "1", "", "");
            } else {
                if (vars.getLanguage().equals("en_US"))
                    data = ProductCompleteData.selectNotStored(this, "1",
                            strKeyValue, "", strBpartner, strClients, strOrgs,
                            "1", "", "");
                else
                    data = ProductCompleteData.selectNotStoredtrl(this, "1",
                            vars.getLanguage(), strKeyValue, "", strBpartner,
            ...
            if (data != null && data.length == 1)
                ...
                printPage(response, vars, strKeyValue, "", strWarehouse,
                        strStore, strBpartner, strClients, strOrgs, "paramKey");
            ...
            String strWarehouse = vars.getGlobalVariable("inpWarehouse",
                    "ProductComplete.warehouse", "");
            String strBpartner = vars.getGlobalVariable("inpBPartner",
                    "ProductComplete.bpartner", "");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strStore, String strBpartner, String strClients,
            String strOrgs, String focusedId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of the product seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/ProductComplete")
                .createXmlDocument();
    ...
    void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
            ProductCompleteData[] data, String strWarehouse)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
    ...
    String generateResult(ProductCompleteData[] data, String strWarehouse)
            throws IOException, ServletException {
        ...
        html.append("new SearchElements(\"_LOC\", true, \""
                + data[0].mLocatorId + "\"),\n");
        html.append("new SearchElements(\"_ATR\", true, \""
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "value", "name", "locator", "qty", "c_uom1",
                "attribute", "qtyorder", "c_uom2", "qty_ref",
                "quantityorder_ref", "rowkey" };
        boolean[] colSortable = { true, true, false, true, false, true, true,
        ...
        String[] colWidths = { "73", "86", "166", "62", "32", "145", "104",
                "67", "97", "167", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "PCS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("PCS_") ? colNames[i]
                    : name));
    ...
    void printGridData(HttpServletResponse response, VariablesSecureApp vars,
            String strKey, String strName, String strWarehouse,
            String strBpartner, String strStore, String strOrgs,
            String strClients, String strOrderBy, String strOffset,
            ...
            try {
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    if (strStore.equals("Y")) {
                        ...
                        strNumRows = ProductCompleteData.countRows(this,
                                strKey, strName, strWarehouse, vars.getRole(),
                                strBpartner, strClients);
                    } else {
                        if (vars.getLanguage().equals("en_US")) {
                            strNumRows = ProductCompleteData
                                    .countRowsNotStored(this, strKey, strName,
                                            strBpartner, strClients, strOrgs);
                        } else {
                            strNumRows = ProductCompleteData
                                    .countRowsNotStoredtrl(this, vars
                                            .getLanguage(), strKey, strName,
                                            strBpartner, strClients, strOrgs);
                        }
                    }
                    ...
                    strNumRows = vars
                            .getSessionValue("ProductComplete.numrows");
                }
                ...
                if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                    ...
                    if (strStore.equals("Y")) {
                        if (vars.getLanguage().equals("en_US"))
                            data = ProductCompleteData.select(this, "ROWNUM",
                                    strKey, strName, strWarehouse, vars
                                            .getRole(), strBpartner,
                                    strClients, strOrderBy, oraLimit, "");
                        else
                            data = ProductCompleteData.selecttrl(this, vars
                                    .getLanguage(), "ROWNUM", strKey, strName,
                                    strWarehouse, vars.getRole(), strBpartner,
                                    strClients, strOrderBy, oraLimit, "");
                    } else {
                        if (vars.getLanguage().equals("en_US"))
                            data = ProductCompleteData.selectNotStored(this,
                                    "ROWNUM", strKey, strName, strBpartner,
                                    strClients, strOrgs, strOrderBy, oraLimit,
                                    "");
                        else
                            data = ProductCompleteData.selectNotStoredtrl(this,
                                    "ROWNUM", vars.getLanguage(), strKey,
                                    strName, strBpartner, strClients, strOrgs,
                                    strOrderBy, oraLimit, "");
                    }
                } else {
                    ...
                    if (strStore.equals("Y")) {
                        if (vars.getLanguage().equals("en_US"))
                            data = ProductCompleteData.select(this, "1",
                                    strKey, strName, strWarehouse, vars
                                            .getRole(), strBpartner,
                                    strClients, strOrderBy, "", pgLimit);
                        else
                            data = ProductCompleteData.selecttrl(this, vars
                                    .getLanguage(), "1", strKey, strName,
                                    strWarehouse, vars.getRole(), strBpartner,
                                    strClients, strOrderBy, "", pgLimit);
                    } else {
                        if (vars.getLanguage().equals("en_US"))
                            data = ProductCompleteData.selectNotStored(this,
                                    "1", strKey, strName, strBpartner,
                                    strClients, strOrgs, strOrderBy, "",
                                    pgLimit);
                        else
                            data = ProductCompleteData.selectNotStoredtrl(this,
                                    "1", vars.getLanguage(), strKey, strName,
                                    strBpartner, strClients, strOrgs,
                                    strOrderBy, "", pgLimit);
                    }
