...
public class Locator extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strWarehouse = vars.getRequestGlobalVariable("inpNameValue",
            ...
            String strWarehouse = vars.getRequestGlobalVariable(
                    "inpmWarehouseId", "Locator.mWarehouseId");
            ...
            String strName = vars.getGlobalVariable("inpKey", "Locator.name",
                    "");
            String strWarehousename = vars.getGlobalVariable("inpWarehouse",
                    "Locator.warehousename", "");
            String strAisle = vars.getGlobalVariable("inpAisle",
                    "Locator.aisle", "");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strNameValue, String strWarehousename) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of Locators seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/Locator").createXmlDocument();
    ...
    String generateResult(LocatorData[] data) throws IOException,
            ServletException {
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "LS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("LS_") ? colNames[i]
                    : name));
