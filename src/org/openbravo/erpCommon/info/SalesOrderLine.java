...
public class SalesOrderLine extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strBpartnerId = vars.getRequestGlobalVariable(
                    "inpcBpartnerId", "SalesOrderLine.bpartner");
            ...
            if (!strNameValue.equals("")) {
                ...
                do {
                    ...
                    case 1:
                        strDocumentNo = token + "%";
                        vars.setSessionValue("SalesOrderLine.documentno",
                                strDocumentNo);
                        break;
                    case 2:
                        strDateFrom = token;
                    ...
                    case 3:
                        strCal1 = token;
                        strCal2 = token;
                        vars.setSessionValue("SalesOrderLine.grandtotalfrom",
                                token);
                        vars.setSessionValue("SalesOrderLine.grandtotalto",
                                token);
                        break;
                    case 4:
            ...
            printPage(response, vars, strBpartnerId, strProduct, strDocumentNo,
                    strDateFrom, strDateTo, strCal1, strCal2);
            ...
            if (strSOTrx.equals("Y"))
                ...
                data = SalesOrderLineData.selectKeySOTrx(this, Utility
                        .getContext(this, vars, "#User_Client",
                                "SalesOrderLine"), Utility.getContext(this,
                        vars, "#User_Org", "SalesOrderLine"), strKeyValue);
            ...
            String strCal1 = vars.getGlobalVariable("inpCal1",
                    "SalesOrderLine.grandtotalfrom", "");
            String strCal2 = vars.getGlobalVariable("inpCal2",
                    "SalesOrderLine.grandtotalto", "");
            String strOrder = vars.getGlobalVariable("inpOrder",
                    "SalesOrderLine.order", "");
            String strDelivered = vars.getGlobalVariable("inpdelivered",
            ...
            String strSortDirs = vars.getStringParameter("sort_dirs")
                    .toUpperCase();
            printGridData(response, vars, strDocumentNo, strDescription,
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strBPartner, String strProduct, String strDocumentNo,
            String strDateFrom, String strDateTo, String strCal1, String strCal2)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of sale-order-lines seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/SalesOrderLine")
                .createXmlDocument();
        if (strBPartner.equals("") && strProduct.equals("")
                && strDocumentNo.equals("") && strDateFrom.equals("")
                && strDateTo.equals("") && strCal1.equals("")
                && strCal2.equals("")) {
            strDocumentNo = "%";
        }
        xmlDocument
        ...
        xmlDocument.setParameter("cBpartnerId_DES", SalesOrderLineData
                .selectBPartner(this, strBPartner));
        xmlDocument.setParameter("mProductId", strProduct);
        xmlDocument.setParameter("mProductId_DES", SalesOrderLineData
                .selectProduct(this, strProduct));
    ...
    String generateResult(SalesOrderLineData[] data) throws IOException,
            ServletException {
        ...
        html.append("var text = \""
                + Replace.replace(data[0].lineText, "\"", "\\\"") + "\";\n");
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "bpartner_name", "dateordered", "documentno",
                "issotrx", "product_name", "qty", "priceactual", "linenetamt",
                "rowkey" };
        String[] colWidths = { "200", "70", "110", "40", "170", "63", "52",
                "68", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "SOLS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("SOLS_") ? colNames[i]
                    : name));
    ...
    void printGridData(HttpServletResponse response, VariablesSecureApp vars,
            String strDocumentNo, String strDescription, String strOrder,
            String strBpartnerId, String strDateFrom, String strDateTo,
