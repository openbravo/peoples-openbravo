...
public class AttributeSetInstance extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT") || vars.commandIn("KEY")) {
            ...
            vars.getRequestGlobalVariable("inpwindowId",
                    "AttributeSetInstance.windowId");
            vars.getRequestGlobalVariable("inpLocatorId",
                    "AttributeSetInstance.locatorId");
            ...
            if (strNameValue.equals("") || strNameValue.equals("0")) {
                ...
                AttributeSetInstanceData[] data = AttributeSetInstanceData
                        .selectProductAttr(this, strProduct);
                ...
                strAttributeSet = AttributeSetInstanceData.selectAttributeSet(
                        this, strNameValue);
            }
            vars.setSessionValue("AttributeSetInstance.attribute",
                    strAttributeSet);
            vars.setSessionValue("AttributeSetInstance.productInstance",
                    strProductInstance);
            ...
            String strNameValue = vars.getGlobalVariable("inpInstance",
                    "AttributeSetInstance.instance", "");
            String strAttributeSet = vars.getGlobalVariable("inpAttribute",
                    "AttributeSetInstance.attribute");
            String strProductInstance = vars.getGlobalVariable(
                    "inpProductInstance",
            ...
            String strTabId = vars.getGlobalVariable("inpTabId",
                    "AttributeSetInstance.tabId", "");
            String strLocator = vars.getGlobalVariable("inpLocatorId",
                    "AttributeSetInstance.locatorId", "");
            String strProduct = vars.getGlobalVariable("inpProduct",
                    "AttributeSetInstance.product", "");
            ...
            if (!strAttributeSet.equals(""))
                printPage(response, vars, strNameValue, strAttributeSet,
            ...
            String strAttributeSet = vars
                    .getRequiredStringParameter("inpAttribute");
            ...
            OBError myMessage = writeFields(this, vars,
                    AttributeSetInstanceData.select(this, strAttributeSet),
                    strAttributeSet, strInstance, strWindowId, strIsSOTrx,
                    strProduct);
            vars.setSessionValue("AttributeSetInstance.attribute",
                    strAttributeSet);
    ...
    String getDescription(VariablesSecureApp vars,
            AttributeSetInstanceData[] data, String strIsSOTrx,
            String strWindowId) {
        if (data == null || data.length == 0)
            return "";
        String description = "";
        try {
            ...
            if (data[0].islot.equals("Y")) {
                ...
                if (!data[0].mLotctlId.equals("")
                    ...
                    description_first += (description_first.equals("") ? ""
                            : "_")
                            + lot;// esto
                } else
                    description_first += (description_first.equals("") ? ""
            ...
            if (!data[0].elementname.equals("")) {
                for (int i = 0; i < data.length; i++) {
                    ...
                    if (data[i].ismandatory.equals("Y"))
                        strValue = vars.getRequiredStringParameter("inp"
                                + replace(data[i].elementname));
                    else
                        strValue = vars.getStringParameter("inp"
                                + replace(data[i].elementname));
                    String strDescValue = strValue;
                    if (data[i].islist.equals("Y"))
                        strDescValue = AttributeSetInstanceData
                                .selectAttributeValue(this, strValue);
                    description += (description.equals("") ? "" : "_")
                            + strDescValue;
                }
            }
    ...
    OBError writeFields(ConnectionProvider cp, VariablesSecureApp vars,
            AttributeSetInstanceData[] data, String strAttributeSet,
            String strInstance, String strWindow, String strIsSOTrx,
            String strProduct) throws ServletException {
        ...
        if (data == null || data.length == 0) {
            ...
            myMessage.setMessage(Utility.messageBD(this, "FindZeroRecords",
                    vars.getLanguage()));
            // Utility.messageBD(this, "FindZeroRecords", vars.getLanguage());
            return myMessage;
        }

        boolean isinstance = !AttributeSetInstanceData.isInstanceAttribute(
                this, strAttributeSet).equals("0");
        ...
        try {
            ...
            if (data[0].islot.equals("Y")) {
                ...
                if (!data[0].mLotctlId.equals("")
                    ...
                    lot = AttributeSetInstanceData.selectNextLot(this,
                            data[0].mLotctlId);
                    AttributeSetInstanceData.updateLotSequence(conn, this, vars
                            .getUser(), data[0].mLotctlId);
                    description_first += (description_first.equals("") ? ""
                            : "_")
                            + lot;// esto
                } else
            ...
            if (data[0].isserno.equals("Y")) {
                ...
                if (!data[0].mSernoctlId.equals("")
                        && (strIsSOTrx.equals("N") || strWindow.equals("191"))) {
                    serno = AttributeSetInstanceData.selectNextSerNo(conn,
                            this, data[0].mSernoctlId);
                    AttributeSetInstanceData.updateSerNoSequence(conn, this,
                            vars.getUser(), data[0].mSernoctlId);
                }
                description_first += (description_first.equals("") ? "" : "_")
                        + "#" + serno;
            }
            ...
            if (!isinstance) {
                strNewInstance = AttributeSetInstanceData.hasIdentical(this,
                        strDescription, data[0].mAttributesetId);
            }
            ...
            if ((!strInstance.equals("")) && (isinstance)) {// Si if it's
                ...
                if (AttributeSetInstanceData
                        .updateHeader(conn, this, vars.getUser(),
                                data[0].mAttributesetId, serno, lot,
                                guaranteedate, "", locked, lockDescription,
                                strInstance) == 0) {
                    AttributeSetInstanceData.insertHeader(conn, this,
                            strInstance, vars.getClient(), vars.getOrg(), vars
                                    .getUser(), data[0].mAttributesetId, serno,
                ...
                AttributeSetInstanceData.insertHeader(conn, this,
                        strNewInstance, vars.getClient(), vars.getOrg(), vars
                                .getUser(), data[0].mAttributesetId, serno,
                        lot, guaranteedate, "", locked, lockDescription);
            }
            if (hasToUpdate) {
                        ...
                        if (!strNewInstance.equals("")) {
                            if (AttributeSetInstanceData
                                    .update(
                                            ...
                                            this,
                                            vars.getUser(),
                                            (data[i].islist.equals("Y") ? strValue
                                                    : ""), strDescValue,
                                            strNewInstance,
                                            data[i].mAttributeId) == 0) {
                                String strNewAttrInstance = SequenceIdData
                                        .getUUID();
                                AttributeSetInstanceData.insert(conn, this,
                                        strNewAttrInstance, strNewInstance,
                                        data[i].mAttributeId, vars.getClient(),
                            ...
                            if (AttributeSetInstanceData
                                    .update(
                                            ...
                                            (data[i].islist.equals("Y") ? strValue
                                                    : ""), strDescValue,
                                            strInstance, data[i].mAttributeId) == 0) {
                                String strNewAttrInstance = SequenceIdData
                                        .getUUID();
                                AttributeSetInstanceData.insert(conn, this,
                                        strNewAttrInstance, strInstance,
                                        data[i].mAttributeId, vars.getClient(),
                                        vars.getOrg(), vars.getUser(),
                                        (data[i].islist.equals("Y") ? strValue
                                                : ""), strDescValue);
                ...
                if (!description_first.equals(""))
                    description += (description.equals("") ? "" : "_")
                            + description_first;
                AttributeSetInstanceData.updateHeaderDescription(conn, this,
                        vars.getUser(), description,
                        (strNewInstance.equals("") ? strInstance
                                : strNewInstance));
            }
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strInstance, String strAttributeSet,
            String strProductInstance, String strWindowId, String strTabId,
            String strLocator, String strIsSOTrx, String strProduct)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of the attributes seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/AttributeSetInstance")
                .createXmlDocument();
        ...
        /*
         * String message =
         * vars.getSessionValue("AttributeSetInstance.message");
         * vars.removeSessionValue("AttributeSetInstance.message"); if
         * (!message.equals("")) { if (!message.equals("OK")) message =
         * "alert('" + message + "');"; else message = "printMessage('');"; }
         * xmlDocument.setParameter("body", message);
         */

        if (strInstance.equals("")
                && AttributeSetInstanceData.isInstanceAttribute(this,
        ...
        String strName = Utility.messageBD(this, "Description", vars
                .getLanguage());
        xmlDocument.setParameter("nameDescription",
                strName.equals("") ? "Description" : strName);
        xmlDocument.setParameter("description", AttributeSetInstanceData
                .selectDescription(this,
                        (strInstance.equals("") ? strProductInstance
                                : strInstance)));
        AttributeSetInstanceData[] data = AttributeSetInstanceData.select(this,
                strAttributeSet);
        xmlDocument.setParameter("data", generateHtml(vars, data,
                AttributeSetInstanceData.selectInstance(this, (strInstance
                        .equals("") ? strProductInstance : strInstance)),
    ...
    String instanceValue(AttributeSetInstanceData[] instanceData,
            String strAttributeId, boolean isList) {
    ...
    String generateScript(VariablesSecureApp vars,
            AttributeSetInstanceData[] fields) throws IOException,
            ServletException {
    ...
    String generateHtml(VariablesSecureApp vars,
            AttributeSetInstanceData[] fields,
            AttributeSetInstanceData[] instanceData,
            String strAttributeInstance, String strIsSOTrx, String strWindowId)
            throws IOException, ServletException {
        if (fields == null || fields.length == 0)
            return "";
        StringBuffer strHtml = new StringBuffer();
        if (!fields[0].elementname.equals("")) {
            for (int i = 0; i < fields.length; i++) {
                ...
                String strValue = instanceValue(instanceData,
                        fields[i].mAttributeId, fields[i].islist.equals("Y"));
                if (fields[i].islist.equals("Y")) {
                    strHtml.append("<select ");
                    strHtml.append("name=\"inp"
                            + replace(fields[i].elementname) + "\" ");
                    strHtml.append("class=\"Combo");
                    if (fields[i].ismandatory.equals("Y"))
                        strHtml.append("Key");
                    strHtml.append(" Combo_OneCell_width\" ");
                    strHtml.append(" id=\"").append(
                            replace(fields[i].elementname)).append("\">");
                    AttributeSetInstanceData[] data = AttributeSetInstanceData
                            .selectList(this, fields[i].mAttributeId);
                    if (!fields[i].ismandatory.equals("Y"))
        ...
        if (fields[0].islot.equals("Y")) {
            ...
            strHtml.append("<td ");
            strHtml
                    .append("class=\"TextBox_ContentCell\"><input type=\"text\" ");
            ...
            if (strAttributeInstance.equals("")
                ...
                strHtml.append("value=\""
                        + AttributeSetInstanceData.selectNextLot(this,
                                fields[0].mLotctlId) + "\" ");
            else
                strHtml
                        .append("value=\""
        ...
        if (fields[0].isserno.equals("Y")) {
            strHtml
                    .append("<tr><td class=\"TitleCell\"><span class=\"LabelText\">");
            String strName = Utility.messageBD(this, "SerNo", vars
                    .getLanguage());
            strHtml.append(strName.equals("") ? "SerNo" : strName);
            strHtml.append("</span></td>\n");
            strHtml
                    .append("<td class=\"TextBox_ContentCell\"><input type=\"text\" ");
            ...
            if (strAttributeInstance.equals("")
                    && (strIsSOTrx.equals("N") || strWindowId.equals("191")))
                strHtml.append("value=\""
                        + AttributeSetInstanceData.selectNextSerNo(this,
                                fields[0].mSernoctlId) + "\" ");
            else
                strHtml
                        .append("value=\""
        ...
        if (fields[0].isguaranteedate.equals("Y")) {
            ...
            if (strAttributeInstance.equals("")
                    && (strIsSOTrx.equals("N") || strWindowId.equals("191")))
                strGuaranteeDate = DateTimeData.nDaysAfter(this, DateTimeData
                        .today(this), fields[0].guaranteedays);
            else
            ...
            strHtml
                    .append("<tr><td class=\"TitleCell\"><span class=\"LabelText\">");
            String strName = Utility.messageBD(this, "GuaranteeDate", vars
                    .getLanguage());
            ...
            strHtml
                    .append("onblur=\"this.className='FieldButtonLink'; window.status=''; return true;\"");
            strHtml
                    .append("onkeypress=\"this.className='FieldButtonLink_active'; return true;\"");
            strHtml
                    .append("onkeyup=\"this.className='FieldButtonLink_hover'; return true;\"");
            strHtml.append("onClick=\"showCalendar('frmMain.");
            strHtml.append("inpDateFrom', ");
            strHtml
                    .append("document.frmMain.inpDateFrom.value, false);return false;\">");
            strHtml.append("<table class=\"FieldButton\"");
            strHtml
                    .append("onmousedown=\"this.className='FieldButton_active'; return true;\"");
            strHtml
                    .append("onmouseup=\"this.className='FieldButton'; return true;\"");
            strHtml
        ...
        if (fields[0].islockable.equals("Y")) {
            strHtml
                    .append("<tr><td class=\"TitleCell\"><span class=\"LabelText\">");
            String strName = Utility.messageBD(this, "IsLocked", vars
                    .getLanguage());
            strHtml.append(strName.equals("") ? "IsLocked" : strName);
            strHtml.append("</span></td>\n");
            strHtml
                    .append("<td class=\"Radio_Check_ContentCell\"><input type=\"checkbox\" ");
            strHtml.append("name=\"inpislocked\" ");
            strHtml.append("value=\"Y\" ");
            if (instanceData != null && instanceData.length > 0
                    && instanceData[0].islocked.equals("Y"))
                strHtml.append("checked ");
            strHtml.append("></td></tr>\n");
            strHtml
                    .append("<tr><td class=\"TitleCell\"><span class=\"LabelText\">");
            strName = Utility.messageBD(this, "LockDescription", vars
                    .getLanguage());
