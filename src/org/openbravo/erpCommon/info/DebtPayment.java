  ...
  void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strBpartnerId, String strDateFrom, String strDateTo, String strCal1, String strCal2, String strPaymentRule, String strIsReceipt, String strIsPaid, String strIsPending, String strOrder, String strInvoice, String strOrderBy, String strOffset, String strPageSize, String strNewFilter ) throws IOException, ServletException {
    ...
    if (headers!=null) {
      ...
      if(strNewFilter.equals("1") || strNewFilter.equals("")) { // New filter or first load
        data = DebtPaymentData.select(this, "1", vars.getLanguage(), Utility.getContext(this, vars, "#User_Client", "DebtPayment"), Utility.getContext(this, vars, "#User_Org", "DebtPayment"), strBpartnerId,  strDateFrom, DateTimeData.nDaysAfter(this,strDateTo, "1"), strCal1, strCal2, strPaymentRule, strIsPaid, strIsReceipt, strIsPending, strInvoice, strOrder, strOrderBy, "", "");
      ...
      if(this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        data = DebtPaymentData.select(this, "ROWNUM", vars.getLanguage(), Utility.getContext(this, vars, "#User_Client", "DebtPayment"), Utility.getContext(this, vars, "#User_Org", "DebtPayment"), strBpartnerId,  strDateFrom, DateTimeData.nDaysAfter(this,strDateTo, "1"), strCal1, strCal2, strPaymentRule, strIsPaid, strIsReceipt, strIsPending, strInvoice, strOrder, strOrderBy, oraLimit, "");
      }
      else {
        String pgLimit = strPageSize + " OFFSET " + strOffset;
        data = DebtPaymentData.select(this, "1", vars.getLanguage(), Utility.getContext(this, vars, "#User_Client", "DebtPayment"), Utility.getContext(this, vars, "#User_Org", "DebtPayment"), strBpartnerId,  strDateFrom, DateTimeData.nDaysAfter(this,strDateTo, "1"), strCal1, strCal2, strPaymentRule, strIsPaid, strIsReceipt, strIsPending, strInvoice, strOrder, strOrderBy, "", pgLimit);
      }     
