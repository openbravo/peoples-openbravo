...
public class DebtPayment extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT") || vars.commandIn("KEY")) {
            ...
            String strBpartnerId = vars.getGlobalVariable("inpBpartnerId",
                    "DebtPayment.inpBpartnerId", "");
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "DebtPayment.inpDateFrom", "");
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "DebtPayment.inpDateTo", "");
            ...
            String strIsReceipt = vars.getGlobalVariable("inpIsReceipt",
                    "DebtPayment.inpIsReceipt", "Y");
            String strIsPaid = vars.getGlobalVariable("inpIsPaid",
                    "DebtPayment.inpIsPaid", "N");
            String strIsPending = vars.getGlobalVariable("inpPending",
                    "DebtPayment.inpPending", "P");
            String strInvoice = vars.getGlobalVariable("inpInvoice",
            ...
            printGridData(response, vars, strBpartnerId, strDateFrom,
    ...
    void printPageFS(HttpServletResponse response, VariablesSecureApp vars)
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/DebtPayment_FS")
                .createXmlDocument();
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars)
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/DebtPayment").createXmlDocument();
        xmlDocument
        ...
        vars.setSessionValue("DebtPayment.inpDateFrom", dateFormat
                .format(today));
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "BPARTNER", "ORDERNO", "INVOICE", "DATEPLANNED",
                "AMOUNT", "WRITEOFFAMT", "CURRENCY", "PAYMENTRULE",
                "DEBTCANCEL", "DEBTGENERATE", "C_DEBT_PAYMENT_ID", "ROWKEY" };
        boolean[] colSortable = { true, true, true, true, true, true, true,
                false, false, false, false, false };
        String[] colWidths = { "113", "59", "57", "60", "65", "62", "55", "81",
                "110", "110", "0", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "DPS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("DPS_") ? colNames[i]
                    : name));
        ...
        if (headers != null) {
            try {
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    strNumRows = vars
                            .getSessionValue("DebtPaymentInfo.numrows");
                }
