...
public class Project extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strKey = "";
            String strWindow = vars.getGlobalVariable("WindowID",
                    "Project.windowId", "");
            String strBpartner = vars.getGlobalVariable("inpBpartnerId",
                    "Project.bpartner", "");
            String strNameValue = vars.getGlobalVariable("inpNameValue",
                    "Project.key", "");
            ...
            printPage(response, vars, strKey, strNameValue + "%", strBpartner,
                    strWindow, "paramName");
            ...
            if (data != null && data.length == 1) {
                ...
                printPage(response, vars, strKeyValue + "%", "", strBpartner,
                        strWindow, "paramKey");
            ...
            String strName = vars.getGlobalVariable("inpName", "Project.name",
                    "");
            String strBpartners = vars.getGlobalVariable("inpBpartnerId",
                    "Project.bpartner", "");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strWindow, String focusedId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of the projects seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/Project").createXmlDocument();
        ...
        xmlDocument.setParameter("tercero", ProjectData.selectTercero(this,
                strBpartners));
    ...
    String generateResult(ProjectData[] data) throws IOException,
            ServletException {
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "value", "name", "bpartner", "projectstatus",
                "rowkey" };
        ...
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "PJS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("PJS_") ? colNames[i]
                    : name));
