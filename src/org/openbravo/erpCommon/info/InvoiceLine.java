...
public class InvoiceLine extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            vars
                    .getRequestGlobalVariable("inpBPartner",
                            "InvoiceLine.bpartner");
            if (!strNameValue.equals("")) {
                ...
                do {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        vars.setSessionValue("InvoiceLine.grandtotalfrom",
                                token);
            ...
            String strDocumentNo = vars.getGlobalVariable("inpdocumentno",
                    "InvoiceLine.documentno", "");
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "InvoiceLine.datefrom", "");
            ...
            data = InvoiceLineData.selectKey(this, Utility.getContext(this,
                    vars, "#User_Client", "InvoiceLine"), Utility.getContext(
                    this, vars, "#User_Org", "InvoiceLine"), strKeyValue + "%");
            ...
            if (data != null && data.length == 1)
                ...
                String strCal2 = vars.getGlobalVariable("inpCal2",
                        "InvoiceLine.grandtotalto", "");
                printPage(response, vars, strBPartner, strProduct,
                        strDocumentNo, strDateFrom, strDateTo, strCal1, strCal2);
            }
            ...
            String strCal2 = vars.getGlobalVariable("inpCal2",
                    "InvoiceLine.grandtotalto", "");
            String strOrder = vars.getGlobalVariable("inpInvoice",
                    "InvoiceLine.invoice", "");
            ...
            printGridData(response, vars, strDocumentNo, strBpartnerId,
                    strDateFrom, strDateTo, strDescription, strCal1, strCal2,
                    strOrder, strProduct, strSortCols + " " + strSortDirs,
    ...
    String generateResult(InvoiceLineData[] data) throws IOException,
            ServletException {
        StringBuffer html = new StringBuffer();
        if (log4j.isDebugEnabled())
            log4j.debug("Save- clave:" + data[0].cInvoicelineId + " txt:"
                    + data[0].lineText);
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
        ...
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/InvoiceLine").createXmlDocument();
        ...
        xmlDocument.setParameter("cBpartnerId_DES", InvoiceLineData
                .selectBPartner(this, strBPartner));
        xmlDocument.setParameter("mProductId", strProduct);
        xmlDocument.setParameter("mProductId_DES", InvoiceLineData
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "BPARTNER_NAME", "DATEINVOICED", "DOCUMENTNO",
                "ISSOTRX", "PRODUCT_NAME", "QTY", "PRICEACTUAL", "LINENETAMT",
                "C_INVOICELINE_ID", "ROWKEY" };
        String[] colWidths = { "220", "80", "110", "35", "170", "60", "50",
                "55", "0", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "ILS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("ILS_") ? colNames[i]
                    : name));
    ...
    void printGridData(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strCal2, String strOrder, String strProduct,
        ...
        if (headers != null) {
            try {
                ...
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    // first
                    // load
                    strNumRows = InvoiceLineData.countRows(this, Utility
                            .getContext(this, vars, "#User_Client",
                                    "InvoiceLine"), Utility.getContext(this,
                            vars, "#User_Org", "InvoiceLine"), strDocumentNo,
                ...
                if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                    ...
                    data = InvoiceLineData.select(this, "ROWNUM", Utility
                            .getContext(this, vars, "#User_Client",
                                    "InvoiceLine"), Utility.getContext(this,
                            vars, "#User_Org", "InvoiceLine"), strDocumentNo,
                            strDescription, strOrder, strBpartnerId,
                            strDateFrom, DateTimeData.nDaysAfter(this,
                                    strDateTo, "1"), strCal1, strCal2,
                            strProduct, strOrderBy, oraLimit, "");
                } else {
                    String pgLimit = strPageSize + " OFFSET " + strOffset;
                    data = InvoiceLineData.select(this, "1", Utility
                            .getContext(this, vars, "#User_Client",
                                    "InvoiceLine"), Utility.getContext(this,
                            vars, "#User_Org", "InvoiceLine"), strDocumentNo,
                            strDescription, strOrder, strBpartnerId,
