...
public class ImageInfo extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strName = vars.getRequestGlobalVariable("inpName",
                    "ImageInfo.name");
            ...
            String strInitRecord = vars
                    .getSessionValue("ImageInfo.initRecordNumber");
            String strRecordRange = Utility.getContext(this, vars,
                    "#RecordRangeInfo", "ImageInfo");
            ...
            if (strInitRecord.equals("") || strInitRecord.equals("0"))
                ...
                strInitRecord = ((initRecord < 0) ? "0" : Integer
                        .toString(initRecord));
                vars.setSessionValue("ImageInfo.initRecordNumber",
                        strInitRecord);
            }
    ...
    void printPageFrame(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (strName.equals("") && strURL.equals("")) {
            ...
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/info/ImageInfo", discard)
                    .createXmlDocument();
