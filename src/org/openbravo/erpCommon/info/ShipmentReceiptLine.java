...
public class ShipmentReceiptLine extends HttpSecureAppServlet {
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            if (!strNameValue.equals("")) {
                ...
                do {
                    ...
                    switch (count) {
                    case 1:
                        vars.setSessionValue("ShipmentReceiptLine.line", token
                                .trim());
                        break;
                    case 2:
                        vars.setSessionValue("ShipmentReceiptLine.movementqty",
                                token.trim());
                        break;
                    case 3:
                        strDocumentNo = token.trim();
                        vars.setSessionValue("ShipmentReceiptLine.documentno",
                                strDocumentNo);
                        break;
                    case 4:
                        strDateFrom = token.trim();
                        strDateTo = token.trim();
                        vars.setSessionValue("ShipmentReceiptLine.datefrom",
                                strDateFrom);
                        vars.setSessionValue("ShipmentReceiptLine.dateto",
                                strDateTo);
                        break;
                    case 5:
                        String ID = ShipmentReceiptLineData.getProductID(this,
                                token);
                        if (!ID.equals(""))
                            strProduct = ID;
                        vars.setSessionValue("ShipmentReceiptLine.product",
                                strProduct);
                        break;
                    }
                    count++;
            ...
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "ShipmentReceiptLine.datefrom", "");
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "ShipmentReceiptLine.dateto", "");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strDateFrom, String strDateTo) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of the delivery lines seekern");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/ShipmentReceiptLine")
                .createXmlDocument();
        ...
        xmlDocument.setParameter("cBpartnerId_DES", ShipmentReceiptLineData
                .selectBPartner(this, strBPartner));
        xmlDocument.setParameter("mProductId", strProduct);
        xmlDocument.setParameter("mProductId_DES", ShipmentReceiptLineData
    ...
    void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
            ShipmentReceiptLineData[] data) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
    ...
    String generateResult(ShipmentReceiptLineData[] data) throws IOException,
            ServletException {
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "bpartner_name", "movementdate", "documentno",
                "issotrx", "product_name", "qty", "locator_name",
                "attribute_name", "rowkey" };
        ...
        String[] colWidths = { "160", "80", "100", "44", "140", "78", "110",
                "80", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            String name = Utility.messageBD(this, "SRLS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("SRLS_") ? colNames[i]
                    : name));
    ...
    void printGridData(HttpServletResponse response, VariablesSecureApp vars,
            String strDocumentNo, String strBpartnerId, String strDateFrom,
                ...
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    if (strSOTrx.equals("Y")) {
                        data = ShipmentReceiptLineData.select(this, "1",
                                ...
                                strProduct, strInvoiced, strOrderBy, "", "");
                    } else {
                    ...
                    vars.setSessionValue("ShipmentReceiptLine.numrows",
                            strNumRows);
                } else {
                    strNumRows = vars
                            .getSessionValue("ShipmentReceiptLine.numrows");
                }
