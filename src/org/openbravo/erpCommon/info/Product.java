...
public class Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strWarehouse = vars.getGlobalVariable("inpWarehouse", "Product.warehouse", Utility.getContext(this, vars, "M_Warehouse_ID", windowId));
      ...
      String strPriceListVersion = getPriceListVersion(vars, strPriceList, strDate);
      vars.setSessionValue("Product.priceListVersion", strPriceListVersion);
      ProductData[] data = ProductData.select(this, strWarehouse, "1", strKeyValue + "%", "", Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getContext(this, vars, "#User_Org", "Product"), strPriceListVersion, "1", "", "");
      ...
      printGridData(response, vars, strKey, strName, strOrg, strWarehouse, strPriceListVersion, strSortCols + " " + strSortDirs,strOffset, strPageSize, strNewFilter);
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue, String strNameValue, String strWarehouse, String strPriceList, String strPriceListVersion, String windowId, String focusedId) throws IOException, ServletException {
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/info/Product", discard).createXmlDocument();
...
//	  String[] gridNames = {"Key", "Name","Disp. Credit","Credit used", "Contact", "Phone no.", "Zip", "City", "Income", "c_bpartner_id", "c_bpartner_contact_id", "c_bpartner_location_id", "rowkey"};
  ...
  void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey, String strName, String strOrg, String strWarehouse, String strPriceListVersion, String strOrderBy, String strOffset, String strPageSize, String strNewFilter ) throws IOException, ServletException {
    ...
    if (headers!=null) {
      try{
    	...
    	if(this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
    		...
    		data = ProductData.select(this, strWarehouse, "ROWNUM", strKey, strName, Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getContext(this, vars, "#User_Org", "Product"), strPriceListVersion, strOrderBy, oraLimit, "");
    	}
    	else {
    		String pgLimit = strPageSize + " OFFSET " + strOffset;
    		data = ProductData.select(this, strWarehouse, "1", strKey, strName, Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getContext(this, vars, "#User_Org", "Product"), strPriceListVersion, strOrderBy, "", pgLimit);
    	}    
