...
public class Account extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strNameValue = vars.getRequestGlobalVariable("inpNameValue",
                    "Account.combination");
            String strAcctSchema = vars.getSessionValue(strWindowId
                    + "|C_AcctSchema_ID");
            ...
            String strAlias = vars.getGlobalVariable("inpAlias",
                    "Account.alias", "");
            String strCombination = vars.getGlobalVariable("inpCombination",
                    "Account.combination", "");
            printPage(response, vars, strAlias, strCombination, "",
                    strAcctSchema, true);
            ...
            String strSortDirs = vars.getStringParameter("sort_dirs")
                    .toUpperCase();
            printGridData(response, vars, strAlias, strCombination,
                    strOrganization, strAccount, strProduct, strBPartner,
                    strProject, strCampaign, strSortCols + " " + strSortDirs,
            ...
            String strAlias = vars.getRequestGlobalVariable("inpAlias",
                    "Account.alias");
            String strOrganization = vars
                    .getRequiredStringParameter("inpOrganization");
            String strAccount = vars.getRequiredStringParameter("inpAccount");
            String strProduct = vars.getStringParameter("inpProduct");
            String strBPartner = vars.getStringParameter("inpBPartner");
            String strProject = vars.getStringParameter("inpProject");
            String strCampaign = vars.getStringParameter("inpCampaign");
            AccountData data = AccountData.insert(this, vars.getClient(),
                    strOrganization, strAcctSchema, strAccount, strClave,
                    strAlias, vars.getUser(), strProduct, strBPartner,
                    strProject, strCampaign);
            if (data != null)
                strClave = data.cValidcombinationId;
            vars.removeSessionValue("Account.alias");
            vars.setSessionValue("Account.combination", AccountData
                    .combination(this, strClave));
    ...
    String generateResult(AccountData[] data) throws IOException,
            ServletException {
        ...
        html.append("var text = \""
                + Replace.replace(data[0].combination, "\"", "\\\"") + "\";\n");
    ...
    void printPage(HttpServletResponse response, VariablesSecureApp vars,
            String strAlias, String strCombination, String strValidCombination,
            String strAcctSchema, boolean isDefault) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: Frame 1 of the accounts seeker");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/info/Account").createXmlDocument();
        ...
        if (isDefault) {
            ...
            data = AccountData.select(this, "1", "", "", "", "", "", "", "",
                    "", "", strValidCombination, Utility.getContext(this, vars,
                            "#User_Client", "Account"), Utility.getContext(
                            this, vars, "#User_Org", "Account"), "1 ASC", "",
                    "");
        }
    ...
    private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
        ...
        String[] colNames = { "ALIAS", "COMBINATION", "DESCRIPTION",
                "AD_ORG_ID_D", "ACCOUNT_ID_D", "M_PRODUCT_ID_D",
                "C_BPARTNER_ID_D", "C_PROJECT_ID_D", "C_CAMPAIGN_ID_D",
                "C_VALIDCOMBINATION_ID", "ROWKEY" };
        String[] colWidths = { "43", "193", "151", "105", "123", "71", "101",
                "43", "59", "0", "0" };
        for (int i = 0; i < colNames.length; i++) {
            ...
            dataAux.setData("iskey", (colNames[i].equals("ROWKEY") ? "true"
                    : "false"));
            dataAux.setData("isvisible", (colNames[i].endsWith("_ID") ? "false"
                    : "true"));
            String name = Utility.messageBD(this, "ACCS_"
                    + colNames[i].toUpperCase(), vars.getLanguage());
            dataAux.setData("name", (name.startsWith("ACCS_") ? colNames[i]
                    : name));
    ...
    void printGridData(HttpServletResponse response, VariablesSecureApp vars,
            String strAlias, String strCombination, String strOrganization,
            String strAccount, String strProduct, String strBPartner,
            String strProject, String strCampaign, String strOrderBy,
            ...
            try {
                ...
                if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
                    ...
                    strNumRows = AccountData.countRows(this, strAcctSchema,
                            ...
                            strCampaign, "", Utility.getContext(this, vars,
                                    "#User_Client", "Account"), Utility
                                    .getContext(this, vars, "#User_Org",
                                            "Account"));
                ...
                if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
                    ...
                    data = AccountData.select(this, "ROWNUM", strAcctSchema,
                            strAlias, strCombination, strOrganization,
                            strAccount, strProduct, strBPartner, strProject,
                            strCampaign, "", Utility.getContext(this, vars,
                                    "#User_Client", "Account"), Utility
                                    .getContext(this, vars, "#User_Org",
                                            "Account"), strOrderBy, oraLimit,
                            "");
                } else {
                    String pgLimit = strPageSize + " OFFSET " + strOffset;
                    data = AccountData
                            .select(this, "1", strAcctSchema, strAlias,
                                    strCombination, strOrganization,
                                    strAccount, strProduct, strBPartner,
                                    strProject, strCampaign, "", Utility
                                            .getContext(this, vars,
                                                    "#User_Client", "Account"),
                                    Utility.getContext(this, vars, "#User_Org",
                                            "Account"), strOrderBy, "", pgLimit);
                }
