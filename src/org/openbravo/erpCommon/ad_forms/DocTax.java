...
public  class DocTax {
  ...
  public Account getAccount (int AcctType, AcctSchema as,ConnectionProvider conn){
    ...
    try{
      ...
      if (data.length > 0){
        switch (AcctType){
        case 0: validCombination_ID = data[0].tDueAcct;
            break;
        case 1: validCombination_ID = data[0].tLiabilityAcct;
            break;
        case 2: validCombination_ID = data[0].tCreditAcct;
            break;
        case 3: validCombination_ID = data[0].tReceivablesAcct;
            break;
        case 4: validCombination_ID = data[0].tExpenseAcct;
            break;
        }  
      }
