...
public class ShowSessionVariables extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("REMOVE")) {
            ...
            String global = vars.getRequestGlobalVariable("inpGlobal",
                    "ShowSessionVariables|global");
            ...
            String window = vars.getRequestGlobalVariable("inpWindow",
                    "ShowSessionVariables|window");
            String strSessionValue = vars
                    .getRequiredStringParameter("inpSessionValue");
            vars.removeSessionValue(strSessionValue);
            printPageDataSheet(request, response, vars, preferences, global,
                    accounting, windowG, window);
            ...
            String strNombre = vars
                    .getRequiredStringParameter("inpNombreVariable");
            ...
            String global = vars.getGlobalVariable("inpGlobal",
                    "ShowSessionVariables|global", "Y");
            ...
            String window = vars.getGlobalVariable("inpWindow",
                    "ShowSessionVariables|window", "0");
            printPageDataSheet(request, response, vars, preferences, global,
                    accounting, windowG, window);
        } else {
            String preferences = vars.getGlobalVariable("inpPreference",
    ...
    ShowSessionVariablesStructureData[] orderStructure(
            ShowSessionVariablesStructureData[] data,
            ShowSessionVariablesData[] windows, boolean preferences,
            boolean global, boolean accounting, boolean windowGlobal,
            String window) {
        ...
        try {
            ...
            if (preferences && (window.equals("") || window.equals("0"))) {
                for (int i = 0; i < data.length; i++) {
                    if (data[i].isPreference
                            && (data[i].window == null || data[i].window
                                    .equals(""))) {
            ...
            if (log4j.isDebugEnabled())
                log4j.debug("ShowSession - orderStructure - Total: "
                        + resData.length + "-" + resData[0].name);
        } catch (Exception e) {
            log4j
                    .error("ShowSession - orderStructure - Ordering Session variables error "
                            + e);
        }
        return resData;
    }

    ShowSessionVariablesStructureData[] compoundSession(
            HttpServletRequest request, VariablesSecureApp vars,
            Vector<Object> windows) {
        if (log4j.isDebugEnabled())
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                if (log4j.isDebugEnabled())
                    log4j
                            .debug("ShowSession - compoundSession - session name: "
                                    + sessionName);
            ...
            log4j
                    .error("ShowSession - compoundSession - Session variables error "
                            + e);
        }
        return data;
    }
    ...
    void printPageDataSheet(HttpServletRequest request,
            ...
            String preferences, String global, String accounting,
            String windowG, String window) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j
                    .debug("ShowSession - printPageDataSheet - Output: data sheet");
        response.setContentType("text/html; charset=UTF-8");
        PrintWriter out = response.getWriter();
        Vector<Object> windows = new Vector<Object>();
        ShowSessionVariablesStructureData[] data = compoundSession(request,
                vars, windows);
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ShowSessionVariables", false, "", "", "", false, "ad_forms",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ShowSessionVariables.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ShowSessionVariables.html", strReplaceWith);
        ...
        ShowSessionVariablesData[] windowsData = (vars.getLanguage().equals(
                "en_US") ? ShowSessionVariablesData.select(this, strWindows
                .toString()) : ShowSessionVariablesData.selectTrl(this,
        ...
        data = orderStructure(data, windowsData, preferences.equals("Y"),
                global.equals("Y"), accounting.equals("Y"),
                windowG.equals("Y"), window);
