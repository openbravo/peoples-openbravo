...
public class AccountingValueData extends MultipartRequest implements
    ...
    public AccountingValueData(VariablesBase _vars, String _filename,
            boolean _firstLineHeads, String _format) throws IOException {
        super(_vars, _filename, _firstLineHeads, _format, null);
    }

    public AccountingValueData(VariablesBase _vars, InputStream _in,
            boolean _firstLineHeads, String _format) throws IOException {
        super(_vars, _in, _firstLineHeads, _format, null);
    }

    public String getField(String fieldName) {
        if (fieldName.equalsIgnoreCase("ACCOUNT_VALUE")
                || fieldName.equals("accountValue"))
            return accountValue;
        else if (fieldName.equalsIgnoreCase("ACCOUNT_NAME")
                || fieldName.equals("accountName"))
            return accountName;
        else if (fieldName.equalsIgnoreCase("ACCOUNT_DESCRIPTION")
                || fieldName.equals("accountDescription"))
            return accountDescription;
        else if (fieldName.equalsIgnoreCase("ACCOUNT_TYPE")
                || fieldName.equals("accountType"))
            return accountType;
        else if (fieldName.equalsIgnoreCase("ACCOUNT_SIGN")
                || fieldName.equals("accountSign"))
            return accountSign;
        ...
        else if (fieldName.equalsIgnoreCase("ACCOUNT_PARENT")
                || fieldName.equals("accountParent"))
            return accountParent;
        else if (fieldName.equalsIgnoreCase("ELEMENT_LEVEL")
                || fieldName.equals("elementLevel"))
            return elementLevel;
        else if (fieldName.equalsIgnoreCase("OPERANDS")
                || fieldName.equals("operands"))
            return operands;
        else if (fieldName.equalsIgnoreCase("BALANCE_SHEET")
                || fieldName.equals("balanceSheet"))
            return balanceSheet;
        ...
        else if (fieldName.equalsIgnoreCase("PROFIT_AND_LOSS")
                || fieldName.equals("profitAndLoss"))
        ...
        else if (fieldName.equalsIgnoreCase("CASH_FLOW")
                || fieldName.equals("cashFlow"))
            return cashFlow;
        else if (fieldName.equalsIgnoreCase("CASH_FLOW_NAME")
                || fieldName.equals("cashFlowName"))
            return cashFlowName;
            ...
            if (log4j.isDebugEnabled())
                log4j
                        .debug("AccountingValueData - getField - Field does not exist: "
                                + fieldName);
            return null;
        }
    }
    ...
    public FieldProvider lineSeparatorFormated(String linea) {
        ...
        for (int i = 0; i < 21; i++) {
            if (siguiente >= linea.length())
                break;
            if ((anterior + 1) < linea.length()
                    && linea.substring(anterior, anterior + 1).equals("\"")) {
            ...
            if (log4j.isDebugEnabled())
                log4j.debug("AccountingValueData - lineSeparatorFormated - i: "
                        + i);
            if (log4j.isDebugEnabled())
                log4j
                        .debug("AccountingValueData - lineSeparatorFormated - texto: "
                                + texto);
            switch (i) {
            case 0:
