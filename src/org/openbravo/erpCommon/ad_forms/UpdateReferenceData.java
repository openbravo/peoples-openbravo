...
public class UpdateReferenceData extends HttpSecureAppServlet {
    ...
    private void printPage(HttpServletResponse response,
            VariablesSecureApp vars, String strOrganization)
            throws IOException, ServletException {
        ModuleReferenceDataOrgTree tree = new ModuleReferenceDataOrgTree(this,
                vars.getClient(), strOrganization, true);
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "UpdateReferenceData", false, "", "", "", false, "ad_forms",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "UpdateReferenceData.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "UpdateReferenceData.html", strReplaceWith);
        ...
        }
        {
            ...
            xmlDocument.setData("reportAD_Org_ID", "liststructure",
                    UpdateReferenceDataData.selectOrganization(this, vars
                            .getRole(), vars.getUserOrg()));
    ...
    private void printPageResult(HttpServletResponse response,
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("UpdateReferenceData - isOK: "
                    + strResultado.equals(""));
        ...
        myMessage.setMessage(Utility.messageBD(this,
                strResultado.equals("") ? "Success" : strResultado, vars
                        .getLanguage()));
        if (log4j.isDebugEnabled())
            log4j.debug("UpdateReferenceData - Message Type: "
                    + myMessage.getType());
    ...
    public String updateReferenceData(HttpServletRequest request,
        ...
        if (strModules != null && !strModules.equals("")) {
            UpdateReferenceDataData[] data = UpdateReferenceDataData
                    .selectModules(this, strModules, strOrganization);
                ...
                for (int i = 0; i < data.length; i++) {
                    ...
                    for (int j = 0; j < myFiles.length; j++) {
                        ...
                        ImportResult myResult = myData.importDataFromXML(
                                (Client) OBDal.getInstance().get(Client.class,
                                        vars.getClient()), (Organization) OBDal
                                        .getInstance().get(Organization.class,
                                                strOrganization), strXml,
                                (Module) OBDal.getInstance().get(Module.class,
                                        data[i].adModuleId));
                    ...
                    if (!strError.toString().equals(""))
                        ...
                        if (UpdateReferenceDataData.selectRegister(this,
                                data[i].adModuleId, strOrganization)
                                .equals("0"))
                            InitialOrgSetupData.insertOrgModule(this, vars
                                    .getClient(), strOrganization, vars
                                    .getUser(), data[i].adModuleId,
                                    data[i].version);
                        else
                            UpdateReferenceDataData.updateOrgModule(this,
                                    data[i].version, vars.getUser(), vars
                                            .getClient(), strOrganization,
                                    data[i].adModuleId);
                        m_info.append(SALTO_LINEA).append(
     ...
     * @return
     */
    private UpdateReferenceDataData[] orderModuleByDependency(
            UpdateReferenceDataData[] modules) {
        ...
        ArrayList<String> orderList = ModuleUtiltiy.orderByDependency(this,
                list);
        UpdateReferenceDataData[] rt = new UpdateReferenceDataData[orderList
                .size()];
