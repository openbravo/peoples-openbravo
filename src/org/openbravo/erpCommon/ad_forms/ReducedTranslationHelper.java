    ...
    switch (table) {
      ...
      case "AD_PROCESS_PARA":
        ...
        sql += " AND ( EXISTS (SELECT 1 "
             ...
             + "                AND (m.translation_Strategy IS NULL OR m.translation_Strategy <> '"+EXCLUDE_FROM_REDUCED_TRL+"')) "
      ...
      case "OBUIAPP_PARAMETER":
        ...
        break;
      case "AD_MENU":
        sql += " AND (o.translation_Strategy IS NULL OR o.translation_Strategy <> '"+EXCLUDE_FROM_REDUCED_TRL+"')";
        break;
      case "AD_WINDOW":
      case "AD_TAB":
