...
public class CallAcctServer extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strTableId = vars.getStringParameter("inpadTableId", "");
      if (data.length > 0 && data[0].status.equals(Process.SCHEDULED)) {
        try {
      ...
      String strMessage = "TODO - Load process log.";
...
//      }
      ...
      runProcess(response, vars, strTableId, adProcessId);
  ...
  private void runProcess(HttpServletResponse response, VariablesSecureApp vars, String strTableId, String adProcessId) throws IOException, ServletException {
