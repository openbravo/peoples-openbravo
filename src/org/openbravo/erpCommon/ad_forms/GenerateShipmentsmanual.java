...
public class GenerateShipmentsmanual extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strC_BPartner_ID = vars.getRequestGlobalVariable(
                    "inpcBpartnerId", "GenerateShipmentsmanual|C_BPartner_ID");
            String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId",
            ...
            PInstanceProcessData.insertPInstance(this, pinstance, "199", "0",
                ...
                if (!pinstanceData[0].errormsg.equals("")) {
                    ...
                    if (errCount > 0 && errCount < errMessages.length) {
                        ...
                        myMessage.setTitle(Utility.messageBD(this,
                                "ShipmentWarning", vars.getLanguage()));
                    } else if (errCount > 0 && errCount == errMessages.length) {
                        myMessage.setType("Error");
                        myMessage.setTitle(Utility.messageBD(this,
                                "ShipmentError", vars.getLanguage()));
                    }
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "GenerateShipmentsmanual", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "GenerateShipmentsmanual.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "GenerateShipmentsmanual.html", strReplaceWith);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Org",
                            "GenerateShipmentsmanual"), Utility.getContext(
                            this, vars, "#User_Client",
                            "GenerateShipmentsmanual"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "GenerateShipmentsmanual", strAD_Org_ID);
