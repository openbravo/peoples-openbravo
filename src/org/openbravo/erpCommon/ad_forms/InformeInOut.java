...
public class InformeInOut extends HttpSecureAppServlet {
  ...
  private void printPageSelector(HttpServletResponse response, VariablesSecureApp vars, String strDesde, String strHasta) throws IOException, ServletException{
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_forms/InformeInOut").createXmlDocument();
