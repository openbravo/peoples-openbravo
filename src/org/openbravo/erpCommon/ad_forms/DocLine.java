...
public class DocLine {
    ...
    public void loadAttributes(FieldProvider data, AcctServer vo) {
        ...
        log4jDocLine.debug("loadAttributes - C_CURRENCY_ID = "
                + m_C_Currency_ID);
        // Qty
    ...
    public void setAmount(String amtSourceDr, String amtSourceCr) {
        m_AmtSourceDr = (amtSourceDr == null || amtSourceDr.equals("")) ? "0"
                : amtSourceDr;
        m_AmtSourceCr = (amtSourceCr == null || amtSourceCr.equals("")) ? "0"
                : amtSourceCr;
    } // setAmounts
     ...
     *            acct amount cr
     */
    public void setConvertedAmt(String C_AcctSchema_ID, String amtAcctDr,
            String amtAcctCr) {
    ...
    public Account getChargeAccount(AcctSchema as, BigDecimal amount,
        ...
        Account acct = null;
        try {
            data = DocLineData.select(conn, m_C_Charge_ID, as
                    .getC_AcctSchema_ID());
            if (data.length > 0) {
            ...
            if (Account_ID.equals("")) {
                log4jDocLine
                        .warn("getChargeAccount - NO account for C_Charge_ID="
                                + m_C_Charge_ID);
                return null;
            }
            // Return Account
    ...
    public void setAmount(String sourceAmt) {
        m_AmtSourceDr = (sourceAmt == null || sourceAmt.equals("")) ? ZERO
                .toString() : sourceAmt;
