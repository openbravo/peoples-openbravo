...
public class About extends HttpSecureAppServlet {
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars)
    ...
    if (data.length == 0) {
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_forms/About",discard).createXmlDocument();
      data = AboutData.set();
    } else  
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_forms/About").createXmlDocument();
