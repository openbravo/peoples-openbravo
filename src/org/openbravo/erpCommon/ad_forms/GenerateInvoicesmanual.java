...
public class GenerateInvoicesmanual extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (!Utility.hasFormAccess(this, vars, "", "org.openbravo.erpCommon.ad_forms.GenerateInvoicesmanual")) {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "GenerateInvoicesmanual|DateTo");
      ...
      if (log4j.isDebugEnabled()) log4j.debug(message);
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strC_BPartner_ID, String strAD_Org_ID, String strDateFrom, String strDateTo)
    ...
    if (strC_BPartner_ID.equals("") && strAD_Org_ID.equals("")) {
     xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_forms/GenerateInvoicesmanual", discard).createXmlDocument();
     data = GenerateInvoicesmanualData.set();
    } else {
     xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_forms/GenerateInvoicesmanual").createXmlDocument();
//     data = GenerateInvoicesmanualData.select(this, Utility.getContext(this, vars, "#User_Client", "GenerateInvoicesmanual"), Utility.getContext(this, vars, "#User_Org", "GenerateInvoicesmanual"), strC_BPartner_ID, strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), strTreeOrg, strAD_Org_ID);
    ...
    try {
      KeyMap key = new KeyMap(this, vars, "GenerateInvoicesmanual.html");
      xmlDocument.setParameter("keyMap", key.getActionButtonKeyMaps());
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    try {
      WindowTabs tabs = new WindowTabs(this, vars, "org.openbravo.erpCommon.ad_forms.GenerateInvoicesmanual");
