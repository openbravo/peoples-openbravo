...
public class GenerateInvoicesmanual extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "GenerateInvoicesmanual|DateTo");
            String strC_BPartner_ID = vars.getRequestGlobalVariable(
                    "inpcBpartnerId", "GenerateInvoicesmanual|C_BPartner_ID");
            ...
            PInstanceProcessData.insertPInstance(this, pinstance, "134", "0",
                    "N", vars.getUser(), vars.getClient(), vars.getOrg());
            PInstanceProcessData.insertPInstanceParam(this, pinstance, "1",
                    "Selection", "Y", vars.getClient(), vars.getOrg(), vars
                            .getUser());
            ...
            if (pinstanceData != null && pinstanceData.length > 0) {
                if (!pinstanceData[0].errormsg.equals("")) {
                    ...
                    if (message.startsWith("@") && message.endsWith("@")) {
                        myMessage.setMessage(message.substring(1, message
                                .length() - 1));
                        if (message.indexOf("@") == -1)
                            myMessage.setMessage(Utility.messageBD(this,
                                    message, vars.getLanguage()));
                        else
                            myMessage.setMessage(Utility.parseTranslation(this,
                                    vars, vars.getLanguage(), "@" + message
                                            + "@"));
                    } else
                        myMessage.setMessage(Utility.parseTranslation(this,
                                vars, vars.getLanguage(), message));
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strAD_Org_ID, String strDateFrom, String strDateTo)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        String strTreeOrg = GenerateShipmentsmanualData.treeOrg(this, vars
                .getClient());
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "GenerateInvoicesmanual", false, "", "", "", false, "ad_forms",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "GenerateInvoicesmanual.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "GenerateInvoicesmanual.html", strReplaceWith);
        ...
        xmlDocument.setParameter("paramBPartnerDescription",
                GenerateInvoicesmanualData.bPartnerDescription(this,
                        strC_BPartner_ID));
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Org",
                            ...
                            vars, "#User_Client", "GenerateInvoicesmanual"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "GenerateInvoicesmanual", strAD_Org_ID);
