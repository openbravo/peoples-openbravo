...
public class DocLine_Material extends DocLine {
    static Logger log4jDocLine_Material = Logger
            .getLogger(DocLine_Material.class);
     ...
     *            trx line id
     */
    public DocLine_Material(String DocumentType, String TrxHeader_ID,
            String TrxLine_ID) {
    ...
    public void setQty(String qty, ConnectionProvider conn) {
        ...
        log4jDocLine_Material.debug(" setQty - productInfo.qty = "
                + p_productInfo.m_qty);
    } // setQty
     ...
     * @return costs
     */
    public String getProductCosts(String date, AcctSchema as,
