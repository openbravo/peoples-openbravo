...
public class DocLine_Cash extends DocLine {
    ...
    public DocLine_Cash(String DocumentType, String TrxHeader_ID,
            String TrxLine_ID) {
     ...
     *            invoice
     */
    public void setReference(String C_Order_ID, String C_Debt_Payment_ID,
    ...
    private void setReferenceInfo(ConnectionProvider conn) {
        ...
        log4jDocLine_Cash
                .debug("DocLineCash - setReferenceInfo - BankAccount_id = "
        ...
        log4jDocLine_Cash
                .debug("DocLineCash - setReferenceInfo - C_CURRENCY_ID = "
                        + m_C_Currency_ID);
    } // setReferenceInfo
    ...
    public Account getGlitemAccount(AcctSchema as, BigDecimal amount,
        ...
        Account acct = null;
        try {
            data = DocLineCashData.selectGlitem(conn, m_C_Glitem_ID, as
                    .getC_AcctSchema_ID());
            if (data.length > 0) {
