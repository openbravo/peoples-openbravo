...
public class DocLine_Cash extends DocLine {
  static Logger log4jDocLine_Cash = Logger.getLogger(DocLine_Cash.class);
    ...
    private void setReferenceInfo(ConnectionProvider conn){
        ...
        log4jDocLine_Cash.debug("DocLineCash - setReferenceInfo - BankAccount_id = " + m_C_BankAccount_ID + "Invoice_ID = " + m_C_Invoice_ID);
        try{
            //  Bank Account Info
    ...
    public String getC_Currency_ID(ConnectionProvider conn){
        if ((m_C_BankAccount_ID == null || m_C_BankAccount_ID.equals("")) && (m_C_Invoice_ID == null || m_C_Invoice_ID.equals("")))
