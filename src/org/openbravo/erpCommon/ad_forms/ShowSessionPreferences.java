...
public class ShowSessionPreferences extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("SAVE_PREFERENCES")) {
            ...
            String strAccounting = vars
                    .getStringParameter("inpAccounting", "N");
            ...
            String strRecordRange = vars.getGlobalVariable("inpRecordRange",
                    "#RecordRange");
            String strRecordRangeInfo = vars.getGlobalVariable(
                    "inpRecordRangeInfo", "#RecordRangeInfo");
            String strTheme = vars.getStringParameter("inpTheme");
            vars.setSessionValue("#Theme", vars.getSessionValue("#Theme")
                    .substring(0, 4)
                    + strTheme);
            String strTransactionalRange = vars.getGlobalVariable(
                    "inpTransactionalRange", "#Transactional$Range");
            vars.setSessionValue("#Date", strFecha);
            vars.setSessionValue("#ShowTrl", strTranslate);
            vars.setSessionValue("#ShowAudit", strAudit);
            String strPreference = ShowSessionPreferencesData.selectPreference(
                    this, Utility.getContext(this, vars, "#User_Client",
                            "ShowSessionPreferences"), Utility.getContext(this,
                            vars, "#User_Org", "ShowSessionPreferences"), vars
                            .getUser(), "ShowTrl");
            ShowSessionPreferencesData.updateRange(this, vars.getUser(),
                    strRecordRange, strRecordRangeInfo, strTransactionalRange,
                    strTheme);
            if (!strPreference.equals(""))
                ShowSessionPreferencesData.update(this, vars.getUser(),
                        strTranslate, strPreference);
            else {
                strPreference = SequenceIdData.getUUID();
                ShowSessionPreferencesData.insert(this, strPreference, vars
                        .getClient(), vars.getOrg(), vars.getUser(), "ShowTrl",
                        strTranslate);
            }
            ...
            if (!strPreference.equals(""))
                ShowSessionPreferencesData.update(this, vars.getUser(),
                        strAccounting, strPreference);
            else {
                strPreference = SequenceIdData.getUUID();
                ShowSessionPreferencesData.insert(this, strPreference, vars
                        .getClient(), vars.getOrg(), vars.getUser(),
                        "ShowAcct", strAccounting);
            }
            ...
            strPreference = ShowSessionPreferencesData.selectPreference(this,
                    Utility.getContext(this, vars, "#User_Client",
                            "ShowSessionPreferences"), Utility.getContext(this,
                            vars, "#User_Org", "ShowSessionPreferences"), vars
                            .getUser(), "ShowAuditDefault");
            if (!strPreference.equals(""))
                ShowSessionPreferencesData.update(this, vars.getUser(),
                        strAudit, strPreference);
            else {
                strPreference = SequenceIdData.getUUID();
                ShowSessionPreferencesData.insert(this, strPreference, vars
                        .getClient(), vars.getOrg(), vars.getUser(),
                        "ShowAuditDefault", strAudit);
            }
    ...
    void printPagePreferences(HttpServletResponse response,
            VariablesSecureApp vars) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j
                    .debug("ShowSession - printPagePreferences - Output: preferences");
        ...
        xmlDocument.setParameter("translate", vars.getSessionValue("#ShowTrl",
                "N"));
        xmlDocument.setParameter("accounting", vars.getSessionValue(
                "#ShowAcct", "N"));
        xmlDocument.setParameter("audit", vars.getSessionValue("#ShowAudit",
                "N"));
        xmlDocument.setParameter("fecha", vars.getSessionValue("#Date", ""));
        xmlDocument.setParameter("fechadisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("fechasaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("transactionalRange", vars.getSessionValue(
                "#Transactional$Range", ""));
        xmlDocument
                .setParameter("test", vars.getSessionValue("#ShowTest", "N"));
        xmlDocument.setParameter("recordRange", vars
                .getSessionValue("#RecordRange"));
        xmlDocument.setParameter("recordRangeInfo", vars
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ShowSessionPreferences", false, "", "", "", false, "ad_forms",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ShowSessionPreferences.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ShowSessionPreferences.html", strReplaceWith);
        ...
        try {
            comboTableData = new ComboTableData(vars, this, "LIST", "Theme",
                    "800102", "", Utility.getContext(this, vars, "#User_Org",
                            "ShowSessionPreferences"), Utility.getContext(this,
                            vars, "#User_Client", "ShowSessionPreferences"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ShowSessionPreferences", "");
            xmlDocument.setData("reportTheme", "liststructure", comboTableData
                    .select(true));
        } catch (Exception ex) {
        }
        comboTableData = null;
    ...
    private String getInfo(VariablesSecureApp vars) throws ServletException {
        ...
        script.append(Utility.messageBD(this, "User", vars.getLanguage()))
                .append(": ").append(
                        ShowSessionPreferencesData
                                .usuario(this, vars.getUser())).append("\n");
        script.append(Utility.messageBD(this, "Role", vars.getLanguage()))
                .append(": ").append(
                        ShowSessionPreferencesData.rol(this, vars.getRole()))
                .append("\n");
        script.append(Utility.messageBD(this, "Client", vars.getLanguage()))
                .append(": ").append(
                        ShowSessionPreferencesData.cliente(this, vars
                                .getClient())).append("\n");
        script.append(Utility.messageBD(this, "Org", vars.getLanguage()))
                .append(": ").append(
                        ShowSessionPreferencesData.organizacion(this, vars
                                .getOrg())).append("\n");
        script.append(Utility.messageBD(this, "Web", vars.getLanguage()))
                .append(": ").append(strReplaceWith).append("\n");
        script.append(Utility.messageBD(this, "DB", vars.getLanguage()))
                .append(": ").append(globalParameters.strBBDD).append("\n");
        script.append(
                Utility.messageBD(this, "RecordRange", vars.getLanguage()))
                .append(": ").append(vars.getSessionValue("#RecordRange"))
                .append("\n");
        script.append(
                Utility.messageBD(this, "SearchsRecordRange", vars
                        .getLanguage())).append(": ").append(
                vars.getSessionValue("#RecordRangeInfo")).append("\n");
        if (globalParameters.strVersion != null
                && !globalParameters.strVersion.equals(""))
            script.append(
                    Utility
                            .messageBD(this, "SourceVersion", vars
                                    .getLanguage())).append(": ").append(
                    globalParameters.strVersion).append("\n");
        if (globalParameters.strParentVersion != null
                && !globalParameters.strParentVersion.equals(""))
            script.append(
                    Utility.messageBD(this, "VerticalSourceVersion", vars
                            .getLanguage())).append(": ").append(
                    globalParameters.strParentVersion).append("\n");
        script.append(Utility.messageBD(this, "JavaVM", vars.getLanguage()))
                .append(": ").append(System.getProperty("java.vm.name"))
                .append("\n");
        script.append(
                Utility.messageBD(this, "VersionJavaVM", vars.getLanguage()))
                .append(": ").append(System.getProperty("java.vm.version"))
                .append("\n");
        script.append(
                Utility.messageBD(this, "SystemLanguage", vars.getLanguage()))
                .append(": ").append(globalParameters.strSystemLanguage)
                .append("\n");
        script.append(Utility.messageBD(this, "JavaTMP", vars.getLanguage()))
                .append(": ").append(System.getProperty("java.io.tmpdir"))
                .append("\n");
