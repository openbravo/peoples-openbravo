...
public class GenerateModel347 extends HttpSecureAppServlet {
    ...
    void printPageGenerate(HttpServletResponse response,
        ...
        GenerateModel347Data[] data = GenerateModel347Data.select(this,
                strType, strComplementar, strDateFrom, DateTimeData.nDaysAfter(
                        this, strDateTo, "1"), Tree.getMembers(this, TreeData
        ...
        if (data.length > 0) {
            ...
            String strLinea = "";
            String strCabecera = "";
            strCabecera = data[0].constant1 + data[0].model + data[0].ejercicio
                    + data[0].nifDeclarante + data[0].nombreDeclarante
                    + data[0].soporte + data[0].persona + data[0].numeroJustif
                    + data[0].tipoDeclaracion + data[0].tipoDeclaracion2
                    + data[0].numeroDec + data[0].numeroPersonas
                    + data[0].importe + data[0].totalInmuebles
                    + data[0].importeTotalInmuebles + data[0].blancos;
            strBuf = strBuf.append(strCabecera);

            GenerateModel347Data[] dataLines = GenerateModel347Data
                    .selectType2(this, strDateFrom, DateTimeData.nDaysAfter(
                            this, strDateTo, "1"), Tree
            ...
            for (int i = 0; i < dataLines.length; i++) {
                strLinea = dataLines[i].constant1 + dataLines[i].model
                        ...
                        + dataLines[i].tipoDeclaracion
                        + dataLines[i].codigoProvincia
                        + dataLines[i].codigoPais + dataLines[i].claveCodigo
                        + dataLines[i].importe + dataLines[i].operacionSeguro
