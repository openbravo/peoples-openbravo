...
public class ReportExpense extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strPartner = vars.getGlobalVariable("inpUser",
                    "ReportExpense|partner", "");
            String strProject = vars.getGlobalVariable("inpcProjectId",
                    "ReportExpense|project", "");
            String strExpense = vars.getGlobalVariable("inpExpense",
                    "ReportExpense|expense", "all");
            ...
            String strcBpartnerId = vars.getRequestGlobalVariable(
                    "inpcBPartnerId", "ReportExpense|cBpartnerId");
            String strPartner = vars.getRequestGlobalVariable("inpUser",
                    "ReportExpense|partner");
    ...
    void printPageDataHtml(HttpServletRequest request,
        ...
        if (vars.commandIn("DEFAULT") && strDateFrom.equals("")
                && strDateTo.equals("") && strcBpartnerId.equals("")
                && strPartner.equals("")) {
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strPartner, strProject, strExpense,
                    strCurrencyId);
            ...
            try {
                data1 = ReportExpenseData.select(this, strCurrencyId,
                        strBaseCurrencyId, vars.getLanguage(), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportExpense"), Utility.getContext(
                                this, vars, "#User_Org", "ReportExpense"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), strcBpartnerId, strPartner, strProject,
                        (strExpense.equals("time") ? "Y" : ""), (strExpense
                                .equals("expense") ? "N" : ""));
        ...
        if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
            ...
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportExpenseEdit")
                    .createXmlDocument();
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportExpense", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportExpense.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportExpense.html", strReplaceWith);
        ...
        xmlDocument.setParameter("bPartnerDescription", ReportExpenseData
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "C_BPartner_ID", "C_BPartner Employee w Address",
                    "", Utility.getContext(this, vars, "#User_Org",
                            "ReportExpense"), Utility.getContext(this, vars,
                            "#User_Client", "ReportExpense"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportExpense", "");

            ComboTableData comboTableDataProject = new ComboTableData(this,
                    "TABLE", "C_Project_ID", "C_Project", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportExpense"), Utility.getContext(this,
                            vars, "#User_Client", "ReportExpense"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableDataProject,
                    "ReportExpense", "");

            xmlDocument.setData("reportC_BPartner_ID", "liststructure",
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Currency_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "ReportExpense"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportExpense"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportExpense", strCurrencyId);
