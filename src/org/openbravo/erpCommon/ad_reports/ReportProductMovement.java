...
public class ReportProductMovement extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strMovement = vars.getGlobalVariable("inpMovement",
                    "ReportProductMovement|movement", "-1");
            ...
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strmProductId, strInout, strInventory,
                    strMovement, strProduction, strmAttributesetinstanceId);
            ...
            String strcBpartnerId = vars.getRequestGlobalVariable(
                    "inpcBPartnerId", "ReportProductMovement|cBpartnerId");
            String strmProductId = vars.getRequestGlobalVariable(
                    "inpmProductId", "ReportProductMovement|mProductId");
            ...
            String strMovement = vars.getRequestGlobalVariable("inpMovement",
                    "ReportProductMovement|movement");
            String strProduction = vars.getRequestGlobalVariable(
                    "inpProduction", "ReportProductMovement|production");
            setHistoryCommand(request, "DIRECT");
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strmProductId, strInout, strInventory,
                    strMovement, strProduction, strmAttributesetinstanceId);
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strcBpartnerId, String strmProductId, String strInout,
            String strInventory, String strMovement, String strProduction,
            String strmAttributesetinstanceId) throws IOException,
            ServletException {
        ...
        if (vars.commandIn("FIND", "DIRECT")) {
            if (strInout.equals("-1")) {
                data = ReportProductMovementData.select(this, vars
                        .getLanguage(), Utility.getContext(this, vars,
                        "#User_Client", "ReportProductMovement"), Utility
                        .getContext(this, vars, "#User_Org",
                                "ReportProductMovement"), strDateFrom,
            ...
            if (strInventory.equals("-1")) {
                data1 = ReportProductMovementData.selectInventory(this, Utility
                        .getContext(this, vars, "#User_Client",
                                "ReportProductMovement"), Utility.getContext(
                        this, vars, "#User_Org", "ReportProductMovement"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), strcBpartnerId, strmProductId);
            ...
            if (strMovement.equals("-1")) {
                data2 = ReportProductMovementData.selectMovement(this, Utility
                        .getContext(this, vars, "#User_Client",
                                "ReportProductMovement"), Utility.getContext(
                        this, vars, "#User_Org", "ReportProductMovement"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportProductMovement", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportProductMovement.html", classInfo.id, classInfo.type,
        ...
        if (strmProductId.equals("")) {
            ...
            data = ReportProductMovementData.select(this, vars.getLanguage(),
                    Utility.getContext(this, vars, "#User_Org",
                            "ReportProductMovement"), Utility.getContext(this,
                            vars, "#User_Client", "ReportProductMovement"),
        ...
        xmlDocument.setData("reportM_ATTRIBUTESETINSTANCE_ID", "liststructure",
                AttributeSetInstanceComboData.select(this, vars.getLanguage(),
                        strmProductId, Utility.getContext(this, vars,
                                "#User_Client", "ReportProductMovement"),
                        Utility.getContext(this, vars, "#User_Org",
        ...
        xmlDocument.setParameter("productDescription",
                ReportWarehousePartnerData.selectMproduct(this, strmProductId));
