  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strcBpartnerId, String strmProductId, String strInout, String strInventory, String strMovement, String strProduction)
    ...
    if (vars.commandIn("FIND", "DIRECT")){
      if (strInout.equals("-1")){
        data = ReportProductMovementData.select(this, Utility.getContext(this, vars, "#User_Client", "ReportProductMovement"), Utility.getContext(this, vars, "#User_Org", "ReportProductMovement"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), strcBpartnerId, strmProductId);
    ...
    try {
      KeyMap key = new KeyMap(this, vars, "ReportProductMovement.html");
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportProductMovement.html", classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportProductMovement.html", strReplaceWith);
