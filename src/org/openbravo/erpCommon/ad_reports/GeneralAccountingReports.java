...
public class GeneralAccountingReports extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strAgno = vars.getGlobalVariable("inpAgno",
                    "GeneralAccountingReports|agno", "");
            String strAgnoRef = vars.getGlobalVariable("inpAgnoRef",
            ...
            String strElementValue = vars.getGlobalVariable(
                    "inpcElementvalueId",
            ...
            printPageDataSheet(response, vars, strAgno, strAgnoRef,
                    strDateFrom, strDateTo, strDateFromRef, strDateToRef,
                    strElementValue, strConImporte, strOrg, strLevel,
            ...
            String strDateFromRef = vars.getRequestGlobalVariable(
                    "inpDateFromRef", "GeneralAccountingReports|dateFromRef");
            String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef",
                    "GeneralAccountingReports|dateToRef");
            String strElementValue = vars.getRequiredGlobalVariable(
                    "inpcElementvalueId",
                    "GeneralAccountingReports|C_ElementValue_ID");
            String strConImporte = vars.getRequestGlobalVariable(
                    "inpConImporte", "GeneralAccountingReports|conImporte");
            ...
            String strLevel = vars.getRequestGlobalVariable("inpLevel",
                    "GeneralAccountingReports|level");
            printPagePDF(response, vars, strAgno, strAgnoRef, strDateFrom,
                    strDateTo, strDateFromRef, strDateToRef, strElementValue,
                    strConImporte, strOrg, strLevel, strConCodigo,
                    strcAcctSchemaId);
        } else
            pageError(response);
    }
    ...
    void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
            String strAgno, String strAgnoRef, String strDateFrom,
            String strDateTo, String strDateFromRef, String strDateToRef,
            String strElementValue, String strConImporte, String strOrg,
            String strLevel, String strConCodigo, String strcAcctSchemaId)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: pdf");
        XmlDocument xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/GeneralAccountingReportsPDF")
                .createXmlDocument();

        GeneralAccountingReportsData[] strGroups = GeneralAccountingReportsData
                .selectGroups(this, strElementValue);
        strGroups[strGroups.length - 1].pagebreak = "";

        String[][] strElementValueDes = new String[strGroups.length][];
        if (log4j.isDebugEnabled())
            log4j.debug("strElementValue:" + strElementValue
                    + " - strGroups.length:" + strGroups.length);
        ...
        String strTreeOrg = GeneralAccountingReportsData.treeOrg(this, vars
                .getClient());
        ...
        for (int i = 0; i < strGroups.length; i++) {
            if (vars.getLanguage().equals("en_US")) {
                elements[i] = AccountTreeData
                        .select(this, strConCodigo, TreeID);
            } else {
                elements[i] = AccountTreeData.selectTrl(this, strConCodigo,
                        vars.getLanguage(), TreeID);
            }
            AccountTreeData[] accounts = AccountTreeData.selectAcct(this,
                    Utility.getContext(this, vars, "#User_Org",
                            "GeneralAccountingReports"), Utility.getContext(
                            this, vars, "#User_Client",
                            "GeneralAccountingReports"), strDateFrom,
                    DateTimeData.nDaysAfter(this, strDateTo, "1"),
                    strcAcctSchemaId,
                    Tree.getMembers(this, strTreeOrg, strOrg), strAgno,
                    strDateFromRef, DateTimeData.nDaysAfter(this, strDateToRef,
                            "1"), strAgnoRef);

            {
                ...
                if (log4j.isDebugEnabled())
                    log4j.debug("*********** strIncomeSummary: "
                            + strIncomeSummary);
                String strISyear = processIncomeSummary(strDateFrom,
                        DateTimeData.nDaysAfter(this, strDateTo, "1"), strAgno,
                ...
                String strISyearRef = processIncomeSummary(strDateFromRef,
                        ...
                        strAgnoRef, strTreeOrg, strOrg, strcAcctSchemaId);
                if (log4j.isDebugEnabled())
                    log4j.debug("*********** strISyearRef: " + strISyearRef);
                accounts = appendRecords(accounts, strIncomeSummary, strISyear,
                        strISyearRef);

            }
            acct[i] = new AccountTree(vars, this, elements[i], accounts,
                    strElementValueDes[i]);
            if (acct[i] != null) {
                acct[i].filterSVC();
        ...
        xmlDocument.setParameter("org", AcctServerData.selectOrgName(this,
                strOrg));
        xmlDocument.setParameter("column1", strAgno);
        xmlDocument.setParameter("columnRef1", strAgnoRef);
        xmlDocument.setParameter("companyName", GeneralAccountingReportsData
                .companyName(this, vars.getClient()));
        ...
        xmlDocument.setParameter("periodRef", strDateFromRef + " - "
                + strDateToRef);
        xmlDocument.setParameter("agnoInitial", strAgno);
        xmlDocument.setParameter("agnoRef", strAgnoRef);

        xmlDocument.setParameter("principalTitle", GeneralAccountingReportsData
                .rptTitle(this, strElementValue));
    ...
    AccountTreeData[] appendRecords(AccountTreeData[] data,
            String strIncomeSummary, String strISyear, String strISyearRef)
            throws ServletException {
        if (data == null || strIncomeSummary == null
                || strIncomeSummary.equals("") || strISyear == null
                || strISyear.equals("") || strISyearRef == null
                || strISyearRef.equals(""))
            return data;
    ...
    String processIncomeSummary(String strDateFrom, String strDateTo,
            String strAgno, String strTreeOrg, String strOrg,
            String strcAcctSchemaId) throws ServletException, IOException {
        String strISRevenue = GeneralAccountingReportsData.selectPyG(this, "R",
                strDateFrom, strDateTo, strcAcctSchemaId, strAgno, Tree
                        .getMembers(this, strTreeOrg, strOrg));
        String strISExpense = GeneralAccountingReportsData.selectPyG(this, "E",
                strDateFrom, strDateTo, strcAcctSchemaId, strAgno, Tree
                        .getMembers(this, strTreeOrg, strOrg));
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strAgno, String strAgnoRef,
            String strDateFrom, String strDateTo, String strDateFromRef,
            String strDateToRef, String strElementValue, String strConImporte,
            String strOrg, String strLevel, String strConCodigo,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "GeneralAccountingReports", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "GeneralAccountingReports.html", classInfo.id,
        ...
        xmlDocument.setData("reportC_ACCTSCHEMA_ID", "liststructure",
                ReportGeneralLedgerData.selectC_ACCTSCHEMA_ID(this, Utility
                        .getContext(this, vars, "#User_Org",
                                "GeneralAccountingReports"), Utility
                        .getContext(this, vars, "#User_Client",
                                "GeneralAccountingReports"), strcAcctSchemaId));
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "", "C_ElementValue level", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "GeneralAccountingReports"), Utility
                            .getContext(this, vars, "#User_Client",
            ...
            xmlDocument.setData("reportLevel", "liststructure", comboTableData
                    .select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "AD_Org_ID", "", "", Utility.getContext(this,
                            vars, "#User_Org", "ReportCashFlow"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportCashFlow"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportCashFlow", "");
        ...
        GeneralAccountingReportsData[] dataReportIsBalanced = GeneralAccountingReportsData
                .selectRpt(this, Utility.getContext(this, vars, "#User_Org",
                        "GeneralAccountingReports"), Utility.getContext(this,
                        vars, "#User_Client", "GeneralAccountingReports"),
                        strcAcctSchemaId);
        reportIsBalanced = "var arrReportIsBalanced = new Array(\n";
        for (int i = 0; i < dataReportIsBalanced.length; i++) {
            reportIsBalanced += "new Array(\""
                    + dataReportIsBalanced[i].getField("id") + "\",\""
        ...
        xmlDocument.setData("reportC_ElementValue_ID", "liststructure",
                dataReportIsBalanced);

        xmlDocument.setParameter("accountingReports", arrayDobleEntrada(
                "arrAccountingReports", GeneralAccountingReportsData
                        .selectRptDouble(this)));
        /*
         * try { ComboTableData comboTableData = new ComboTableData(vars, this,
         * "TABLEDIR", "C_Acct_Rpt_ID", "", "", Utility.getContext(this, vars,
         * "#User_Org", "GeneralAccountingReports"), Utility.getContext(this,
         * vars, "#User_Client", "GeneralAccountingReports"), 0);
         * Utility.fillSQLParameters(this, vars, null, comboTableData,
         * "GeneralAccountingReports", "");
         * xmlDocument.setData("reportC_ElementValue_ID","liststructure",
