...
public class ReportRefundSalesDimensionalAnalysesPDF extends
    ...
    void printPagePdf(HttpServletRequest request, HttpServletResponse response,
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportRefundSalesDimensionalAnalysesData.select(this,
                        ...
                        strTextShow[5], strTextShow[6], Tree.getMembers(this,
                                ...
                                strOrg), Utility.getContext(this, vars,
                                "#User_Client",
                        ...
                        strmWarehouseId, strDateFromRef, DateTimeData
                                .nDaysAfter(this, strDateToRef, "1"),
                        strOrderby);
