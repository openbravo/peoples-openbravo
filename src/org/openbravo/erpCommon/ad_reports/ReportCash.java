...
public class ReportCash extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strCashbook = vars.getRequestGlobalVariable(
                    "inpcCashbookId", "ReportCash|Cashbook");
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportCashEdit")
                    .createXmlDocument();
            data = ReportCashData.select(this, vars.getLanguage(), Utility
                    .getContext(this, vars, "#User_Client", "ReportCash"),
                    Utility.getContext(this, vars, "#User_Org", "ReportCash"),
                    strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"),
                    strCashbook);
            xmlDocument.setParameter("sumAmount", ReportCashData
                    .BeginningBalance(this, Utility.getContext(this, vars,
                            "#User_Client", "ReportCash"), Utility.getContext(
                            this, vars, "#User_Org", "ReportCash"),
                            strDateFrom, strCashbook));
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportCash")
                .createXmlDocument();
        xmlDocument.setParameter("sumAmount", ReportCashData.BeginningBalance(
                this, Utility.getContext(this, vars, "#User_Client",
                        "ReportCash"), Utility.getContext(this, vars,
                        "#User_Org", "ReportCash"), strDateFrom, strCashbook));

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportCash",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportCash.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportCash.html", strReplaceWith);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_CashBook_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "ReportCash"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportCash"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportCash", strCashbook);
