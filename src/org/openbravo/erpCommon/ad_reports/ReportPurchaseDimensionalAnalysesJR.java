...
public class ReportPurchaseDimensionalAnalysesJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
      ...
      String strOrg = vars.getRequestGlobalVariable("inpOrg", "ReportPurchaseDimensionalAnalysesJR|org");
  ...
  void printPageHtml(HttpServletRequest request, HttpServletResponse response,
    ...
    if (vars.getLanguage().equals("en_US")) {
      ...
      dimensionLabel = ReportPurchaseDimensionalAnalysesJRData.selectNotShownTrl(this, vars
          .getLanguage(), "");
    }
