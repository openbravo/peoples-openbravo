...
public class ReportPurchaseDimensionalAnalysesJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strcBpartnerId = vars.getInGlobalVariable(
                    "inpcBPartnerId_IN",
                    "ReportPurchaseDimensionalAnalysesJR|partner", "");
            ...
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportPurchaseDimensionalAnalyzeJR|currency",
                    strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strDateToRef, String strOrg, String strOrder,
            String strMayor, String strMenor, String strCurrencyId)
            throws IOException, ServletException {
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportPurchaseDimensionalAnalysesFilterJR",
                        discard).createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportPurchaseDimensionalAnalysesFilterJR", false, "", "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportPurchaseDimensionalAnalysesFilterJR.html",
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportPurchaseDimensionalAnalysesJR");
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_BP_Group_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportPurchaseDimensionalAnalysesJR"), Utility
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportPurchaseDimensionalAnalysesJRData.selectBpartner(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportPurchaseDimensionalAnalysesJRData.selectMproduct(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        ...
        if (vars.getLanguage().equals("en_US")) {
            xmlDocument.setData("structure1",
                    ReportPurchaseDimensionalAnalysesJRData.selectNotShown(
                            this, strShown));
            xmlDocument
                    .setData(
                            "structure2",
                            strShown.equals("") ? new ReportPurchaseDimensionalAnalysesJRData[0]
                                    : ReportPurchaseDimensionalAnalysesJRData
                                            .selectShown(this, strShown));
        } else {
            xmlDocument.setData("structure1",
                    ReportPurchaseDimensionalAnalysesJRData.selectNotShownTrl(
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportPurchaseDimensionalAnalysesJRData.selectBpgroup(
        ...
        if (vars.getLanguage().equals("en_US")) {
            dimensionLabel = ReportPurchaseDimensionalAnalysesJRData
                    .selectNotShown(this, "");
        } else {
            dimensionLabel = ReportPurchaseDimensionalAnalysesJRData
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportPurchaseDimensionalAnalysesJRData.select(this,
                        strCurrencyId, strTextShow[0], strTextShow[1],
                        strTextShow[2], strTextShow[3], strTextShow[4], Tree
            ...
            try {
                data = ReportPurchaseDimensionalAnalysesJRData
                        .selectNoComparative(this, strCurrencyId,
