...
public class ReportDebtPayment extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DIRECT")) {
            ...
            String strCal1 = vars.getGlobalVariable("inpCal1",
                    "ReportDebtPayment|Cal1", "");
            String strCalc2 = vars.getGlobalVariable("inpCalc2",
                    "ReportDebtPayment|Cal2", "");
            ...
            String strGroup = vars.getGlobalVariable("inpGroup",
                    "ReportDebtPayment|Group", "isGroup");
            String strPending = "";
            String strReceipt = "";
            if (vars.commandIn("DIRECT")) {
                strReceipt = vars.getGlobalVariable("inpReceipt",
                        "ReportDebtPayment|Receipt", "N");
                strPending = vars.getGlobalVariable("inpPending",
                        "ReportDebtPayment|Pending", "");
            } else {
                strReceipt = vars.getGlobalVariable("inpReceipt",
                        "ReportDebtPayment|Receipt", "Y");
                strPending = vars.getGlobalVariable("inpPending",
                        "ReportDebtPayment|Pending", "isPending");
            }
            ...
            printPageDataSheet(response, vars, strcBpartnerId, strDateFrom,
                    strDateTo, strCal1, strCalc2, strPaymentRule, strSettle,
                    strConciliate, strReceipt, strPending, strcbankaccount,
                    strStatus, strGroup);
        } else if (vars.commandIn("FIND")) {
            String strcbankaccount = vars.getRequestGlobalVariable(
                    "inpcBankAccountId", "ReportDebtPayment|C_Bankaccount_ID");
            String strcBpartnerId = vars.getRequestInGlobalVariable(
                    "inpcBPartnerId_IN", "ReportDebtPayment|inpcBPartnerId_IN");
            // String strC_BPartner_ID =
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportDebtPayment|DateTo");
            String strCal1 = vars.getRequestGlobalVariable("inpCal1",
                    "ReportDebtPayment|Cal1");
            String strCalc2 = vars.getRequestGlobalVariable("inpCal2",
                    "ReportDebtPayment|Cal2");
            String strPaymentRule = vars.getRequestGlobalVariable(
                    "inpCPaymentRuleId", "ReportDebtPayment|PaymentRule");
            String strSettle = vars.getRequestGlobalVariable("inpSettle",
                    "ReportDebtPayment|Settle");
            String strConciliate = vars.getRequestGlobalVariable(
                    "inpConciliate", "ReportDebtPayment|Conciliate");
            ...
            String strReceipt = vars.getStringParameter("inpReceipt")
                    .equals("") ? "N" : vars.getStringParameter("inpReceipt");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strDateFrom, String strDateTo, String strCal1,
            String strCalc2, String strPaymentRule, String strSettle,
            String strConciliate, String strReceipt, String strPending,
            String strcbankaccount, String strStatus, String strGroup)
            throws IOException, ServletException {
        ...
        if (strPending.equals("") && strConciliate.equals("")
                && strSettle.equals("")) {
            strAux = "";
        } else {
        ...
        if (!strGroup.equals(""))
            data = ReportDebtPaymentData.select(this, vars.getLanguage(),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportDebtPayment"), Utility.getContext(this,
                            vars, "#User_Org", "ReportDebtPayment"),
                    strC_BPartner_ID, strDateFrom, DateTimeData.nDaysAfter(
                            this, strDateTo, "1"), strCal1, strCalc2,
                    strPaymentRule, strReceipt, strStatus, strAux,
                    strcbankaccount);
        else
            data = ReportDebtPaymentData.selectNoBpartner(this, vars
                    .getLanguage(), Utility.getContext(this, vars,
                    "#User_Client", "ReportDebtPayment"), Utility.getContext(
                    this, vars, "#User_Org", "ReportDebtPayment"),
                    strC_BPartner_ID, strDateFrom, DateTimeData.nDaysAfter(
                            this, strDateTo, "1"), strCal1, strCalc2,
                    strPaymentRule, strReceipt, strStatus, strAux,
                    strcbankaccount);
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportDebtPayment", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportDebtPayment.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportDebtPayment.html", strReplaceWith);
        ...
        xmlDocument.setData("reportC_ACCOUNTNUMBER", "liststructure",
                AccountNumberComboData.select(this, Utility.getContext(this,
                        vars, "#User_Client", "ReportDebtPayment"), Utility
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("diacard = " + discard[0] + " - " + discard[1] + " - "
                    + discard[2]);
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportDebtPayment", strPaymentRule);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "", "C_DP_Management_Status", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportDebtPayment"), Utility.getContext(
                            this, vars, "#User_Client", "ReportDebtPayment"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportDebtPayment", strStatus);
            xmlDocument.setData("reportStatus", "liststructure", comboTableData
                    .select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        }
        xmlDocument.setData(!strGroup.equals("") ? "structure1" : "structure2",
                data);
