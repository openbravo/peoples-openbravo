...
public class ReportPricelist extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strPricelistversionId = vars.getGlobalVariable(
                    "inpmPricelistVersion", "ReportPricelist|pricelistversion",
                    "");
            String strmProductId = vars.getInGlobalVariable("inpmProductId_IN",
                    "ReportPricelist|mProductId", "");
            printPageDataSheet(response, vars, strProductCategory,
                    strPricelistversionId, strmProductId);
            /*
             * } else if (vars.commandIn("DIRECT")) { String strDateFrom =
             * vars.getGlobalVariable("inpDateFrom", "ReportPricelist|dateFrom",
             * ""); String strDateTo = vars.getGlobalVariable("inpDateTo",
             * "ReportPricelist|dateTo", ""); String strcBpartnerId =
             * vars.getGlobalVariable("inpcBPartnerId",
             * "ReportPricelist|cBpartnerId", ""); String strPartner =
             * vars.getGlobalVariable("inpPartner", "ReportPricelist|partner",
            ...
            String strProductCategory = vars.getRequestGlobalVariable(
                    "inpProductCategory", "ReportPricelist|productCategory");
            String strPricelistversionId = vars.getRequestGlobalVariable(
                    "inpmPricelistVersion", "ReportPricelist|pricelistversion");
            String strmProductId = vars.getRequestInGlobalVariable(
                    "inpmProductId_IN", "ReportPricelist|mProductId");
            /* setHistoryCommand(request, "DIRECT"); */
            printPageDataSheet(response, vars, strProductCategory,
                    strPricelistversionId, strmProductId);
            ...
            String strmProductId = vars.getRequestInGlobalVariable(
                    "inpmProductId_IN", "ReportPricelist|mProductId");
            printPagePdf(response, vars, strProductCategory,
                    strPricelistversionId, strmProductId);
        } else
            pageError(response);
    }
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strProductCategory,
            String strPricelistversionId, String strmProductId)
            throws IOException, ServletException {
        ...
        if (vars.commandIn("DEFAULT") && strProductCategory.equals("")
            ...
            data = ReportPricelistData.select(this, Utility.getContext(this,
                    vars, "#User_Client", "ReportPricelist"), Utility
                    .getContext(this, vars, "#User_Org", "ReportPricelist"),
                    strPricelistversionId, strProductCategory, strmProductId);
        }
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportPricelist", discard)
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportPricelist", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportPricelist.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportPricelist.html", strReplaceWith);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "MProductId_IN", "null", "", Utility.getContext(
                            this, vars, "#User_Org", ""), Utility.getContext(
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_PriceList_Version_ID", "", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportPricelist"), Utility.getContext(
                            this, vars, "#User_Client", "ReportPricelist"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportPricelist", strPricelistversionId);
    ...
    void printPagePdf(HttpServletResponse response, VariablesSecureApp vars,
            String strProductCategory, String strPricelistversionId,
            String strmProductId) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: print pdf");
        XmlDocument xmlDocument = null;
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportPricelist_Pdf")
                .createXmlDocument();
        xmlDocument.setData("structure1", ReportPricelistData.selectPDF(this,
                Utility.getContext(this, vars, "#User_Client",
                        "ReportPricelist"), Utility.getContext(this, vars,
                        "#User_Org", "ReportPricelist"), strPricelistversionId,
                strProductCategory, strmProductId));
