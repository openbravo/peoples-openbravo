...
public class ReportSalesOrderDimensionalPDF extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportSalesDimensionalAnalyses|org", "0");
            String strsalesrepId = vars.getRequestGlobalVariable(
                    "inpSalesrepId", "ReportSalesDimensionalAnalyses|salesrep");
    ...
    void printPagePdf(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strMenor, String strPartnerSalesrepId) throws IOException,
            ServletException {
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeData.selectBpgroup(this,
                            strPartnerGroup);
        if (!strProductCategory.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ProductCategory", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeData.selectProductCategory(
        ...
        if (!strsalesrepId.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + ReportSalesDimensionalAnalyzeData.selectSalesrep(this,
                            strsalesrepId);
        ...
        if (!strmWarehouseId.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "TheWarehouse", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeData.selectMwarehouse(this,
                            strmWarehouseId);
        ...
        if (strComparative.equals("Y")) {
            data = ReportSalesDimensionalAnalyzeData.select(this,
                    strTextShow[0], strTextShow[1], strTextShow[2],
                    strTextShow[3], strTextShow[4], strTextShow[5],
                    strTextShow[6], strTextShow[7], strTextShow[8], Tree
                            .getMembers(this, TreeData.getTreeOrg(this, vars
                                    .getClient()), strOrg), Utility.getContext(
                            this, vars, "#User_Client",
                            "ReportSalesDimensionalAnalyze"), strDateFrom,
                    DateTimeData.nDaysAfter(this, strDateTo, "1"),
                    strPartnerGroup, strcBpartnerId, strProductCategory,
                    strmProductId, strmWarehouseId, strsalesrepId,
                    strPartnerSalesrepId, strDateFromRef, DateTimeData
                            .nDaysAfter(this, strDateToRef, "1"), strOrderby);
        } else {
            data = ReportSalesDimensionalAnalyzeData.selectNoComparative(this,
                    strTextShow[0], strTextShow[1], strTextShow[2],
                    strTextShow[3], strTextShow[4], strTextShow[5],
                    strTextShow[6], strTextShow[7], strTextShow[8], Tree
                            .getMembers(this, TreeData.getTreeOrg(this, vars
            ...
            if (intAuxDiscard == -1) {
                if (strComparative.equals("Y")) {
                    for (int j = 1; j < 10; j++) {
                        ...
                        discard1[j + 9] = "fieldTotalRefQtyNivel"
                                + String.valueOf(j);
                    ...
                    while (count > contador) {
                        discard1[count + 54] = "fieldTotalNivel"
                                + String.valueOf(count);
                        discard1[count + 63] = "fieldTotalRefNivel"
                                + String.valueOf(count);
                        discard1[count + 72] = "fieldTotal"
                                + String.valueOf(count);
                        // discard1[count+81] =
                    ...
                    for (int j = 1; j < 10; j++) {
                        discard1[j] = "fieldNoncomparativeTotalQtyNivel"
                                + String.valueOf(j);
                        discard1[j + 27] = "fieldNoncomparativeUomsymbol"
                                + String.valueOf(j);
                        // discard1[j+36] =
                    ...
                    int count = 9;
                    while (count > contador) {
                        discard1[count + 45] = "fieldNoncomparativeTotalNivel"
                                + String.valueOf(count);
                        // discard1[count+54] =
                ...
                if (strComparative.equals("Y")) {
                    for (int j = contador; j > 0; j--) {
                        ...
                        discard1[k + 9] = "fieldTotalRefQtyNivel"
                                + String.valueOf(j);
                    ...
                    while (count > intDiscard + 1) {
                        discard1[count + 54] = "fieldTotal"
                                + String.valueOf(count);
                        discard1[count + 63] = "fieldTotalNivel"
                                + String.valueOf(count);
                        discard1[count + 72] = "fieldTotalRefNivel"
                                + String.valueOf(count);
                        discard1[count + 81] = "fieldTotalQtyNivel"
                                + String.valueOf(count);
                        discard1[count + 90] = "fieldTotalRefQtyNivel"
                                + String.valueOf(count);
                        discard1[count + 99] = "fieldTotalQty"
                                + String.valueOf(count);
                        discard1[count + 108] = "fieldUomsymbol"
                                + String.valueOf(count);
                        // discard1[count+117] =
                        // "fieldTotalWeightNivel"+String.valueOf(count);
                        // discard1[count+126] =
                    ...
                    for (int j = contador; j > 0; j--) {
                        discard1[k] = "fieldNoncomparativeTotalQtyNivel"
                                + String.valueOf(j);
                        discard1[k + 27] = "fieldNoncomparativeUomsymbol"
                                + String.valueOf(j);
                        // discard1[k+36] =
                        // "fieldNoncomparativeTotalWeightNivel"+String.valueOf(j);
                        k++;
                    ...
                    while (countNon > intDiscard + 1) {
                        discard1[countNon + 45] = "fieldNoncomparativeTotalNivel"
                                + String.valueOf(countNon);
                        discard1[countNon + 54] = "fieldNoncomparativeTotalQtyNivel"
                                + String.valueOf(countNon);
                        discard1[countNon + 63] = "fieldNoncomparativeUomsymbol"
                                + String.valueOf(countNon);
        ...
        xmlDocument.setParameter("entity", ReportSalesDimensionalAnalyzeData
                .selectEntity(this, vars.getClient()));
