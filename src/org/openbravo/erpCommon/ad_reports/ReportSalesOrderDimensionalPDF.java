...
public class ReportSalesOrderDimensionalPDF extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")){
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportSalesDimensionalAnalyses|dateFrom");
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportSalesDimensionalAnalyses|dateTo");
      String strDateFromRef = vars.getRequestGlobalVariable("inpDateFromRef", "ReportSalesDimensionalAnalyses|dateFromRef");
      String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef", "ReportSalesDimensionalAnalyses|dateToRef");
      String strPartnerGroup = vars.getRequestGlobalVariable("inpPartnerGroup", "ReportSalesDimensionalAnalyses|partnerGroup");
      String strcBpartnerId = vars.getRequestInGlobalVariable("inpcBPartnerId_IN", "ReportSalesDimensionalAnalyses|partner");
      String strProductCategory = vars.getRequestGlobalVariable("inpProductCategory", "ReportSalesDimensionalAnalyses|productCategory");
      String strmProductId = vars.getRequestInGlobalVariable("inpmProductId_IN", "ReportSalesDimensionalAnalyses|product");
      String strmWarehouseId = vars.getRequestGlobalVariable("inpmWarehouseId", "ReportSalesDimensionalAnalyze|warehouse");
      ...
      String strsalesrepId = vars.getRequestGlobalVariable("inpSalesrepId", "ReportSalesDimensionalAnalyses|salesrep");
      ...
      String strPartnerSalesrepId = vars.getRequestGlobalVariable("inpPartnerSalesrepId", "ReportSalesDimensionalAnalyses|partnersalesrep");
      printPagePdf(response, vars, strComparative, strDateFrom, strDateTo, strPartnerGroup, strcBpartnerId, strProductCategory, strmProductId, strmWarehouseId, strNotShown,
  ...
  void printPagePdf(HttpServletResponse response, VariablesSecureApp vars, String strComparative, String strDateFrom, String strDateTo, String strPartnerGroup, String
    ...
    if (!strPartnerGroup.equals("")) strTitle = strTitle + ", " + Utility.messageBD(this, "ForBPartnerGroup", vars.getLanguage()) + " "+ReportSalesDimensionalAnalyzeData.selectBpgroup(this, strPartnerGroup);
    if (!strProductCategory.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "ProductCategory", vars.getLanguage()) + " "+ReportSalesDimensionalAnalyzeData.selectProductCategory(this, strProductCategory);
    if (!strsalesrepId.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "TheSalesRep", vars.getLanguage()) + " "+ReportSalesDimensionalAnalyzeData.selectSalesrep(this, strsalesrepId);
    if (!strPartnerSalesrepId.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "TheClientSalesRep", vars.getLanguage()) + " "+ReportSalesDimensionalAnalyzeData.selectSalesrep(this, strPartnerSalesrepId);
    if (!strmWarehouseId.equals("")) strTitle = strTitle+" " + Utility.messageBD(this, "And", vars.getLanguage()) + " " + Utility.messageBD(this, "TheWarehouse", vars.getLanguage()) + " "+ReportSalesDimensionalAnalyzeData.selectMwarehouse(this, strmWarehouseId);
    ...
    if (strComparative.equals("Y")){
      data = ReportSalesDimensionalAnalyzeData.select(this, strTextShow[0], strTextShow[1], strTextShow[2], strTextShow[3], strTextShow[4], strTextShow[5], strTextShow[6],
          strTextShow[7], strTextShow[8], Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg), Utility.getContext(this, vars, "#User_Client", "ReportSalesDimensionalAnalyze"), strDateFrom,
      ...
      data = ReportSalesDimensionalAnalyzeData.selectNoComparative(this, strTextShow[0], strTextShow[1], strTextShow[2], strTextShow[3], strTextShow[4], strTextShow[5],
          strTextShow[6], strTextShow[7], strTextShow[8], Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg), Utility.getContext(this, vars, "#User_Client", "ReportSalesDimensionalAnalyze"), strDateFrom,
      ...
      if (intAuxDiscard == -1) {
        if (strComparative.equals("Y")){
          for ( int j=1; j<10; j++){
            ...
            //discard1[j+36] = "fieldTotalWeightNivel"+String.valueOf(j);
          ...
          while (count>contador){
            ...
            //discard1[count+81] = "fieldTotalWeightNivel"+String.valueOf(count);
          ...
          for ( int j=1; j<10; j++){
            ...
            //discard1[j+36] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(j);
          }
          int count=9;
          while(count>contador){
            discard1[count+45] = "fieldNoncomparativeTotalNivel"+String.valueOf(count);
            //discard1[count+54] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(count);
            count--;
          }
        }
        ...
        if (strComparative.equals("Y")){
          for (int j = contador; j>0; j--){
            ...
            //discard1[k+36] = "fieldTotalWeightNivel"+String.valueOf(j);
          ...
          while (count>intDiscard+1){
            ...
            //discard1[count+117] = "fieldTotalWeightNivel"+String.valueOf(count);
          ...
          for (int j = contador; j>0; j--){
            ...
            //discard1[k+36] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(j);
            k++;
          }
          int countNon = 9;
          while (countNon>intDiscard+1){
            ...
            //discard1[countNon+72] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(countNon);
            countNon--;
          }
        }
      }
    ...
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportSalesOrderDimensionalPDF", discard1).createXmlDocument();
    ...
    xmlDocument.setParameter("entity", ReportSalesDimensionalAnalyzeData.selectEntity(this, vars.getClient()));
