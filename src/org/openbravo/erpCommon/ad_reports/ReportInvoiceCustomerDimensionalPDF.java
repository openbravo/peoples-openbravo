...
public class ReportInvoiceCustomerDimensionalPDF extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            printPagePdf(response, vars, strComparative, strDateFrom,
                    ...
                    strOrder, strcProjectId, strProducttype, strMayor,
    ...
    void printPagePdf(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strOrder, String strcProjectId, String strProducttype,
        ...
        if (!strProductCategory.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ProductCategory", vars
                            .getLanguage())
                    + " "
                    + ReportInvoiceCustomerDimensionalAnalysesData
        ...
        if (strComparative.equals("Y")) {
            data = ReportInvoiceCustomerDimensionalAnalysesData.select(this,
                    ...
                    strTextShow[9], Tree.getMembers(this, TreeData.getTreeOrg(
                            this, vars.getClient()), strOrg), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerDimensionalPDF"),
                    strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"),
                    strPartnerGroup, strcBpartnerId, strProductCategory,
                    strmProductId, strsalesrepId, strPartnerSalesrepId,
                    strcProjectId, strProducttype, strDateFromRef, DateTimeData
                            .nDaysAfter(this, strDateToRef, "1"), strOrderby);
        } else {
            data = ReportInvoiceCustomerDimensionalAnalysesData
                    .selectNoComparative(this, strTextShow[0], strTextShow[1],
                            strTextShow[2], strTextShow[3], strTextShow[4],
                            strTextShow[5], strTextShow[6], strTextShow[7],
                            strTextShow[8], strTextShow[9], Tree.getMembers(
                                    this, TreeData.getTreeOrg(this, vars
                                            .getClient()), strOrg),
            ...
            if (intAuxDiscard == -1) {
                if (strComparative.equals("Y")) {
                    for (int j = 1; j < 11; j++) {
                        ...
                        discard1[j + 10] = "fieldTotalRefQtyNivel"
                                + String.valueOf(j);
                     ...
                     * "fieldNoncomparativeTotalNivel"+String.valueOf(count);
                     * count--; }
                     */
                }
                ...
                if (strComparative.equals("Y")) {
                    for (int j = contador; j > 0; j--) {
                        ...
                        discard1[k + 10] = "fieldTotalRefQtyNivel"
                                + String.valueOf(j);
                    ...
                    while (count > intDiscard + 1) {
                        discard1[count + 30] = "fieldTotal"
                                + String.valueOf(count);
                        // discard1[count+30] =
                        // "fieldTotalNivel"+String.valueOf(count);
                        // discard1[count+36] =
                        // "fieldTotalRefNivel"+String.valueOf(count);
                        discard1[count + 40] = "fieldTotalQtyNivel"
                                + String.valueOf(count);
                        discard1[count + 50] = "fieldTotalRefQtyNivel"
                                + String.valueOf(count);
                        discard1[count + 60] = "fieldTotalQty"
                                + String.valueOf(count);
                        // discard1[count+63] =
                    ...
                    while (countNon > intDiscard + 1) {
                        ...
                        discard1[countNon + 40] = "fieldNoncomparativeTotalQtyNivel"
        ...
        xmlDocument.setParameter("total",
                ReportInvoiceCustomerDimensionalAnalysesData.selectTotal(this,
        ...
        xmlDocument.setParameter("entity",
                ReportInvoiceCustomerDimensionalAnalysesData.selectEntity(this,
                        vars.getClient()));
