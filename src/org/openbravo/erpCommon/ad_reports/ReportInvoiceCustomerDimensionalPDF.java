...
public class ReportInvoiceCustomerDimensionalPDF extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (!Utility.hasProcessAccess(this, vars, "", "RV_ReportInvoiceCustomerDimensionalAnaly")) {
      bdError(response, "AccessTableNoView", vars.getLanguage());
      return;
    }

    if (vars.commandIn("DEFAULT")){
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportInvoiceCustomerDimensionalAnalyses|dateFrom");
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportSInvoiceCustomerDimensionalAnalyses|dateTo");
      String strDateFromRef = vars.getRequestGlobalVariable("inpDateFromRef", "ReportInvoiceCustomerDimensionalAnalyses|dateFromRef");
      String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef", "ReportSInvoiceCustomerDimensionalAnalyses|dateToRef");
      String strPartnerGroup = vars.getRequestGlobalVariable("inpPartnerGroup", "ReportInvoiceCustomerDimensionalAnalyses|partnerGroup");
      String strcBpartnerId = vars.getRequestInGlobalVariable("inpcBPartnerId_IN", "ReportInvoiceCustomerDimensionalAnalyses|partner");
      String strProductCategory = vars.getRequestGlobalVariable("inpProductCategory", "ReportInvoiceCustomerDimensionalAnalyses|productCategory");
      String strmProductId = vars.getRequestInGlobalVariable("inpmProductId_IN", "ReportInvoiceCustomerDimensionalAnalyses|product");
      String strNotShown = vars.getInStringParameter("inpNotShown");
      String strShown = vars.getInStringParameter("inpShown");
      String strOrg = vars.getGlobalVariable("inpOrg", "ReportInvoiceCustomerDimensionalAnalyses|org", "0");
      String strsalesrepId = vars.getRequestGlobalVariable("inpSalesrepId", "ReportInvoiceCustomerDimensionalAnalyses|salesrep");
      String strOrder = vars.getRequestGlobalVariable("inpOrder","ReportInvoiceCustomerDimensionalAnalyses|order");
      String strcProjectId = vars.getRequestGlobalVariable("inpcProjectId", "ReportInvoiceCustomerDimensionalAnalyses|project");
      ...
      String strPartnerSalesrepId = vars.getRequestGlobalVariable("inpPartnerSalesrepId", "ReportInvoiceCustomerDimensionalAnalyses|partnersalesrep");
      printPagePdf(response, vars, strComparative, strDateFrom, strDateTo, strPartnerGroup, strcBpartnerId, strProductCategory, strmProductId, strNotShown, strShown,
          strDateFromRef, strDateToRef, strOrg, strsalesrepId, strOrder, strcProjectId, strProducttype, strMayor, strMenor, strPartnerSalesrepId);
    } else pageErrorPopUp(response);
  }

  void printPagePdf(HttpServletResponse response, VariablesSecureApp vars, String strComparative, String strDateFrom, String strDateTo, String strPartnerGroup, String
      strcBpartnerId, String strProductCategory, String strmProductId, String strNotShown, String strShown, String strDateFromRef, String strDateToRef, String strOrg, String
      strsalesrepId, String strOrder, String strcProjectId, String strProducttype, String strMayor, String strMenor, String strPartnerSalesrepId) throws IOException, ServletException{
    if (log4j.isDebugEnabled()) log4j.debug("Output: print pdf");
    XmlDocument xmlDocument=null;
    String strPage = "basicPSMSecond";
    String strOrderby = "";
    String[] discard = {"", "", "", "", "","", "", "", "", ""};
    String[] discard1={"selEliminarBody1", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard",
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard",
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard",
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard",
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", 
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", 
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", 
      "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", "discard", 
    ...
    if (!strPartnerGroup.equals("")) strTitle = strTitle + ", " + Utility.messageBD(this, "ForBPartnerGroup", vars.getLanguage()) + " "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectBpgroup(this, strPartnerGroup);
    //if (!strcBpartnerId.equals("")) strTitle = strTitle+", para el tercero "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectBpartner(this, strcBpartnerId);
    ...
    if (!strcProjectId.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "Project", vars.getLanguage()) + " "+ReportInvoiceCustomerDimensionalAnalysesData.selectProject(this, strcProjectId);
    if (!strProducttype.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "PRODUCTTYPE", vars.getLanguage()) + " "+ReportInvoiceCustomerDimensionalAnalysesData.selectProducttype(this, "270", vars.getLanguage(), strProducttype);
    if (!strsalesrepId.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "TheSalesRep", vars.getLanguage()) + " "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectSalesrep(this, strsalesrepId);
    if (!strPartnerSalesrepId.equals("")) strTitle = strTitle+", " + Utility.messageBD(this, "TheClientSalesRep", vars.getLanguage()) + " "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectSalesrep(this, strPartnerSalesrepId);
      ...
      if (intAuxDiscard == -1) {
        if (strComparative.equals("Y")){
          ...
          for ( int j=1; j<11; j++){
            ...
            //discard1[j+27] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(j);
            //discard1[j+18] = "fieldNoncomparativeUomsymbol"+String.valueOf(j);
          }
          /*while(count>contador){
            discard1[count+24] = "fieldNoncomparativeTotalNivel"+String.valueOf(count);
            count--;
            }*/
        }
        ...
        if (strComparative.equals("Y")){
          for (int j = contador; j>0; j--){
            ...
            //discard1[k+27] = "fieldTotalWeightNivel"+String.valueOf(j);
          ...
          while (count>intDiscard+1){
            ...
            //discard1[count+30] = "fieldTotalNivel"+String.valueOf(count);
            ...
            //discard1[count+63] = "fieldTotalWeightNivel"+String.valueOf(count);
          ...
          for (int j = contador; j>0; j--){
            ...
            //discard1[k+27] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(j);
            //discard1[k+18] = "fieldNoncomparativeUomsymbol"+String.valueOf(j);
            k++;
          }
          int countNon = 10;
          while (countNon>intDiscard+1){
            //discard1[countNon+24] = "fieldNoncomparativeTotalNivel"+String.valueOf(countNon);
            discard1[countNon+40] = "fieldNoncomparativeTotalQtyNivel"+String.valueOf(countNon);
            //discard1[k+27] = "fieldNoncomparativeTotalWeightNivel"+String.valueOf(countNon);
    ...
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportInvoiceCustomerDimensionalPDF", discard1).createXmlDocument();
    ...
    xmlDocument.setParameter("entity", ReportInvoiceCustomerDimensionalAnalysesData.selectEntity(this, vars.getClient()));
