...
public class ReportGeneralLedgerJournal extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            log4j.debug("********DEFAULT***************  strShowClosing: "
                    + strShowClosing);
            log4j.debug("********DEFAULT***************  strShowReg: "
                    + strShowReg);
            ...
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strDocument, strOrg, strTable, strRecord, "",
                    strcAcctSchemaId, strShowClosing, strShowReg,
                    strShowOpening);
            ...
            String strFactAcctGroupId = vars.getGlobalVariable(
                    "inpFactAcctGroupId",
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportGeneralLedgerJournal|Org", "0");
            String strShowClosing = vars.getRequestGlobalVariable(
                    "inpShowClosing", "ReportGeneralLedgerJournal|ShowClosing");
            String strShowReg = vars.getRequestGlobalVariable("inpShowReg",
                    "ReportGeneralLedgerJournal|ShowReg");
            String strShowOpening = vars.getRequestGlobalVariable(
                    "inpShowOpening", "ReportGeneralLedgerJournal|ShowOpening");
            ...
            log4j.debug("********FIND***************  strShowClosing: "
                    + strShowClosing);
            log4j.debug("********FIND***************  strShowReg: "
                    + strShowReg);
            log4j.debug("********FIND***************  strShowOpening: "
                    + strShowOpening);
            log4j.debug("********FIND***************  strShowClosing1: "
                    + strShowClosing1);
            log4j.debug("********FIND***************  strShowReg1: "
                    + strShowReg1);
            log4j.debug("********FIND***************  strShowOpening1: "
                    + strShowOpening1);
            vars.setSessionValue("ReportGeneralLedgerJournal.initRecordNumber",
                    "0");
            setHistoryCommand(request, "DEFAULT");
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strDocument, strOrg, "", "", "", strcAcctSchemaId,
                    strShowClosing, strShowReg, strShowOpening);
            ...
            if (strInitRecord.equals("") || strInitRecord.equals("0"))
                ...
                strInitRecord = ((initRecord < 0) ? "0" : Integer
                        .toString(initRecord));
                vars.setSessionValue(
                        "ReportGeneralLedgerJournal.initRecordNumber",
                        strInitRecord);
            }
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strDocument, String strOrg, String strTable,
            String strRecord, String strFactAcctGroupId,
        ...
        if (vars.commandIn("DEFAULT", "FIND")) {
            String strCheck = buildCheck(strShowClosing, strShowReg,
                    strShowOpening);
            String strTreeOrg = ReportGeneralLedgerJournalData.treeOrg(this,
                    vars.getClient());
            String strOrgFamily = getFamily(strTreeOrg, strOrg);
            if (strRecord.equals("")) {
                data = ReportGeneralLedgerJournalData.select(this, Utility
                        .getContext(this, vars, "#User_Client",
                                "ReportGeneralLedger"), Utility.getContext(
                        this, vars, "#User_Org", "ReportGeneralLedger"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), strDocument, strcAcctSchemaId,
                        strOrgFamily, strCheck, initRecordNumber,
                        intRecordRange);
                if (data != null && data.length > 0)
                    strPosition = ReportGeneralLedgerJournalData.selectCount(
                            this, Utility.getContext(this, vars,
                                    "#User_Client", "ReportGeneralLedger"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportGeneralLedger"), strDateFrom,
                            DateTimeData.nDaysAfter(this, strDateTo, "1"),
                            strDocument, strcAcctSchemaId, strOrgFamily,
                            strCheck, data[0].dateacct, data[0].identifier);
            } else {
                ...
                if (data != null && data.length > 0)
                    strPosition = ReportGeneralLedgerJournalData
                            .selectCountDirect(this, Utility
                                    .getContext(this, vars, "#User_Client",
                                            "ReportGeneralLedger"), Utility
                                    .getContext(this, vars, "#User_Org",
                                            "ReportGeneralLedger"), strTable,
                                    strRecord, data[0].dateacct,
                                    data[0].identifier);
            }
        } else if (vars.commandIn("DIRECT")) {
            data = ReportGeneralLedgerJournalData.selectDirect(this, Utility
                    .getContext(this, vars, "#User_Client",
                            "ReportGeneralLedger"), Utility.getContext(this,
                    vars, "#User_Org", "ReportGeneralLedger"), strTable,
                    strRecord, initRecordNumber, intRecordRange);
            if (data != null && data.length > 0)
                strPosition = ReportGeneralLedgerJournalData.selectCountDirect(
            ...
            data = ReportGeneralLedgerJournalData.selectDirect2(this, Utility
                    .getContext(this, vars, "#User_Client",
                            "ReportGeneralLedger"), Utility.getContext(this,
                    vars, "#User_Org", "ReportGeneralLedger"),
                    strFactAcctGroupId, initRecordNumber, intRecordRange);
            if (data != null && data.length > 0)
                strPosition = ReportGeneralLedgerJournalData
                        .selectCountDirect2(this, Utility.getContext(this,
                                vars, "#User_Client", "ReportGeneralLedger"),
                                Utility.getContext(this, vars, "#User_Org",
                                        "ReportGeneralLedger"),
                                strFactAcctGroupId, data[0].dateacct,
                                data[0].identifier);
        }
        if (data == null || data.length == 0) {
            ...
            /*
             * String[] discard = {"withoutPrevious", "withoutNext"}; if
             * (data==null || data.length==0 || initRecordNumber<=1) discard[0]
             * = new String("hasPrevious"); if (data==null || data.length==0 ||
             * data.length<intRecordRange) discard[1] = new String("hasNext");
            ...
            xmlDocument.setParameter("jsDisablePreviousNext",
                    jsDisablePreviousNext);
        }
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "", "C_DocType DocBaseType", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportGeneralLedgerJournal"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportGeneralLedgerJournal"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportGeneralLedgerJournal", strDocument);
            xmlDocument.setData("reportDocument", "liststructure",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportGeneralLedgerJournal.html", classInfo.id,
        ...
        xmlDocument.setParameter("showClosing", strShowClosing.equals("") ? "0"
                : "1");
        xmlDocument.setParameter("showReg", strShowReg.equals("") ? "0" : "1");
        xmlDocument.setParameter("showOpening", strShowOpening.equals("") ? "0"
                : "1");
    ...
    void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
            String strDateFrom, String strDateTo, String strDocument,
            String strOrg, String strTable, String strRecord,
            String strFactAcctGroupId, String strcAcctSchemaId,
            String strShowClosing, String strShowReg, String strShowOpening)
            throws IOException, ServletException {

        ReportGeneralLedgerJournalData[] data = null;

        String strTreeOrg = ReportGeneralLedgerJournalData.treeOrg(this, vars
                .getClient());
        String strOrgFamily = getFamily(strTreeOrg, strOrg);
        ...
        if (strRecord.equals("")) {
            ...
            data = ReportGeneralLedgerJournalData.select(this, Utility
                    .getContext(this, vars, "#User_Client",
                            "ReportGeneralLedger"), Utility.getContext(this,
                    vars, "#User_Org", "ReportGeneralLedger"), strDateFrom,
        ...
        String strSubtitle = Utility.messageBD(this, "CompanyName", vars
                .getLanguage())
                + ": "
        ...
        if (strDateFrom.equals("") && strDateTo.equals(""))
            strSubtitle += " - "
                    + Utility.messageBD(this, "Period", vars.getLanguage())
    ...
    public String getFamily(String strTree, String strChild)
            throws IOException, ServletException {
        return Tree.getMembers(this, strTree, (strChild == null || strChild
                .equals("")) ? "0" : strChild);
        /*
    ...
    public String buildCheck(String strShowClosing, String strShowReg,
            String strShowOpening) {
        if (strShowClosing.equals("") && strShowReg.equals("")
                && strShowOpening.equals(""))
            return "'C','N','O','R'";
        String[] strElements = { strShowClosing.equals("") ? "" : "'C'",
                strShowReg.equals("") ? "" : "'R'",
                strShowOpening.equals("") ? "" : "'O'" };
        int no = 0;
        String strCheck = "";
