...
public class ReportCashJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "ReportCashJR|DateFrom", "");
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "ReportCashJR|DateTo", "");
            String strCashbook = vars.getGlobalVariable("inpcCashbookId",
                    "ReportCashJR|Cashbook", "");
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportCashJR|DateTo");
            String strCashbook = vars.getRequestGlobalVariable(
                    "inpcCashbookId", "ReportCashJR|Cashbook");
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            data = ReportCashJRData
                    .select(this, vars.getLanguage(), Utility.getContext(this,
                            vars, "#User_Client", "ReportCashJR"),
            ...
            parameters.put("USER_CLIENT", Utility.getContext(this, vars,
                    "#User_Client", "ReportBankJR"));
            renderJR(vars, response, strReportPath, "html", parameters, data,
                    null);
        }
         ...
         * "ReportCashJR"), Utility.getContext(this, vars, "#User_Org",
         * "ReportCashJR"), strDateFrom, DateTimeData.nDaysAfter(this,
         * strDateTo,"1"), strCashbook); xmlDocument.setParameter("sumAmount",
         * ReportCashJRData.BeginningBalance(this, Utility.getContext(this,
         * vars, "#User_Client", "ReportCashJR"), Utility.getContext(this, vars,
         * "#User_Org", "ReportCashJR"), strDateFrom, strCashbook));
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strCashbook) throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: dataSheet");
        response.setContentType("text/html; charset=UTF-8");
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportCashJR",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportCashJR.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportCashJR.html", strReplaceWith);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_CashBook_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "ReportCashJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportCashJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportCashJR", strCashbook);
            xmlDocument.setData("reportC_CASHBOOK", "liststructure",
