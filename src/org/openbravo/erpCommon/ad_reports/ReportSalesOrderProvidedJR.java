...
public class ReportSalesOrderProvidedJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strmWarehouseId = vars.getStringParameter("inpmWarehouseId");
            String strcProjectId = vars.getStringParameter("inpcProjectId");
            String strmCategoryId = vars
                    .getStringParameter("inpProductCategory");
            String strProjectkind = vars.getStringParameter("inpProjectkind");
            String strcRegionId = vars.getStringParameter("inpcRegionId");
            String strProjectpublic = vars
                    .getStringParameter("inpProjectpublic");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportSalesOrderProvidedJR", false, "", "", "", false,
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportSalesOrderProvidedJR.html", classInfo.id,
            ...
            }
            {
                OBError myMessage = vars
                        .getMessage("ReportSalesOrderProvidedJR");
            ...
            xmlDocument.setParameter("paramBPartnerDescription",
                    ReportSalesOrderProvidedData.bPartnerDescription(this,
                            strcBpartnerId));
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "M_Warehouse_ID", "", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportSalesOrderProvidedJR"), Utility
            ...
            try {
                ...
                xmlDocument.setData("reportM_PRODUCT_CATEGORYID",
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_Public_ID", "PublicPrivate", "",
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportSalesOrderProvidedJR"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportSalesOrderProvidedJR"), 0);
            ...
            SubCategoryProductData[] dataSub = SubCategoryProductData.select(
                    this, Utility.getContext(this, vars, "#User_Org",
                            "ReportSalesOrderProvidedJR"), Utility.getContext(
                            this, vars, "#User_Client",
                            "ReportSalesOrderProvidedJR"));
            xmlDocument.setParameter("product", arrayDobleEntrada("array",
                    SubCategoryProductData.selectProduct(this, Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportSalesOrderProvidedJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportSalesOrderProvidedJR"))));
            ...
            if (dataSub != null && dataSub.length != 0) {
                ...
                xmlDocument.setData("structureProduct", SubCategoryProductData
                        .selectCategoryProduct(this, dataSub[0].id));
            }
        } else {
            ReportSalesOrderProvidedData[] data = ReportSalesOrderProvidedData
                    .select(this, strCurrencyId, Utility.getContext(this, vars,
                            "#User_Client", "ReportSalesOrderProvided"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportSalesOrderProvided"), strdateFrom,
            ...
            if (data == null || data.length == 0) {
                xmlDocument = xmlEngine
                        .readXmlTemplate(
                                "org/openbravo/erpCommon/ad_reports/ReportSalesOrderProvidedPop",
                                discard).createXmlDocument();
                xmlDocument.setData("structure1", ReportSalesOrderProvidedData
                        .set());
            } else {
                xmlDocument = xmlEngine
                        .readXmlTemplate(
            ...
            if (!strmWarehouseId.equals(""))
                strTitle += " "
                        + Utility.messageBD(this, "ForWarehouse", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectWarehouse(this,
                                strmWarehouseId);
            if (!strcRegionId.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "InRegion", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectRegionId(this,
                                strcRegionId);
            if (!strmCategoryId.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ForProductCategory", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectCategoryId(this,
                                strmCategoryId);
            if (!strProjectkind.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ProjectType", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectProjectkind(this,
                                vars.getLanguage(), strProjectkind);
            if (!strProjectpublic.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "WithInitiativeType", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectProjectpublic(
                                this, vars.getLanguage(), strProjectpublic);
            ...
            if (!strProduct.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ForProduct", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderProvidedData.selectProduct(this,
                                strProduct);
        ...
        try {
            data = ReportSalesOrderProvidedData.select(this, strCurrencyId,
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportSalesOrderProvided"), Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportSalesOrderProvided"), strdateFrom,
                    DateTimeData.nDaysAfter(this, strdateTo, "1"),
                    strcBpartnerId, strmWarehouseId, strcProjectId,
        ...
        if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
            ...
            if (strOutput.equals("pdf"))
                response.setHeader("Content-disposition",
                        "inline; filename=ReportSalesOrderProvided.pdf");
