...
public class ReportRefundInvoiceCustomerDimensionalAnalyses extends
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    ...
                    strOrder, strMayor, strMenor, strRatioMayor, strRatioMenor);
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportRefundInvoiceCustomerDimensionalAnalyses|dateTo");
            String strDateFromRef = vars
                    .getRequestGlobalVariable("inpDateFromRef",
                            "ReportRefundInvoiceCustomerDimensionalAnalyses|dateFromRef");
            String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef",
                    "ReportRefundInvoiceCustomerDimensionalAnalyses|dateToRef");
            String strPartnerGroup = vars
                    .getRequestGlobalVariable("inpPartnerGroup",
                            "ReportRefundInvoiceCustomerDimensionalAnalyses|partnerGroup");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strRatioMayor, String strRatioMenor) throws IOException,
            ServletException {
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "SalesRep_ID", "AD_User SalesRep", "",
                    Utility.getContext(this, vars, "#User_Org",
                            "ReportRefundInvoiceCustomerDimensionalAnalyses"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportRefundInvoiceCustomerDimensionalAnalyses"),
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (strComparative.equals("Y")) {
            data = ReportRefundInvoiceCustomerDimensionalAnalysesData.select(
                    this, strTextShow[0], strTextShow[1], strTextShow[2],
                    strTextShow[3], strTextShow[4], strTextShow[5], Tree
                    ...
                    strmProductId, strsalesrepId, strDateFromRef, DateTimeData
        ...
        if (data.length == 0 || data == null) {
            ...
            if (strComparative.equals("Y")) {
                for (int j = contador; j > 0; j--) {
                    ...
                    discard1[k + 10] = "fieldTotalRefundQtyNivel"
                            + String.valueOf(j);
                    discard1[k + 20] = "fieldUomsymbol" + String.valueOf(j);
                    discard1[k + 5] = "fieldTotalRefQtyNivel"
                            + String.valueOf(j);
                    discard1[k + 15] = "fieldTotalRefRefundQtyNivel"
                            + String.valueOf(j);
                    k++;
                }
            } else {
