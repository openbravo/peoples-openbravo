...
public class ReportToInvoiceConsignmentJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strWarehouse = vars
                    .getRequestGlobalVariable("inpmWarehouseId",
                            "ReportToInvoiceConsignmentJR|Warehouse");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportToInvoiceConsignmentJR|currency", strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportToInvoiceConsignmentJR", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportToInvoiceConsignmentJR.html", classInfo.id,
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Currency_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportToInvoiceConsignmentJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportToInvoiceConsignmentJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportToInvoiceConsignmentJR", strCurrencyId);
