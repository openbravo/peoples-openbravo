    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "ReportNotPosted|DateFrom", "");
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "ReportNotPosted|DateTo", "");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportNotPosted")
                    .createXmlDocument();
            data = ReportNotPostedData.select(this, vars.getLanguage(),
                    strDateFrom, strDateTo, vars.getClient());
        }// DateTimeData.nDaysAfter

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportNotPosted", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportNotPosted.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportNotPosted.html", strReplaceWith);
