...
public class ReportValuationStock extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "RELATION")) {
            String strDate = vars.getGlobalVariable("inpDate",
                    "ReportValuationStock|Date", DateTimeData.today(this));
            String strWarehouse = vars.getGlobalVariable("inpmWarehouseId",
                    "ReportValuationStock|Warehouse", "");
            String strCategoryProduct = vars.getGlobalVariable(
                    "inpCategoryProduct",
                    "ReportValuationStock|CategoryProduct", "");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId", "",
                    strUserCurrencyId);
            printPageDataSheet(response, vars, strDate, strWarehouse,
                    strCategoryProduct, strCurrencyId);
        } else if (vars.commandIn("FIND")) {
            String strDate = vars.getGlobalVariable("inpDate",
                    "ReportValuationStock|Date", DateTimeData.today(this));
            String strWarehouse = vars.getRequestGlobalVariable(
                    "inpmWarehouseId", "ReportValuationStock|Warehouse");
            String strCategoryProduct = vars.getRequestGlobalVariable(
                    "inpCategoryProduct",
                    "ReportValuationStock|CategoryProduct");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strDate, String strWarehouse,
            String strCategoryProduct, String strCurrencyId)
            throws IOException, ServletException {
        ...
        try {
            data = ReportValuationStockData.select(this, vars.getLanguage(),
                    strDate, strBaseCurrencyId, strCurrencyId, DateTimeData
                            .nDaysAfter(this, strDate, "1"), strWarehouse,
                    strCategoryProduct);
        ...
        if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportValuationStock", false, "", "", "", false,
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportValuationStock.html", classInfo.id,
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "C_Currency_ID", "", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportValuationStock"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportValuationStock"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportValuationStock", strCurrencyId);
