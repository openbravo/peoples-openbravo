...
public class ReportValuationStock extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "RELATION")) {      
      ...
      printPageDataSheet(response, vars, strDate, strWarehouse, strCategoryProduct, strCurrencyId);
      ...
      String strCurrencyId = vars.getGlobalVariable("inpCurrencyId", "ReportValuationStock|currency", strUserCurrencyId);
      printPageDataSheet(response, vars, strDate, strWarehouse, strCategoryProduct, strCurrencyId);
    } else pageError(response);
  }

  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDate,  String strWarehouse, String strCategoryProduct, String strCurrencyId)
    ...
    try {
      data = ReportValuationStockData.select(this, vars.getLanguage(), strDate, strBaseCurrencyId, strCurrencyId, DateTimeData.nDaysAfter(this, strDate,"1"), strWarehouse, strCategoryProduct);
    ...
    if(!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Currency_ID", "", "", Utility.getContext(this, vars, "#User_Org", "ReportValuationStock"), Utility.getContext(this, vars, "#User_Client", "ReportValuationStock"), 0);
        Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportValuationStock", strCurrencyId);
