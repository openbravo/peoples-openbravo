...
public class ReportInvoiceVendorDimensionalAnalysesJR extends HttpSecureAppServlet {
  ...
  private void printPageHtml(HttpServletRequest request, HttpServletResponse response,
    ...
    if ("xls".equals(strOutput)) {
      try {
        data = ReportInvoiceVendorDimensionalAnalysesJRData.selectXLS(this, strCurrencyId, Tree
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      if ("xls".equals(strOutput)) {
        ...
        XmlDocument xmlDocument = null;
        xmlDocument = xmlEngine.readXmlTemplate(
            "org/openbravo/erpCommon/ad_reports/ReportInvoiceVendorDimensionalAnalysesXLS")
            .createXmlDocument();
        xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
        xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
