...
public class ReportInvoiceVendorDimensionalAnalysesJR extends
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strNotShown = vars.getInGlobalVariable("inpNotShown",
                    "ReportInvoiceVendorDimensionalAnalysesJR|notShown", "");
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    ...
                    strMenor, strProducttype, strCurrencyId);
            ...
            printPageHtml(request, response, vars, strComparative, strDateFrom,
                    ...
                    strProductCategory, strmProductId, strNotShown, strShown,
                    strDateFromRef, strDateToRef, strOrg, strOrder, strMayor,
                    strMenor, strProducttype, strCurrencyId, "html");
            ...
            printPageHtml(request, response, vars, strComparative, strDateFrom,
                    ...
                    strProductCategory, strmProductId, strNotShown, strShown,
                    strDateFromRef, strDateToRef, strOrg, strOrder, strMayor,
                    strMenor, strProducttype, strCurrencyId, "pdf");
        } else
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strMayor, String strMenor, String strProducttype,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceVendorDimensionalAnalysesFilterJR", false, "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceVendorDimensionalAnalysesFilterJR.html",
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportInvoiceVendorDimensionalAnalysesJR");
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportInvoiceVendorDimensionalAnalysesJRData.selectBpartner(
                        this, Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportInvoiceVendorDimensionalAnalysesJRData.selectMproduct(
                        this, Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceVendorDimensionalAnalysesJRData"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceVendorDimensionalAnalysesJRData", "");
    ...
    void printPageHtml(HttpServletRequest request,
        ...
        if (vars.getLanguage().equals("en_US")) {
            dimensionLabel = ReportInvoiceVendorDimensionalAnalysesJRData
                    .selectNotShown(this, "");
        } else {
            dimensionLabel = ReportInvoiceVendorDimensionalAnalysesJRData
                    .selectNotShownTrl(this, vars.getLanguage(), "");
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportInvoiceVendorDimensionalAnalysesJRData.select(
