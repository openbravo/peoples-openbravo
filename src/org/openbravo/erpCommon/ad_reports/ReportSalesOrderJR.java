...
public class ReportSalesOrderJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strProjectpublic = vars.getGlobalVariable(
                    "inpProjectpublic", "ReportSalesOrderJR|projectpublic", "");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportSalesOrderJR|currency", strUserCurrencyId);
            printPageDataSheet(response, vars, strdateFrom, strdateTo,
                    strmWarehouseId, strcProjectId, strProjectpublic,
                    strCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportSalesOrderFilterJR")
                .createXmlDocument();
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportSalesOrderFilterJR.html", classInfo.id,
        ...
        xmlDocument.setParameter("projectName", OrderEditionData.selectProject(
                this, strcProjectId));
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_Warehouse_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "SalesOrderFilterJR"),
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "C_Projectkind_ID", "Projectkind", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "SalesOrderFilterJR"), Utility.getContext(
                            this, vars, "#User_Client", "SalesOrderFilterJR"),
                    0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "SalesOrderFilterJR", "");
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Org",
                            "SalesOrderFilterJR"), Utility.getContext(this,
                            vars, "#User_Client", "SalesOrderFilterJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "SalesOrderFilterJR", "");
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "C_Projectkind_ID", "PublicPrivate", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "SalesOrderFilterJR"), Utility.getContext(
                            this, vars, "#User_Client", "SalesOrderFilterJR"),
                    0);
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "SalesOrderFilterJR", strCurrencyId);
        ...
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportProjectBuildingSiteData.selectMproduct(this, Utility
                        .getContext(this, vars, "#User_Org", ""), Utility
                        .getContext(this, vars, "#User_Client", ""), ""));
    ...
    void printPageHtml(HttpServletRequest request,
            ...
            String strdateFrom, String strdateTo, String strmWarehouseId,
            String strcProjectId, String strProjectpublic, String strcRegionId,
            String strmProductCategoryId, String strProjectkind,
        ...
        try {
            data = OrderEditionData.select(this, strCurrencyId, Utility
                    .getContext(this, vars, "#User_Org", "SalesOrderFilterJR"),
                    Utility.getContext(this, vars, "#User_Client",
                            "SalesOrderFilterJR"), strdateFrom, strdateTo,
                    strmWarehouseId, strcProjectId, strProjectpublic,
                    strcRegionId, strmProductCategoryId, strProjectkind,
