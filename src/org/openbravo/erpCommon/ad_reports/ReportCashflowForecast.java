...
public class ReportCashflowForecast extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strBankAccount = vars.getRequestGlobalVariable(
                    "inpcBankAccountId", "ReportCashflowForecast|AcctNo");
            ...
            printPageDataSheet(response, vars, strBankAccount, strDateFrom,
                    strBreakDate, true);
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strBankAccount, String strDateMax,
            String strBreakDate, boolean showDefault) throws IOException,
            ServletException {
        String[] discard = { "", "" };
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportCashflowForecast", false, "", "", "", false,
        ...
        // "#User_Org", "ReportBank"));
        ReportCashflowForecastData[] dataSummary = ReportCashflowForecastData
                .select(this, strDateMax, "", Utility.getContext(this, vars,
                        "#User_Client", "ReportBank"), Utility.getContext(this,
        ...
        if (!showDefault) {
            ...
            // strBankAccount);
            dataAcct = ReportCashflowForecastData.select(this, strDateMax,
                    strBankAccount, Utility.getContext(this, vars,
                            "#User_Client", "ReportBank"), Utility.getContext(
                            this, vars, "#User_Org", "ReportBank"));
            data = new ReportCashflowForecastData[dataAcct.length][];

            if (log4j.isDebugEnabled())
                log4j.debug("length: " + dataAcct.length + " - bankaccount:"
                        + strBankAccount);
            if (dataAcct.length == 0) {
                ...
                for (int i = 0; i < dataAcct.length; i++) {
                    if (strBreakDate.equals(""))
                        dataDetail = ReportCashflowForecastData.selectLines(
                                this, vars.getSqlDateFormat(), vars
                                        .getLanguage(),
                                dataAcct[i].cBankaccountId, strDateMax,
                                "2 DESC, 1");
                    else
                        dataDetail = ReportCashflowForecastData.selectLines(
                                this, vars.getSqlDateFormat(), vars
                                ...
                                "1,2 DESC");
                    if (log4j.isDebugEnabled())
                        log4j.debug("length: " + dataAcct.length + " bankacct:"
                                + dataAcct[i].cBankaccountId + " lenght:"
                                + dataDetail.length);
                    data[i] = dataDetail;
                }
            }
            ...
            if (strBreakDate.equals(""))
                xmlDocument
                        .setDataArray("reportAcct", "structureAccount", data);
            else
                xmlDocument.setDataArray("reportAcctDate", "structureAccount",
                        data);
        } else
            xmlDocument = xmlEngine
                    .readXmlTemplate(
        ...
        xmlDocument.setData("reportC_ACCOUNTNUMBER", "liststructure",
                AccountNumberComboData.select(this, Utility.getContext(this,
                        vars, "#User_Client", "ReportCashflowForecast"),
        ...
        xmlDocument.setParameter("date", ReportCashflowForecastData.getDate(
                this, vars.getSqlDateFormat()));
        xmlDocument.setParameter("date1", ReportCashflowForecastData.getDate(
                this, vars.getSqlDateFormat()));
        xmlDocument.setParameter("breakDate", strBreakDate.equals("") ? "0"
                : "1");
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportCashflowForecast.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportCashflowForecast.html", strReplaceWith);
