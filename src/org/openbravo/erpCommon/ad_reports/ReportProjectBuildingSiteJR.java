    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strcProjectId = vars.getRequestGlobalVariable(
                    "inpcProjectId", "ReportProjectBuildingSiteJR|cProjectId");
            ...
            String strmCategoryId = vars.getRequestInGlobalVariable(
                    "inpmProductCategoryId",
                    "ReportProjectBuildingSiteJR|mCategoryId");
            String strProjectkind = vars
                    .getRequestInGlobalVariable("inpProjectkind",
                            "ReportProjectBuildingSiteJR|Projectkind");
            ...
            String strcRegionId = vars.getRequestInGlobalVariable(
                    "inpcRegionId", "ReportProjectBuildingSiteJR|cRegionId");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportProjectBuildingSiteJR|currency", strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportProjectBuildingSiteJR", false, "", "", "", false,
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportProjectBuildingSiteJR.html", classInfo.id,
            ...
            }
            {
                OBError myMessage = vars
                        .getMessage("ReportProjectBuildingSiteJR");
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_kind", "Projectkind", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportProjectBuildingSiteJR"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSiteJR"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSiteJR", strProjectkind);
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_phase", "Projectphase", "", Utility
                                ...
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSiteJR"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSiteJR", strProjectphase);
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        ...
                        Utility.getContext(this, vars, "#User_Org",
                                ...
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSiteJR"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSiteJR", strProjectstatus);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_publicprivate", "PublicPrivate", "",
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportProjectBuildingSiteJR"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSiteJR"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSiteJR", strProjectpublic);
            ...
            xmlDocument.setData("reportC_PRODUCTCATREGORY", "liststructure",
                    SubCategoryProductData.select(this, Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportProjectBuildingSiteJR"), Utility.getContext(
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "C_Currency_ID", "", "", Utility
                                ...
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSiteJR"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSiteJR", strCurrencyId);
            ...
            ReportProjectBuildingSiteData[] data = ReportProjectBuildingSiteData
                    .select(this, strCurrencyId, Utility.getContext(this, vars,
                            "#User_Client", "ReportProjectBuildingSiteJR"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportProjectBuildingSiteJR"),
                            strdateFrom, DateTimeData.nDaysAfter(this,
                                    strdateTo, "1"), strcBpartnerId,
                            strcProjectId, strmCategoryId, strProjectkind,
                            strProjectphase, strProjectstatus,
        ...
        try {
            data = ReportProjectBuildingSiteData.select(this, strCurrencyId,
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportProjectBuildingSiteJR"), Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportProjectBuildingSiteJR"), strdateFrom,
