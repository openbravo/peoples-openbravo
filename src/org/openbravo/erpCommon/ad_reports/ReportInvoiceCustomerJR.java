...
public class ReportInvoiceCustomerJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strProjectphase = vars.getInGlobalVariable(
                    "inpProjectphase", "ReportInvoiceCustomerJR|Projectphase",
                    "");
            ...
            String strcProjectId = vars.getRequestGlobalVariable(
                    "inpcProjectId", "ReportInvoiceCustomerJR|cProjectId");
            ...
            String strProjectkind = vars.getRequestInGlobalVariable(
                    "inpProjectkind", "ReportInvoiceCustomerJR|Projectkind");
            String strProjectstatus = vars
                    .getRequestInGlobalVariable("inpProjectstatus",
                            "ReportInvoiceCustomerJR|Projectstatus");
            String strProjectphase = vars.getRequestInGlobalVariable(
                    "inpProjectphase", "ReportInvoiceCustomerJR|Projectphase");
            String strProduct = vars
                    .getRequestInGlobalVariable("inpmProductId_IN",
                            "ReportInvoiceCustomerJR|mProductId_IN");
            String strProjectpublic = vars
                    .getRequestGlobalVariable("inpProjectpublic",
                            "ReportInvoiceCustomerJR|Projectpublic");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strSalesRep, String strcRegionId, String strCurrencyId)
            throws IOException, ServletException {
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportInvoiceCustomerFilterJR")
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceCustomerFilterJR", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceCustomerFilterJR.html", classInfo.id,
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "Projectkind", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportInvoiceCustomerJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strProjectkind);
            ...
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "Projectphase", "", Utility.getContext(this, vars,
                            ...
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strProjectphase);
            ...
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "ProjectStatus", "", Utility.getContext(this, vars,
                            ...
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strProjectstatus);
            ...
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "PublicPrivate", "", Utility.getContext(this, vars,
                            ...
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strProjectpublic);
        ...
        xmlDocument.setData("reportC_PRODUCTCATREGORY", "liststructure",
                SubCategoryProductData.select(this, Utility.getContext(this,
                        vars, "#User_Org", "ReportInvoiceCustomerJR"), Utility
                        .getContext(this, vars, "#User_Client",
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this,
                    ...
                    Utility.getContext(this, vars, "#User_Org",
                            "ReportInvoiceCustomerJR"), Utility.getContext(
                            this, vars, "#User_Client",
                            "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strcRegionId);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "TABLE",
                    "", "190", "AD_User SalesRep", Utility.getContext(this,
                            vars, "#User_Org", "ReportInvoiceCustomerJR"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strSalesRep);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Org",
                            ...
                            "ReportInvoiceCustomerJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerJR", strCurrencyId);
    ...
    void printPageHtml(HttpServletRequest request,
        ...
        try {
            data = InvoiceCustomerEditionData.select(this, strCurrencyId,
                    Utility.getContext(this, vars, "#User_Org",
                            "InvoiceCustomerFilter"), Utility.getContext(this,
                            vars, "#User_Client", "InvoiceCustomerFilter"),
                    strdateFrom, strdateTo, strcBpartnerId, strcProjectId,
                    strmCategoryId, strProjectkind, strProjectphase,
                    strProjectstatus, strProjectpublic, strcRegionId,
