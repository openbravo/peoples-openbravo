...
public class ReportInvoicesJR extends HttpSecureAppServlet {
    ...
    void printPageDataHtml(HttpServletResponse response,
        ...
        if (strOutput.equals("html"))
            response.setHeader("Content-disposition",
                    "inline; filename=ReportInvoicesEdit.html");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoicesJR", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoicesJR.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportInvoicesJR.html", strReplaceWith);
