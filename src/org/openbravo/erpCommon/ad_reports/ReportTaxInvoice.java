...
public class ReportTaxInvoice extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strDateFrom = vars.getGlobalVariable("inpDateFrom",
                    "ReportTaxInvoice|DateFrom", "");
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "ReportTaxInvoice|DateTo", "");
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportTaxInvoice|Org", "0");
            ...
            String strDetail = vars.getStringParameter("inpDetalle");
            String strSales = vars.getStringParameter("inpSales");
            printPageDataExcel(response, vars, strDateFrom, strDateTo, strOrg,
                    strDetail, strSales);
        } else
            pageError(response);
    }
    ...
    void printPageDataHtml(HttpServletResponse response,
            ...
            String strOrg, String strDetail, String strSales)
            throws IOException, ServletException {
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("****** strSales: " + strSales + " fecha desde: "
                    + strDateFrom + " fecha hasta: " + strDateTo + " detalle: "
                    + strDetail);
        /*
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")
            ...
            if (strSales.equals("S")) {
                dataSale = ReportTaxInvoiceData.select(this, Utility
                        .getContext(this, vars, "C_Country_Id",
                                "ReportTaxInvoice"), Utility.getContext(this,
                        vars, "#User_Client", "ReportTaxInvoice"), strDateFrom,
                        DateTimeData.nDaysAfter(this, strDateTo, "1"), "Y",
                        Tree.getMembers(this, TreeData.getTreeOrg(this, vars
                                .getClient()), strOrg));
                data2Sale = ReportTaxInvoiceData.selectForeign(this, Utility
                        .getContext(this, vars, "C_Country_Id",
                                "ReportTaxInvoice"), Utility.getContext(this,
                        vars, "#User_Client", "ReportTaxInvoice"), strDateFrom,
                        DateTimeData.nDaysAfter(this, strDateTo, "1"), "Y",
                ...
                dataPurchase = ReportTaxInvoiceData.select(this, Utility
                        .getContext(this, vars, "C_Country_Id",
                                "ReportTaxInvoice"), Utility.getContext(this,
                        vars, "#User_Client", "ReportTaxInvoice"), strDateFrom,
                        DateTimeData.nDaysAfter(this, strDateTo, "1"), "N",
                        Tree.getMembers(this, TreeData.getTreeOrg(this, vars
                                .getClient()), strOrg));
                data2Purchase = ReportTaxInvoiceData.selectForeign(this,
                        Utility.getContext(this, vars, "C_Country_Id",
                                "ReportTaxInvoice"), Utility.getContext(this,
                                vars, "#User_Client", "ReportTaxInvoice"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), "N", Tree.getMembers(this, TreeData
                                .getTreeOrg(this, vars.getClient()), strOrg));
                strPurchase = Utility.messageBD(this, "Purchase", vars
                        .getLanguage());
            } else {
                dataSale = ReportTaxInvoiceData.select(this, Utility
                        .getContext(this, vars, "C_Country_Id",
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("****** strSale: " + strSale + " strPurchase: "
                    + strPurchase);
        if (log4j.isDebugEnabled())
        ...
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportTaxInvoiceEdit",
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("****** xmlDocument");
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportTaxInvoice", discard)
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportTaxInvoice", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportTaxInvoice.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportTaxInvoice.html", strReplaceWith);
         ...
         * Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"));
         * xmlDocument
         * .setData("reportAD_ORGID","liststructure",AdOrgTreeComboData
         * .select(this, strTreeNode, vars.getOrg()));
         */
     ...
     * vars, String strDateFrom, String strDateTo, String strOrg, String
     * strDetail, String strSales) throws IOException, ServletException { if
     * (log4j.isDebugEnabled()) log4j.debug("Output: dataSheet");
     * response.setContentType("text/html; charset=UTF-8"); PrintWriter out =
     * response.getWriter(); XmlDocument xmlDocument=null;
     * ReportTaxInvoiceData[] dataSale=null; ReportTaxInvoiceData[]
     * data2Sale=null; ReportTaxInvoiceData[] dataPurchase=null;
     * ReportTaxInvoiceData[] data2Purchase=null; String strSalesAux; String
     * strTitle = "FACTURAS CON EL EXTRANJERO"; String strSale = ""; String
     * strPurchase = ""; String discard[] = {"discard", "discard", "discard",
     * "discard"}; if (log4j.isDebugEnabled()) log4j.debug("****** strSales: " +
     * strSales + " fecha desde: " + strDateFrom + " fecha hasta: " + strDateTo
     * + " detalle: " + strDetail);
     * 
     * if (strDateFrom.equals("") && strDateTo.equals("") &&
     * strDetail.equals("-1")) { if (log4j.isDebugEnabled())
     * log4j.debug("****** all null"); discard[0] = "sectionTaxSale"; discard[1]
     * = "sectionTaxForeignSale"; discard[2] = "sectionTaxPurchase"; discard[3]
     * = "sectionTaxForeignPurchase"; strTitle = ""; dataSale =
     * ReportTaxInvoiceData.set(); data2Sale = ReportTaxInvoiceData.set();
     * dataPurchase = ReportTaxInvoiceData.set(); data2Purchase =
     * ReportTaxInvoiceData.set(); } else if (!strDetail.equals("-1")){ if
     * (log4j.isDebugEnabled()) log4j.debug("****** not datailed"); discard[0] =
     * "selEliminarSale"; discard[1] = "selEliminar1Sale"; discard[2] =
     * "selEliminarPurchase"; discard[3] = "selEliminar1Purchase"; if
     ...
     * strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y",
     * Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()),
     * strOrg)); strSale = Utility.messageBD(this, "Sale", vars.getLanguage());
     * } else if (strSales.equals("P")) { dataPurchase =
     * ReportTaxInvoiceData.select(this, Utility.getContext(this, vars,
     * "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars,
     * "#User_Client", "ReportTaxInvoice"), strDateFrom,
     * DateTimeData.nDaysAfter(this, strDateTo,"1"), "N", Tree.getMembers(this,
     ...
     * Utility.messageBD(this, "Purchase", vars.getLanguage()); } else {
     * dataSale = ReportTaxInvoiceData.select(this, Utility.getContext(this,
     * vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars,
     * "#User_Client", "ReportTaxInvoice"), strDateFrom,
     * DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this,
     * TreeData.getTreeOrg(this, vars.getClient()), strOrg)); data2Sale =
     * ReportTaxInvoiceData.selectForeign(this, Utility.getContext(this, vars,
     * "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars,
     * "#User_Client", "ReportTaxInvoice"), strDateFrom,
     * DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this,
     * TreeData.getTreeOrg(this, vars.getClient()), strOrg)); dataPurchase =
     * ReportTaxInvoiceData.select(this, Utility.getContext(this, vars,
     * "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars,
     * "#User_Client", "ReportTaxInvoice"), strDateFrom,
     * DateTimeData.nDaysAfter(this, strDateTo,"1"), "N", Tree.getMembers(this,
     ...
     * Utility.messageBD(this, "Sale", vars.getLanguage()); strPurchase =
     * Utility.messageBD(this, "Purchase", vars.getLanguage()); } } else { if
     * (log4j.isDebugEnabled()) log4j.debug("****** detailed"); if
     * (strSales.equals("S")) { dataSale = ReportTaxInvoiceData.select(this,
     * Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"),
     * Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"),
     * strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y",
     ...
     * TreeData.getTreeOrg(this, vars.getClient()), strOrg)); strSale =
     * Utility.messageBD(this, "Sale", vars.getLanguage()); strPurchase =
     * Utility.messageBD(this, "Purchase", vars.getLanguage()); } } if
     * (log4j.isDebugEnabled()) log4j.debug("****** strSale: " + strSale +
     * " strPurchase: " + strPurchase); if (log4j.isDebugEnabled())
     * log4j.debug("****** check nulls"); if (dataSale == null ||
     * dataSale.length == 0){ discard [0] = "sectionTaxSale"; dataSale =
     * ReportTaxInvoiceData.set(); } if (data2Sale == null || data2Sale.length
     * == 0){ discard [1] = "sectionTaxForeignSale"; strTitle = ""; data2Sale =
     * ReportTaxInvoiceData.set(); } if (dataPurchase == null ||
     * dataPurchase.length == 0){ discard [2] = "sectionTaxPurchase";
     * dataPurchase = ReportTaxInvoiceData.set(); } if (data2Purchase == null ||
     * data2Purchase.length == 0){ discard [3] = "sectionTaxForeignPurchase";
     * strTitle = ""; data2Purchase = ReportTaxInvoiceData.set(); } if
     * (log4j.isDebugEnabled()) log4j.debug("****** xmlDocument"); xmlDocument =
     * xmlEngine
     ...
     * ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
     * "ReportTaxInvoice", false, "", "", "",false, "ad_reports",
     * strReplaceWith, false, true);toolbar.prepareSimpleExcelToolBarTemplate(
     ...
     * new NavigationBar(this, vars.getLanguage(), "ReportTaxInvoice.html",
     * classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
     * xmlDocument.setParameter("navigationBar", nav.toString()); LeftTabsBar
     * lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportTaxInvoice.html",
     * strReplaceWith); xmlDocument.setParameter("leftTabs",
     * lBar.manualTemplate()); } catch (Exception ex) { throw new
     ...
     * xmlDocument.setParameter("titlePurchase", strTitle);
     * xmlDocument.setParameter("sale", strSale);
     * xmlDocument.setParameter("purchase", strPurchase); if
     * (log4j.isDebugEnabled()) log4j.debug("****** setData reportAD_ORGID");
     * 
     * xmlDocument.setData("reportAD_ORGID", "liststructure",
     * OrganizationComboData.selectCombo(this, vars.getRole()));
     * 
     ...
     * (log4j.isDebugEnabled()) log4j.debug("****** setData data2Sale");
     ...
     * (log4j.isDebugEnabled()) log4j.debug("****** setData data2Purchase");
     * xmlDocument.setData("structure2Purchase", data2Purchase);
     * out.println(xmlDocument.print()); out.close(); }
     */

    void printPageDataExcel(HttpServletResponse response,
            VariablesSecureApp vars, String strDateFrom, String strDateTo,
            String strOrg, String strDetail, String strSales)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("****** xmlDocument");
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportTaxInvoice_Excel",
                discard).createXmlDocument();
