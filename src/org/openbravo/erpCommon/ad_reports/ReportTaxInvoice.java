...
public class ReportTaxInvoice extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportTaxInvoice|DateFrom");
  ...
  void printPageDataHtml(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strDetail, String strSales)
    ...
    if (strDateFrom.equals("") && strDateTo.equals("") && strDetail.equals("-1")) {
      ...
      if (strSales.equals("S")) {
        dataSale = ReportTaxInvoiceData.select(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
        data2Sale = ReportTaxInvoiceData.selectForeign(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
        strSale = Utility.messageBD(this, "Sale", vars.getLanguage());
      } else if (strSales.equals("P")) {
        dataPurchase = ReportTaxInvoiceData.select(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "N", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
        data2Purchase = ReportTaxInvoiceData.selectForeign(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "N", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
      ...
      if (log4j.isDebugEnabled()) log4j.debug("****** detailed");
      if (strSales.equals("S")) {
        dataSale = ReportTaxInvoiceData.select(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
        data2Sale = ReportTaxInvoiceData.selectForeign(this, Utility.getContext(this, vars, "C_Country_Id", "ReportTaxInvoice"), Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"), "Y", Tree.getMembers(this, TreeData.getTreeOrg(this, vars.getClient()), strOrg));
        strSale = Utility.messageBD(this, "Sale", vars.getLanguage());
    ...
    if (log4j.isDebugEnabled()) log4j.debug("****** strSale: " + strSale + " strPurchase: " + strPurchase);
    if (log4j.isDebugEnabled()) log4j.debug("****** check nulls");
    ...
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportTaxInvoiceEdit", discard).createXmlDocument();
    ...
    if (log4j.isDebugEnabled()) log4j.debug("****** setData data2Sale");
    xmlDocument.setData("structure2Sale", data2Sale);
    if (log4j.isDebugEnabled()) log4j.debug("****** setData dataPurchase");
    xmlDocument.setData("structure1Purchase", dataPurchase);
    if (log4j.isDebugEnabled()) log4j.debug("****** setData data2Purchase");
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strDetail, String strSales)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: dataSheet");
    response.setContentType("text/html; charset=UTF-8");
    PrintWriter out = response.getWriter();
    ...
    if (log4j.isDebugEnabled()) log4j.debug("****** xmlDocument");
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportTaxInvoice", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportTaxInvoice", false, "", "", "",false, "ad_reports",  strReplaceWith, false,  true);
    ...
    try {
      ...
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportTaxInvoice.html", classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportTaxInvoice.html", strReplaceWith);
    ...
    /*String strTreeNode = ReportTaxInvoiceData.selectTreeNode(this, Utility.getContext(this, vars, "#User_Client", "ReportTaxInvoice"));
      xmlDocument.setData("reportAD_ORGID","liststructure",AdOrgTreeComboData.select(this, strTreeNode, vars.getOrg()));*/
  ...
  void printPageDataExcel(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strDetail, String strSales)
    ...
    if (log4j.isDebugEnabled()) log4j.debug("****** xmlDocument");
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportTaxInvoice_Excel", discard).createXmlDocument();
