...
public class ReportDebtPaymentTrack extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strcBpartnerId = vars.getInGlobalVariable(
                    "inpcBPartnerId_IN", "ReportDebtPaymentTrack|cBpartnerId",
                    "");
            ...
            String strInvoice = vars.getGlobalVariable("inpInvoice",
                    "ReportDebtPaymentTrack|Invoice", "I");
            String strDPCNA = vars.getGlobalVariable("inpDPCNA",
                    "ReportDebtPaymentTrack|DPCNA", "C");
            String strDPCA = vars.getGlobalVariable("inpDPCA",
                    "ReportDebtPaymentTrack|DPCA", "A");
            String strDPGNA = vars.getGlobalVariable("inpDPGNA",
                    "ReportDebtPaymentTrack|DPGNA", "G");
            String strDPGA = vars.getGlobalVariable("inpDPGA",
                    "ReportDebtPaymentTrack|DPGA", "J");
            String strDPM = vars.getGlobalVariable("inpDPM",
                    "ReportDebtPaymentTrack|DPM", "M");
            String strDPC = vars.getGlobalVariable("inpDPC",
                    "ReportDebtPaymentTrack|DPC", "K");
            String strDPB = vars.getGlobalVariable("inpDPB",
                    "ReportDebtPaymentTrack|DPB", "B");
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strAmtFrom, strAmtTo, strInvoice, strDPCNA,
                    strDPCA, strDPGNA, strDPGA, strDPM, strDPC, strDPB);
            ...
            String strDPCNA = vars.getRequestGlobalVariable("inpDPCNA",
                    "ReportDebtPaymentTrack|DPCNA");
            String strDPCA = vars.getRequestGlobalVariable("inpDPCA",
                    "ReportDebtPaymentTrack|DPCA");
            String strDPGNA = vars.getRequestGlobalVariable("inpDPGNA",
                    "ReportDebtPaymentTrack|DPGNA");
            String strDPGA = vars.getRequestGlobalVariable("inpDPGA",
                    "ReportDebtPaymentTrack|DPGA");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strcBpartnerId, String strAmtFrom, String strAmtTo,
            String strInvoice, String strDPCNA, String strDPCA,
            String strDPGNA, String strDPGA, String strDPM, String strDPC,
            String strDPB) throws IOException, ServletException {
        ...
        if ((strDateFrom.equals("") && strDateTo.equals("")
                && strcBpartnerId.equals("") && strAmtFrom.equals("")
                && strAmtTo.equals("") && strInvoice.equals("")
                && strDPCNA.equals("") && strDPCA.equals("")
                && strDPGNA.equals("") && strDPGA.equals("")
            ...
            String strDocTypes = "'" + strInvoice + "','" + strDPCNA + "','"
                    + strDPCA + "','" + strDPGNA + "','" + strDPGA + "','"
                    + strDPM + "','" + strDPC + "','" + strDPB + "'";
            data = ReportDebtPaymentTrackData.select(this, vars.getLanguage(),
                    ...
                    strcBpartnerId, strDateFrom, strDateTo, strAmtFrom,
                    strAmtTo, strDocTypes);
        }
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportDebtPaymentTrack", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportDebtPaymentTrack.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportDebtPaymentTrack.html", strReplaceWith);
