...
public class ReportDimensionalAnalysesPDF extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")){
      ...
      printPagePdf(response, vars, strComparative, strDateFrom, strDateTo, strPartnerGroup, strcBpartnerId, strProductCategory, strmProductId, strNotShown, strShown, strDateFromRef, strDateToRef, strOrg, strsalesrepId, strOrder, strMayor, strMenor, strRatioMayor, strRatioMenor);
    } else pageErrorPopUp(response);
  }

  void printPagePdf(HttpServletResponse response, VariablesSecureApp vars, String strComparative, String strDateFrom, String strDateTo, String strPartnerGroup, String strcBpartnerId, String strProductCategory, String strmProductId, String strNotShown, String strShown, String strDateFromRef, String strDateToRef, String strOrg, String strsalesrepId, String strOrder, String strMayor, String strMenor, String strRatioMayor, String strRatioMenor) throws IOException, ServletException{
    ...
    if (!strPartnerGroup.equals("")) strTitle = strTitle+", para el grupo de terceros "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectBpgroup(this, strPartnerGroup);
    ...
    if (!strsalesrepId.equals("")) strTitle = strTitle+"y el comercial "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectSalesrep(this, strsalesrepId);
    //if (!strmProductId.equals("")) strTitle = strTitle+" y el producto "+ReportRefundInvoiceCustomerDimensionalAnalysesData.selectMproduct(this, strmProductId);
    ...
    if (data.length == 0 || data == null){
      ...
      if (log4j.isDebugEnabled()) log4j.debug("*************************level1PDF"+data[0].nivel1);
    ...
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportRefundInvoiceCustomerDimensionalAnalysesEditionPDF", discard1).createXmlDocument();
