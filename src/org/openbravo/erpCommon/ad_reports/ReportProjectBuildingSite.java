...
public class ReportProjectBuildingSite extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strcProjectId = vars.getRequestGlobalVariable(
                    "inpcProjectId", "ReportProjectBuildingSite|cProjectId");
            ...
            String strProjectkind = vars.getRequestInGlobalVariable(
                    "inpProjectkind", "ReportProjectBuildingSite|Projectkind");
            String strProjectstatus = vars.getRequestInGlobalVariable(
                    "inpProjectstatus",
                    "ReportProjectBuildingSite|Projectstatus");
            String strProjectphase = vars
                    .getRequestInGlobalVariable("inpProjectphase",
                            "ReportProjectBuildingSite|Projectphase");
            ...
            String strcRegionId = vars.getRequestInGlobalVariable(
                    "inpcRegionId", "ReportProjectBuildingSite|cRegionId");
            printPageDataSheet(response, vars, strdateFrom, strdateTo,
                    strcBpartnerId, strcProjectId, strmCategoryId,
                    strProjectkind, strProjectphase, strProjectstatus,
                    strProjectpublic, strcRegionId, strSalesRep, strProduct);
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportProjectBuildingSite.html", classInfo.id,
            ...
            }
            {
                OBError myMessage = vars
                        .getMessage("ReportProjectBuildingSite");
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_kind", "Projectkind", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportProjectBuildingSite"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSite"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSite", strProjectkind);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_phase", "Projectphase", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportProjectBuildingSite"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSite"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSite", strProjectphase);
                xmlDocument.setData("reportC_PROJECTKIND", "liststructure",
                        comboTableData.select(false));
                comboTableData = null;
            } catch (Exception ex) {
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_status", "ProjectStatus", "",
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportProjectBuildingSite"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSite"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSite", strProjectstatus);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "LIST", "C_Project_public", "ProjectPrivate", "",
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportProjectBuildingSite"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSite"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProjectBuildingSite", strProjectpublic);
            ...
            xmlDocument.setData("reportC_PRODUCTCATREGORY", "liststructure",
                    SubCategoryProductData.select(this, Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportProjectBuildingSite"), Utility.getContext(
            ...
            try {
                ...
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportSalesOrderProvided", strcRegionId);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLE", "", "AD_User SalesRep", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportProjectBuildingSite"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProjectBuildingSite"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportSalesOrderProvided", strSalesRep);
            ...
            String strCurrencyId = Utility.stringBaseCurrencyId(this, vars
                    .getClient());
            ReportProjectBuildingSiteData[] data = ReportProjectBuildingSiteData
                    .select(this, strCurrencyId, Utility.getContext(this, vars,
                            "#User_Client", "ReportProjectBuildingSite"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportProjectBuildingSite"), strdateFrom,
                            DateTimeData.nDaysAfter(this, strdateTo, "1"),
                            strcBpartnerId, strcProjectId, strmCategoryId,
                            strProjectkind, strProjectphase, strProjectstatus,
                            strProjectpublic, strcRegionId, strSalesRep,
                            strProduct);

            if (data == null || data.length == 0) {
                xmlDocument = xmlEngine
                        .readXmlTemplate(
                                "org/openbravo/erpCommon/ad_reports/ReportProjectBuildingSitePop",
                                discard).createXmlDocument();
                xmlDocument.setData("structure1", ReportProjectBuildingSiteData
                        .set());
            } else {
                xmlDocument = xmlEngine
                        .readXmlTemplate(
            ...
            if (!strProjectpublic.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "WithInitiativeType", vars
                                .getLanguage())
                        + " "
                        + ReportProjectBuildingSiteData.selectProjectpublic(
            ...
            if (!strSalesRep.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ForTheSalesRep", vars
                                .getLanguage())
                        + " "
    ...
    void printPageDataPDF(HttpServletResponse response,
        ...
        ReportProjectBuildingSiteData[] data = ReportProjectBuildingSiteData
                .select(this, strCurrencyId, Utility.getContext(this, vars,
                        "#User_Client", "ReportProjectBuildingSite"), Utility
                        .getContext(this, vars, "#User_Org",
                                "ReportProjectBuildingSite"), strdateFrom,
                        DateTimeData.nDaysAfter(this, strdateTo, "1"),
                        strcBpartnerId, strcProjectId, strmCategoryId,
        ...
        if (data == null || data.length == 0) {
            xmlDocument = xmlEngine
                    .readXmlTemplate(
                            "org/openbravo/erpCommon/ad_reports/ReportProjectBuildingSitePDF",
                            discard).createXmlDocument();
            xmlDocument.setData("structure1", ReportProjectBuildingSiteData
                    .set());
        } else {
        ...
        if (!strProjectpublic.equals(""))
            strTitle += ", "
                    + Utility.messageBD(this, "WithInitiativeType", vars
                            .getLanguage())
                    + " "
                    + ReportProjectBuildingSiteData.selectProjectpublic(this,
                            vars.getLanguage(), strProjectpublic);
        if (!strdateFrom.equals(""))
            strTitle += ", "
                    + Utility.messageBD(this, "From", vars.getLanguage()) + " "
                    + strdateFrom;
        if (!strdateTo.equals(""))
            strTitle += " " + Utility.messageBD(this, "To", vars.getLanguage())
                    + " " + strdateTo;
        if (!strSalesRep.equals(""))
            strTitle += ", "
                    + Utility.messageBD(this, "ForTheSalesRep", vars
