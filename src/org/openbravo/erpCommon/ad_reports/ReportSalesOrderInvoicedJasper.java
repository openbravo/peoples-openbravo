    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportSalesOrderInvoicedJasper|currency",
                    strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportSalesOrderInvoicedJasper", false, "", "", "", false,
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportSalesOrderInvoicedJasper.html", classInfo.id,
            ...
            }
            {
                OBError myMessage = vars
                        .getMessage("ReportSalesOrderInvoicedJasper");
            ...
            xmlDocument.setParameter("paramBPartnerDescription",
                    ReportSalesOrderInvoicedData.bPartnerDescription(this,
                            strcBpartnerId));
            try {
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        ...
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportSalesOrderInvoicedJasper"), Utility
            ...
            ReportSalesOrderInvoicedData[] data = ReportSalesOrderInvoicedData
                    .select(this, strCurrencyId, Utility.getContext(this, vars,
                            "#User_Client", "ReportSalesOrderInvoiced"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportSalesOrderInvoiced"), strdateFrom,
            ...
            if (data == null || data.length == 0) {
                ...
                xmlDocument.setData("structure1", ReportSalesOrderInvoicedData
                        .set());
            } else {
                xmlDocument = xmlEngine
                        .readXmlTemplate(
            ...
            if (!strmWarehouseId.equals(""))
                strTitle += " "
                        + Utility.messageBD(this, "ForWarehouse", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectWarehouse(this,
                                strmWarehouseId);
            if (!strcRegionId.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "InRegion", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectRegionId(this,
                                strcRegionId);
            if (!strmCategoryId.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ForProductCategory", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectCategoryId(this,
                                strmCategoryId);
            if (!strProjectkind.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ProjectType", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectProjectkind(this,
            ...
            if (!strProjectpublic.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "WithInitiativeType", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectProjectpublic(
            ...
            if (!strProduct.equals(""))
                strTitle += ", "
                        + Utility.messageBD(this, "ForProduct", vars
                                .getLanguage())
                        + " "
                        + ReportSalesOrderInvoicedData.selectProduct(this,
                                strProduct);
    ...
    void printPageDataSheetJasper(HttpServletRequest request,
        ...
        try {
            data = ReportSalesOrderInvoicedData.select(this, strCurrencyId,
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportSalesOrderInvoiced"), Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportSalesOrderInvoiced"), strdateFrom,
                    DateTimeData.nDaysAfter(this, strdateTo, "1"),
                    strcBpartnerId, strmWarehouseId, strcProjectId,
        ...
        if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
            ...
            if (strOutput.equals("pdf"))
                response.setHeader("Content-disposition",
                        "inline; filename=ReportSalesOrderInvoiced.pdf");
