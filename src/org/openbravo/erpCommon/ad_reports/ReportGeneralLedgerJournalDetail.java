...
public class ReportGeneralLedgerJournalDetail extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strFactAcctGroupId = vars
                    .getStringParameter("inpFactAcctGroupId");
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strFactAcctGroupId,
            String strDateacct, String strDPId, String strcAcctSchemaId)
            throws IOException, ServletException {
        ...
        if (strDPId == null)
            data = ReportGeneralLedgerJournalDetailData.select(this,
                    strFactAcctGroupId, strDateacct, initRecordNumber,
                    intRecordRange);
        else
            data = ReportGeneralLedgerJournalDetailData.selectByDP(this,
                    strDPId, strcAcctSchemaId);
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportGeneralLedger", false, "", "", "", false, "ad_reports",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportGeneralLedgerJournalDetail.html", classInfo.id,
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportGeneralLedgerJournalDetail");
