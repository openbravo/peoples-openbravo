...
public class ReportSalesOrderOpenItem extends HttpSecureAppServlet {
  ...
  private void printPageDataHtml(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (data == null || data.length == 0) {
      ...
      xmlDocument = xmlEngine.readXmlTemplate(
          "org/openbravo/erpCommon/ad_reports/ReportSalesOrderOpenItemEdit").createXmlDocument();
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ReportSalesOrderOpenItem.html", classInfo.id, classInfo.type, strReplaceWith, tabs
              .breadcrumb());
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "M_Warehouse_ID",
          ...
          Utility.getContext(this, vars, "#User_Client", "ReportSalesOrderOpenItem"), 0);
