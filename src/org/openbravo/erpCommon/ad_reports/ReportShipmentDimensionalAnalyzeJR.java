...
public class ReportShipmentDimensionalAnalyzeJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportShipmentDimensionalAnalyzeJR|org", "0");
            ...
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportShipmentDimensionalAnalyzeJR|currency",
                    strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportShipmentDimensionalAnalyzeJRFilter",
                        discard).createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportShipmentDimensionalAnalyzeJRFilter", false, "", "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportShipmentDimensionalAnalyzeJR.html", classInfo.id,
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportShipmentDimensionalAnalyzeJR");
         ...
         * ReportShipmentDimensionalAnalyzeJRData.selectBpartner(this,
         * strcBpartnerId)); xmlDocument.setParameter("mProduct",
         * strmProductId); xmlDocument.setParameter("productDescription",
         * ReportShipmentDimensionalAnalyzeJRData.selectMproduct(this,
         * strmProductId));
         */
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_Warehouse_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportShipmentDimensionalAnalyzeJR"), Utility
        ...
        if (vars.getLanguage().equals("en_US")) {
            xmlDocument.setData("structure1",
                    ReportShipmentDimensionalAnalyzeJRData.selectNotShown(this,
                            strShown));
            xmlDocument
                    .setData(
                            "structure2",
                            strShown.equals("") ? new ReportShipmentDimensionalAnalyzeJRData[0]
                                    : ReportShipmentDimensionalAnalyzeJRData
                                            .selectShown(this, strShown));
        } else {
            xmlDocument.setData("structure1",
                    ReportShipmentDimensionalAnalyzeJRData.selectNotShownTrl(
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportShipmentDimensionalAnalyzeJRData.selectBpgroup(
        ...
        if (!strmWarehouseId.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "TheWarehouse", vars
                            .getLanguage())
                    + " "
                    + ReportShipmentDimensionalAnalyzeJRData.selectMwarehouse(
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportShipmentDimensionalAnalyzeJRData.select(this,
