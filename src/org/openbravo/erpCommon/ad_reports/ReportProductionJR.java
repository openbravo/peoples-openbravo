...
public class ReportProductionJR extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (!Utility.hasProcessAccess(this, vars, "", "RV_ReportProductionJR")) {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strRawMaterial = vars.getGlobalVariable("inpRawMaterial", "ReportProductionJR|RawMaterial", "");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strRawMaterial);
    } else if (vars.commandIn("FIND")) {
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportProductionJR|DateFrom");
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportProductionJR|DateTo");
      String strRawMaterial = vars.getRequestGlobalVariable("inpRawMaterial", "ReportProductionJR|RawMaterial");
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,  String strDateFrom, String strDateTo, String strRawMaterial)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportProductionJR").createXmlDocument();
    ...
    try {
      KeyMap key = new KeyMap(this, vars, "ReportProductionJR.html");
      xmlDocument.setParameter("keyMap", key.getReportKeyMaps());
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    try {
      WindowTabs tabs = new WindowTabs(this, vars, "org.openbravo.erpCommon.ad_reports.ReportProductionJR");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportProductionJR.html", classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportProductionJR.html", strReplaceWith);
  ...
  void printPagePDF(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strRawMaterial)
    ...
    if (log4j.isDebugEnabled()) log4j.debug("Output: Jasper Report : Production Report");
   ...
   // String strSubTitle = (!strDateFrom.equals("")?"From "+strDateFrom:"")  + (!strDateTo.equals("")?" to "+strDateTo:"");
    ...
    ReportProductionData[] data = ReportProductionData.select(this, strRawMaterial, Utility.getContext(this, vars, "#User_Client", "ReportProductionJR"), Utility.getContext(this, vars, "#User_Org", "ReportProductionJR"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,"1"));
 ...
 /*   try{
      parameters.put("DATE_FROM", new SimpleDateFormat("dd-MM-yyyy").parse(vars.getRequestGlobalVariable("inpDateFrom", "ReportProductionJR|DateFrom")));
      parameters.put("DATE_TO", new SimpleDateFormat("dd-MM-yyyy").parse(vars.getRequestGlobalVariable("inpDateTo", "ReportProductionJR|DateTo")));
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    */
    if (log4j.isDebugEnabled()) log4j.debug("parameters: " + parameters.toString());
    if (log4j.isDebugEnabled()) log4j.debug("data: " + data);
