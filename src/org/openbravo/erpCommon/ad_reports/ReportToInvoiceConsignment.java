...
public class ReportToInvoiceConsignment extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strWarehouse = vars.getRequestGlobalVariable(
                    "inpmWarehouseId", "ReportToInvoiceConsignment|Warehouse");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportToInvoiceConsignment", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportToInvoiceConsignment.html", classInfo.id,
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "M_Warehouse_ID", "M_Warehouse of Client", "",
                    Utility.getContext(this, vars, "#User_Client", ""), Utility
    ...
    void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
        ...
        XmlDocument xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportToInvoiceConsignment_PDF")
                .createXmlDocument();
        // Get user Client's base currency
        String strCurrencyId = Utility.stringBaseCurrencyId(this, vars
                .getClient());
        ReportToInvoiceConsignmentData[] data = ReportToInvoiceConsignmentData
                .select(this, strCurrencyId, Utility.getContext(this, vars,
                        "#User_Client", "ReportToInvoiceConsignment"), Utility
                        .getContext(this, vars, "#User_Org",
                                "ReportToInvoiceConsignment"), strDateFrom,
