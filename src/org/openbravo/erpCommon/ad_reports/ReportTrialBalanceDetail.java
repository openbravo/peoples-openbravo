...
public class ReportTrialBalanceDetail extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportTrialBalanceDetailDetail|Org", "");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strOrg, String strLevel, String strId) throws IOException,
            ServletException {
        ...
        String strTreeOrg = ReportTrialBalanceDetailData.treeOrg(this, vars
                .getClient());
        String strOrgFamily = getFamily(strTreeOrg, strOrg);
        String strTreeAccount = ReportTrialBalanceDetailData.treeAccount(this,
                vars.getClient());
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            if (log4j.isDebugEnabled())
                log4j
                        .debug("printPageDataSheet - getFamily - strTreeAccount = "
                                + strTreeAccount);
            if (log4j.isDebugEnabled())
                log4j
                        .debug("printPageDataSheet - getFamily - strId = "
                                + strId);
            String strIdFamily = getFamily(strTreeAccount, strId);
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - strOrgFamily = "
                        + strOrgFamily);
            if (log4j.isDebugEnabled())
            ...
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - #User_Org = "
                        + Utility.getContext(this, vars, "#User_Org",
                                "ReportTrialBalanceDetail"));
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - strDateFrom = "
                        + strDateFrom);
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - strDateTo = "
                        + DateTimeData.nDaysAfter(this, strDateTo, "1"));
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - strIdFamily = "
                        + strIdFamily);
            if (log4j.isDebugEnabled())
                log4j.debug("printPageDataSheet - select - strId = " + strId);
            data = ReportTrialBalanceDetailData.select(this, strOrgFamily,
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportTrialBalanceDetail"), Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportTrialBalanceDetail"), strDateFrom,
                    DateTimeData.nDaysAfter(this, strDateTo, "1"), strIdFamily,
                    strId);
        }

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportTrialBalanceDetail", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportTrialBalanceDetail.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportTrialBalanceDetail.html", strReplaceWith);
        ...
        xmlDocument.setParameter("paramLanguage", "defaultLang=\""
                + vars.getLanguage() + "\";");
        xmlDocument.setParameter("account", ReportTrialBalanceDetailData
                .selectAccountName(this, strId));
    ...
    public String getFamily(String strTree, String strChild)
         ...
         * TreeData [] data = Tree.getMembers(this, strTree, strChild); String
