...
public class ReportInvoiceDiscountJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strDateTo = vars.getGlobalVariable("inpDateTo",
                    "ReportInvoiceDiscountJR|dateTo", "");
            String strcBpartnerId = vars.getInGlobalVariable(
                    "inpcBPartnerId_IN", "ReportInvoiceDiscountJR|partner", "");
            ...
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strCurrencyId, strDiscount);
            ...
            printPageDataHtml(response, vars, strDateFrom, strDateTo,
                    strcBpartnerId, strDiscount, strCurrencyId);
        } else
            pageError(response);
    }
    ...
    void printPageDataHtml(HttpServletResponse response,
            ...
            String strcBpartnerId, String strDiscount, String strCurrencyId)
            throws IOException, ServletException {
        ...
        if (strOutput.equals("pdf"))
            response.setHeader("Content-disposition",
                    "inline; filename=ReportInvoiceDiscountEdit.pdf");
        ...
        try {
            data = ReportInvoiceDiscountData
                    .select(this, strCurrencyId, Utility.getContext(this, vars,
                            "#User_Client", "ReportInvoiceDiscountJR"), Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportInvoiceDiscountJR"), strDateFrom,
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strDateFrom, String strDateTo,
            String strcBpartnerId, String strCurrencyId, String strDiscount)
            throws IOException, ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: dataSheet");
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceDiscountReportInvoiceDiscountJR", false, "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceDiscountJR.html", classInfo.id,
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportInvoiceDiscountData.selectBpartner(this, Utility
                        .getContext(this, vars, "#User_Org",
                                "ReportInvoiceDiscountJR"), Utility.getContext(
                        this, vars, "#User_Client", "ReportInvoiceDiscountJR"),
                        strcBpartnerId));
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceDiscountJR", strCurrencyId);
