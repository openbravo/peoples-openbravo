...
public class ReportInvoiceCustomerEdition extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strmCategoryId = vars.getInGlobalVariable(
            ...
            String strProjectstatus = vars.getInGlobalVariable(
                    "inpProjectstatus",
                    "ReportInvoiceCustomerEdition|Projectstatus", "");
            String strProjectphase = vars.getInGlobalVariable(
                    "inpProjectphase",
            ...
            String strProjectpublic = vars.getGlobalVariable(
                    "inpProjectpublic",
            ...
            String strcProjectId = vars.getRequestGlobalVariable(
                    "inpcProjectId", "ReportInvoiceCustomerEdition|cProjectId");
            String strcBpartnerId = vars.getRequestInGlobalVariable(
                    "inpcBPartnerId_IN",
                    "ReportInvoiceCustomerEdition|cBPartnerId_IN");
            String strmCategoryId = vars.getRequestInGlobalVariable(
                    "inpmProductCategoryId",
                    "ReportInvoiceCustomerEdition|mCategoryId");
            String strProjectkind = vars.getRequestInGlobalVariable(
                    "inpProjectkind",
                    "ReportInvoiceCustomerEdition|Projectkind");
            String strProjectstatus = vars.getRequestInGlobalVariable(
                    "inpProjectstatus",
                    "ReportInvoiceCustomerEdition|Projectstatus");
            String strProjectphase = vars.getRequestInGlobalVariable(
                    "inpProjectphase",
                    "ReportInvoiceCustomerEdition|Projectphase");
            String strProduct = vars.getRequestInGlobalVariable(
                    "inpmProductId_IN",
                    "ReportInvoiceCustomerEdition|mProductId_IN");
            String strProjectpublic = vars.getRequestGlobalVariable(
                    "inpProjectpublic",
                    "ReportInvoiceCustomerEdition|Projectpublic");
            String strSalesRep = vars.getRequestGlobalVariable("inpSalesRepId",
                    "ReportInvoiceCustomerEdition|SalesRepId");
            String strcRegionId = vars.getRequestInGlobalVariable(
                    "inpcRegionId", "ReportInvoiceCustomerEdition|cRegionId");
            ...
            String strcRegionId = vars.getRequestInGlobalVariable(
                    "inpcRegionId", "ReportInvoiceCustomerEdition|cRegionId");
            printPagePdf(response, vars, strdateFrom, strdateTo, strcProjectId,
                    strcBpartnerId, strmCategoryId, strProjectkind,
                    strProjectstatus, strProjectphase, strProduct,
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strcProjectId, String strcBpartnerId, String strmCategoryId,
            String strProjectkind, String strProjectstatus,
            String strProjectphase, String strProduct, String strProjectpublic,
            String strSalesRep, String strcRegionId) throws IOException,
            ServletException {
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportInvoiceCustomerFilter")
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceCustomerFilter", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceCustomerEdition.html", classInfo.id,
        ...
        xmlDocument.setParameter("projectName", InvoiceCustomerEditionData
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "Projectkind", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportInvoiceCustomerEdition"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strProjectkind);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "Projectphase", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportInvoiceCustomerEdition"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strProjectphase);
            xmlDocument.setData("reportC_PROJECTPHASE", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    "", "ProjectStatus", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportInvoiceCustomerEdition"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strProjectstatus);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "LIST",
                    ...
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strProjectpublic);
            xmlDocument.setData("reportC_PROJECTPUBLIC", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        ...
        xmlDocument.setData("reportC_PRODUCTCATREGORY", "liststructure",
                SubCategoryProductData.select(this, Utility.getContext(this,
                        vars, "#User_Org", "ReportInvoiceCustomerEdition"),
                        Utility.getContext(this, vars, "#User_Client",
                                "ReportInvoiceCustomerEdition")));

        try {
            ComboTableData comboTableData = new ComboTableData(this,
                    "TABLEDIR", "C_REGION_ID", "", "C_Region of Country",
                    Utility.getContext(this, vars, "#User_Org",
                            "ReportInvoiceCustomerEdition"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strcRegionId);
            xmlDocument.setData("reportC_REGIONID", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(this, "TABLE",
                    "", "190", "AD_User SalesRep", Utility.getContext(this,
                            vars, "#User_Org", "ReportInvoiceCustomerEdition"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerEdition"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerEdition", strSalesRep);
            xmlDocument.setData("reportSALESREP", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        String strCurrencyId = Utility.stringBaseCurrencyId(this, vars
                .getClient());
        data = InvoiceCustomerEditionData.select(this, strCurrencyId, Utility
                .getContext(this, vars, "#User_Org", "InvoiceCustomerFilter"),
                Utility.getContext(this, vars, "#User_Client",
                        "InvoiceCustomerFilter"), strdateFrom, strdateTo,
                strcBpartnerId, strcProjectId, strmCategoryId, strProjectkind,
                strProjectphase, strProjectstatus, strProjectpublic,
    ...
    void printPagePdf(HttpServletResponse response, VariablesSecureApp vars,
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportInvoiceCustomerEdition_Pdf")
                .createXmlDocument();
        InvoiceCustomerEditionData[] data = null;
        // Get user Client's base currency
        String strCurrencyId = Utility.stringBaseCurrencyId(this, vars
