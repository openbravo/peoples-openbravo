...
public class ReportProjectProgress extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strRefDate = vars.getGlobalVariable("inpRefDate",
                    "ReportProjectProgress|RefDateFrom", DateTimeData
                            .today(this));
            String strOlderFirst = vars.getStringParameter("inpOlderFirst");
            String strStartDateFrom = vars.getGlobalVariable(
                    "inpStartDateFrom", "ReportProjectProgress|StartDateFrom",
                    "");
            String strStartDateTo = vars.getGlobalVariable("inpStartDateTo",
                    "ReportProjectProgress|StartDateTo", "");
            String strContractDateFrom = vars.getGlobalVariable(
                    "inpContractDateFrom",
                    "ReportProjectProgress|ContractDateFrom", "");
            String strContractDateTo = vars.getGlobalVariable(
                    "inpContractDateTo",
                    "ReportProjectProgress|ContractDateTo", "");
            String strEndingDateFrom = vars.getGlobalVariable(
                    "inpEndingDateFrom",
            ...
            String strProjectStatus = vars.getInGlobalVariable(
                    "inpProjectstatus", "ReportProjectProgress|Projectstatus",
                    "");
            ...
            printPageDataSheet(response, vars, strRefDate, strOlderFirst,
                    strStartDateFrom, strStartDateTo, strContractDateFrom,
                    strContractDateTo, strEndingDateFrom, strEndingDateTo,
                    strProject, strProjectStatus, strBPartner, strResponsible);
            ...
            String strOlderFirst = vars.getRequestGlobalVariable(
                    "inpOlderFirst", "ReportProjectProgress|OlderFirst");
            String strStartDateFrom = vars.getRequestGlobalVariable(
                    "inpStartDateFrom", "ReportProjectProgress|StartDateFrom");
            String strStartDateTo = vars.getRequestGlobalVariable(
                    "inpStartDateTo", "ReportProjectProgress|StartDateTo");
            String strContractDateFrom = vars.getRequestGlobalVariable(
                    "inpContractDateFrom",
                    "ReportProjectProgress|ContractDateFrom");
            String strContractDateTo = vars
                    .getRequestGlobalVariable("inpContractDateTo",
                            "ReportProjectProgress|ContractDateTo");
            String strEndingDateFrom = vars
                    .getRequestGlobalVariable("inpEndingDateFrom",
                            "ReportProjectProgress|EndingDateFrom");
            String strEndingDateTo = vars.getRequestGlobalVariable(
                    "inpEndingDateTo", "ReportProjectProgress|EndingDateTo");
            ...
            String strBPartner = vars.getRequestGlobalVariable(
                    "inpcBPartnerId", "ReportProjectProgress|Partner");
            String strResponsible = vars.getRequestGlobalVariable(
                    "inpResponsible", "ReportProjectProgress|Responsible");
            ...
            try {
                printPageDataHtml(response, vars, strRefDate, strOlderFirst,
                        strStartDateFrom, strStartDateTo, strContractDateFrom,
                        strContractDateTo, strEndingDateFrom, strEndingDateTo,
                        strProject, strProjectStatus, strBPartner,
                        strResponsible, strOutput);
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strRefDate, String strOlderFirst,
            String strStartDateFrom, String strStartDateTo,
            String strContractDateFrom, String strContractDateTo,
            String strEndingDateFrom, String strEndingDateTo,
            String strProject, String strProjectStatus, String strBPartner,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportProjectProgress", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportProjectProgress.html", classInfo.id, classInfo.type,
        ...
        xmlDocument.setParameter("direction", "var baseDirectory = \""
                + strReplaceWith + "/\";\n");
        ...
        xmlDocument.setParameter("datedisplayFormatRef", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("datesaveFormatRef", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        xmlDocument.setParameter("dateFromdisplayFormatStart", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFromsaveFormatStart", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("startDateTo", strStartDateTo);
        xmlDocument.setParameter("dateTodisplayFormatStart", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTosaveFormatStart", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        xmlDocument.setParameter("dateTodisplayFormatContract", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTosaveFormatContract", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        xmlDocument.setParameter("dateFromdisplayFormatEnding", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFromsaveFormatEnding", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("endingDateTo", strEndingDateTo);
        xmlDocument.setParameter("dateTodisplayFormatEnding", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTosaveFormatEnding", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Project_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org", "ReportProjectProgress"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportProjectProgress"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportProjectProgress", strProject);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "LIST", "C_Project_status", "ProjectStatus", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportProjectProgress"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportProjectProgress"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportProjectProgress", strProjectStatus);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "Responsible_ID", "Responsible employee", "",
                    Utility.getContext(this, vars, "#User_Org",
                            "ReportProjectProgress"), Utility.getContext(this,
                            vars, "#User_Client", "ReportProjectProgress"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportProjectProgress", strResponsible);
            xmlDocument.setData("reportResponsible", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
    ...
    void printPageDataHtml(HttpServletResponse response,
            ...
            String strEndingDateFrom, String strEndingDateTo,
            String strProject, String strProjectStatus, String strBPartner,
            String strResponsible, String strOutput) throws IOException,
        ...
        data = ReportProjectProgressData.select(this, vars.getLanguage(),
                Utility.getContext(this, vars, "#User_Client",
                        "ReportProjectProgress"), Utility.getContext(this,
                        vars, "#User_Org", "ReportProjectProgress"),
                strStartDateFrom, DateTimeData.nDaysAfter(this, strStartDateTo,
                        "1"), strContractDateFrom, DateTimeData.nDaysAfter(
                        this, strContractDateTo, "1"), strEndingDateFrom,
                DateTimeData.nDaysAfter(this, strEndingDateTo, "1"),
                strProject, strProjectStatus, strBPartner, strResponsible,
                strOlderPhasesTasksFirst);

        String strReferenceDate = strRefDate.equals("") ? DateTimeData
                .today(this) : strRefDate;
        ...
        if (data == null || data.length == 0) {
            ...
            for (int i = 0; data != null && i < data.length; i++) {
                ...
                if (!data[i].projectid.equals("")
                        && !data[i].projectid.equals(strProjectId)) {
                    ...
                    if (!data[i].startingdate.equals("")) {
                        if (Utility.isBiggerDate(strReferenceDate,
                                data[i].startingdate, DateFormatter)) {
                            data[i].dayselapsed = Utility.calculateLaborDays(
                                    data[i].startingdate, strReferenceDate,
                                    DateFormatter);
                        } else if (data[i].startingdate
                                .equals(strReferenceDate)) {
                    ...
                    if (!data[i].startingdate.equals("")
                            && !data[i].contractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].contractdate,
                                data[i].startingdate, DateFormatter)) {
                            data[i].projectcontractduration = Utility
                                    .calculateLaborDays(data[i].startingdate,
                                            data[i].contractdate, DateFormatter);
                            Integer ProjectContractDuration = Integer
                                    .parseInt(data[i].projectcontractduration) + 1;
                            data[i].projectcontractduration = ProjectContractDuration
                                    .toString();
                        } else if (data[i].startingdate
                                .equals(data[i].contractdate)) {
                    ...
                    if (!strDaysElapsed.equals("")
                            && !strDaysElapsed.equals("0")
				...
				decimalPlace, BigDecimal.ROUND_UP);
                    ...
                    if (!data[i].endingdate.equals("")
                            && !data[i].contractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].endingdate,
                                data[i].contractdate, DateFormatter)) {
                            data[i].daysdelayed = Utility.calculateLaborDays(
                                    data[i].contractdate, data[i].endingdate,
                                    DateFormatter);
                        } else if (Utility.isBiggerDate(data[i].contractdate,
                ...
                if (!data[i].phaseid.equals("")
                        && !data[i].phaseid.equals(strPhaseId)) {
                    ...
                    // (from its starting date to its contract date)
                    if (!data[i].phasestartingdate.equals("")
                            && !data[i].phasecontractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].phasecontractdate,
                                data[i].phasestartingdate, DateFormatter)) {
                            data[i].phasecontractduration = Utility
                                    .calculateLaborDays(
                                            data[i].phasestartingdate,
                                            data[i].phasecontractdate,
                                            DateFormatter);
                            Integer PhaseContractDuration = Integer
                                    .parseInt(data[i].phasecontractduration) + 1;
                            data[i].phasecontractduration = PhaseContractDuration
                                    .toString();
                        } else if (data[i].phasestartingdate
                                .equals(data[i].phasecontractdate)) {
                    ...
                    // contract date to its ending date)
                    if (!data[i].phaseendingdate.equals("")
                            && !data[i].phasecontractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].phaseendingdate,
                                data[i].phasecontractdate, DateFormatter)) {
                            data[i].phasedaysdelayed = Utility
                                    .calculateLaborDays(
                                            data[i].phasecontractdate,
                                            data[i].phaseendingdate,
                                            DateFormatter);
                        } else if (Utility.isBiggerDate(
                                data[i].phasecontractdate,
                                data[i].phaseendingdate, DateFormatter)) {
                            data[i].phasedaysdelayed = "-"
                                    + Utility.calculateLaborDays(
                                            data[i].phaseendingdate,
                                            data[i].phasecontractdate,
                                            DateFormatter);
                        } else if (data[i].phaseendingdate
                                .equals(data[i].phasecontractdate)) {
                ...
                if (!data[i].taskid.equals("")
                        && !data[i].taskid.equals(strTaskId)) {
                    strTaskId = data[i].taskid;

                    // Calculates the task contract duration in labor days (from
                    // its starting date to its contract date)
                    if (!data[i].taskstartingdate.equals("")
                            && !data[i].taskcontractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].taskcontractdate,
                                data[i].taskstartingdate, DateFormatter)) {
                            data[i].taskcontractduration = Utility
                                    .calculateLaborDays(
                                            data[i].taskstartingdate,
                                            data[i].taskcontractdate,
                                            DateFormatter);
                            Integer TaskContractDuration = Integer
                                    .parseInt(data[i].taskcontractduration) + 1;
                            data[i].taskcontractduration = TaskContractDuration
                                    .toString();
                        } else if (data[i].taskstartingdate
                                .equals(data[i].taskcontractdate)) {
                    ...
                    // contract date to its ending date)
                    if (!data[i].taskendingdate.equals("")
                            && !data[i].taskcontractdate.equals("")) {
                        if (Utility.isBiggerDate(data[i].taskendingdate,
                                data[i].taskcontractdate, DateFormatter)) {
                            data[i].taskdaysdelayed = Utility
                                    .calculateLaborDays(
                                            data[i].taskcontractdate,
                                            data[i].taskendingdate,
                                            DateFormatter);
                        } else if (Utility.isBiggerDate(
                                data[i].taskcontractdate,
                    ...
                    for (int j = dataStart; j < i + 1; j++) {
                        if (!data[j].taskid.equals("")
                            ...
                            if (!data[j].taskdaysdelayed.equals("")
                                    && data[j].taskdaysdelayed != null)
                                CumDaysDelayed = CumDaysDelayed
                                        + Integer
                                                .parseInt(data[j].taskdaysdelayed);
                            ...
                            if (!data[j].phasedaysdelayed.equals("")
                                    && data[j].phasedaysdelayed != null)
                                CumDaysDelayed = CumDaysDelayed
                                        + Integer
                                                .parseInt(data[j].phasedaysdelayed);
                            ...
                            if (!data[j].cumdaysdelayed.equals("")
                                    && data[j].cumdaysdelayed != null)
                                CumDaysDelayed = Integer
                                        .parseInt(data[j].cumdaysdelayed);
                        }
                    }
