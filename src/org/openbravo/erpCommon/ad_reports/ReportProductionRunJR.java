...
public class ReportProductionRunJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strLaunchDateFrom = vars.getGlobalVariable(
                    "inpLaunchDateFrom",
            ...
            String strStartDateFrom = vars.getGlobalVariable(
                    "inpStartDateFrom", "ReportProductionRunJR|StartDateFrom",
                    "");
            ...
            String strmaWorkRequirement = vars.getGlobalVariable(
                    "inpmaWorkRequirementId",
                    "ReportProductionRunJR|maWorkRequirement", "");
            printPageDataSheet(response, vars, strLaunchDateFrom,
                    strLaunchDateTo, strStartDateFrom, strStartDateTo,
                    strEndDateFrom, strEndDateTo, strmaWorkRequirement);
        } else if (vars.commandIn("FIND")) {
            String strLaunchDateFrom = vars
                    .getRequestGlobalVariable("inpLaunchDateFrom",
                            "ReportProductionRunJR|LaunchDateFrom");
            String strLaunchDateTo = vars.getRequestGlobalVariable(
                    "inpLaunchDateTo", "ReportProductionRunJR|LaunchDateTo");
            String strStartDateFrom = vars.getRequestGlobalVariable(
                    "inpStartDateFrom", "ReportProductionRunJR|StartDateFrom");
            String strStartDateTo = vars.getRequestGlobalVariable(
                    "inpStartDateTo", "ReportProductionRunJR|StartDateTo");
            String strEndDateFrom = vars.getRequestGlobalVariable(
                    "inpEndDateFrom", "ReportProductionRunJR|EndDateFrom");
            String strEndDateTo = vars.getRequestGlobalVariable("inpEndDateTo",
                    "ReportProductionRunJR|EndDateTo");
            String strmaWorkRequirement = vars.getRequestGlobalVariable(
                    "inpmaWorkRequirementId",
                    "ReportProductionRunJR|maWorkRequirement");
            printPageDataHtml(response, vars, strLaunchDateFrom,
                    strLaunchDateTo, strStartDateFrom, strStartDateTo,
                    strEndDateFrom, strEndDateTo, strmaWorkRequirement);
        } else
            pageError(response);
    ...
    void printPageDataHtml(HttpServletResponse response,
            VariablesSecureApp vars, String strLaunchDateFrom,
            String strLaunchDateTo, String strStartDateFrom,
        ...
        data = ReportProductionRunData.select(this, vars.getLanguage(),
                Utility.getContext(this, vars, "#User_Client",
                        "ReportProductionRunJR"), Utility.getContext(this,
                        vars, "#User_Org", "ReportProductionRunJR"),
                strLaunchDateFrom, strLaunchDateTo, strStartDateFrom,
                strStartDateTo, strEndDateFrom, strEndDateTo,
                strmaWorkRequirement);

        String strSubtitle = "";
        if (!strLaunchDateFrom.equals(""))
            strSubtitle = Utility.messageBD(this, "LaunchDateFrom", vars
                    .getLanguage())
                    + ":" + strLaunchDateFrom;
        if (!strLaunchDateTo.equals(""))
            strSubtitle += strSubtitle.equals("") ? "" : " - "
                    + Utility.messageBD(this, "LaunchDateTo", vars
                            .getLanguage()) + ":" + strLaunchDateTo;
        if (!strStartDateFrom.equals(""))
            strSubtitle += strSubtitle.equals("") ? "" : " - "
                    + Utility.messageBD(this, "StartDateFrom", vars
                            .getLanguage()) + ":" + strStartDateFrom;
        if (!strStartDateTo.equals(""))
            strSubtitle += strSubtitle.equals("") ? "" : " - "
                    + Utility
                            .messageBD(this, "StartDateTo", vars.getLanguage())
                    + ":" + strStartDateTo;
        if (!strEndDateFrom.equals(""))
            strSubtitle += strSubtitle.equals("") ? "" : " - "
                    + Utility
                            .messageBD(this, "EndDateFrom", vars.getLanguage())
                    + ":" + strEndDateFrom;
        if (!strmaWorkRequirement.equals(""))
            strSubtitle += strSubtitle.equals("") ? "" : " - "
                    + Utility.messageBD(this, "WorkRequirement", vars
                            .getLanguage()) + ":" + strmaWorkRequirement;
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportProductionRunJR", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportProductionRunJR.html", classInfo.id, classInfo.type,
        ...
        xmlDocument.setParameter("launchDateFromsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("launchDateTo", strLaunchDateTo);
        xmlDocument.setParameter("launchDateTodisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("launchDateTosaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("startDateFrom", strStartDateFrom);
        xmlDocument.setParameter("startDateFromdisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("startDateFromsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("startDateTo", strStartDateTo);
        xmlDocument.setParameter("startDateTodisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("startDateTosaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("endDateFrom", strEndDateFrom);
        xmlDocument.setParameter("endDateFromdisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("endDateFromsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("endDateTo", strEndDateTo);
        xmlDocument.setParameter("endDateTodisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("endDateTosaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));

        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "MA_Workrequirement_ID", "", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportProductionRunJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportProductionRunJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportProductionRunJR", strmaWorkRequirement);
     ...
     * vars, String strLaunchDateFrom, String strLaunchDateTo, String
     * strStartDateFrom, String strStartDateTo, String strEndDateFrom, String
     * strEndDateTo, String strmaWorkRequirement) throws IOException,
     * ServletException { if (log4j.isDebugEnabled())
     * log4j.debug("Output: dataSheet");
     * response.setContentType("text/html; charset=UTF-8"); PrintWriter out =
     * response.getWriter(); //String discard[]={"sectionAmount"}; XmlDocument
     * xmlDocument=null; ReportProductionRunData[] data=null; xmlDocument =
     * xmlEngine
     * .readXmlTemplate("org/openbravo/erpCommon/ad_reports/ReportProductionRun"
     * ).createXmlDocument(); data = ReportProductionRunData.select(this,
     * Utility.getContext(this, vars, "#User_Client", "ReportProductionRun"),
     * Utility.getContext(this, vars, "#User_Org", "ReportProductionRun"),
     * strLaunchDateFrom, strLaunchDateTo, strStartDateFrom, strStartDateTo,
     * strEndDateFrom, strEndDateTo, strmaWorkRequirement);
     * 
     * ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
     * "ReportProductionRun", false, "", "", "",false, "ad_reports",
     ...
     * xmlDocument.setParameter("endDateTo", strEndDateTo);
     * xmlDocument.setData("reportMA_WORKREQUIREMENT", "liststructure",
     * WorkRequirementComboData.select(this, Utility.getContext(this, vars,
     * "#User_Client", "ReportProductionRun"), Utility.getContext(this, vars,
     * "#User_Org", "ReportProductionRun"))); xmlDocument.setData("structure1",
