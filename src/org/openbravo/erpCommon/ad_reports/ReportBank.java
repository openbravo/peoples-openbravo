...
public class ReportBank extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strcbankaccount = vars.getRequestGlobalVariable(
                    "inpcBankAccountId", "ReportBank|C_Bankaccount_ID");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportBank")
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportBank",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportBank.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportBank.html", strReplaceWith);
        ...
        xmlDocument.setData("reportC_ACCOUNTNUMBER", "liststructure",
                AccountNumberComboData.select(this, Utility.getContext(this,
                        vars, "#User_Client", "ReportBank"), Utility
                        .getContext(this, vars, "#User_Org", "ReportBank")));
    ...
    void printPageDataHtml(HttpServletResponse response,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportBank", discard)
                    .createXmlDocument();
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportBank", false, "", "", "", false, "ad_reports",
            ...
            xmlDocument.setParameter("paramMessage",
                    (strMessage.equals("") ? "" : "alert('" + strMessage
                            + "');"));
            xmlDocument
                    .setData("reportC_ACCOUNTNUMBER", "liststructure",
                            AccountNumberComboData.select(this, Utility
                                    .getContext(this, vars, "#User_Client",
                                            "ReportBank"), Utility.getContext(
                                    this, vars, "#User_Org", "ReportBank")));
        } else {
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportBankEdit")
                    .createXmlDocument();
            data = ReportBankData.select(this, Utility.getContext(this, vars,
                    "#User_Client", "ReportBank"), Utility.getContext(this,
                    vars, "#User_Org", "ReportBank"), strDateFrom, DateTimeData
                    .nDaysAfter(this, strDateTo, "1"), strcbankaccount);
            xmlDocument.setParameter("sumAmount", ReportBankData
                    .BeginningBalance(this, Utility.getContext(this, vars,
                            "#User_Client", "ReportBank"), Utility.getContext(
                            this, vars, "#User_Org", "ReportBank"),
                            strDateFrom, strcbankaccount));
            xmlDocument.setParameter("directory", "var baseDirectory = \""
                    + strReplaceWith + "/\";\n");
            xmlDocument.setParameter("paramLanguage", "defaultLang=\""
                    + vars.getLanguage() + "\";");
