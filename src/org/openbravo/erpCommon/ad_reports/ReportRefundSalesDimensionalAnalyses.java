...
public class ReportRefundSalesDimensionalAnalyses extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportRefundSalesDimensionalAnalyses|org", "0");
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    ...
                    strmWarehouseId, strOrder, strMayor, strMenor,
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strmWarehouseId, String strOrder, String strMayor,
            String strMenor, String strRatioMayor, String strRatioMenor,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportRefundSalesDimensionalAnalysesFilter", false, "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportRefundSalesDimensionalAnalyses.html", classInfo.id,
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportRefundSalesDimensionalAnalyses");
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_BP_Group_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportRefundSalesDimensionalAnalyses"), Utility
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportRefundSalesDimensionalAnalysesData.selectBpartner(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportRefundSalesDimensionalAnalysesData.selectMproduct(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_Warehouse_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportSalesDimensionalAnalyze"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportRefundSalesDimensionalAnalyses"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
        ...
        if (vars.getLanguage().equals("en_US")) {
            xmlDocument.setData("structure1",
                    ReportRefundSalesDimensionalAnalysesData.selectNotShown(
                            this, strShown));
            xmlDocument
                    .setData(
                            "structure2",
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportRefundSalesDimensionalAnalysesData.selectBpgroup(
        ...
        if (!strsalesrepId.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + ReportRefundSalesDimensionalAnalysesData.selectSalesrep(
                            this, strsalesrepId);
        if (!strmWarehouseId.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + ReportRefundSalesDimensionalAnalysesData
                            .selectMwarehouse(this, strmWarehouseId);
            ...
            try {
                data = ReportRefundSalesDimensionalAnalysesData
                        .select(
                                ...
                                strmProductId, strsalesrepId, strmWarehouseId,
            ...
            if (data.length == 0 || data == null) {
                ...
                if (strComparative.equals("Y")) {
                    for (int j = contador; j > 0; j--) {
                        ...
                        discard1[k + 12] = "fieldTotalRefundQtyNivel"
                                + String.valueOf(j);
                        discard1[k + 24] = "fieldUomsymbol" + String.valueOf(j);
                        discard1[k + 6] = "fieldTotalRefQtyNivel"
                                + String.valueOf(j);
                        discard1[k + 18] = "fieldTotalRefRefundQtyNivel"
                                + String.valueOf(j);
                        k++;
                    }
                } else {
                    for (int j = contador; j > 0; j--) {
                        discard1[k] = "fieldNoncomparativeTotalQtyNivel"
                                + String.valueOf(j);
                        discard1[k + 10] = "fieldNoncomparativeTotalRefundQtyNivel"
                                + String.valueOf(j);
                        discard1[k + 20] = "fieldNoncomparativeUomsymbol"
                                + String.valueOf(j);
                        k++;
                    }
                }
