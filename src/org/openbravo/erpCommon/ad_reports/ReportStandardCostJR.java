...
public class ReportStandardCostJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strdate = vars.getGlobalVariable("inpDateFrom",
                    "ReportStandardCostJR|date", "");
            String strProcessPlan = vars.getGlobalVariable(
                    "inpmaProcessPlanId", "ReportStandardCostJR|ProcessPlanID",
                    "");
            String strVersion = vars.getGlobalVariable(
                    "inpmaProcessPlanVersionId",
                    "ReportStandardCostJR|versionID", "");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportStandardCostJR|currency", Utility
                            .stringBaseCurrencyId(this, vars.getClient()));
            printPageDataSheet(response, vars, strdate, strProcessPlan,
                    strVersion, strCurrencyId);
        } else if (vars.commandIn("FIND")) {
            String strdate = vars.getRequestGlobalVariable("inpDateFrom",
                    "ReportStandardCostJR|date");
            String strProcessPlan = vars.getRequestGlobalVariable(
                    "inpmaProcessPlanId", "ReportStandardCostJR|ProcessPlanID");
            String strVersion = vars.getRequestGlobalVariable(
                    "inpmaProcessPlanVersionId",
                    "ReportStandardCostJR|versionID");
            String strCurrencyId = vars.getRequiredGlobalVariable(
    ...
    void printPageDataSheet(HttpServletResponse response,
            VariablesSecureApp vars, String strdate, String strProcessPlan,
            String strVersion, String strCurrencyId) throws IOException,
            ServletException {
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportStandardCostJRFilter")
                .createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportStandardCostJRFilter", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportStandardCostJR.html", classInfo.id, classInfo.type,
        ...
        xmlDocument.setData("reportMA_PROCESSPLAN", "liststructure",
                ProcessPlanComboData.select(this, Utility.getContext(this,
                        vars, "#User_Client", "ReportStandardCostJR"), Utility
                        .getContext(this, vars, "#User_Org",
                                "ReportStandardCostJR")));
        xmlDocument.setData("reportMA_PROCESSVERSIONPLAN", "liststructure",
                ProcessPlanVersionComboData.select(this, Utility.getContext(
                        this, vars, "#User_Client", "ReportStandardCostJR"),
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
            String strdate, String strProcessPlan, String strVersion,
        ...
        try {
            JasperDesign jasperDesignCost = JRXmlLoader
                    .load(strBaseDesign
                            + "/org/openbravo/erpCommon/ad_reports/ReportStandardCostsJR_srptcosts.jrxml");
            JasperDesign jasperDesignProduced = JRXmlLoader
                    .load(strBaseDesign
                            + "/org/openbravo/erpCommon/ad_reports/ReportStandardCostsJR_subreport0.jrxml");
            jasperReportCost = JasperCompileManager
                    .compileReport(jasperDesignCost);
            jasperReportProduced = JasperCompileManager
                    .compileReport(jasperDesignProduced);
        } catch (JRException e) {
            e.printStackTrace();
