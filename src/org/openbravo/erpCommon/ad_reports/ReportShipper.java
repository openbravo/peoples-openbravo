...
public class ReportShipper extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strTo = vars.getGlobalVariable("inpTo", "ReportShipper|To",
                    "");
            String strShipper = vars.getGlobalVariable("inpShipper",
                    "ReportShipper|Shipper", "");
            String strSale = vars.getGlobalVariable("inpSale",
                    "ReportShipper|Sale", "N");
            String strPurchase = vars.getGlobalVariable("inpPurchase",
                    "ReportShipper|Purchase", "N");
            String strDetail = vars.getGlobalVariable("inpDetail",
            ...
            String strTo = vars.getRequestGlobalVariable("inpTo",
                    "ReportShipper|To");
            String strShipper = vars.getRequestGlobalVariable("inpShipper",
                    "ReportShipper|Shipper");
            String strSale = vars.getRequestGlobalVariable("inpSale",
                    "ReportShipper|Sale");
            String strPurchase = vars.getRequestGlobalVariable("inpPurchase",
                    "ReportShipper|Purchase");
            String strDetail = vars.getRequestGlobalVariable("inpDetail",
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine.readXmlTemplate(
                "org/openbravo/erpCommon/ad_reports/ReportShipper", discard)
                .createXmlDocument();
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("****data passed from: " + strFrom + " to: " + strTo
                    + " shiper: " + strShipper + " isso " + strIsSOTrx
                    + " det " + strDetail);
        ...
        String strBaseCurrencyId = Utility.stringBaseCurrencyId(this, vars
                .getClient());
        try {
            data = ReportShipperData.select(this, vars.getLanguage(),
                    strCurrencyId, strBaseCurrencyId, strFrom, strTo,
                    strShipper, strIsSOTrx);
        ...
        if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
            ...
            if (data != null && data.length > 0) {
                ...
                for (int i = 0; i < data.length; i++) {
                    ...
                    dataLine[i] = ReportShipperData.selectLine(this, vars
                            .getLanguage(), data[i].shipmentid);
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportShipper", false, "", "", "", false, "ad_reports",
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportShipper.html", classInfo.id, classInfo.type,
                        strReplaceWith, tabs.breadcrumb());
                xmlDocument.setParameter("navigationBar", nav.toString());
                LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                        "ReportShipper.html", strReplaceWith);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "M_Shipper_ID", "", "", Utility.getContext(
                                this, vars, "#User_Org", "ReportShipper"),
                        Utility.getContext(this, vars, "#User_Client",
                                "ReportShipper"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportShipper", strShipper);
                xmlDocument.setData("reportShipper", "liststructure",
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "C_Currency_ID", "", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportShipper"), Utility.getContext(
                                this, vars, "#User_Client", "ReportShipper"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportShipper", strCurrencyId);
