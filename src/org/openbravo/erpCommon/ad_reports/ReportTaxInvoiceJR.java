...
public class ReportTaxInvoiceJR extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportTaxInvoiceJR|DateFrom");
  ...
  void printPageDataHtml(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strDetail, String strSales, String strOutput)
    ...
    try {
      ...
      JasperDesign jasperPurchaseForeignD = JRXmlLoader.load(strBaseDesign+"/org/openbravo/erpCommon/ad_reports/ReportTaxInvoicePurchaseForeign.jrxml");
      jasperSale = JasperCompileManager.compileReport(jasperSaleD);
      jasperSaleForeign = JasperCompileManager.compileReport(jasperSaleForeignD);
      jasperPurchase = JasperCompileManager.compileReport(jasperPurchaseD);
      jasperPurchaseForeign = JasperCompileManager.compileReport(jasperPurchaseForeignD);
    } catch (JRException e){
      e.printStackTrace();
      throw new ServletException(e.getMessage());
    }
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strDetail, String strSales)
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportTaxInvoiceJR", false, "", "", "",false, "ad_reports",  strReplaceWith, false,  true);
