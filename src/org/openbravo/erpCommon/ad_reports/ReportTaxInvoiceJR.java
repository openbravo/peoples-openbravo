...
public class ReportTaxInvoiceJR extends HttpSecureAppServlet {
    ...
    void printPageDataHtml(HttpServletResponse response,
            ...
            String strOrg, String strDetail, String strSales, String strOutput)
            throws IOException, ServletException {
        ...
        parameters.put("PARAM_ORG", Tree.getMembers(this, TreeData.getTreeOrg(
        ...
        try {
            ...
            parameters.put("parDateTo", dateFormat.parse(DateTimeData
        ...
        try {
            JasperDesign jasperSaleD = JRXmlLoader
                    .load(strBaseDesign
                            + "/org/openbravo/erpCommon/ad_reports/ReportTaxInvoiceSale.jrxml");
            JasperDesign jasperSaleForeignD = JRXmlLoader
                    .load(strBaseDesign
                            + "/org/openbravo/erpCommon/ad_reports/ReportTaxInvoiceSaleForeign.jrxml");
            JasperDesign jasperPurchaseD = JRXmlLoader
                    .load(strBaseDesign
                            + "/org/openbravo/erpCommon/ad_reports/ReportTaxInvoicePurchase.jrxml");
            JasperDesign jasperPurchaseForeignD = JRXmlLoader
                    .load(strBaseDesign
            ...
            jasperSaleForeign = JasperCompileManager
                    .compileReport(jasperSaleForeignD);
            jasperPurchase = JasperCompileManager
                    .compileReport(jasperPurchaseD);
            jasperPurchaseForeign = JasperCompileManager
                    .compileReport(jasperPurchaseForeignD);
        } catch (JRException e) {
            e.printStackTrace();
            throw new ServletException(e.getMessage());
        }
        ...
        renderJR(vars, response, strReportName, strOutput, parameters, null,
                null);
    }
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportTaxInvoiceJR", false, "", "", "", false, "ad_reports",
