...
public class ReportInvoiceCustomerDimensionalAnalyses extends
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strNotShown = vars.getInGlobalVariable("inpNotShown",
                    "ReportInvoiceCustomerDimensionalAnalyses|notShown", "");
            String strShown = vars.getInGlobalVariable("inpShown",
                    "ReportInvoiceCustomerDimensionalAnalyses|shown", "");
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceCustomerDimensionalAnalysesFilter", false, "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceCustomerDimensionalAnalyses.html",
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportInvoiceCustomerDimensionalAnalyses");
         ...
         * ReportInvoiceCustomerDimensionalAnalysesData.selectBpartner(this,
         * strcBpartnerId)); xmlDocument.setParameter("mProduct",
         * strmProductId); xmlDocument.setParameter("productDescription",
         * ReportInvoiceCustomerDimensionalAnalysesData.selectMproduct(this,
         * strmProductId));
         */
        ...
        xmlDocument.setParameter("projectName",
                ReportInvoiceCustomerDimensionalAnalysesData.selectProject(
                        this, strcProjectId));
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerDimensionalAnalyses"), 0);
            Utility
            ...
            if (strComparative.equals("Y")) {
                ...
                for (int j = contador; j > 0; j--) {
                    discard1[k] = "fieldNoncomparativeTotalQtyNivel"
                            + String.valueOf(j);
                    discard1[k + 20] = "fieldNoncomparativeTotalQty"
                            + String.valueOf(j);
                    // discard1[k+27] =
