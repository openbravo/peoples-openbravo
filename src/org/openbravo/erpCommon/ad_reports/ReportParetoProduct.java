...
public class ReportParetoProduct extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strAD_Org_ID = vars.getRequestGlobalVariable("inpadOrgId",
                    "ReportParetoProduct|AD_Org_ID");
            OBError myMessage = mUpdateParetoProduct(vars, strWarehouse,
                    strAD_Org_ID, strClient);
            myMessage.setTitle("");
    ...
    void printPageDataSheet(HttpServletRequest request,
        ...
        if (vars.commandIn("FIND")) {
            ...
            try {
                data = ReportParetoProductData.select(this, strWarehouse,
                        strAD_Org_ID, strClient, strBaseCurrencyId,
                        strCurrencyId);
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            ...
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportParetoProduct", false, "", "", "", false,
            ...
            try {
                ...
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportParetoProduct.html", classInfo.id,
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "M_Warehouse_ID", "", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportParetoProduct"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportParetoProduct"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportParetoProduct", strWarehouse);
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        ...
                        Utility.getContext(this, vars, "#User_Org",
                                "ReportParetoProduct"), Utility.getContext(
                                this, vars, "#User_Client",
                                "ReportParetoProduct"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportParetoProduct", strAD_Org_ID);
                ...
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "C_Currency_ID", "", "", Utility
                                ...
                                .getContext(this, vars, "#User_Client",
                                        "ReportParetoProduct"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportParetoProduct", strCurrencyId);
            ...
            xmlDocument.setParameter("warehouseArray", arrayDobleEntrada(
                    "arrWarehouse", ReportParetoProductData
                            .selectWarehouseDouble(this, Utility.getContext(
                                    this, vars, "#User_Client",
                                    "ReportParetoProduct"))));
    ...
    OBError mUpdateParetoProduct(VariablesSecureApp vars, String strWarehouse,
            String strAD_Org_ID, String strAD_Client_ID) throws IOException,
            ServletException {
        String pinstance = SequenceIdData.getUUID();

        PInstanceProcessData.insertPInstance(this, pinstance, "1000500001",
                "0", "N", vars.getUser(), vars.getClient(), vars.getOrg());
        PInstanceProcessData.insertPInstanceParam(this, pinstance, "1",
                "m_warehouse_id", strWarehouse, vars.getClient(),
                vars.getOrg(), vars.getUser());
        PInstanceProcessData.insertPInstanceParam(this, pinstance, "2",
                "ad_org_id", strAD_Org_ID, vars.getClient(), vars.getOrg(),
                vars.getUser());
        PInstanceProcessData.insertPInstanceParam(this, pinstance, "3",
                "ad_client_id", strAD_Client_ID, vars.getClient(), vars
                        .getOrg(), vars.getUser());
