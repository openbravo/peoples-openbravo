...
public class ReportProductionCost extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            printPageDataSheet(response, vars, strdateFrom, strdateTo,
                    strmProductId, strCurrencyId);
        } else if (vars.commandIn("FIND")) {
            String strdateFrom = vars.getRequestGlobalVariable("inpDateFrom",
                    "ReportProductionCost|dateFrom");
            String strdateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportProductionCost|dateTo");
            String strmProductId = vars.getRequestGlobalVariable(
                    "inpmProductId", "ReportProductionCost|mProductId");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
            ...
            String strmProductId = vars
                    .getRequiredStringParameter("inpProduct");
            ...
            printPageOpen(response, vars, strdateFrom, strdateTo,
                    strmProductId, strId, strLevel, strCurrencyId);
        } else
            pageError(response);
    }
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportProductionCost", false, "", "", "", false, "ad_reports",
        ...
        if (strdateFrom.equals("") && strdateTo.equals("")) {
            ...
            try {
                data = ReportProductionCostData.select(this, strBaseCurrencyId,
                        strCurrencyId, strLevel, strdateFrom, DateTimeData
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            ...
            try {
                WindowTabs tabs = new WindowTabs(this, vars,
                        "org.openbravo.erpCommon.ad_reports.ReportProductionCost");
                xmlDocument.setParameter("parentTabContainer", tabs
                        .parentTabs());
                xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
                xmlDocument.setParameter("childTabContainer", tabs.childTabs());
                xmlDocument.setParameter("theme", vars.getTheme());
                NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                        "ReportProductionCost.html", classInfo.id,
            ...
            try {
                ComboTableData comboTableData = new ComboTableData(vars, this,
                        "TABLEDIR", "C_Currency_ID", "", "", Utility
                                .getContext(this, vars, "#User_Org",
                                        "ReportProductionCost"), Utility
                                .getContext(this, vars, "#User_Client",
                                        "ReportProductionCost"), 0);
                Utility.fillSQLParameters(this, vars, null, comboTableData,
                        "ReportProductionCost", strCurrencyId);
...

            {
                ...
                if (myMessage != null) {
                    ...
                    xmlDocument.setParameter("messageTitle", myMessage
                            .getTitle());
            ...
            xmlDocument.setParameter("calendar", vars.getLanguage().substring(
                    0, 2));
            ...
            xmlDocument.setParameter("paramProductDescription",
                    ReportProductionCostData.mProductDescription(this,
                            strmProductId));
    ...
    void printPageOpen(HttpServletResponse response, VariablesSecureApp vars,
            String strdateFrom, String strdateTo, String strmProductId,
            String strId, String strLevel, String strCurrencyId)
            throws IOException, ServletException {
        // Ajax response
        if (log4j.isDebugEnabled())
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            try {
                dataMaterial = ReportProductionCostData.selectMaterial(this,
                        strId, strLevel, strBaseCurrencyId, strCurrencyId,
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            try {
                dataMachine = ReportProductionCostData.selectMachine(this,
                        strLevel, strBaseCurrencyId, strCurrencyId,
                        strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,
                                "1"), strmProductId);
            } catch (ServletException ex) {
                myMessage = Utility.translateError(this, vars, vars
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            try {
                dataIndirect = ReportProductionCostData.selectIndirect(this,
                        strLevel, strBaseCurrencyId, strCurrencyId,
                        strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,
                                "1"), strmProductId);
            } catch (ServletException ex) {
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            try {
                dataEmployee = ReportProductionCostData.selectEmployee(this,
                        strLevel, strBaseCurrencyId, strCurrencyId,
                        strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,
                                "1"), strmProductId);
            } catch (ServletException ex) {
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            try {
                dataCostCenter = ReportProductionCostData.selectCostCenter(
                        this, strLevel, strBaseCurrencyId, strCurrencyId,
                        strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,
                                "1"), strmProductId);
            } catch (ServletException ex) {
                myMessage = Utility.translateError(this, vars, vars
        ...
        if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
            xmlDocument = xmlEngine
                    .readXmlTemplate(
                            "org/openbravo/erpCommon/ad_reports/ReportProductionCostSubreport",
     ...
     * strCOrgId, String strInvoiceRule, String strDetail) throws IOException,
     * ServletException{ if (log4j.isDebugEnabled())
     * log4j.debug("Output: print html"); XmlDocument xmlDocument=null;
     * ReportOrderNotInvoiceData[] data = null; if (!strDetail.equals("-1")) {
     * String[] discard = {"selEliminar"}; xmlDocument =
     * xmlEngine.readXmlTemplate
     * ("org/openbravo/erpCommon/ad_reports/ReportOrderNotInvoice",
     * discard).createXmlDocument(); } else { xmlDocument =
     * xmlEngine.readXmlTemplate
     * ("org/openbravo/erpCommon/ad_reports/ReportOrderNotInvoice"
     * ).createXmlDocument(); } data = ReportOrderNotInvoiceData.select(this,
     * vars.getLanguage(), Utility.getContext(this, vars, "#User_Client",
     * "ReportOrderNotInvoice"), Utility.getContext(this, vars, "#User_Org",
     * "ReportOrderNotInvoice"), strcBpartnetId, strCOrgId, strInvoiceRule,
     * strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,"1"));
     * xmlDocument.setData("structure1", data);
     * response.setContentType("text/html; charset=UTF-8"); PrintWriter out =
     * response.getWriter(); out.println(xmlDocument.print()); out.close(); }
     */
