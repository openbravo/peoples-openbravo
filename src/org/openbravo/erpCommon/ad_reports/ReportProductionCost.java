...
public class ReportProductionCost extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")){
      ...
      printPageDataSheet(response, vars, strdateFrom, strdateTo, strmProductId, strCurrencyId);
      ...
      String strCurrencyId = vars.getGlobalVariable("inpCurrencyId", "ReportProductionCost|currency", strUserCurrencyId);
      printPageDataSheet(response, vars, strdateFrom, strdateTo, strmProductId, strCurrencyId);
      ...
      printPageOpen(response, vars, strdateFrom, strdateTo, strmProductId, strId, strLevel, strCurrencyId);
    }else pageError(response);
  }

  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strdateFrom, String strdateTo, String strmProductId, String strCurrencyId) throws IOException, ServletException {
    ...
    if (strdateFrom.equals("") && strdateTo.equals("")){
      ...
      try {
        data = ReportProductionCostData.select(this, strBaseCurrencyId, strCurrencyId, strLevel, strdateFrom,  DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Currency_ID", "", "", Utility.getContext(this, vars, "#User_Org", "ReportProductionCost"), Utility.getContext(this, vars, "#User_Client", "ReportProductionCost"), 0);
        Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportProductionCost", strCurrencyId);
  ...
  void printPageOpen(HttpServletResponse response, VariablesSecureApp vars, String strdateFrom, String strdateTo, String strmProductId, String strId, String strLevel, String strCurrencyId) throws IOException, ServletException {
    //Ajax response
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      try {
        dataMaterial = ReportProductionCostData.selectMaterial(this, strId, strLevel, strBaseCurrencyId, strCurrencyId, strdateFrom,  DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
      } catch(ServletException ex) {
        myMessage = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
      }
      strConvRateErrorMsg = myMessage.getMessage();
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      try {
        dataMachine = ReportProductionCostData.selectMachine(this, strLevel, strBaseCurrencyId, strCurrencyId, strdateFrom,  DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
      } catch(ServletException ex) {
        myMessage = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
      }
      strConvRateErrorMsg = myMessage.getMessage();
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      try {
        dataIndirect = ReportProductionCostData.selectIndirect(this, strLevel, strBaseCurrencyId, strCurrencyId, strdateFrom,  DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
      } catch(ServletException ex) {
        myMessage = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
      }
      strConvRateErrorMsg = myMessage.getMessage();
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      try {
        dataEmployee = ReportProductionCostData.selectEmployee(this, strLevel, strBaseCurrencyId, strCurrencyId, strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
      } catch(ServletException ex) {
        myMessage = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
      }
      strConvRateErrorMsg = myMessage.getMessage();
    ...
    if(strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      try {
        dataCostCenter = ReportProductionCostData.selectCostCenter(this, strLevel, strBaseCurrencyId, strCurrencyId, strdateFrom, DateTimeData.nDaysAfter(this, strdateTo,"1"), strmProductId);
      } catch(ServletException ex) {
        myMessage = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
      }
      strConvRateErrorMsg = myMessage.getMessage();
