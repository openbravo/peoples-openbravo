...
public class ReportProjectProfitabilityJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportProjectProfitabilityJR|Org", vars.getOrg());
            ...
            String strExpand = vars.getGlobalVariable("inpExpand",
                    "ReportProjectProfitabilityJR|Expand", "Y");
    ...
    void printPageDataHtml(HttpServletResponse response,
        ...
        String strBaseCurrencyId = Utility.stringBaseCurrencyId(this, vars
                .getClient());
        try {
            data = ReportProjectProfitabilityData.select(this, strCurrencyId,
                    strBaseCurrencyId, strDateFrom2, DateTimeData.nDaysAfter(
                            this, strDateTo2, "1"), strTreeOrg, Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportProjectProfitabilityJR"),
                    strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"),
                    strDateFrom3, DateTimeData
                            .nDaysAfter(this, strDateTo3, "1"), strProjectType,
                    strProject, strResponsible, strPartner);
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strDateTo, String strExpand, String strPartner,
            String strDateFrom2, String strDateTo2, String strDateFrom3,
            String strDateTo3, String strCurrencyId) throws IOException,
            ServletException {
        if (log4j.isDebugEnabled())
            log4j.debug("Output: dataSheet");
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportProjectProfitabilityJR", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportProjectProfitabilityJR.html", classInfo.id,
        ...
        xmlDocument.setParameter("dateFromdisplayFormat2", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFromsaveFormat2", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTo2", strDateTo2);
        xmlDocument.setParameter("dateTodisplayFormat2", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTosaveFormat2", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFrom3", strDateFrom3);
        xmlDocument.setParameter("dateFromdisplayFormat3", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFromsaveFormat3", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTo3", strDateTo3);
        xmlDocument.setParameter("dateTodisplayFormat3", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateTosaveFormat3", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        try {
            ...
            comboTableData = new ComboTableData(vars, this, "TABLE",
                    "Responsible_ID", "Responsible employee", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportProjectProfitabilityJR"), Utility
                            .getContext(this, vars, "#User_Client",
            ...
            comboTableData = new ComboTableData(vars, this, "TABLEDIR",
                    "AD_Org_ID", "", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportProjectProfitabilityJR"),
            ...
            comboTableData = new ComboTableData(vars, this, "TABLEDIR",
                    "C_Project_ID", "", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportProjectProfitabilityJR"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportProjectProfitabilityJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
            ...
            comboTableData = new ComboTableData(vars, this, "TABLEDIR",
                    "C_ProjectType_ID", "", "", Utility.getContext(this, vars,
                            "#User_Org", "ReportProjectProfitabilityJR"),
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportProjectProfitabilityJR"), 0);
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportProjectProfitabilityJR", strProjectType);
            xmlDocument.setData("reportC_ProjectType_ID", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
    ...
    void treeOrg(VariablesSecureApp vars, String strOrg)
        ...
        ReportProjectProfitabilityData[] dataOrg = ReportProjectProfitabilityData
