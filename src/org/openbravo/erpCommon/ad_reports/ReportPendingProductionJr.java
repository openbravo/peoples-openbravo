...
public class ReportPendingProductionJr extends HttpSecureAppServlet {
    ...
    void printPageDataHtml(HttpServletResponse response, VariablesSecureApp vars)
        ...
        data = ReportPendingProductionJrData.select(this, Utility.getContext(
                this, vars, "#User_Client", "ReportPendingProductionJr"),
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportPendingProductionJr", false, "", "", "", false,
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportPendingProductionJr.html", classInfo.id,
