...
public class ReportInvoiceCustomerDimensionalAnalysesJR extends
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strNotShown = vars.getInGlobalVariable("inpNotShown",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|notShown", "");
            ...
            String strPartnerSalesRepId = vars
                    .getGlobalVariable(
            ...
            if (vars.commandIn("DEFAULT_COMPARATIVE"))
                strComparative = vars
                        .getRequestGlobalVariable("inpComparative",
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    ...
                    strcProjectId, strProducttype, strOrder, strMayor,
            ...
            String strcBpartnerId = vars.getRequestInGlobalVariable(
                    ...
                    "ReportInvoiceCustomerDimensionalAnalysesJR|partner");
            String strProductCategory = vars
                    .getRequestGlobalVariable("inpProductCategory",
                            "ReportInvoiceCustomerDimensionalAnalysesJR|productCategory");
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|org", "0");
            String strsalesrepId = vars.getRequestGlobalVariable(
                    "inpSalesrepId",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|salesrep");
            String strcProjectId = vars.getRequestGlobalVariable(
                    "inpcProjectId",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|project");
            String strProducttype = vars.getRequestGlobalVariable(
                    "inpProducttype",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|producttype");
            ...
            String strComparative = vars.getStringParameter("inpComparative",
                    "N");
            String strPartnerSalesrepId = vars
                    .getRequestGlobalVariable("inpPartnerSalesrepId",
                            "ReportInvoiceCustomerDimensionalAnalysesJR|partnersalesrep");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportInvoiceCustomerDimensionalAnalysesJR|currency",
                    strUserCurrencyId);
            printPageHtml(response, vars, strComparative, strDateFrom,
                    ...
                    strDateFromRef, strDateToRef, strOrg, strsalesrepId,
                    strcProjectId, strProducttype, strOrder, strMayor,
                    strMenor, strPartnerSalesrepId, strCurrencyId, "html");
            ...
            printPageHtml(response, vars, strComparative, strDateFrom,
                    ...
                    strDateFromRef, strDateToRef, strOrg, strsalesrepId,
                    strcProjectId, strProducttype, strOrder, strMayor,
                    strMenor, strPartnerSalesrepId, strCurrencyId, "pdf");
        } else
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strcProjectId, String strProducttype, String strOrder,
            String strMayor, String strMenor, String strPartnerSalesrepId,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportInvoiceCustomerDimensionalAnalysesJRFilter", false, "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportInvoiceCustomerDimensionalAnalysesJR.html",
                    classInfo.id, classInfo.type, strReplaceWith, tabs
                            .breadcrumb());
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportInvoiceCustomerDimensionalAnalysesJR");
         ...
         * strmProductId); xmlDocument.setParameter("productDescription",
        ...
        xmlDocument.setParameter("projectName",
                ReportInvoiceCustomerDimensionalAnalysesJRData.selectProject(
                        this, strcProjectId));
        try {
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportInvoiceCustomerDimensionalAnalysesJRData.selectBpartner(
                        this, Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportInvoiceCustomerDimensionalAnalysesJRData.selectMproduct(
                        this, Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        ...
        try {
            ...
            Utility.fillSQLParameters(this, vars, null, comboTableData,
                    "ReportInvoiceCustomerDimensionalAnalysesJR", "");
            xmlDocument.setData("reportProductType", "liststructure",
                    comboTableData.select(false));
            comboTableData = null;
        } catch (Exception ex) {
            throw new ServletException(ex);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    ...
                    Utility.getContext(this, vars, "#User_Client",
                            "ReportInvoiceCustomerDimensionalAnalysesJR"), 0);
            Utility
                    .fillSQLParameters(this, vars, null, comboTableData,
                            "ReportInvoiceCustomerDimensionalAnalysesJR",
                            strCurrencyId);
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + ReportInvoiceCustomerDimensionalAnalysesJRData
                            .selectBpgroup(this, strPartnerGroup);
        ...
        if (!strProducttype.equals(""))
            strTitle = strTitle
                    + ", "
                    + Utility
                            .messageBD(this, "PRODUCTTYPE", vars.getLanguage())
                    + " "
                    + ReportInvoiceCustomerDimensionalAnalysesJRData
                            .selectProducttype(this, "270", vars.getLanguage(),
                                    strProducttype);
        ...
        if (!strPartnerSalesrepId.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + ReportInvoiceCustomerDimensionalAnalysesJRData
                            .selectSalesrep(this, strPartnerSalesrepId);
        ...
        String strBaseCurrencyId = Utility.stringBaseCurrencyId(this, vars
                .getClient());
        if (strComparative.equals("Y")) {
            try {
                data = ReportInvoiceCustomerDimensionalAnalysesJRData.select(
                        this, strCurrencyId, strBaseCurrencyId, strTextShow[0],
                        strTextShow[1], strTextShow[2], strTextShow[3],
                        strTextShow[4], strTextShow[5], strTextShow[6],
                        strTextShow[7], strTextShow[8], strTextShow[9], Tree
                                .getMembers(this, TreeData.getTreeOrg(this,
                                        vars.getClient()), strOrg),
                        Utility.getContext(this, vars, "#User_Client",
                                "ReportInvoiceCustomerDimensionalAnalysesJR"),
                ...
                data = ReportInvoiceCustomerDimensionalAnalysesJRData
                        .selectNoComparative(
                                ...
                                strDateFrom, DateTimeData.nDaysAfter(this,
                                        strDateTo, "1"), strPartnerGroup,
                                strcBpartnerId, strProductCategory,
                                strmProductId, strsalesrepId,
                                strPartnerSalesrepId, strcProjectId,
