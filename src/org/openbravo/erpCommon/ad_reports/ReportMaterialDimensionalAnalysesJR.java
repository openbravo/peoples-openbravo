...
public class ReportMaterialDimensionalAnalysesJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strcBpartnerId = vars.getInGlobalVariable(
                    "inpcBPartnerId_IN",
                    "ReportMaterialDimensionalAnalysesJR|partner", "");
            ...
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportMaterialDimensionalAnalysesJR|currency",
                    strUserCurrencyId);
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportMaterialDimensionalAnalysesFilterJR",
                        discard).createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportMaterialDimensionalAnalysesFilterJR", false, "", "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportMaterialDimensionalAnalysesFilterJR.html",
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportMaterialDimensionalAnalysesJR");
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_BP_Group_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportMaterialDimensionalAnalysesJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportMaterialDimensionalAnalysesJR"), 0);
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportMaterialDimensionalAnalysesJRData.selectBpartner(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportMaterialDimensionalAnalysesJRData.selectMproduct(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        ...
        if (vars.getLanguage().equals("en_US")) {
            xmlDocument.setData("structure1",
                    ReportMaterialDimensionalAnalysesJRData.selectNotShown(
                            this, strShown));
            xmlDocument
                    .setData(
                            "structure2",
            ...
            xmlDocument.setData("structure1",
                    ReportMaterialDimensionalAnalysesJRData.selectNotShownTrl(
    ...
    void printPageHtml(HttpServletRequest request,
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    ...
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportMaterialDimensionalAnalysesJRData.selectBpgroup(
        ...
        if (vars.getLanguage().equals("en_US")) {
            dimensionLabel = ReportMaterialDimensionalAnalysesJRData
                    .selectNotShown(this, "");
        } else {
            dimensionLabel = ReportMaterialDimensionalAnalysesJRData
        ...
        if (!strMayor.equals("") && !strMenor.equals("")) {
            strHaving = " HAVING (SUM(QTY) > " + strMayor + " AND SUM(QTY) < "
                    + strMenor + ")";
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportMaterialDimensionalAnalysesJRData.select(this,
