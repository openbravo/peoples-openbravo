...
public class ReportSalesDimensionalAnalyzeJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strOrder = vars.getGlobalVariable("inpOrder",
                    "ReportSalesDimensionalAnalyzeJR|order", "Normal");
            ...
            String strPartnerSalesRepId = vars.getGlobalVariable(
                    "inpPartnerSalesrepId",
                    "ReportSalesDimensionalAnalyzeJR|partnersalesrep", "");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportSalesDimensionalAnalyzeJR|currency",
                    strUserCurrencyId);
            String strComparative = "";
            if (vars.commandIn("DEFAULT_COMPARATIVE"))
                strComparative = vars.getRequestGlobalVariable(
                        "inpComparative",
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    strDateTo, strPartnerGroup, strcBpartnerId,
                    strProductCategory, strmProductId, strmWarehouseId,
                    strNotShown, strShown, strDateFromRef, strDateToRef,
                    strOrg, strsalesrepId, strOrder, strMayor, strMenor,
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportSalesDimensionalAnalyzeJR|dateTo");
            String strDateFromRef = vars.getRequestGlobalVariable(
                    "inpDateFromRef",
                    "ReportSalesDimensionalAnalyzeJR|dateFromRef");
            String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef",
                    "ReportSalesDimensionalAnalyzeJR|dateToRef");
            String strPartnerGroup = vars.getRequestGlobalVariable(
                    "inpPartnerGroup",
                    "ReportSalesDimensionalAnalyzeJR|partnerGroup");
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportSalesDimensionalAnalyzeJR|org", "0");
            String strsalesrepId = vars
                    .getRequestGlobalVariable("inpSalesrepId",
                            "ReportSalesDimensionalAnalyzeJR|salesrep");
            ...
            String strComparative = vars.getStringParameter("inpComparative",
                    "N");
            String strPartnerSalesrepId = vars.getRequestGlobalVariable(
                    "inpPartnerSalesrepId",
                    "ReportSalesDimensionalAnalyzeJR|partnersalesrep");
            String strCurrencyId = vars.getGlobalVariable("inpCurrencyId",
                    "ReportSalesDimensionalAnalyzeJR|currency",
            ...
            printPageHtml(response, vars, strComparative, strDateFrom,
                    ...
                    strNotShown, strShown, strDateFromRef, strDateToRef,
                    strOrg, strsalesrepId, strOrder, strMayor, strMenor,
                    strPartnerSalesrepId, strCurrencyId, "html");
            ...
            printPageHtml(response, vars, strComparative, strDateFrom,
                    ...
                    strNotShown, strShown, strDateFromRef, strDateToRef,
                    strOrg, strsalesrepId, strOrder, strMayor, strMenor,
                    strPartnerSalesrepId, strCurrencyId, "pdf");
        } else
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strmWarehouseId, String strNotShown, String strShown,
            String strDateFromRef, String strDateToRef, String strOrg,
            String strsalesrepId, String strOrder, String strMayor,
        ...
        xmlDocument = xmlEngine
                .readXmlTemplate(
                        "org/openbravo/erpCommon/ad_reports/ReportSalesDimensionalAnalyzeJRFilter",
                        discard).createXmlDocument();

        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportSalesDimensionalAnalyzeJRFilter", false, "", "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportSalesDimensionalAnalyzeJRFilter.html", classInfo.id,
                    classInfo.type, strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportSalesDimensionalAnalyzeJRFilter.html",
                    strReplaceWith);
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportSalesDimensionalAnalyzeJR");
        ...
        xmlDocument.setParameter("dateFromRefdisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateFromRefsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateToRef", strDateToRef);
        xmlDocument.setParameter("dateToRefdisplayFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        xmlDocument.setParameter("dateToRefsaveFormat", vars
                .getSessionValue("#AD_SqlDateFormat"));
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "M_Warehouse_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportSalesDimensionalAnalyzeJR"), Utility
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_BP_Group_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportSalesDimensionalAnalyzeJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportSalesDimensionalAnalyzeJR"), 0);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "SalesRep_ID", "AD_User SalesRep", "", Utility
                            .getContext(this, vars, "#User_Org",
                                    "ReportSalesDimensionalAnalyzeJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportSalesDimensionalAnalyzeJR"), 0);
        ...
        xmlDocument.setData("reportCBPartnerId_IN", "liststructure",
                ReportSalesDimensionalAnalyzeJRData.selectBpartner(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strcBpartnerId));
        xmlDocument.setData("reportMProductId_IN", "liststructure",
                ReportSalesDimensionalAnalyzeJRData.selectMproduct(this,
                        Utility.getContext(this, vars, "#User_Org", ""),
                        Utility.getContext(this, vars, "#User_Client", ""),
                        strmProductId));
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLE", "", "C_BPartner SalesRep", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportSalesDimensionalAnalyzeJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportSalesDimensionalAnalyzeJR"), 0);
        ...
        try {
            ComboTableData comboTableData = new ComboTableData(vars, this,
                    "TABLEDIR", "C_Currency_ID", "", "", Utility.getContext(
                            this, vars, "#User_Org",
                            "ReportSalesDimensionalAnalyzeJR"), Utility
                            .getContext(this, vars, "#User_Client",
                                    "ReportSalesDimensionalAnalyzeJR"), 0);
        ...
        if (vars.getLanguage().equals("en_US")) {
            xmlDocument.setData("structure1",
                    ReportSalesDimensionalAnalyzeJRData.selectNotShown(this,
                            strShown));
            xmlDocument
                    .setData(
                            "structure2",
                            strShown.equals("") ? new ReportSalesDimensionalAnalyzeJRData[0]
                                    : ReportSalesDimensionalAnalyzeJRData
                                            .selectShown(this, strShown));
        } else {
            xmlDocument.setData("structure1",
                    ReportSalesDimensionalAnalyzeJRData.selectNotShownTrl(this,
    ...
    void printPageHtml(HttpServletResponse response, VariablesSecureApp vars,
        ...
        String strOrderby = "";
        String[] discard = { "", "", "", "", "", "", "", "", "" };
        String[] discard1 = { "selEliminarBody1", "discard", "discard",
        ...
        String strTitle = "";
        strTitle = Utility.messageBD(this, "From", vars.getLanguage()) + " "
                + strDateFrom + " "
        ...
        if (!strPartnerGroup.equals(""))
            strTitle = strTitle
                    + ", "
                    + Utility.messageBD(this, "ForBPartnerGroup", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeJRData.selectBpgroup(this,
                            strPartnerGroup);
        if (!strProductCategory.equals(""))
            strTitle = strTitle
                    + ", "
                    + Utility.messageBD(this, "ProductCategory", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeJRData
        ...
        if (!strsalesrepId.equals(""))
            strTitle = strTitle
                    + ", "
                    + Utility
                            .messageBD(this, "TheSalesRep", vars.getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeJRData.selectSalesrep(this,
                            strsalesrepId);
        if (!strPartnerSalesrepId.equals(""))
            strTitle = strTitle
                    + ", "
                    + Utility.messageBD(this, "TheClientSalesRep", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeJRData.selectSalesrep(this,
        ...
        if (!strmWarehouseId.equals(""))
            strTitle = strTitle
                    ...
                    + " "
                    + Utility.messageBD(this, "TheWarehouse", vars
                            .getLanguage())
                    + " "
                    + ReportSalesDimensionalAnalyzeJRData.selectMwarehouse(
                            this, strmWarehouseId);
        ...
        if (vars.getLanguage().equals("en_US")) {
            dimensionLabel = ReportSalesDimensionalAnalyzeJRData
                    .selectNotShown(this, "");
        } else {
            dimensionLabel = ReportSalesDimensionalAnalyzeJRData
                    .selectNotShownTrl(this, vars.getLanguage(), "");
        }
        ...
        if (strComparative.equals("Y")) {
            try {
                data = ReportSalesDimensionalAnalyzeJRData.select(this,
                        strCurrencyId, strTextShow[0], strTextShow[1],
                        strTextShow[2], strTextShow[3], strTextShow[4],
                        strTextShow[5], strTextShow[6], strTextShow[7],
                        strTextShow[8], Tree.getMembers(this, TreeData
                                .getTreeOrg(this, vars.getClient()), strOrg),
                        Utility.getContext(this, vars, "#User_Client",
                                "ReportSalesDimensionalAnalyzeJR"),
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), strPartnerGroup, strcBpartnerId,
                        strProductCategory, strmProductId, strmWarehouseId,
                        strsalesrepId, strPartnerSalesrepId, strDateFromRef,
            ...
            try {
                data = ReportSalesDimensionalAnalyzeJRData.selectNoComparative(
                        this, strCurrencyId, strTextShow[0], strTextShow[1],
                        strTextShow[2], strTextShow[3], strTextShow[4],
                        strTextShow[5], strTextShow[6], strTextShow[7],
                        strTextShow[8], Tree.getMembers(this, TreeData
                                .getTreeOrg(this, vars.getClient()), strOrg),
                        ...
                        strDateFrom, DateTimeData.nDaysAfter(this, strDateTo,
                                "1"), strPartnerGroup, strcBpartnerId,
                        strProductCategory, strmProductId, strmWarehouseId,
                        strsalesrepId, strPartnerSalesrepId, strOrderby);
            } catch (ServletException ex) {
                myMessage = Utility.translateError(this, vars, vars
                        .getLanguage(), ex.getMessage());
            }
