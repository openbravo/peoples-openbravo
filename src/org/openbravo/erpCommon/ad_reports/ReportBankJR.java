...
public class ReportBankJR extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
                    "ReportBankJR|DateTo");
            String strcbankaccount = vars.getRequestGlobalVariable(
                    "inpcBankAccountId", "ReportBankJR|C_Bankaccount_ID");
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strcbankaccount) throws IOException, ServletException {
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportBankJR",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportBankJR.html", classInfo.id, classInfo.type,
                    strReplaceWith, tabs.breadcrumb());
            xmlDocument.setParameter("navigationBar", nav.toString());
            LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
                    "ReportBankJR.html", strReplaceWith);
        ...
        xmlDocument.setData("reportC_ACCOUNTNUMBER", "liststructure",
                AccountNumberComboData.select(this, Utility.getContext(this,
                        vars, "#User_Client", "ReportBankJR"), Utility
                        .getContext(this, vars, "#User_Org", "ReportBankJR")));
    ...
    void printPageDataHtml(HttpServletResponse response,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            XmlDocument xmlDocument = null;
            xmlDocument = xmlEngine.readXmlTemplate(
                    "org/openbravo/erpCommon/ad_reports/ReportBankJR", discard)
                    .createXmlDocument();
            data = ReportBankJRData.set();
            if (vars.commandIn("FIND")) {
                strMessage = Utility.messageBD(this, "BothDatesCannotBeBlank",
                        vars.getLanguage());
                log4j.warn("Both dates are blank");
            }
            ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                    "ReportBankJR", false, "", "", "", false, "ad_reports",
            ...
            xmlDocument.setParameter("paramMessage",
                    (strMessage.equals("") ? "" : "alert('" + strMessage
                            + "');"));
            xmlDocument.setData("reportC_ACCOUNTNUMBER", "liststructure",
                    AccountNumberComboData.select(this, Utility.getContext(
                            this, vars, "#User_Client", "ReportBankJR"),
            ...
            // strcbankaccount));
            data = ReportBankJRData
                    .select(this, vars.getLanguage(), Utility.getContext(this,
                            vars, "#User_Client", "ReportBankJR"),
                            Utility.getContext(this, vars, "#User_Org",
                                    "ReportBankJR"), strDateFrom, DateTimeData
