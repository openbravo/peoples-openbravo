...
public class ReportAnnualCertification extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT")) {
            ...
            String strOrg = vars.getGlobalVariable("inpOrg",
                    "ReportAnnualCertification|Org", "0");
            ...
            String strAll = vars.getGlobalVariable("inpAll",
                    "ReportAnnualCertification|All", "");
            String strReportType = vars.getRequestGlobalVariable(
                    "inpcReportType", "ReportAnnualCertification|ReportType");
            ...
            printPageDataSheet(response, vars, strDateFrom, strDateTo,
                    ...
                    strReportType, strHide, strcAcctSchemaId);
            ...
            if (strHide.equals(""))
                vars
                        .removeSessionValue("ReportAnnualCertification|HideMatched");
            else
            ...
            if (log4j.isDebugEnabled())
                log4j
                        .debug("##################### DoPost - XLS - strcelementvalueto= "
                                + strcelementvalueto);
            vars.setSessionValue("ReportAnnualCertification.initRecordNumber",
                    "0");
            ...
            if (strInitRecord.equals("") || strInitRecord.equals("0"))
                ...
                strInitRecord = ((initRecord < 0) ? "0" : Integer
                        .toString(initRecord));
                vars.setSessionValue(
                        "ReportAnnualCertification.initRecordNumber",
                        strInitRecord);
            }
    ...
    void printPageDataSheet(HttpServletResponse response,
            ...
            String strAll, String strReportType, String strHide,
        ...
        ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
                "ReportAnnualCertification", false, "", "",
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportAnnualCertification.html", classInfo.id,
        ...
        if (strDateFrom.equals("") && strDateTo.equals("")) {
            ...
            data = ReportAnnualCertificationData.select(this, Utility
                    .getContext(this, vars, "#User_Client",
                            "ReportAnnualCertification"), Utility.getContext(
                    this, vars, "#User_Org", "ReportAnnualCertification"),
    ...
    void printPageDataPDF(HttpServletResponse response,
        ...
        ReportAnnualCertificationData[] data = null;
        data = ReportAnnualCertificationData.select(this, Utility.getContext(
                this, vars, "#User_Client", "ReportAnnualCertification"),
                Utility.getContext(this, vars, "#User_Org",
                        "ReportAnnualCertification"), strDateFrom, DateTimeData
        ...
        OrganizationData[] dataOrganization = OrganizationData.select(this,
                vars.getLanguage(), sClientID, sOrganID);
