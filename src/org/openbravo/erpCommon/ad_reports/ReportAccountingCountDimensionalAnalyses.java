...
public class ReportAccountingCountDimensionalAnalyses extends
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
            ...
            String strAccountingCount = vars.getGlobalVariable(
                    "inpAccountingCount",
            ...
            printPageDataSheet(response, vars, strComparative, strDateFrom,
                    strDateTo, strAccountingCount, strcBpartnerId,
                    strmProductId, strShown, strDateFromRef, strDateToRef,
                    strOrg, strcProjectId, strPeriod, strLevel, strColumnLevel);
            ...
            String strDateToRef = vars.getRequestGlobalVariable("inpDateToRef",
                    "ReportAccountingCountDimensionalAnalyses|dateToRef");
            String strAccountingCount = vars.getRequestGlobalVariable(
                    "inpAccountingCount",
                    "ReportAccountingCountDimensionalAnalyses|accountingCount");
            ...
            String strPeriod = vars.getRequestGlobalVariable("inpPeriod",
                    "ReportAccountingCountDimensionalAnalyses|period");
            printPageDataHtml(response, vars, strComparative, strDateFrom,
                    strDateTo, strAccountingCount, strcBpartnerId,
                    strmProductId, strShown, strDateFromRef, strDateToRef,
                    strOrg, strcProjectId, strPeriod, strLevel, strColumnLevel);
            ...
            String strDateTo = vars
                    .getSessionValue("ReportAccountingCountDimensionalAnalyses|dateTo");
            ...
            String strShown = vars
                    .getSessionValue("ReportAccountingCountDimensionalAnalyses|shown");
            String strOrg = vars
                    .getSessionValue("ReportAccountingCountDimensionalAnalyses|org");
            if (strOrg.equals(""))
                strOrg = "0";
            ...
            String strPeriod = vars
                    .getSessionValue("ReportAccountingCountDimensionalAnalyses|period");
            // String strPeriod="without";
            // String strPeriod = "without";
            // //vars.getRequestGlobalVariable("inpPeriod",
            // "ReportAccountingCountDimensionalAnalyses|period");
            printPageOpen(response, vars, strComparative, strDateFrom,
                    strDateTo, strAccountingCount, strcBpartnerId,
                    strmProductId, strShown, strDateFromRef, strDateToRef,
                    strOrg, strcProjectId, strPeriod, strLevel, strColumnLevel);
    ...
    void printPageDataHtml(HttpServletResponse response,
            ...
            String strDateTo, String strAccountingCount, String strcBpartnerId,
            String strmProductId, String strShown, String strDateFromRef,
            String strDateToRef, String strOrg, String strcProjectId,
            String strPeriod, String strLevel, String strColumnLevel)
            throws IOException, ServletException {
        // Find response
        if (log4j.isDebugEnabled())
            log4j.debug("Output: dataSheet - period:" + strPeriod
                    + " strAccountingCount:" + strAccountingCount);
        ...
        if (strAccountingCount.equals("")) {
            ...
            arrayString = createArrayString(vectorArray, strShown,
                    strColumnLevel);
            strFilter = createFilter(vars, vectorArray, strShown,
                    arrayString[1]);
            ...
            if (strPeriod.equals("without")) {
                if (strComparative.equals("Y")) {
                    ...
                    data = ReportAccountingCountDimensionalAnalysesData
                            .selectComparative(
                                    this,
                                    "'" + arrayString[0] + "'",
                                    "''",
                                    arrayString[2],
                                    arrayString[1],
                                    vars.getStringParameter("inpNivel1", "0"),
                                    vars.getStringParameter("inpNivel2", "0"),
                                    vars.getStringParameter("inpNivel3", "0"),
                                    vars.getStringParameter("inpNivel4", "0"),
                                    arrayString[3],
                                    Utility
                                            .getContext(this, vars,
                                                    "#User_Client",
                                                    "ReportAccountingCountDimensionalAnalyses"),
                                    strAccountingCount, strDateFrom,
                                    DateTimeData.nDaysAfter(this, strDateTo,
                                            "1"), Tree.getMembers(this,
                                            TreeData.getTreeOrg(this, vars
                                                    .getClient()), strOrg),
                                    strcBpartnerId, strmProductId,
                                    strcProjectId, strFilter, strGroupBy,
                                    strDateFromRef, DateTimeData.nDaysAfter(
                                            this, strDateToRef, "1"),
                ...
                dataPeriod = ReportAccountingCountDimensionalAnalysesData
                        .selectDate(this, strDateFrom, strDateTo);
                if (!strComparative.equals("Y")) {
                    discard1[0] = "selEliminarDetail1";
                    discard1[1] = "selEliminarDetail3";
                    discard1[2] = "selEliminarDetail4";
                    ...
                    data = ReportAccountingCountDimensionalAnalysesData
                            .selectPeriod(
                                    ...
                                    strcBpartnerId, strmProductId,
                                    strcProjectId, strFilter, strGroupBy,
                                    strDateTo, arrayString[4], arrayString[5]);
                    if (data == null || data.length == 0)
                        data = ReportAccountingCountDimensionalAnalysesData
                                .set();
                } else {
                ...
                dataPeriod = ReportAccountingCountDimensionalAnalysesData
                        .selectQuarter(this, strDateFrom, strDateTo);
                if (!strComparative.equals("Y")) {
                    discard1[0] = "selEliminarDetail1";
                    discard1[1] = "selEliminarDetail3";
                    discard1[2] = "selEliminarDetail4";
                    ...
                    discard1[2] = "selEliminarDetail2";
                    data = ReportAccountingCountDimensionalAnalysesData
                            .selectPeriodComparativeQuarter(
                                    this,
                                    "'" + arrayString[0] + "'",
                                    "''",
                                    arrayString[2],
        ...
        xmlDocument.setParameter("title", " From: " + strDateFrom + " - To: "
                + strDateTo);
     ...
     * vars, String strComparative, String strDateFrom, String strDateTo, String
     * strAccountingCount, String strcBpartnerId, String strmProductId, String
     * strShown, String strDateFromRef, String strDateToRef, String strOrg,
     * String strcProjectId, String strPeriod, String strLevel, String
     ...
     * arrayVector = {"", "", "", "", "", ""}; Vector<Object> vectorArray =
     * createVector();
     * 
     * XmlDocument xmlDocument=null; String strTitle = ""; String strGroupBy =
     * ""; String strFilter = "";
     * 
     * 
     * String[] arrayString = {"", "", "", "", "", ""};
     ...
     * "ReportAccountingCountDimensionalAnalysesFilter", false, "", "",
     ...
     * xmlDocument.setParameter("calendarLanguage",
     * vars.getLanguage().substring(0,2)); xmlDocument.setParameter("dateFrom",
     * strDateFrom); xmlDocument.setParameter("dateFromdisplayFormat",
     ...
     * ReportAccountingCountDimensionalAnalysesData.selectProject(this,
     * strcProjectId)); xmlDocument.setParameter("withoutPeriod", strPeriod);
     ...
     * Utility.getContext(this, vars, "#User_Org", ""), Utility.getContext(this,
     ...
     * "ReportAccountingCountDimensionalAnalyses.html", classInfo.id,
     ...
     * vars.removeMessage("ReportAccountingCountDimensionalAnalyses"); if
     * (myMessage!=null) { xmlDocument.setParameter("messageType",
     * myMessage.getType()); xmlDocument.setParameter("messageTitle",
     * myMessage.getTitle()); xmlDocument.setParameter("messageMessage",
    ...
    void printPageDataSheet(HttpServletResponse response,
        ...
        // Find response
        if (log4j.isDebugEnabled())
            log4j.debug("Output: dataSheet strAccountingCount:"
                    + strAccountingCount);

        XmlDocument xmlDocument = null;
        String discard1[] = { "discard", "discard", "discard", "discard" };

        ReportAccountingCountDimensionalAnalysesData[] dataList = createList(
                vars, strShown);
        if (!strComparative.equals("Y")) {
        ...
        xmlDocument.setParameter("directory", "var baseDirectory = \""
                + strReplaceWith + "/\";\n");
        xmlDocument.setParameter("calendarLanguage", vars.getLanguage()
                .substring(0, 2));
        ...
        xmlDocument.setParameter("cProjectId", strcProjectId);
        xmlDocument.setParameter("projectName",
                ReportAccountingCountDimensionalAnalysesData.selectProject(
                        this, strcProjectId));
        ...
        try {
            ...
            NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
                    "ReportAccountingCountDimensionalAnalyses.html",
        ...
        }
        {
            OBError myMessage = vars
                    .getMessage("ReportAccountingCountDimensionalAnalyses");
    ...
    void printPageOpen(HttpServletResponse response, VariablesSecureApp vars,
            ...
            String strAccountingCount, String strcBpartnerId,
            String strmProductId, String strShown, String strDateFromRef,
            String strDateToRef, String strOrg, String strcProjectId,
            String strPeriod, String strLevel, String strColumnLevel)
            throws IOException, ServletException {
        // Ajax response
        if (log4j.isDebugEnabled())
            log4j.debug("Output: open - period: " + strPeriod
                    + " strAccountingCount:" + strAccountingCount);
        Vector<Object> vectorArray = createVector();
        String strGroupBy = "";
        String strFilter = "";
        ...
        if (strAccountingCount.equals("")) {
            ...
            String[] arrayString = createArrayString(vectorArray, strShown,
                    strColumnLevel);
            if (log4j.isDebugEnabled())
                log4j.debug("array created, length:" + arrayString.length
                        + "creating filter");
            strFilter = createFilter(vars, vectorArray, strShown,
                    arrayString[1]);
            if (log4j.isDebugEnabled())
            ...
            if (strPeriod.equals("without")) {
                if (!strComparative.equals("Y")) {
                    ...
                    xmlDocument = xmlEngine
                            ...
                            .createXmlDocument();
                    if (log4j.isDebugEnabled())
                        log4j.debug("inpLevel"
                                + strLevel
                                + ":"
                                + vars
                                        .getStringParameter("inpNivel"
                                                + strLevel));
                    data = ReportAccountingCountDimensionalAnalysesData
                            .select(
                                    this,
                                    "'" + arrayString[0] + "'",
                                    vars.getStringParameter("inpNivel"
                                            + strLevel),
                                    arrayString[2],
                                    arrayString[1],
                                    vars.getStringParameter("inpNivel1", "0"),
    ...
    Vector<Object> createVector() throws IOException, ServletException {
        ...
        ReportAccountingCountDimensionalAnalysesData[] data = ReportAccountingCountDimensionalAnalysesData
                .selectDimension(this,
                        "RV_ReportAccountingCountDimensionalAnaly");
    ...
    ReportAccountingCountDimensionalAnalysesData[] createList(
            VariablesSecureApp vars, String strShown) throws IOException,
            ServletException {
        ...
        if (!strShown.equals("")) {
            ...
            if (!strShown.equals("")) {
                ...
                while (st.hasMoreTokens()) {
                    ...
                    data[intContador].name = ReportAccountingCountDimensionalAnalysesData
                            .selectDimensionName(this, vars.getLanguage(),
                                    strAux);
                    intContador++;
                }
            }
            ...
            for (int i = 0; i < dataDimension.length; i++) {
                ...
                data[i].name = ReportAccountingCountDimensionalAnalysesData
                        .selectDimensionName(this, vars.getLanguage(),
                                dataDimension[i].columnname);
            }
        }
        return data;
    ...
    String[] createArrayString(Vector<Object> vectorArray, String strShown,
        ...
        if (log4j.isDebugEnabled())
            log4j.debug("createArrayString strShown:" + strShown + " - level:"
                    + strColumnLevel);
    ...
    String createFilter(VariablesSecureApp vars, Vector<Object> vectorArray,
            String strShown, String strLevel) throws IOException,
            ServletException {
        // Method which creates filter to sqlc.
        if (log4j.isDebugEnabled())
            log4j.debug("Filter params: strShown:" + strShown + " - level:"
                    + strLevel);
        String strFilter = "";
    ...
    String createGroupby(Vector<Object> vectorArray, String strShown,
