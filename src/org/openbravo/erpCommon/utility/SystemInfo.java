...
public class SystemInfo {
    ...
    public static void load(Item i, ConnectionProvider conn)
        ...
        case SERVLET_CONTAINER_VERSION:
            systemInfo.put(i, SystemInfoData
                    .selectServletContainerVersion(conn));
            break;
        case ANT_VERSION:
            systemInfo
                    .put(i, getVersion(SystemInfoData.selectAntVersion(conn)));
            break;
        case OB_VERSION:
    ...
    final static String getSystemIdentifier(ConnectionProvider conn)
            throws ServletException {
    ...
    final static String getDatabaseVersion(ConnectionProvider conn)
            throws ServletException {
        validateConnection(conn);
        ...
        if ("ORACLE".equals(database)) {
            databaseVersion = getVersion(SystemInfoData
                    .selectOracleVersion(conn));
        } else {
    ...
    /**
     * Runs a native command to try and locate the user's web server version.
     * Tests all combinations of paths + commands.
     * 
    ...
    final static String[] getWebserver(ConnectionProvider conn) {
        ...
        String[] paths = { "/usr/local/sbin", "/usr/local/bin", "/usr/sbin",
                "/usr/bin", "/sbin", "/bin" };
    ...
    /**
     * Returns the activity rate of the system. Range: 0..............1.-
     * Inactive 1-100..........2.- Low 101-500........3.- Medium
     * 500-1000.......4.- High 1001 or more...5.- Very High
     * 
     * @param data
     * @return
     * @throws ServletException
     */
    final static String getActivityRate(ConnectionProvider conn)
            throws ServletException {
        String result = null;
        int activityRate = Integer.valueOf(SystemInfoData
                .selectActivityRate(conn));
        if (activityRate == 0) {
            result = "1";
    ...
    /**
     * Returns the complexity rate of the system Range: 0-2 ............1.- Low
     * 3-6.............2.- Medium 7 or more.......3.- High
     * 
     * @param data
     * @return
     * @throws ServletException
     */
    final static String getComplexityRate(ConnectionProvider conn)
            throws ServletException {
        String result = null;
        int complexityRate = Integer.valueOf(SystemInfoData
                .selectComplexityRate(conn));
    ...
    public static boolean validateConnection(ConnectionProvider conn)
            throws ServletException {
        if (conn == null) {
    ...
    /**
     * Returns the string representation of a numerical version from a longer
     * string. For example, given the string: 'Apache Ant version 1.7.0 compiled
     * on August 29 2007' getVersion() will return '1.7.0'
     * 
     * @param str
     * @return
     */
    ...
    public enum Item {
        SYSTEM_IDENTIFIER("systemIdentifier"), OPERATING_SYSTEM("os"), OPERATING_SYSTEM_VERSION(
                "osVersion"), DATABASE("db"), DATABASE_VERSION("dbVersion"), WEBSERVER(
                "webserver"), WEBSERVER_VERSION("webserverVersion"), SERVLET_CONTAINER(
                "servletContainer"), SERVLET_CONTAINER_VERSION(
                "servletContainerVersion"), ANT_VERSION("antVersion"), OB_VERSION(
                "obVersion"), OB_INSTALL_MODE("obInstallMode"), CODE_REVISION(
                "codeRevision"), NUM_REGISTERED_USERS("numRegisteredUsers"), ISHEARTBEATACTIVE(
                "isheartbeatactive"), ISPROXYREQUIRED("isproxyrequired"), PROXY_SERVER(
                "proxyServer"), PROXY_PORT("proxyPort"), ACTIVITY_RATE(
                "activityRate"), COMPLEXITY_RATE("complexityRate"), JAVA_VERSION(
                "javaVersion");
