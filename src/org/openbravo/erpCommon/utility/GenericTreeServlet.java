 ...
 * 
 * It is able to manage the following commands:
 *   -OPENNODE    : Opens the subtree for the node, and returns its subtree.
 *   -DESCRIPTION : Returns the description for a node.
 *   -DESCRIPTION2: Returns an alternative description (e.g. Update description for Modules)
 *
 */
public class GenericTreeServlet extends HttpSecureAppServlet {
   ...
   */
  void printOpenNode(HttpServletResponse response, VariablesSecureApp vars, String strNodeId, String treeClass, String level) throws IOException, ServletException {
   ...
   * @throws ServletException
   */
  void printDescription(HttpServletResponse response, VariablesSecureApp vars, String strNodeId, String treeClass, int type) throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: ajaxreponse");
