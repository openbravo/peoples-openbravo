...
/**
 * The DalQueryTool supports entering HQL queries in a webpage and see the result directly displayed
 * in the browser.
 * 
 * @author mtaal
 */
...
public class HQLQueryTool extends HttpSecureAppServlet {
  ...
  private String getResult(VariablesSecureApp vars) {
    ...
    try {
      ...
      final String xmlTemplateName = "org/openbravo/erpCommon/utility/HQLQueryTool_Result";
  ...
  private String getErrorResult(VariablesSecureApp vars, Throwable t) {
    ...
    final String xmlTemplateName = "org/openbravo/erpCommon/utility/HQLQueryTool_Error";
    final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(xmlTemplateName).createXmlDocument();
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, OBError obError)
    ...
    String xmlTemplateName = "org/openbravo/erpCommon/utility/HQLQueryTool";
  ...
  private FieldProvider[] getEntityFieldProviders() {
    ...
    final SimpleFieldProvider fpEmpty = new SimpleFieldProvider();
    fpEmpty.setField("id", "");
