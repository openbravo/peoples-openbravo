...
public class SetPriorityCategoryData implements FieldProvider {
    ...
    public static SetPriorityCategoryData[] getCategories() {
        ...
        Vector<SetPriorityCategoryData> vector = new Vector<SetPriorityCategoryData>(
                0);
        for (Enumeration<?> e = LogManager.getCurrentLoggers(); e
            ...
            if (categoryItem.getLevel() != null) {
                setPriorityCategoryData.priority = categoryItem.getLevel()
                        .toString();
            }
            if (vector.isEmpty()) {
        ...
        SetPriorityCategoryData categoryData[] = new SetPriorityCategoryData[vector
                .size()];
