...
public class ReportManager {
    ...
    public void processReport(Report report, VariablesSecureApp variables)
        ...
        templateLocation = Replace.replace(Replace.replace(templateLocation,
                ...
                _strAttachmentPath);
        String templateFile = templateLocation
        ...
        try {
            ...
            DecimalFormat NumberFormat = new DecimalFormat(variables
            ...
            File targetDirectory = new File(_strAttachmentPath + "/"
                    + TEMP_REPORT_DIR);
            if (!targetDirectory.exists())
                targetDirectory.mkdirs();

            String target = _strAttachmentPath + "/" + TEMP_REPORT_DIR + "/"
                    + report.getFilename();
    ...
    public File createAttachmentForReport(
        ...
        File destinationFolder = new File(_strAttachmentPath + "/"
                + destination);
