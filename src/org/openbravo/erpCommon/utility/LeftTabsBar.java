...
public class LeftTabsBar {
    ...
    public LeftTabsBar(ConnectionProvider _conn, String _language,
            String _action, String _baseDirection) {
        this.conn = _conn;
    ...
    public String editionTemplate(boolean isNew) {
        String strClassEdition = "Main_LeftTabsBar_ButtonRight_Icon_edition"
                + (isNew ? "_new" : "") + "_selected";
        ...
        text
                .append("      <table cellpadding=\"0\" cellspacing=\"0\" class=\"Main_LeftTabsBar\">\n");
        text.append("        <tr>\n");
        ...
        text.append("        <tr>\n");
        text
                .append("          <td class=\"Main_LeftTabsBar_bg_separator_cell\">\n");
        text.append("          </td>\n");
        text.append("        </tr>\n");
        text.append("        <tr>\n");
        text.append("          <td>\n");
        text
                .append("                <div class=\"Main_LeftTabsBar_ButtonRight_selected\">\n");
        text
                .append(
                        "                  <img class=\"Main_LeftTabsBar_ButtonRight_Icon ")
                .append(strClassEdition)
                .append(
                        "\" alt=\""
                                + Utility.messageBD(this.conn, "Form View",
                                        this.language)
                                + "\" title=\""
                                + Utility.messageBD(this.conn, "Form View",
                                        this.language) + "\" src=\"")
                .append(base_direction)
                .append(
                        "/images/blank.gif\" border=\"0\" id=\"linkButtonEdition\"></img>\n");
        text.append("                </div>\n");
        text.append("          </td>\n");
        text.append("        </tr>\n");
        text.append("        <tr>\n");
        ...
        text
                .append(
                        "                  <img class=\"Main_LeftTabsBar_ButtonRight_Icon Main_LeftTabsBar_ButtonRight_Icon_relation\" alt=\""
                                + Utility.messageBD(this.conn, "Grid View",
                                        this.language)
                                + "\" title=\""
                                + Utility.messageBD(this.conn, "Grid View",
                                        this.language) + "\" src=\"").append(
                        base_direction).append(
        ...
        text.append("        <tr>\n");
        text
                .append("          <td class=\"Main_LeftTabsBar_bg_empty_cell\">\n");
        text.append("          </td>\n");
        text.append("        </tr>\n");
        text.append("      </table>\n");
        text.append("    </td>\n");
