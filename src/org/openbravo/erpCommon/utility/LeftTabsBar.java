...
public class LeftTabsBar {
  ...
  public String editionTemplate(boolean isNew) {
    ...
    text.append("                  <IMG class=\"Main_LeftTabsBar_ButtonRight_Icon ").append(strClassEdition).append("\" alt=\"" + Utility.messageBD(this.conn, "Form View", this.language) + "\" title=\"" + Utility.messageBD(this.conn, "Form View", this.language) + "\" src=\"").append(base_direction).append("/images/blank.gif\" border=\"0\" id=\"linkButtonEdition\"></IMG>\n");
    text.append("                </DIV>\n");
    text.append("          </td>\n");
    text.append("        </tr>\n");
    text.append("        <tr>\n");
  ...
  public String relationTemplate() {
    ...
    text.append("                  <IMG class=\"Main_LeftTabsBar_ButtonRight_Icon Main_LeftTabsBar_ButtonRight_Icon_edition\" alt=\"" + Utility.messageBD(this.conn, "Form View", this.language) + "\" title=\"" + Utility.messageBD(this.conn, "Form View", this.language) + "\" src=\"").append(base_direction).append("/images/blank.gif\" border=\"0\"></IMG>\n");
    text.append("                </A>\n");
    text.append("          </td>\n");
    text.append("        </tr>\n");
    text.append("        <tr>\n");
