...
public class KeyMap {
     ...
     * @throws Exception
     */
    public KeyMap(ConnectionProvider _conn, String _tabId, String _windowId)
            throws Exception {
        if (_conn == null || _tabId == null || _tabId.equals("")
                || _windowId == null || _windowId.equals(""))
    ...
    public String getSortTabKeyMaps() {
        ...
        script
                .append("new keyArrayItem(\"M\", \"menuShowHide('buttonMenu');\", null, \"ctrlKey\")\n");
        script.append(");\n");
    ...
    public String getRelationKeyMaps() {
        ...
        script
                ...
                .append(getData("TabNameUrl")).append(
                        "_Edition.html', '_self');\", null, \"ctrlKey\"),\n");
        script
                .append(
                        "new keyArrayItem(\"E\", \"submitCommandForm('EDIT', true, null, '")
                .append(getData("TabNameUrl")).append(
                        "_Edition.html', '_self');\", null, \"ctrlKey\"),\n");
        script
                .append(
    ...
    public String getEditionKeyMaps(boolean isNew) {
        ...
        script
                ...
                .append(getData("TabNameUrl"))
                .append(
                        "_Edition.html', '_self', null, true, null, true);\", null, \"ctrlKey\")\n");
        script
                .append(
                        ",new keyArrayItem(\"L\", \"submitCommandForm('RELATION', true, null, '")
                .append(getData("TabNameUrl"))
                .append(
                        "_Relation.html', '_self', null, true, null, true);\", null, \"ctrlKey\")\n");
        script
                .append(
                        ",new keyArrayItem(\"B\", \"openSearchWindow('../businessUtility/Buscador.html', 'BUSCADOR', document.frmMain.inpTabId.value, '")
                .append(getData("WindowNameUrl"))
        ...
        if (!getData("IsTabReadOnly").equals("Y")) {
            if (!isNew) {
                script
                        .append(
                                ",new keyArrayItem(\"D\", \"submitCommandForm('DELETE', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self');\", null, \"ctrlKey\")\n");
                script
                        .append(
                                ",new keyArrayItem(\"S\", \"submitCommandForm('SAVE_EDIT_EDIT', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self', true, null, null, true);\", null, \"ctrlKey\")\n");
                script
                        .append(
                ...
                script
                        .append(
                                ",new keyArrayItem(\"H\", \"submitCommandForm('SAVE_EDIT_NEW', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self', true, null, null, true);\", null, \"ctrlKey\")\n");
                script
                        .append(
                                ",new keyArrayItem(\"A\", \"submitCommandForm('SAVE_EDIT_NEXT', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self', true, null, null, true);\", null, \"ctrlKey\")\n");
            } else {
                script
                        .append(
                                ",new keyArrayItem(\"S\", \"submitCommandForm('SAVE_NEW_EDIT', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self', true, null, null, true);\", null, \"ctrlKey\")\n");
                script
                ...
                script
                        .append(
                                ",new keyArrayItem(\"H\", \"submitCommandForm('SAVE_NEW_NEW', true, null, '")
                        .append(getData("TabNameUrl"))
                        .append(
                                "_Relation.html', '_self', true, null, null, true);\", null, \"ctrlKey\")\n");
            }
        ...
        script
                .append(
                        ",new keyArrayItem(\"REPAGE\", \"submitCommandForm('FIRST', false, null, '")
                .append(getData("TabNameUrl"))
                .append(
                        "_Edition.html', '_self', null, true);\", null, \"ctrlKey\")\n");
        script
                .append(
                        ",new keyArrayItem(\"AVPAGE\", \"submitCommandForm('LAST', false, null, '")
                .append(getData("TabNameUrl"))
                .append(
                        "_Edition.html', '_self', null, true);\", null, \"ctrlKey\")\n");
        script
                .append(
                        ",new keyArrayItem(\"RIGHTARROW\", \"submitCommandForm('NEXT', false, null, '")
                .append(getData("TabNameUrl"))
                .append(
                        "_Edition.html', '_self', null, true);\", null, \"ctrlKey\")\n");
        script
                .append(
                        ",new keyArrayItem(\"LEFTARROW\", \"submitCommandForm('PREVIOUS', false, null, '")
                .append(getData("TabNameUrl"))
                .append(
                        "_Edition.html', '_self', null, true);\", null, \"ctrlKey\")\n");
        script.append(");\n");
    ...
    private void generateStructure() throws Exception {
        TableSQLQueryData[] data = TableSQLQueryData.selectKeyMapStructure(
                this.conn, this.TabID);
