...
/**
 * FieldProviderFactory is an utility class to obtain a FieldProvider object from
 * any Object with getter methods.<p>
 * 
 * Its is used invoking the static getFieldProvider or getFieldProviderArray methods
 * with an object or array of objects as parameter. These objects must have getter methods,
 * the FieldProvider.getField method will call the getter with the same name.
 * 
 * Example:
 * 
 *   MyClass obj = new MyClass();
 *   FieldProvider fp = FieldProviderFactory.getFieldProvider(obj);
