...
/**
 * FieldProviderFactory is an utility class to obtain a FieldProvider object
 * from any Object with getter methods.
 * <p>
 * 
 * Its is used invoking the static getFieldProvider or getFieldProviderArray
 * methods with an object or array of objects as parameter. These objects must
 * have getter methods, the FieldProvider.getField method will call the getter
 * with the same name.
 * 
 * Example:
 * 
 * MyClass obj = new MyClass(); FieldProvider fp =
 * FieldProviderFactory.getFieldProvider(obj); String name =
 * fp.getField("name");
 * 
...
public class FieldProviderFactory implements FieldProvider {
    ...
    /**
     * This is the implementation for the FieldProvider.getField(String s)
     * method which will be invoked in the object.
     * <p>
     * 
     * Note that for a fieldName it must exist in the object a getter called
     * "getFieldName" "F" is upper case though in the passed parameter can be
     * lower case.
     */
    ...
    /**
     * Returns an array of FieldProvider objects for the getter methods of the
     * objects
     * 
     * @param obj
     * @return
