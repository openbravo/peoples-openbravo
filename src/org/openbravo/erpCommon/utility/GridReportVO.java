...
public class GridReportVO {
    ...
    public GridReportVO(String jrxmlTemplate, FieldProvider[] fieldProvider,
            String title, List<?> columns, String context, int totalWidth,
        ...
        this.headerBandStyle = new BandStyleVO(null, new Color(65, 134, 18), 9,
                true, false, false);
