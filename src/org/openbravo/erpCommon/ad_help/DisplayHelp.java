...
public class DisplayHelp extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
       ...
       * vars.setSessionValue("Help.field", strFieldClave); vars.removeSessionValue("Help.clave");
       */
      vars.getRequiredGlobalVariable("inpClave", "Help.clave");
      printPageEdit_FS(response, vars, vars.getCommand());
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
     ...
     * ).createXmlDocument();
     * 
     * DisplayHelpData[] data = (vars.getLanguage().equals("en_US")?DisplayHelpData.select(this,
     * strWindow):DisplayHelpData.selectTrl(this, strWindow, vars.getLanguage()));
     * 
     * xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
     * xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
     * xmlDocument.setParameter("theme", vars.getTheme()); xmlDocument.setParameter("windowId",
     * strWindow); xmlDocument.setParameter("windowName",
     * (vars.getLanguage().equals("en_US")?DisplayHelpData.windowName(this,
     * strWindow):DisplayHelpData.windowNameTrl(this, strWindow, vars.getLanguage())));
     * xmlDocument.setParameter("windowHelp",
     * (vars.getLanguage().equals("en_US")?DisplayHelpData.windowHelp(this,
     * strWindow):DisplayHelpData.windowHelpTrl(this, strWindow, vars.getLanguage())));
     * xmlDocument.setData("structure1", data); xmlDocument.setData("structure2", data);
