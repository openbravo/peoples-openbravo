...
public class XMLConstants {
     ...
     * used in the opening tag of a business object and in tags of association
     * properties.
     */
    public static final String ID_ATTRIBUTE = "id";

    /**
     * The name of the attribute which holds the identifier of a object (in
     * XML). Is used in the opening tag of a business object and in tags of
     * association properties.
     */
    public static final String IDENTIFIER_ATTRIBUTE = "identifier";

    /**
     * Is set on the xml tag of a property when the property is transient.
     * Transient properties are exported but are ignored when imported.
     */
    public static final String TRANSIENT_ATTRIBUTE = "transient";

    /**
     * The inactive attribute is used to signal that a certain business object
     * is inactive. A business object tag without this attribute means that the
     * business object is active.
     */
    public static final String INACTIVE_ATTRIBUTE = "inactive";

    /**
     * The reference attribute is used to signal that a certain business object
     * is included in the XML because it was referenced from another Business
     * Object.
     */
    ...
    /**
     * A system attribute which is added to the Openbravo opening tag (depends
     * on an option set in the export:
     * {@link EntityXMLConverter#setAddSystemAttributes(boolean)})
     */
