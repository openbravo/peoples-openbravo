...
class UpdateProductAndAttributes implements CreateLinesFromOrderProcessImplementationInterface {
  ...
  public void exec(final Invoice processingInvoice, final OrderLine copiedOrderLine,
    ...
    // Update the product
    newInvoiceLine.setProduct(copiedOrderLine.getProduct());

    // Update the attributes
    if (isInstanceAttribute(copiedOrderLine.getAttributeSetValue())) {
      AttributeSetInstance newAttributeSetInstance = copyAttributeSetValue(copiedOrderLine
