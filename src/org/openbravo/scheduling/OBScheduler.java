...
public class OBScheduler implements OBSchedulerMBean {
   ...
   * scheduler instance from being started. If this instance is not started later and no other scheduler
   * instances are active, then it should also prevent scheduling processes.
   */
