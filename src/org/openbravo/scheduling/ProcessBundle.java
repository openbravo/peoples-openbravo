...
public class ProcessBundle {
  ...
  public ProcessBundle(String processId, VariablesSecureApp vars, Channel channel) {
   ...
   * 
   * @param pinstanceId Pinstance Id.
   * @param vars        VariablesSecureApp to be converted into the ProcessContext
