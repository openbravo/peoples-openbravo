...
public class WadUtility {
  ...
  public static String columnIdentifier (ConnectionProvider conn, String tableName, boolean required, FieldsData fields, int ilist, int itable, boolean translated, Vector<Object> vecFields, Vector<Object> vecTable, Vector<Object> vecWhere, Vector<Object> vecParameters, Vector<Object> vecTableParameters, String sqlDateFormat) throws ServletException {
    ...
    if (fields.reference.equals("17")) { //List
      ...
      if (log4j.isDebugEnabled()) log4j.debug(" number of TableRelationData: " + trd.length);
      vecTable.addElement("left join (select " + trd[0].keyname + ((trd[0].isvaluedisplayed.equals("Y") && !trd[0].keyname.equalsIgnoreCase("value"))?", value":"") + (!trd[0].keyname.equalsIgnoreCase(trd[0].name)?(", " + trd[0].name):"") + " from " + trd[0].tablename + ") table" + itable + " on (" + tableName + "." + fields.name + " = table" + itable + "." + trd[0].keyname + ") ");
      ...
      if (trd[0].isvaluedisplayed.equals("Y")) texto.append("table" + itable + ".value || ' - ' || ");
      texto.append(columnIdentifier(conn, "table" + itable, required, fieldsAux, ilist, itable, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
      ...
      vecTable.addElement("left join " + tableDirName + " on (" + tableName + "." + fields.name + " = " + tableDirName + "." + fields.name + ") ");
      for (int i=0;i< fdi.length; i++) {
        if (i>0) texto.append(" || ' - ' || ");
        texto.append(columnIdentifier(conn, tableDirName, required, fdi[i], ilist, itable, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
      }
    } else if (fields.reference.equals("30")) {
      itable++;
      EditionFieldsData[] dataSearchs = EditionFieldsData.selectSearchs(conn, "", fields.referencevalue);
      String tableDirName = "", fieldId = "";
      if (dataSearchs==null || dataSearchs.length==0) {
        int ilength = fields.name.length();
        if (fields.reference.equals("25")) tableDirName = "C_ValidCombination";
        else if (fields.reference.equals("31")) tableDirName = "M_Locator";
        else if (fields.reference.equals("800011")) tableDirName = "M_Product";
        else tableDirName = fields.name.substring(0,ilength-3);
        if (fields.reference.equals("25")) fieldId = "C_ValidCombination_ID";
        else if (fields.reference.equals("31")) fieldId = "M_Locator_ID";
        else if (fields.reference.equals("800011")) fieldId = "M_Product_ID";
        else fieldId = fields.name;
      } else {
        tableDirName = dataSearchs[0].reference;
        fieldId = dataSearchs[0].columnname;
      }
      FieldsData fdi[] = FieldsData.identifierColumns(conn, tableDirName);
      vecTable.addElement("left join " + tableDirName + " on (" + tableName + "." + fields.name + " = " + tableDirName + "." + fieldId + ")");
      for (int i=0;i< fdi.length; i++) {
        if (i>0) texto.append(" || ' - ' || ");
        texto.append(columnIdentifier(conn, tableDirName, required, fdi[i], ilist, itable, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
      }
    } else if (fields.reference.equals("31") || fields.reference.equals("35") || fields.reference.equals("25") || fields.reference.equals("800011")) { //Search y Locator
      itable++;
      int ilength = fields.name.length();
      String tableDirName = "";
      if (fields.reference.equals("25")) tableDirName = "C_ValidCombination";
      ...
      if (fields.istranslated.equals("Y") && TableRelationData.existsTableColumn(conn, fields.tablename + "_TRL", fields.name)) {
        FieldsData fdi[] = FieldsData.tableKeyColumnName(conn, fields.tablename);
        if (fdi==null || fdi.length==0) {
          vecFields.addElement(applyFormat(tableName + "." + fields.name, fields.reference, sqlDateFormat));
          texto.append(applyFormat(tableName + "." + fields.name, fields.reference, sqlDateFormat));
        } else {
          vecTable.addElement("left join (select " + fdi[0].name + ", AD_Language" + (!fdi[0].name.equalsIgnoreCase(fields.name)?(", " + fields.name):"") + " from " + fields.tablename + "_TRL) tableTRL" + itable + " on (" + tableName + "." + fdi[0].name + " = tableTRL" + itable + "." + fdi[0].name + " and tableTRL" + itable + ".AD_Language = ?) ");
          vecTableParameters.addElement("<Parameter name=\"paramLanguage\"/>");
          vecFields.addElement(applyFormat("(CASE WHEN tableTRL" + itable + "." + fields.name + " IS NULL THEN TO_CHAR(" + tableName + "." + fields.name + ") ELSE TO_CHAR(tableTRL" + itable + "." + fields.name + ") END)", fields.reference, sqlDateFormat));
          texto.append(applyFormat("(CASE WHEN tableTRL" + itable + "." + fields.name + " IS NULL THEN TO_CHAR(" + tableName + "." + fields.name + ") ELSE TO_CHAR(tableTRL" + itable + "." + fields.name + ") END)", fields.reference, sqlDateFormat));
        }
      } else {
        vecFields.addElement(applyFormat(tableName + "." + fields.name, fields.reference, sqlDateFormat));
        texto.append(applyFormat(tableName + "." + fields.name, fields.reference, sqlDateFormat));
  ...
  public static String columnIdentifier (ConnectionProvider conn, String tableName, boolean required, FieldsData fields, Vector<Object> vecCounters, boolean translated, Vector<Object> vecFields, Vector<Object> vecTable, Vector<Object> vecWhere, Vector<Object> vecParameters, Vector<Object> vecTableParameters, String sqlDateFormat) throws ServletException {
    if (fields==null) return "";
    StringBuffer texto = new StringBuffer();
    ...
    if (fields.reference.equals("13")) { //ID
      ...
      for (int i=0;i< fdi.length; i++) {
        ...
        texto.append(columnIdentifier(conn, tableName, required, fdi[i], vecCounters, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
      ...
      if (texto.toString().equals("")) {
        vecFields.addElement(((tableName!=null && tableName.length()!=0)?(tableName + "."):"") + fields.name);
        texto.append(((tableName!=null && tableName.length()!=0)?(tableName + "."):"") + fields.name);
      }
      ...
      vecCounters.set(1, Integer.toString(ilist));
      if (trd[0].isvaluedisplayed.equals("Y")) texto.append("table" + itable + ".value || ' - ' || ");
      texto.append(columnIdentifier(conn, "table" + itable, required, fieldsAux, vecCounters, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
      ilist = Integer.valueOf(vecCounters.elementAt(1).toString()).intValue();
      itable = Integer.valueOf(vecCounters.elementAt(0).toString()).intValue();
    } else if (fields.reference.equals("32")) { //Image
      ilist++;
      if (tableName!=null && tableName.length()!=0) {
        vecTable.addElement("left join (select AD_Image_ID, ImageURL from AD_Image) list" + ilist + " on (" + tableName + "." + fields.name + " = list" + ilist + ".AD_Image_ID) ");
      } else {
      ...
      vecCounters.set(0, Integer.toString(itable));
      vecCounters.set(1, Integer.toString(ilist));
    } else if (fields.reference.equals("19") || fields.reference.equals("30") || fields.reference.equals("31") || fields.reference.equals("35") || fields.reference.equals("25") || fields.reference.equals("800011")) { //TableDir, Search y Locator
      itable++;
      EditionFieldsData[] dataSearchs = null;
      if (fields.reference.equals("30")) dataSearchs = EditionFieldsData.selectSearchs(conn, "", fields.referencevalue);
      String tableDirName = "", fieldId="";
      if (dataSearchs==null || dataSearchs.length==0) {
        int ilength = fields.name.length();
        if (fields.reference.equals("25")) tableDirName = "C_ValidCombination";
        ...
        else if (fields.name.equalsIgnoreCase("C_SETTLEMENT_CANCEL_ID")) tableDirName = "C_Settlement";
        else if (fields.name.equalsIgnoreCase("SUBSTITUTE_ID")) tableDirName = "M_Product";
        else tableDirName = fields.name.substring(0,ilength-3);
        if (fields.reference.equals("25")) fieldId = "C_ValidCombination_ID";
        else if (fields.reference.equals("31")) fieldId = "M_Locator_ID";
        else if (fields.reference.equals("800011")) fieldId = "M_Product_ID";
        else if (fields.name.equalsIgnoreCase("C_SETTLEMENT_CANCEL_ID")) fieldId = "C_Settlement_ID";
        else if (fields.name.equalsIgnoreCase("SUBSTITUTE_ID")) fieldId = "M_Product_ID";
        else fieldId = fields.name;
      } else {
        tableDirName = dataSearchs[0].reference;
        fieldId = dataSearchs[0].columnname;
      ...
      if (tableName!=null && tableName.length()!=0) {
        ...
        for (int i=0;i< fdi.length; i++) {
          if (!fdi[i].name.equalsIgnoreCase(fieldId)) fieldsAux.append(", ").append(fdi[i].name);
        }
        vecTable.addElement("left join (select " + fieldId + fieldsAux.toString() + " from " + tableDirName + ") table" + itable + " on (" + tableName + "." + fields.name + " = table" + itable + "." + fieldId + ")");
      } else {
      ...
      for (int i=0;i< fdi.length; i++) {
        ...
        vecCounters.set(0, Integer.toString(itable));
        vecCounters.set(1, Integer.toString(ilist));
        texto.append(columnIdentifier(conn, "table" + tableId, required, fdi[i], vecCounters, translated, vecFields, vecTable, vecWhere, vecParameters, vecTableParameters, sqlDateFormat));
        ilist = Integer.valueOf(vecCounters.elementAt(1).toString()).intValue();
        itable = Integer.valueOf(vecCounters.elementAt(0).toString()).intValue();
      }
    } else {
      if (fields.istranslated.equals("Y") && TableRelationData.existsTableColumn(conn, fields.tablename + "_TRL", fields.name)) {
        FieldsData fdi[] = FieldsData.tableKeyColumnName(conn, fields.tablename);
        if (fdi==null || fdi.length==0) {
          vecFields.addElement(applyFormat(((tableName!=null && tableName.length()!=0)?(tableName + "."):"") + fields.name, fields.reference, sqlDateFormat));
          texto.append(applyFormat(((tableName!=null && tableName.length()!=0)?(tableName + "."):"") + fields.name, fields.reference, sqlDateFormat));
        } else {
          vecTable.addElement("left join (select " + fdi[0].name + ",AD_Language" + (!fdi[0].name.equalsIgnoreCase(fields.name)?(", " + fields.name):"") + " from " + fields.tablename + "_TRL) tableTRL" + itable + " on (" + tableName + "." + fdi[0].name + " = tableTRL" + itable + "." + fdi[0].name + " and tableTRL" + itable + ".AD_Language = ?) ");
          vecTableParameters.addElement("<Parameter name=\"paramLanguage\"/>");
          vecFields.addElement(applyFormat("(CASE WHEN tableTRL" + itable + "." + fields.name + " IS NULL THEN TO_CHAR(" + tableName + "." + fields.name + ") ELSE TO_CHAR(tableTRL" + itable + "." + fields.name + ") END)", fields.reference, sqlDateFormat));
  ...
  * @param efd - Estructura de tipo EditionFieldsData
  * @return Devuelve un String con el parámetro class completo o un String vacío en caso de no tener
  *         class asociado para el campo indicado.
  */
  public static String classRequiredUpdateable(EditionFieldsData efd, boolean isupdateable, boolean tabIsReadOnly) {
    StringBuffer htmltext = new StringBuffer();
    String strAux="";
    try {
      if (isDecimalNumber(efd.reference) || isPriceNumber(efd.reference) || isIntegerNumber(efd.reference) || isGeneralNumber(efd.reference) || isQtyNumber(efd.reference)) {
        strAux=" number";
      }
      ...
      if (efd.required.equals("Y") && !efd.columnname.equalsIgnoreCase("Value")){
        if (efd.isreadonly.equals("Y") || tabIsReadOnly) {
          htmltext.append(" class=\"").append(strType).append(" required ").append(classType).append("_OneCell_width").append(strAux).append(" readonly\" ");
        } else if (!isupdateable) {
          htmltext.append(" class=\"").append(strType).append(" required ").append(classType).append("_OneCell_width").append(strAux).append(" readonly\" ");
        } else {
          htmltext.append(" class=\"").append(strType).append(" required ").append(classType).append("_OneCell_width").append(strAux).append("\" ");
        }
      } else if (efd.isreadonly.equals("Y") || tabIsReadOnly) {
        htmltext.append(" class=\"").append(strType).append(" ").append(classType).append("_OneCell_width").append(strAux).append(" readonly\" ");
      } else if (!isupdateable) {
        htmltext.append(" class=\"").append(strType).append(" ").append(classType).append("_OneCell_width").append(strAux).append(" readonly\" ");
      } else {
        htmltext.append(" class=\"").append(strType).append(" ").append(classType).append("_OneCell_width").append(strAux).append("\" ");
      }
    } catch (Exception e) {
      return "";
    }
  ...
  public static String columnRelationType(String reference) {
    if (isDateField(reference)) return "DATE";
    else if (isTimeField(reference)) return "TIME";
    else if (isDateTimeField(reference)) return "DATETIME";
    else if (reference.equals("20")) return "YN";
    else if (isDecimalNumber(reference)) return "DECIMAL";
    else if (isQtyNumber(reference)) return "DECIMAL";
    else if (isPriceNumber(reference)) return "DECIMAL";
    else if (isIntegerNumber(reference)) return "INTEGER";
    else if (isGeneralNumber(reference)) return "NUMBER";
    else if (reference.equals("32")) return "IMAGE";
    else if (isLinkType(reference)) return "LINK";
    else return "TEXT";
  }


  public static boolean columnRelationFormat(FieldsData data, boolean header, int maxColSize) throws IOException, ServletException {
    if (data==null) return false;
    if (data.reference.equals("28")) return false;
    if (maxColSize>0) {
      if (Integer.valueOf(data.displaylength).intValue()>maxColSize) data.displaylength=Integer.toString(maxColSize);
  ...
  public static void xmlFormatAttribute(FieldsData data) {
    ...
    if (data.isdisplayed.equals("Y")) {
      if (isIntegerNumber(data.reference)) data.xmlFormat="INTEGER";
      else if (isDecimalNumber(data.reference)) data.xmlFormat="EURO";
      else if (isQtyNumber(data.reference)) data.xmlFormat="QTY";
      else if (isPriceNumber(data.reference)) data.xmlFormat="PRICE";
      else if (isGeneralNumber(data.reference)) data.xmlFormat="GENERALQTY";
      else data.xmlFormat="REPLACECHARACTERS";
    }
  }

  public static String xmlFields(FieldsData fd, String completeName, int maxTextboxLength, boolean forcedAttribute, boolean tabIsReadOnly) {
    ...
    if (forcedAttribute) {
      ...
      if (isDecimalNumber(fd.reference)) html.append(" format=\"euroEdition\"");
      else if (isQtyNumber(fd.reference)) html.append(" format=\"qtyEdition\"");
      else if (isPriceNumber(fd.reference)) html.append(" format=\"priceEdition\"");
      else if (isIntegerNumber(fd.reference)) html.append(" format=\"integerEdition\"");
      else if (isGeneralNumber(fd.reference)) html.append(" format=\"generalQtyEdition\"");
      else html.append(" replaceCharacters=\"htmlPreformated\"");
      html.append(">");
      ...
      if (fd.isdisplayed.equals("Y")) {
        ...
        html.append(" report=\"org" + strSystemSeparator + "openbravo" + strSystemSeparator + "erpCommon" + strSystemSeparator + "reference" + strSystemSeparator + "List\">\n");
      ...
      if (fd.isdisplayed.equals("Y")) {
        html.append("<FIELD id=\"" + fd.name + completeName + "\" name=\"" + fd.name + completeName + "\" attribute=\"src\" replace=\"xx\">");
      ...
      html.append(">");
      html.append(fd.name + completeName + "</FIELD>");
    } else if (fd.reference.equals("28") && fd.isdisplayed.equals("Y") && !fd.referencevalue.equals("") && !fd.columnname.equals("ChangeProjectStatus")) {  // Button
      html.append("<FIELD ");
      html.append("id=\"" + fd.name + completeName + "\" ");
      html.append("replaceCharacters=\"htmlPreformated\" ");
      html.append(" attribute=\"value\">");
    ...
    } else if (Integer.valueOf(fd.fieldlength).intValue()>maxTextboxLength && fd.isdisplayed.equals("Y")) {
      html.append("<FIELD ");
      html.append("id=\"" + fd.name + completeName + "\" ");
      if (isDecimalNumber(fd.reference)) html.append(" format=\"euroEdition\"");
      else if (isQtyNumber(fd.reference)) html.append(" format=\"qtyEdition\"");
      ...
      else html.append(" replaceCharacters=\"htmlPreformatedTextarea\"");
      html.append(">");
      html.append(fd.name + completeName + "</FIELD>");
    } else {
      html.append("<FIELD ");
  ...
  public static String htmlFields(EditionFieldsData efd, String completeName, String completeID, boolean isupdateable, int maxTextboxLength, boolean forcedAttribute, boolean isdesigne, Vector<Object> vecCallOuts, String tabName, Vector<Object> vecDisplayLogic, Vector<Object> vecReloads, boolean tabIsReadOnly, int textareaLength) {
    StringBuffer html = new StringBuffer();
    String onChange = ((isInVector(vecDisplayLogic, efd.columnname) && !tabIsReadOnly)?"displayLogic();":"");
    String logChanges = "logChanges(this);";
    if (vecReloads!=null && vecReloads.size()>0 && efd.calloutname.equals("") && !tabIsReadOnly && isInVector(vecReloads, efd.columnname)) {
    ...
    if (forcedAttribute) {
      ...
      html.append(">");
      if (!efd.required.equals("Y")) html.append("<option value=\"\"></option>");
      ...
      if (!isdesigne) html.append("xxV");
      html.append("\"");
      if (!tabIsReadOnly) onChange =callouts(efd, vecCallOuts, maxTextboxLength) + onChange;
      if (!onChange.equals("")) onChange = onChange + "return true;";
      ...
      html.append(" width=\"").append((efd.displaysize.equals("") || IMAGE_EDITION_WIDTH<Integer.valueOf(efd.displaysize).intValue())?Integer.toString(IMAGE_EDITION_WIDTH):efd.displaysize).append("\"");
      html.append(" height=\"").append((efd.displaysize.equals("") || IMAGE_EDITION_HEIGHT<Integer.valueOf(efd.displaysize).intValue())?Integer.toString(IMAGE_EDITION_HEIGHT):efd.displaysize).append("\" ");
      html.append(classRequiredUpdateable(efd, isupdateable, tabIsReadOnly));
      html.append(" name=\"inp").append(Sqlc.TransformaNombreColumna(efd.columnnameinp)).append(completeName);
      html.append("\" id=\"").append(efd.columnname).append(completeID).append("\" alt=\"").append(efd.name).append("\" title=\"").append(efd.name).append("\"");
      if (!tabIsReadOnly) onChange =callouts(efd, vecCallOuts, maxTextboxLength) + onChange;
      if (!onChange.equals("")) onChange = onChange + "return true;";
      html.append(" onchange=\"").append(logChanges).append(onChange).append("\"");
      if (!isupdateable || tabIsReadOnly) {
      ...
      if (!isdesigne) html.append("xxV");
      html.append("\">");
    } else if (!efd.reference.equals("20") && (Integer.valueOf(efd.fieldlength).intValue() > maxTextboxLength) && efd.isdisplayed.equals("Y")){ //TEXTAREA
      StringBuffer html1 = new StringBuffer();
      double rowLength = ((Integer.valueOf(efd.fieldlength).intValue() *20)/ 4000);
      if (rowLength<3.0) rowLength = 3.0;
      html.append("<textarea cols=\"").append(textareaLength).append("\" rows=\"").append(Double.toString(rowLength)).append("\" name=\"inp").append(Sqlc.TransformaNombreColumna(efd.columnnameinp));
      ...
      if (efd.reference.equals("14") && Integer.valueOf(efd.fieldlength).intValue() > maxTextboxLength) {
        html.append((!onChange.equals("")?(" onblur=\"" + onChange + "\""):""));
      } else if (efd.reference.equals("20")) {
        if (!isupdateable || tabIsReadOnly) onChange = "return false;";
        html.append((!onChange.equals("")?(" onclick=\"" + onChange + "\""):""));
      } else {
        html.append((!onChange.equals("")?(" onchange=\"" + onChange + "\""):""));
      }
      if (efd.isdisplayed.equals("Y") && isupdateable && (isDateField(efd.reference) || isTimeField(efd.reference))) {  // Date. Put a calendar
        html.append(" onkeyup=\"auto_completar_");
        if (isDateField(efd.reference)) html.append("fecha(this");
        else html.append("hora(this, true");
  ...
  public static void setLabel(ConnectionProvider conn, WADControl auxControl, boolean isSOTrx, String keyName) throws ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("processing WadUtility.setLabel() - field name: " + auxControl.getData("Name"));
    ...
    } else if (auxControl.getData("AD_Reference_ID").equals("19") || auxControl.getData("AD_Reference_ID").equals("30") || auxControl.getData("AD_Reference_ID").equals("800011")) {
      EditionFieldsData[] dataSearchs = null;
      if (auxControl.getData("AD_Reference_ID").equals("30")) dataSearchs = EditionFieldsData.selectSearchs(conn, "", auxControl.getData("AD_Reference_Value_ID"));
  ...
  public static void comboReloadScript(EditionFieldsData efd, Vector<Object> vecCallOuts, Vector<Object> vecReloads, int maxTextboxLength, String strTab) {
    if (vecReloads==null) return;
    if (isInVector(vecReloads, efd.columnnameinp)) {
      if (efd.isdisplayed.equals("Y") && (efd.reference.equals("21") || efd.reference.equals("30") || efd.reference.equals("31") || efd.reference.equals("35") || efd.reference.equals("25") || efd.reference.equals("800011")) && efd.calloutname.equals("")) {
  ...
  public static String callouts(EditionFieldsData efd, Vector<Object> vecCallOuts, int maxTextboxLength) {
    return callouts(efd, vecCallOuts, maxTextboxLength, false);
  }

  public static String callouts(EditionFieldsData efd, Vector<Object> vecCallOuts, int maxTextboxLength, boolean isReload) {
    StringBuffer html = new StringBuffer();
    boolean existCallOut=false;
    if (!efd.calloutname.equals("")) {
      if (efd.calloutname.startsWith("ComboReload")) isReload=true;
      String calloutName = FormatUtilities.replace(efd.calloutname);
      if (efd.reference.equals("30") || efd.reference.equals("31") || efd.reference.equals("35") || efd.reference.equals("25") || efd.reference.equals("800011")) {
        ...
        } else if (isDecimalNumber(efd.reference) || isPriceNumber(efd.reference) || isIntegerNumber(efd.reference) || isGeneralNumber(efd.reference) || isQtyNumber(efd.reference)) { //Calculator
          boolean existDebug=false;
          int i;
          for (i=0;i<vecCallOuts.size();i++) {
            CallOutsStructure data = (CallOutsStructure)vecCallOuts.elementAt(i);
  ...
  public static String findField(ConnectionProvider conn, EditionFieldsData[] fields, EditionFieldsData[] auxiliars, String fieldName) {
    if (fields==null) return "";
    for (int i=0;i<fields.length;i++) if (fields[i].columnname.equalsIgnoreCase(fieldName)) return fields[i].columnnameinp;
    if (auxiliars==null) return "";
    for (int i=0;i<auxiliars.length;i++) if (auxiliars[i].columnname.equalsIgnoreCase(fieldName)) return auxiliars[i].columnnameinp;
    return "";
  }

  public static String searchsCommand(EditionFieldsData efd, boolean fromButton, String tabId, ConnectionProvider conn, String windowId, EditionFieldsData[] fieldsData, EditionFieldsData[] auxiliarsData) {
    ...
    String searchName = (efd.reference.equals("25")?"/info/Account":("/info/" + FormatUtilities.replace(efd.searchname.trim()))) + "_FS.html";
    ...
    if (fieldsSearch!=null && fieldsSearch.length>0) {
      ...
      params.append(", document.frmMain.inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + ".value");
    ...
    /*
    if (efd.searchname.equalsIgnoreCase("PRODUCT")) {
      field=findField(conn, fieldsData, auxiliarsData, "m_pricelist_id");
      if (!field.equals("")) {
      ...
      field=findField(conn, fieldsData, auxiliarsData, "dateordered");
      if (!field.equals("")) {
        params.append(", 'inpDate'");
        params.append(", document.frmMain.inp" + Sqlc.TransformaNombreColumna(field) + ".value");
      }
    } else if (efd.searchname.equalsIgnoreCase("PROJECT")) {
      field=findField(conn, fieldsData, auxiliarsData, "c_bpartner_id");
      if (!field.equals("")) {
        params.append(", 'inpBPartner'");
        params.append(", document.frmMain.inp" + Sqlc.TransformaNombreColumna(field) + ".value");
    ...
    } else if (efd.searchname.equalsIgnoreCase("SALES ORDER LINE")) {
      field=findField(conn, fieldsData, auxiliarsData, "c_bpartner_id");
      if (!field.equals("")) {
        params.append(", 'inpBPartner'");
        params.append(", document.frmMain.inp" + Sqlc.TransformaNombreColumna(field) + ".value");
    ...
    } else if (efd.searchname.equalsIgnoreCase("SHIPMENT/RECEPIT LINE")) {
      field=findField(conn, fieldsData, auxiliarsData, "c_bpartner_id");
      if (!field.equals("")) {
        params.append(", 'inpBPartner'");
        params.append(", document.frmMain.inp" + Sqlc.TransformaNombreColumna(field) + ".value");
  ...
  public static String productSearch(EditionFieldsData efd, int maxTextboxLength, Vector<Object> vecCallOuts, String tabId, ConnectionProvider conn, String windowId, EditionFieldsData[] fieldsData, EditionFieldsData[] auxiliarsData) {
    StringBuffer html = new StringBuffer();
    Vector<Object> vec = new Vector<Object>();
    efd.searchname = "Product Complete";
    html.append(htmlFields(efd, "_LOC", "_LOC", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_ATR", "_ATR", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_PQTY", "_PQTY", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_PUOM", "_PUOM", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_QTY", "_QTY", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_UOM", "_UOM", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_PLIST", "_PLIST", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_PSTD", "_PSTD", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_PLIM", "_PLIM", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    html.append(htmlFields(efd, "_CURR", "_CURR", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    if (!efd.displaylogic.equals("")) {
      html.append("<span id=\"" + efd.columnname + "_btt\">");
    }
    html.append("<a href=\"#\"");
    html.append("onClick=\"" + searchsCommand(efd, true, tabId, conn, windowId, fieldsData, auxiliarsData) + "return false;\" ");
    html.append("onMouseOut=\"window.status='';return true;\"");
    html.append("onMouseOver=\"window.status='").append(efd.referenceName).append("';return true;\" class=\"windowbutton\"><img alt=\"").append(efd.name).append("\" title=\"").append(efd.name).append("\"");
    html.append(" width=\"").append(IMAGE_BUTTON_WIDTH).append("\" height=\"").append(IMAGE_BUTTON_HEIGHT).append("\" ");
    html.append("border=\"0\" src=\"../../../../../web/images/" + FormatUtilities.replace(efd.searchname.trim()) + ".jpg\" id=\"button" + FormatUtilities.replace(efd.searchname.trim()) + "\"></a>");
    if (!efd.displaylogic.equals("")) {
      html.append("</span>");
    }
    return html.toString();
  ...
  public static String searchs(EditionFieldsData efd, int maxTextboxLength, Vector<Object> vecCallOuts, String tabId, ConnectionProvider conn, String windowId, EditionFieldsData[] fieldsData, EditionFieldsData[] auxiliarsData) {
    StringBuffer html = new StringBuffer();
    Vector<Object> vec = new Vector<Object>();
    EditionFieldsData[] fieldsSearch = null;
    try {
    ...
    if (fieldsSearch != null && fieldsSearch.length > 0) {
      if (!fieldsSearch[0].columnnameinp.equals("")) {
        ...
        for (int i=0;i<fieldsSearch.length;i++) {
          ...
          html.append(htmlFields(efd, fieldsSearch[i].columnnameEnd, fieldsSearch[i].columnnameEnd, true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
        }
    ...
    if (efd.searchname.toUpperCase().indexOf("BUSINESS")!=-1) {
      html.append(htmlFields(efd, "_LOC", "_LOC", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
      html.append(htmlFields(efd, "_CON", "_CON", true, maxTextboxLength, true, true, vecCallOuts, "", vec, null, false, 0));
    ...
    html.append("onMouseOver=\"window.status='").append(efd.referenceName).append("';return true;\" class=\"windowbutton\"><img alt=\"").append(efd.name).append("\" title=\"").append(efd.name).append("\"");
    html.append(" width=\"").append(IMAGE_BUTTON_WIDTH).append("\" height=\"").append(IMAGE_BUTTON_HEIGHT).append("\" ");
    html.append("border=\"0\" src=\"../../../../../web/images/" + (efd.reference.equals("25")?"Account":FormatUtilities.replace(efd.searchname.trim())) + ".jpg\" id=\"button" + FormatUtilities.replace(efd.searchname.trim()) + "\"></a>");
    if (!efd.displaylogic.equals("")) {
      html.append("</span>");
    }
    return html.toString();
  ...
  public static String locatorCommands(EditionFieldsData efd, boolean fromButton, String tabId, ConnectionProvider conn, String windowId, EditionFieldsData[] fieldsData, EditionFieldsData[] auxiliarsData) {
    StringBuffer params = new StringBuffer();
    StringBuffer html = new StringBuffer();
    if (!fromButton) {
      params.append(", 'Command'");
    ...
    html.append("openSearch(null, null, '../info/Locator").append((efd.reference.equals("800013")?"_Detail":"")).append("_FS.html', null, " + ((efd.calloutname.equals(""))?"false":"true") + ", 'frmMain', 'inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + "', 'inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + "_R', document.frmMain.inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + "_R.value, 'inpIDValue', document.frmMain.inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + ".value" + params.toString() + ");");
    return html.toString();
  }

  public static String locator(EditionFieldsData efd, int maxTextboxLength, Vector<Object> vecCallOuts, String tabId, ConnectionProvider conn, String windowId, EditionFieldsData[] fieldsData, EditionFieldsData[] auxiliarsData) {
    StringBuffer html = new StringBuffer();
    ...
    html.append("<a href=\"#\"");
    html.append("onClick=\"" + locatorCommands(efd, true, tabId, conn, windowId, fieldsData, auxiliarsData) + "return false;\" ");
    html.append("onMouseOut=\"window.status='';return true;\"");
    html.append("onMouseOver=\"window.status='").append(efd.referenceName).append("';return true;\" class=\"windowbutton\"><img alt=\"").append(efd.name).append("\" title=\"").append(efd.name).append("\"");
    html.append(" width=\"").append(IMAGE_BUTTON_WIDTH).append("\" height=\"").append(IMAGE_BUTTON_HEIGHT).append("\" ");
    html.append("border=\"0\" src=\"../../../../../web/images/Locator.jpg\" id=\"buttonLocator\"></a>");
    if (!efd.displaylogic.equals("")) {
      html.append("</span>");
    }
    return html.toString();
  ...
  public static String locationCommands(EditionFieldsData efd) {
    ...
    html.append("openLocation(null, null, '../info/Location_FS.html', null, " + ((efd.calloutname.equals(""))?"false":"true") + ", 'frmMain', 'inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + "', 'inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + "_R', document.frmMain.inp" + Sqlc.TransformaNombreColumna(efd.columnnameinp) + ".value, 'inpwindowId', document.frmMain.inpwindowId.value);");
    return html.toString();
  }
  ...
  public static String location(EditionFieldsData efd) {
    ...
    html.append("onMouseOver=\"window.status='").append(efd.referenceName).append("';return true;\" class=\"windowbutton\"><img alt=\"").append(efd.name).append("\" title=\"").append(efd.name).append("\"");
    html.append(" width=\"").append(IMAGE_BUTTON_WIDTH).append("\" height=\"").append(IMAGE_BUTTON_HEIGHT).append("\" ");
    html.append("border=\"0\" src=\"../../../../../web/images/Location.jpg\" id=\"buttonLocation\"></a>");
    if (!efd.displaylogic.equals("")) {
      html.append("</span>");
    }
    return html.toString();
  ...
  public static String buttonsCommand(EditionFieldsData efd, String servletName) {
    ...
    if (efd.javaClassName.equals("")) {
      html.append("openServletNewWindow('BUTTON" + FormatUtilities.replace(efd.columnname) + efd.adProcessId + "', false, '" + servletName + "', 'BUTTON', null, true" + (efd.columnname.equalsIgnoreCase("CreateFrom")?",600, 900":"") + ");return false;");
    } else {
      html.append("openServletNewWindow('DEFAULT', false, '.." + (efd.javaClassName.startsWith("/")?"":"/") + efd.javaClassName + "', 'BUTTON', '" + efd.adProcessId + "', true" + ",600, 900" + ");return false;");
    }
    return html.toString();
  }
  ...
  public static String getSQLWadContext(String code, Vector<Object> vecParameters) {
    ...
    while (i != -1) {
      if (strValue.length()>(i+5) && strValue.substring(i+1, i+5).equalsIgnoreCase("SQL=")) {
        ...
        } else strOut.append(strValue.substring(0,i));
        strAux1 = strAux;
        if (strAux.substring(strAux.length()-1).equals("(")) strAux=strAux.substring(0, strAux.length()-1).toUpperCase().trim();
        ...
        if (token.substring(0,1).indexOf("#")>-1 || token.substring(0,1).indexOf("$")>-1) token = token.substring(1, token.length());
        if (strAux.equals("")) strOut.append("?");
        else strOut.append("'" + i + "'");
        vecParameters.addElement("<Parameter name=\"" + token + "\"" + strAux + "/>");
        strValue = strValue.substring(j+1, strValue.length());
        strAux = strValue.trim();
        if (strAux.length()>0 && strAux.substring(0,1).indexOf("'")>-1) strValue = strAux.substring(1, strValue.length());
      }
      i = strValue.indexOf("@");
    }
  ...
  public static String getWadContext(String code, Vector<Object> vecFields, Vector<Object> vecAuxiliarFields, FieldsData[] parentsFieldsData, boolean isDefaultValue, String isSOTrx, String windowId) {
    ...
    while (i != -1) {
      if (strValue.length()>(i+5) && strValue.substring(i+1,i+5).equalsIgnoreCase("SQL=")) {
        ...
        token = strValue.substring(0,j);
        strAux = getWadContextTranslate(token, vecFields, vecAuxiliarFields, parentsFieldsData, isDefaultValue, isSOTrx, windowId, true);
        if (!strAux.trim().equals("") && strOut.toString().indexOf(strAux)==-1) strOut.append(", " + strAux);
  ...
  public static String getWadComboReloadContextTranslate(String token, String isSOTrx) {
    ...
    if (token.substring(0,1).indexOf("#")>-1 || token.substring(0,1).indexOf("$")>-1) {
      if (token.equalsIgnoreCase("#DATE")) result = "DateTimeData.today(this)";
      ...
      if (token.equalsIgnoreCase("ISSOTRX")) result = ("\"" + isSOTrx + "\"");
      else result = "vars.getStringParameter(\"inp" + aux + "\")";
    }
    return result;
  }
  ...
  public static String getTextWadContext(String code, Vector<Object> vecFields, Vector<Object> vecAuxiliarFields, FieldsData[] parentsFieldsData, boolean isDefaultValue, String isSOTrx, String windowId) {
    ...
    if (h!=-1) {
      ...
      String strFirstElement = getTextWadContext(strValue.substring(0,h), vecFields, vecAuxiliarFields, parentsFieldsData, isDefaultValue, isSOTrx, windowId);
      total.append("(");
      if (strValue.substring(0, h).indexOf("@")==-1) total.append("(\"");
      total.append(strFirstElement);
      if (strValue.substring(0, h).indexOf("@")==-1) total.append("\")");
      total.append(".equals(\"\")?(");
      if (strValue.substring(h+1).indexOf("@")==-1) total.append("\"");
      total.append(getTextWadContext(strValue.substring(h+1), vecFields, vecAuxiliarFields, parentsFieldsData, isDefaultValue, isSOTrx, windowId));
      if (strValue.substring(h+1).indexOf("@")==-1) total.append("\"");
      total.append("):(");
      if (strValue.substring(0, h).indexOf("@")==-1) total.append("\"");
      total.append(strFirstElement);
    ...
    while (i != -1) {
      ...
      token = strValue.substring(0,j);
      strOut.append(getWadContextTranslate(token, vecFields, vecAuxiliarFields, parentsFieldsData, isDefaultValue, isSOTrx, windowId, true));
  ...
  public static String transformFieldName(String field) {
    ...
    if (aux!=-1) return field.substring(aux+3).trim();
    aux = field.lastIndexOf(".");
    if (aux!=-1) return field.substring(aux+1).trim();
  ...
  public static boolean findField(Vector<Object> vecFields, String field) {
    ...
    for (int i=0;i<vecFields.size();i++) {
      ...
      if (strAux.equalsIgnoreCase(field)) return true;
    }
    return false;
  }

  public static String getWadContextTranslate(String token, Vector<Object> vecFields, Vector<Object> vecAuxiliarFields, FieldsData[] parentsFieldsData, boolean isDefaultValue, String isSOTrx, String windowId, boolean dataMultiple) {
    if (token.substring(0,1).indexOf("#")>-1 || token.substring(0,1).indexOf("$")>-1) {
      if (token.equalsIgnoreCase("#DATE")) return "DateTimeData.today(this)";
      //else return "vars.getSessionValue(\"" + token + "\")";
      else return "Utility.getContext(this, vars, \"" + token + "\", windowId)";
    } else {
      String aux=Sqlc.TransformaNombreColumna(token);
      if (token.equalsIgnoreCase("ISSOTRX")) return ("\"" + isSOTrx + "\"");
      if (parentsFieldsData!=null) {
        for (int i=0;i<parentsFieldsData.length;i++) {
          if (parentsFieldsData[i].name.equalsIgnoreCase(token)) return "strP" + parentsFieldsData[i].name;
        }
      }
      if (!isDefaultValue) {
        if (vecFields!=null && findField(vecFields, token)) {
          return (dataMultiple?"((dataField!=null)?dataField.getField(\"" + aux + "\"):((data==null || data.length==0)?\"\":data[0].":"((data==null)?\"\":data.") + aux + "))";
  ...
  public static String getWadDefaultValue(FieldsData fd) {
    if (fd==null) return "";
    if (fd.referencevalue.equals("28") && !fd.name.toUpperCase().endsWith("_ID")) return "N"; //Button
  ...
  public static String displayLogic(String code, Vector<Object> vecDL, FieldsData[] parentsFieldsData, Vector<Object> vecAuxiliar, Vector<Object> vecFields, String windowId, Vector<Object> vecContext) {
    ...
    while (st.hasMoreTokens()) {
      ...
      if (i[0]!=-1) {
        strAux = strAux.substring(0,i[0]) + unions[i[1]][1] + strAux.substring(i[0] + unions[i[1]][0].length());
      }
      ...
      if (pos[0]>=0) {
        ...
        strAux = strAux.substring(0, pos[0]) + comparations[pos[1]][1] + strAux.substring(pos[0]+comparations[pos[1]][0].length(), strAux.length());
      }

      strOut.append(getDisplayLogicText(token, vecFields, parentsFieldsData, vecAuxiliar, vecDL, windowId, vecContext, true));
      if (pos[0]>=0) strOut.append(comparations[pos[1]][1]);
      strOut.append(getDisplayLogicText(token2, vecFields, parentsFieldsData, vecAuxiliar, vecDL, windowId, vecContext,false));
    }
    return strOut.toString();
  }
  ...
  public static boolean isInVector(Vector<Object> vec, String field) {
    if (field==null || field.trim().equals("")) return false;
    for (int i=0;i<vec.size();i++) {
      String aux = (String)vec.elementAt(i);
      if (aux.equalsIgnoreCase(field)) return true;
    }
    return false;
  }
  ...
  public static void saveVectorField(Vector<Object> vec, String field) {
    if (field==null || field.trim().equals("")) return;
    if (!isInVector(vec, field)) vec.addElement(field);
  }

  public static String getComboReloadText(String token, Vector<Object> vecFields, FieldsData[] parentsFieldsData, Vector<Object> vecComboReload, String prefix) {
    return getComboReloadText(token, vecFields, parentsFieldsData, vecComboReload, prefix, "");
  }

  public static String getComboReloadText(String token, Vector<Object> vecFields, FieldsData[] parentsFieldsData, Vector<Object> vecComboReload, String prefix, String columnname) {
    StringBuffer strOut = new StringBuffer();
    int i=token.indexOf("@");
    while (i!=-1) {
      ...
      if (!token.startsWith("SQL")) {
        ...
        if (i!=-1) {
          ...
          token=token.substring(i+1);
          if (!strOut.toString().trim().equals("")) strOut.append(", ");
          strOut.append(getComboReloadTextTranslate(strAux, vecFields, parentsFieldsData, vecComboReload, prefix, columnname));
        }
      }
      i=token.indexOf("@");
    }
  ...
  public static String getComboReloadTextTranslate(String token, Vector<Object> vecFields, FieldsData[] parentsFieldsData, Vector<Object> vecComboReload, String prefix, String columnname) {
    if (token==null || token.trim().equals("")) return "";
    if (!token.equalsIgnoreCase(columnname)) saveVectorField(vecComboReload, token);
    if (parentsFieldsData!=null) {
      for (int i=0;i<parentsFieldsData.length;i++) {
        if (parentsFieldsData[i].name.equalsIgnoreCase(token)) return ((prefix.equals(""))?("\"" + parentsFieldsData[i].name + "\""):("\"" + prefix + Sqlc.TransformaNombreColumna(parentsFieldsData[i].name) + "\""));
      }
    }
    if (vecFields!=null && findField(vecFields, token)) {
      return ((prefix.equals(""))?("\"" + token + "\""):("\"" + prefix + Sqlc.TransformaNombreColumna(token) + "\""));
    }
    return ((prefix.equals(""))?("\"" + FormatUtilities.replace(token) + "\""):("\"" + prefix + Sqlc.TransformaNombreColumna(token) + "\""));
  }

  public static String getDisplayLogicText(String token, Vector<Object> vecFields, FieldsData[] parentsFieldsData, Vector<Object> vecAuxiliar, Vector<Object> vecDisplayLogic, String windowId, Vector<Object> vecContext, boolean save) {
    StringBuffer strOut = new StringBuffer();
    int i=token.indexOf("@");
    while (i!=-1) {
      strOut.append(token.substring(0,i));
      ...
      if (i!=-1) {
        String strAux=token.substring(0,i);
        token=token.substring(i+1);
        strOut.append(getDisplayLogicTextTranslate(strAux, vecFields, parentsFieldsData, vecAuxiliar, vecDisplayLogic, windowId, vecContext, save));
      }
      i=token.indexOf("@");
    }
    strOut.append(token);
  ...
  public static String getDisplayLogicTextTranslate(String token, Vector<Object> vecFields, FieldsData[] parentsFieldsData, Vector<Object> vecAuxiliar, Vector<Object> vecDisplayLogic, String windowId, Vector<Object> vecContext, boolean save) {
    if (token==null || token.trim().equals("")) return "";
    String aux=Sqlc.TransformaNombreColumna(token);
    if (save) saveVectorField(vecDisplayLogic, token);
    if (parentsFieldsData!=null) {
      for (int i=0;i<parentsFieldsData.length;i++) {
        if (parentsFieldsData[i].name.equalsIgnoreCase(token)) return "inputValue(document.frmMain.inp" + Sqlc.TransformaNombreColumna(parentsFieldsData[i].name) + ")";
      }
    }
  ...
  public static String getDisplayLogicComparation(String token) {
    ...
    for (int i=0;i<comparations.length;i++) {
      if (comparations[i][0].equals(aux)) return comparations[i][1];
    }
    return aux;
  }
  ...
  public static boolean isInFieldList(FieldsData[] fields, String columnName) {
    ...
    for (int i=0;i<fields.length;i++) {
      if (fields[i].name.equalsIgnoreCase(columnName)) return true;
    }
    return false;
  }
  ...
  public static void setPropertyValue(Properties _prop, FieldProvider _field, String _name, String _fieldName, String _defaultValue) throws Exception {
    String aux = "";
    try {
      aux = _field.getField(_fieldName);
      if (aux==null || aux.equals("")) aux = _defaultValue;
    } catch (Exception ex) {
      if (_defaultValue==null) throw new Exception("Inexistent field: " + _fieldName);
      else aux = _defaultValue;
    }
  ...
  public static String getDisplayLogic(WADControl auxControl, Vector<Object> vecDL, FieldsData[] parentsFieldsData, Vector<Object> vecAuxiliar, Vector<Object> vecFields, String windowId, Vector<Object> vecContext, boolean isreadonly) {
    ...
    _displayLogic.append(displayLogic(code, vecDL, parentsFieldsData, vecAuxiliar, vecFields, windowId, vecContext));
    _displayLogic.append(") {\n");
    ...
    if ((isGeneralNumber(auxControl.getData("AD_Reference_ID")) || isDateField(auxControl.getData("AD_Reference_ID")) || isTimeField(auxControl.getData("AD_Reference_ID")) || isLikeType(auxControl.getData("AD_Reference_ID")) || isDecimalNumber(auxControl.getData("AD_Reference_ID")) || isQtyNumber(auxControl.getData("AD_Reference_ID")) || isPriceNumber(auxControl.getData("AD_Reference_ID")) || isIntegerNumber(auxControl.getData("AD_Reference_ID")) || auxControl.getData("AD_Reference_ID").equals("21") || auxControl.getData("AD_Reference_ID").equals("25") || auxControl.getData("AD_Reference_ID").equals("30") || auxControl.getData("AD_Reference_ID").equals("800011") || auxControl.getData("AD_Reference_ID").equals("31") || auxControl.getData("AD_Reference_ID").equals("32") || auxControl.getData("AD_Reference_ID").equals("35") || isLinkType(auxControl.getData("AD_Reference_ID"))) && !auxControl.getData("IsReadOnly").equals("Y") && !isreadonly) {
      _displayLogic.append("displayLogicElement('");
      _displayLogic.append(auxControl.getData("ColumnName"));
    ...
    if ((isGeneralNumber(auxControl.getData("AD_Reference_ID")) || isDateField(auxControl.getData("AD_Reference_ID")) || isTimeField(auxControl.getData("AD_Reference_ID")) || isLikeType(auxControl.getData("AD_Reference_ID")) || isDecimalNumber(auxControl.getData("AD_Reference_ID")) || isQtyNumber(auxControl.getData("AD_Reference_ID")) || isPriceNumber(auxControl.getData("AD_Reference_ID")) || isIntegerNumber(auxControl.getData("AD_Reference_ID")) || auxControl.getData("AD_Reference_ID").equals("21") || auxControl.getData("AD_Reference_ID").equals("25") || auxControl.getData("AD_Reference_ID").equals("30") || auxControl.getData("AD_Reference_ID").equals("800011") || auxControl.getData("AD_Reference_ID").equals("31") || auxControl.getData("AD_Reference_ID").equals("35") || auxControl.getData("AD_Reference_ID").equals("32") || isLinkType(auxControl.getData("AD_Reference_ID"))) && !auxControl.getData("IsReadOnly").equals("Y") && !isreadonly) {
      _displayLogic.append("displayLogicElement('");
      _displayLogic.append(auxControl.getData("ColumnName"));
