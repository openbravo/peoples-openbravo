...
public class WADFieldButton extends WADControl {
  ...
  public WADFieldButton(String _buttonName, String _columnName, String _columnNameInp, String _name, String _onclick) {
  ...
  public String toString() {
    XmlDocument xmlDocument = getReportEngine().readXmlTemplate("org/openbravo/wad/controls/WADFieldButton").createXmlDocument();
