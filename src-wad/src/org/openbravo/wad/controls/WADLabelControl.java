...
public class WADLabelControl {
    ...
    public WADLabelControl(int labelType, String tabId, String fieldId,
            String columnId, String columnName, String baseLabelText,
            String trlLabelText, String linkable, String keyColumnName,
            String columnNameInp, String AD_Table_ID) {
    ...
    private void setLabelId(String textId) {
        String tempLabelId = (labelType == FIELD_GROUP_LABEL) ? "fldgrp::"
                : "lbl::";
