...
public class WADLabelControl {
  ...
  public WADLabelControl(
      int labelType, String tabId, String fieldId, String columnId, String columnName, String baseLabelText, String trlLabelText, String linkable, String keyColumnName, String columnNameInp, String AD_Table_ID) {
  ...
  public int getLabelType() { return labelType; }
  public void setLabelType(int type) { 
    labelType = type;
    if (labelType == FIELD_GROUP_LABEL) {
      if (fieldGroupId != null && !fieldGroupId.trim().equals("")) setLabelId(fieldGroupId);
      if (columnName != null && !columnName.trim().equals("")) setLabelPlaceHolderText(columnName);
    }
  }
  ...
  public String getFieldGroupId() { return fieldGroupId; }
  ...
  public void setColumnName(String columnName) {
    if (columnName != null && !columnName.trim().equals("")) {
      ...
      if (labelType == FIELD_LABEL || labelType == BUTTON_LABEL) {
        if (getLabelId() == null || getLabelId().equals("")) setLabelId(this.columnName);
        setLabelPlaceHolderText(this.columnName);
  ...
  public String getLabelPlaceHolderText() { return labelPlaceHolderText; }
  ...
  public String getBaseLabelText() { return baseLabelText; }
  ...
  public String getTrlLabeltext() { return trlLabeltext; }
  ...
  public boolean isLinkable() { return isLinkable; }
  public void setLinkable(String linkable) {
    isLinkable = false;
    if (linkable != null && linkable.equalsIgnoreCase("y")) isLinkable = true;
  }
  public void setLinkable(boolean linkable) { isLinkable = linkable; }
  ...
  public String getColumnNameInp() { return columnNameInp; }
  ...
  public String toLabelXML() {
    ...
    if (getLabelId() != null && !getLabelId().equals("") && getLabelPlaceHolderText() != null && !getLabelPlaceHolderText().equals("")) {
