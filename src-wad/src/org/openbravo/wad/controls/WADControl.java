...
public class WADControl {
  ...
  public void addCSSImport(String name, String _data) {
    if (css==null) css = new Vector<String[]>();
  ...
  public void addImport(String name, String _data) {
    if (imports==null) imports = new Vector<String[]>();
    String[] aux = new String[2];
    aux[0]=name;
    aux[1]=_data;
  ...
  public void addJSCode(String name, String _code) {
    if (jsCode==null) jsCode = new Vector<String[]>();
    String[] aux = new String[2];
    aux[0] = name;
    aux[1] = _code;
  ...
  public void setCalloutJS() {
    ...
    if (callout!=null && !callout.equals("")) {
      XmlDocument xmlDocument = getReportEngine().readXmlTemplate("org/openbravo/wad/controls/WADControlJS").createXmlDocument();
  ...
  public String getOnChangeCode() {
    ...
    if (callout!=null && !callout.equals("")) text.append("callout").append(callout).append("(this.name);");
    if (isComboReload.equals("Y")) text.append("reloadComboReloads").append(getData("AD_Tab_ID")).append("(this.name);");
    return text.toString();
  }

  public String editMode() {
    XmlDocument xmlDocument = getReportEngine().readXmlTemplate("org/openbravo/wad/controls/WADControl").createXmlDocument();
  ...
  public String getType() {
    if (getData("IsDisplayed").equals("N")) return "Hidden";
    else return "TextBox";
  }
  ...
  public String toLabel() {
    if (getData("AD_Reference_ID").equals("28")) return "";
