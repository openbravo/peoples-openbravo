...
public class WADNumber extends WADControl {
    ...
    private void generateJSCode() {
        addImport("ValidationNumberBox",
                "../../../../../web/js/default/ValidationNumberBox.js");
    ...
    public void generateValidation() {
        ...
        XmlDocument xmlDocument = getReportEngine().readXmlTemplate(
                "org/openbravo/wad/controls/WADNumberJSValidation", discard)
                .createXmlDocument();
    ...
    public String editMode() {
        ...
        XmlDocument xmlDocument = getReportEngine().readXmlTemplate(
                "org/openbravo/wad/controls/WADNumber", discard)
                .createXmlDocument();
    ...
    public String toXml() {
        ...
        if (getData("IsParameter").equals("Y"))
            discard[0] = "xx";
        XmlDocument xmlDocument = getReportEngine().readXmlTemplate(
                "org/openbravo/wad/controls/WADNumberXML", discard)
                .createXmlDocument();
