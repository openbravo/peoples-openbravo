...
public class WADLink extends WADControl {
  ...
  public void initialize() {
    generateJSCode();
    this.button = new WADFieldButton("Link", getData("ColumnName"), getData("ColumnNameInp"), getData("Name"), "window.open(document.getElementById('" + getData("ColumnName") + "').value);");
  }
  ...
  public String editMode() {
    ...
    XmlDocument xmlDocument = getReportEngine().readXmlTemplate("org/openbravo/wad/controls/WADLink", discard).createXmlDocument();
