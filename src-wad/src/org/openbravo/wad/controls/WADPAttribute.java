...
public class WADPAttribute extends WADSearch {
    ...
    private void generateJSCode() {
        ...
        if (!getData("IsReadOnly").equals("Y")
            ...
            commandScript
                    .append("openPAttribute(null, null, '../info/AttributeSetInstance.html', ");
            commandScript.append("null, true, 'frmMain', 'inp").append(
                    getData("ColumnNameInp")).append("', ");
            ...
            commandScript.append(
                    "'inpKeyValue', inputValue(document.frmMain.inp").append(
                    getData("ColumnNameInp")).append("), ");
            commandScript
                    .append("'inpwindowId', inputValue(document.frmMain.inpwindowId), ");
            commandScript
                    .append("'inpProduct', inputValue(document.frmMain.inpmProductId)");
