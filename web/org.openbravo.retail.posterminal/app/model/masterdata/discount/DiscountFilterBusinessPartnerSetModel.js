...
(function discountFilterBusinessPartnerSetModel() {
  class DiscountFilterBusinessPartnerSet extends OB.App.Class.MasterdataModel {
    constructor() {
      super();
      this.indices = [
    ...
    getName() {
      return 'DiscountFilterBusinessPartnerSet';
    }
  }
