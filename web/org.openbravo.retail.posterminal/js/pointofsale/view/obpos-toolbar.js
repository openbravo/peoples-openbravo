...
enyo.kind({
  ...
  initComponents: function() {
    ...
    this.menuEntries.push({
      kind: 'OB.UI.MenuSimplifiedInvoice',
      classes:
        'obObposPointOfSaleUiLeftToolbarImpl-menuEntries-obUiMenuSimplifiedInvoice'
    });
    this.menuEntries.push({
      kind: 'OB.UI.MenuFullInvoice',
      classes:
        'obObposPointOfSaleUiLeftToolbarImpl-menuEntries-obUiMenuFullInvoice'
    });
    this.menuEntries.push({
