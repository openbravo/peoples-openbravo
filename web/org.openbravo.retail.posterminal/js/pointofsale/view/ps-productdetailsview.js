...
enyo.kind({
  ...
  classes: 'obObposPointOfSaleUiProductDetailsViewButtonStockThisStore obpos-product-details-view-buttons',
  events: {
...
enyo.kind({
  ...
  kind: 'OB.UI.SmallButton',
  classes: 'obObposPointOfSaleUiProductDetailsViewButtonStockOtherStore obpos-product-details-view-buttons',
  events: {
  ...
  tap: function () {
    ...
    if (product) {
      ...
      if (OB.MobileApp.model.hasPermission('OBRDM_EnableDeliveryModes', true) && line && line.get('obrdmDeliveryMode') !== product.get('obrdmDeliveryMode')) {
        ...
        attrs.nameDelivery = _.find(OB.MobileApp.model.get('deliveryModes'), function (mode) {
  ...
  components: [{
    ...
    components: [{
      ...
      components: [{
        ...
        classes: 'obObposPointOfSaleUiProductDetailsViewBody-container3-container1-container2',
        components: [{
          kind: 'OB.OBPOSPointOfSale.UI.ProductDetailsView_ButtonStockOtherStore',
          name: 'stockOthers',
          classes: 'obObposPointOfSaleUiProductDetailsViewBody-container3-container1-container2-stockOthers'
        }]
      }, {
        name: 'productDeliveryModes',
        kind: 'OB.OBPOSPointOfSale.UI.EditLine.DeliveryModesButton',
        classes: 'obObposPointOfSaleUiProductDetailsViewBody-container3-container1-productDeliveryModes'
      }]
    }, {
