...
OB.OBPOS.ClientSideEventHandlers.refreshCharacteristicsGrid = function(
  view,
  form,
  grid,
  extraParameters,
  ...
  callback = function(response, cdata, request) {
    if (cdata && cdata.warn) {
      view.messageBar.setMessage(
        ...
        cdata.warnMessageTitle,
        cdata.warnMessageBody
      );
    }
  ...
  OB.RemoteCallManager.call(
    'org.openbravo.retail.posterminal.actionHandler.ProductCharacteristicActionHandler',
    {
      isDelete: isDelete,
...
OB.EventHandlerRegistry.register(
  OB.OBPOS.CHARACTERISTICS_HEADER_TAB,
  OB.EventHandlerRegistry.POSTSAVE,
  OB.OBPOS.ClientSideEventHandlers.refreshCharacteristicsGrid,
  'OBPOS_refreshCharacteristicsGrid'
);
OB.EventHandlerRegistry.register(
  OB.OBPOS.CHARACTERISTICS_HEADER_TAB,
