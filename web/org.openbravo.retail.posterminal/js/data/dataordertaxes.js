...
/*global OLDTAXES,window,Promise,_ */
...
(function () {
        ...
        OB.Dal.query(OB.Model.TaxRate, args.sql, [], function (coll, args) { // success
          ...
          if (coll && coll.length > 0) {
            ...
            coll = _.filter(coll.models, function (taxRate) {
              return (taxRate.get('destinationCountry') === toCountryId)
            ...
            var linenet, calculatedLineNet, roundedLinePriceNet, linepricenet, linegross,
                pricenet, discountedNet, pricenetcascade, discountedLinePriceNet, roundedDiscountedLinePriceNet, calculatedDiscountedNet;
            if (orggross === 0) {
  ...
  // Previous function to the refactor for testing and documentation purposes.
  var legacyCalculateTaxes = function (callback) {
    var me = this,
