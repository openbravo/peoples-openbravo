...
(function() {
  ...
  OB.I18N.formatRate = function(number) {
    var symbol = '%',
      maskNumeric =
        OB.Format.formats.taxInform || OB.Format.formats.euroEdition,
      decSeparator = OB.Format.defaultDecimalSymbol,
      groupSeparator = OB.Format.defaultGroupingSymbol,
      groupInterval = OB.Format.defaultGroupingSize;
    ...
    var formattedNumber = OB.Utilities.Number.JSToOBMasked(
      number,
      maskNumeric,
      decSeparator,
      groupSeparator,
  ...
  OB.I18N.formatHour = function(d) {
    ...
    return (
      OB.UTIL.padNumber(curr_hour, 2) + ':' + OB.UTIL.padNumber(curr_min, 2)
    );
  };
