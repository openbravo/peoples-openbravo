              ...
              function(payment, index) {
                ...
                if (index === activePaymentsList.length - 1) {
                  ...
                  for (i = 0; i < tempList.length; i++) {
                    if (
                      me.cashupsteps[paymentsIndex].isSubstepAvailable(me, i)
                    ) {
                      cashPayments = true;
                    }
                  ...
                  me.set(
                    'totalDifference',
                    OB.DEC.sub(
                      me.get('totalDifference'),
                      me.get('totalExpected')
                    )
                  );
                  me.setIgnoreStep3();
                }
    ...
    OB.Dal.find(
      ...
      function(pendingOrderList, me) {
        ...
        emptyOrders = _.filter(pendingOrderList.models, function(pendingorder) {
          if (
            pendingorder &&
            pendingorder.get('lines') &&
            pendingorder.get('lines').length === 0
          ) {
            return true;
          }
        });
            ...
            function(cashUp, me) {
              ...
              _.each(
                ...
                function(curModel) {
                  ...
                  cashCloseInfo.foreignExpected = curModel.get(
                    'foreignExpected'
                  );
