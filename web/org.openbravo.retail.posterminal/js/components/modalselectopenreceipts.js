        ...
        components: [
          {
            ...
            style:
              'float: left; width: 44px; height: 44px; background-position: center center; border: 1px solid white; cursor: pointer;',
          ...
          components: [
            {
              ...
              classes: 'btnselect',
              style:
                'height: 63px; line-height: 23px; width: 100%; font-size: 16px; background-color: white; border-bottom: 1px solid #cccccc;',
              components: [
                {
                  style: 'width: 100%',
                  components: [
                      ...
                      components: [
                        {
                          tag: 'img',
                          style:
                            'float: left; width: 19px; height: 19px; color: black; margin-left: 10px;',
                          attributes: {
                            src:
                    ...
                    {
                      style:
                        'float: left; width: 80%; color: white; display: hidden;',
                      content: '.'
                    },
                    {
                      style: 'clear: both;'
      ...
      components: [
        ...
        },
        {
          components: [
            ...
            {
              style:
                'float: right; text-align: right; width: 25%; font-weight: bold;',
              name: 'total'
            },
            {
              style: 'clear: both;'
