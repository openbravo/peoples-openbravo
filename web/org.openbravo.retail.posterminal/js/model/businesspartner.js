...
(function () {
  ...
  var BusinessPartner = Backbone.Model.extend({
    ...
    insertStatement: 'INSERT INTO c_bpartner(c_bpartner_id, value, name, description, taxID, c_bpartnerlocation_id, c_bpartnerlocation_name, _identifier, _idx)  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
    updateStatement: ''
  });
