  ...
  var Order = Backbone.Model.extend({
    ...
    _addProduct: function (p, qty, options, attrs, callback) {
      ...
      function addProductToOrder() {
        ...
        if ((p.get('isdiscontinued') || p.get('issalediscontinued')) && (attrs === undefined || attrs.kindOriginator !== 'OB.OBPOSPointOfSale.UI.KeyboardOrder') && !OB.MobileApp.model.hasPermission('OBPOS_AvoidProductDiscontinuedStockCheck', true)) {
