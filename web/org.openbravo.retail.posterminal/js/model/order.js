                ...
                if (promo.pendingQtyOffer && promo.pendingQtyOffer >= line.get('qty')) {
                  ...
                  if (line.get('promotions')) {
                    auxPromo = _.find(line.get('promotions'), function (promo) {
                      return promo.ruleId === copiedPromo.ruleId && promo.discountinstance === copiedPromo.discountinstance;
                  ...
                  if (line.get('promotions')) {
                    auxPromo = _.find(line.get('promotions'), function (promo) {
                      return promo.ruleId === copiedPromo.ruleId && promo.discountinstance === copiedPromo.discountinstance && promo.preserve !== true;
                  ...
                  actProm = _.find(line.get('promotions'), function (prom) {
                    return prom.ruleId === promo.ruleId && prom.discountinstance === promo.discountinstance;
                  });
                  if (actProm) {
