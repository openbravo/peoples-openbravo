...
(function () {
  ...
  var Product = Backbone.Model.extend({
    ...
    dataLimit: 300,
    properties: ['id', 'searchkey', 'uPCEAN', 'uOM', 'uOMsymbol', 'productCategory', 'taxCategory', 'img', 'description', 'obposScale', 'groupProduct', 'stocked', 'showstock', 'isGeneric', 'generic_product_id', 'brand', 'bestseller', 'ispack', 'listPrice', 'standardPrice', 'priceLimit', 'cost', '_identifier', '_idx'],
