if(!dojo._hasResource["dojox.editor._Plugin"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor._Plugin"] = true;
dojo.provide("dojox.editor._Plugin");
dojo.require("dijit._Widget");
dojo.require("dojox.editor.Editor");
dojo.require("dijit.form.Button");

dojo.declare("dojox.editor._Plugin", null, {
	// summary
