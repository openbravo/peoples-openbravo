if(!dojo._hasResource["dojox.editor.Editor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor.Editor"] = true;
					...
					var onGlobalMouseDown = function(e){
						...
						if(focused && focused.nodeName !='BODY' && newfocused!=focused && focused.contentEditable){
							if(!dojo.isDescendant(newfocused,focused)){
								...
								if(editor && editor instanceof dojox.editor.Editor){
...
//			dojox.editor.Editor.superclass.postCreate.apply(this, arguments);
