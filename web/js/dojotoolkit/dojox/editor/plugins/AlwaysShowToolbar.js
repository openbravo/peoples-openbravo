if(!dojo._hasResource["dojox.editor.plugins.AlwaysShowToolbar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor.plugins.AlwaysShowToolbar"] = true;
dojo.provide("dojox.editor.plugins.AlwaysShowToolbar");

dojo.declare("dojox.editor.plugins.AlwaysShowToolbar", dojox.editor._Plugin,
	{
	// summary:
