...
if(!dojo._hasResource["dojox.editor.plugins.FontChoice"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor.plugins.FontChoice"] = true;
dojo.provide("dojox.editor.plugins.FontChoice");
...
dojo.declare("dojox.editor.plugins.FontChoice",
	dojox.editor._Plugin,
	{
		...
		//
		//	|	plugins="[{name:'dojox.editor.plugins.FontChoice', command:'fontName', custom:['Verdana','Myriad','Garamond']},...]"
		//
...
dojo.subscribe(dijit._scopeName + ".Editor.getPlugin",null,function(o){
	...
	case "fontName": case "fontSize": case "formatBlock":
		o.plugin = new dojox.editor.plugins.FontChoice({command: o.args.name});
	}
});
