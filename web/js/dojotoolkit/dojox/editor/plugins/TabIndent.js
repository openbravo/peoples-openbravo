...
if(!dojo._hasResource["dojox.editor.plugins.TabIndent"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor.plugins.TabIndent"] = true;
dojo.provide("dojox.editor.plugins.TabIndent");
dojo.experimental("dojox.editor.plugins.TabIndent");

dojo.require("dojox.editor._Plugin");

dojo.declare("dojox.editor.plugins.TabIndent",
...
dojo.subscribe(dijit._scopeName + ".Editor.getPlugin",null,function(o){
	...
	switch(o.args.name){
	case "tabIndent":
		o.plugin = new dojox.editor.plugins.TabIndent({command: o.args.name});
	}
});
