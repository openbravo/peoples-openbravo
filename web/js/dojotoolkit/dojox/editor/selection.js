if(!dojo._hasResource["dojox.editor.selection"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.editor.selection"] = true;
dojo.provide("dojox.editor.selection");
...
dojo.mixin(dojox.editor.selection, {
	getType: function(){
	...
	getSelectedText: function(){
		...
		if(dojo.doc.selection){ //IE
			if(dojox.editor.selection.getType() == 'control'){
				return null;
			}
