	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "ja,en,fr,es,en-au,en-ca,it,ko,zh,pt,en-us,de,zh-tw,ROOT");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "ja,en,fr,es,en-au,ROOT,it,ko,zh,pt,ja-jp,es-es,en-us,zh-cn,de,en-gb,zh-tw,ko-kr,de-de");
				}
			},
			runTest: function(t){
