...
//    private boolean _defaultValueUsedForIdentitySpec = false;
     ...
     *
     * @param supportingChecks <code>true</code> if checks are supported
     */
    ...
    /**
     * Determines whether the checks are embedded in the create table clause
     * or as seperate statements. Per default, checks are external.
     * 
    ...
    /**
     * Specifies whether checks are embedded in the create table clause or
     * as seperate alter table statements.
     * 
     * @param checksEmbedded Whether checks are embedded
     */
     ...
     *
     * @param supportingSequences <code>true</code> if sequences are supported
     */
     ...
     *
     * @param supportingViews <code>true</code> if views are supported
     */
     ...
     *
     * @param supportingFunctions <code>true</code> if functions and procedures are supported
     */
     ...
     *
     * @param supportingTriggers <code>true</code> if triggers are supported
     */
