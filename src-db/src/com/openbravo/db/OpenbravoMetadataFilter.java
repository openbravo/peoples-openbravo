...
public class OpenbravoMetadataFilter extends AbstractDatabaseFilter {
    ...
    public void init(Database database) {
        ...
        addTable("AD_ALERTRULE_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        ...
        addTable("AD_ELEMENT_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_FIELD", "AD_CLIENT_ID = 0");
        addTable("AD_FIELD_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_FIELDGROUP", "AD_CLIENT_ID = 0");
        addTable("AD_FIELDGROUP_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_FORM", "AD_CLIENT_ID = 0");
        addTable("AD_FORM_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        ...
        addTable("AD_MENU_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_MESSAGE", "AD_CLIENT_ID = 0");
        addTable("AD_MESSAGE_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        ...
        addTable("AD_PROCESS_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_PROCESS_PARA", "AD_CLIENT_ID = 0");
        addTable("AD_PROCESS_PARA_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_REFERENCE", "AD_CLIENT_ID = 0");
        addTable("AD_REFERENCE_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_REF_LIST", "AD_CLIENT_ID = 0");
        addTable("AD_REF_LIST_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        ...
        addTable("AD_TAB_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_TABLE", "AD_CLIENT_ID = 0");
        addTable("AD_TASK", "AD_CLIENT_ID = 0");
        addTable("AD_TASK_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_TEXTINTERFACES", "AD_CLIENT_ID = 0");
        addTable("AD_TEXTINTERFACES_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        ...
        addTable("AD_WF_NODE_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_WF_NODENEXT", "AD_CLIENT_ID = 0");
        addTable("AD_WINDOW", "AD_CLIENT_ID = 0");
        addTable("AD_WINDOW_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
        addTable("AD_WORKFLOW", "AD_CLIENT_ID = 0");
        addTable("AD_WORKFLOW_TRL", "AD_CLIENT_ID = 0 AND AD_LANGUAGE = 'es_ES'");
