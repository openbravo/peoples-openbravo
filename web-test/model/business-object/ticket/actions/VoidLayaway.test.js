...
require('../../../../../web/org.openbravo.retail.posterminal/app/model/business-object/ticket/actions/VoidLayaway');
require('../../global/SetupGlobalUtils');
const deepfreeze = require('deepfreeze');

describe('Void Layaway action', () => {
  it('should void ticket, print it and synchronize it', () => {
    ...
    const newState = OB.App.StateAPI.Global.voidLayaway(state, payload);
