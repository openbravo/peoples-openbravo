...
require('../SetupTicket');
require('../../../../../web/org.openbravo.retail.posterminal/app/model/business-object/ticket/actions/CreateCancelTicket');
require('../SetupTicketUtils');
const deepfreeze = require('deepfreeze');

describe('createCancelTicket', () => {
  it('cancels ticket', () => {
  ...
  `('should cancel ticket lines', ({ lines, result }) => {
    const globalState = deepfreeze({ Cashup: {} });
    const ticket = deepfreeze({
      id: '1',
      documentNo: 'O1',
