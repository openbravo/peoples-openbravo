...
public class TestCosting extends WeldBaseTest {
  ...
  public void testIssue37033_NoCostAdjustment() throws Exception {
    try {
      ...
      Product costingProduct = createProduct("product37033-A", new BigDecimal("10.00"));

      Order purchaseOrder = createPurchaseOrder(costingProduct, new BigDecimal("10.00"),
          BigDecimal.ONE, 0);
      ShipmentInOut goodsReceipt = createMovementFromOrder(purchaseOrder.getId(), false,
          BigDecimal.ONE, LOCATOR1_ID, 0);
      completeDocument(goodsReceipt);

      Invoice firstInvoice = createInvoiceFromMovement(goodsReceipt.getId(), false, new BigDecimal(
          "10.00"), BigDecimal.ONE, 0);
      Invoice secondInvoice = createInvoiceFromMovement(goodsReceipt.getId(), false,
  ...
  public void testIssue37033_CostAdjustmentToIncreaseCost() throws Exception {
    try {
      ...
      Product costingProduct = createProduct("product37033-B", new BigDecimal("10.00"));
  ...
  public void testIssue37033_CostAdjustmentToDecreaseCost() throws Exception {
    try {
      ...
      Product costingProduct = createProduct("product37033-C", new BigDecimal("10.00"));
  ...
  public void testIssue37033_CostAdjustmentToIncreaseCostWithReceiptPartiallyInvoiced()
    ...
    try {
      ...
      Product costingProduct = createProduct("product37033-D", new BigDecimal("10.00"));
      ...
      Invoice purchaseInvoice = createInvoiceFromMovement(goodsReceipt.getId(), false,
  ...
  public void testIssue37033_CostAdjustmentToDecreaseCostWithReceiptPartiallyInvoiced()
    ...
    try {
      ...
      Product costingProduct = createProduct("product37033-E", new BigDecimal("10.00"));
      ...
      Invoice purchaseInvoice = createInvoiceFromMovement(goodsReceipt.getId(), false,
          new BigDecimal("9.00"), BigDecimal.ONE, 0);
      purchaseInvoice.getInvoiceLineList().get(0).setInvoicedQuantity(BigDecimal.ONE);
      OBDal.getInstance().flush();
      completeDocument(purchaseInvoice);
