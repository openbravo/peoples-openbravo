...
public class TaxesTestData120 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes2.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-4.78", "-1.19", "-4.78",
        "-1.19", "-9.55", "-2.39", "-9.55", "-2.39" });
    lineTaxes2.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-3.18", "-1.60", "-3.18",
        "-1.60", "-6.37", "-3.18", "-6.37", "-3.18" });
