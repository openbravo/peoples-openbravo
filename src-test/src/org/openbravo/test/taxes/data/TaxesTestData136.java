...
public class TaxesTestData136 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes6.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-9290.48", "-1486.48",
        "-9290.48", "-1486.48", "-18580.97", "-2972.95", "-18580.97", "-2972.95" });
    lineTaxes6.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-6072.21", "-3218.27",
        "-6072.21", "-3218.27", "-12144.42", "-6436.55", "-12144.42", "-6436.55" });
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-21337.05", "-3413.94", "-21337.05",
        "-3413.94", "-42674.13", "-6827.85", "-42674.13", "-6827.85" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-13945.79", "-7391.26", "-13945.79",
        "-7391.26", "-27891.58", "-14782.55", "-27891.58", "-14782.55" });
    setDoctaxes(taxes);
