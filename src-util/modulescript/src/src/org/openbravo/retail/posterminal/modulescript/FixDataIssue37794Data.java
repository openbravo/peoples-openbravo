...
class FixDataIssue37794Data implements FieldProvider {
  ...
  public static FixDataIssue37794Data[] select(ConnectionProvider connectionProvider)
  ...
  public static FixDataIssue37794Data[] select(ConnectionProvider connectionProvider,
    ...
    String strSql = "";
    strSql = strSql + "      SELECT '' AS counter" + "      FROM DUAL";
  ...
  public static int deleteDuplicatedOrganizationUserPosTerminal(Connection conn,
      ConnectionProvider connectionProvider) throws ServletException {
    String strSql = "";
    strSql = strSql + "      DELETE FROM obpos_userterminal_access "
