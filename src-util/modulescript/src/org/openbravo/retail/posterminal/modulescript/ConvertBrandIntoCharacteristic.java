      ...
      if (!ConvertBrandIntoCharacteristicData.hasPreference(cp)) {
        ...
        for (ConvertBrandIntoCharacteristicData brand : data) {
          ...
          for (ConvertBrandIntoCharacteristicData brand2 : data2) {
            ...
            ConvertBrandIntoCharacteristicData.insertTreeNode(cp.getConnection(), cp, brand2.mBrandId, 
                brand2.adClientId, brand2.adOrgId);
          }
          ...
          for (ConvertBrandIntoCharacteristicData brand3 : data3) {
            ...
            ConvertBrandIntoCharacteristicData.insertProductCharacteristicValue(cp.getConnection(),
                cp, brand3.adClientId, brand3.adOrgId, brand3.mProductId, id, brand3.mBrandId);
            ConvertBrandIntoCharacteristicData.updateCharacteristicDesc (cp.getConnection(),
                cp, brand3.name, brand3.mProductId);
          }
        }
