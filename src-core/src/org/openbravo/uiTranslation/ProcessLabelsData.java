...
public class ProcessLabelsData implements FieldProvider {
static Logger log4j = Logger.getLogger(ProcessLabelsData.class);
  ...
  public static ProcessLabelsData[] select(ConnectionProvider connectionProvider, String ad_process_id, String language)    throws ServletException {
    return select(connectionProvider, ad_process_id, language, 0, 0);
  }

  public static ProcessLabelsData[] select(ConnectionProvider connectionProvider, String ad_process_id, String language, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    boolean existsKey = false;
    String strSql = "";
    strSql = strSql + 
      "		select " +
      "		  process.ad_process_id as adProcessId" +
      ...
      "		  , processParaTrl.name as processParaTrlName" +
      "		from " +
      "		  ad_process process, ad_process_para processPara" +
      "		  , ad_process_para_trl processParaTrl" +
      "		where " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(result.next() && !searchComplete) {
        ...
        objectProcessLabelsData.processparacolumnname = UtilSql.getValue(result, "PROCESSPARACOLUMNNAME");
        ...
        if (!existsKey) existsKey = (objectProcessLabelsData.getField(keyName).equalsIgnoreCase(keyValue));
  ...
  public static ProcessLabelsData[] select(ConnectionProvider connectionProvider, String ad_process_id, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "		select " +
      "		  process.ad_process_id as adProcessId" +
  ...
  public static ProcessLabelsData[] selectOriginalParameters(ConnectionProvider connectionProvider, String ad_process_id)    throws ServletException {
    return selectOriginalParameters(connectionProvider, ad_process_id, 0, 0);
  }

  public static ProcessLabelsData[] selectOriginalParameters(ConnectionProvider connectionProvider, String ad_process_id, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    boolean existsKey = false;
    String strSql = "";
    strSql = strSql + 
      "		select " +
  ...
  public static ProcessLabelsData[] selectOriginalParameters(ConnectionProvider connectionProvider, String ad_process_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "		select " +
      "		  processPara.ad_process_para_id as processParaId " +
  ...
  public static ProcessLabelsData[] selectTranslatedParameters(ConnectionProvider connectionProvider, String ad_process_id, String language)    throws ServletException {
    return selectTranslatedParameters(connectionProvider, ad_process_id, language, 0, 0);
  }

  public static ProcessLabelsData[] selectTranslatedParameters(ConnectionProvider connectionProvider, String ad_process_id, String language, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    boolean existsKey = false;
    String strSql = "";
    strSql = strSql + 
      "		select " +
  ...
  public static ProcessLabelsData[] selectTranslatedParameters(ConnectionProvider connectionProvider, String ad_process_id, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "		select " +
      "		  processPara.ad_process_para_id as processParaId" +
