...
public class ProcessLabelsData implements FieldProvider {
    ...
    public static ProcessLabelsData[] select(
            ConnectionProvider connectionProvider, String ad_process_id,
    ...
    public static ProcessLabelsData[] select(
        ...
        try {
            ...
            while (result.next() && !searchComplete) {
                ...
                objectProcessLabelsData.adprocessid = UtilSql.getValue(result,
                        "ADPROCESSID");
                objectProcessLabelsData.processname = UtilSql.getValue(result,
                        "PROCESSNAME");
                objectProcessLabelsData.processparaid = UtilSql.getValue(
                        result, "PROCESSPARAID");
                objectProcessLabelsData.processparaname = UtilSql.getValue(
                        result, "PROCESSPARANAME");
                objectProcessLabelsData.processparacolumnname = UtilSql
                        .getValue(result, "PROCESSPARACOLUMNNAME");
                objectProcessLabelsData.processparatrlname = UtilSql.getValue(
                        result, "PROCESSPARATRLNAME");
                objectProcessLabelsData.InitRecordNumber = Long
                        .toString(initRecord);
                if (!existsKey)
                    existsKey = (objectProcessLabelsData.getField(keyName)
        ...
        if (existsKey) {
            ProcessLabelsData objectProcessLabelsData[] = new ProcessLabelsData[vector
                    .size()];
    ...
    public static ProcessLabelsData[] select(
        ...
        try {
            ...
            while (continueResult && result.next()) {
                ...
                objectProcessLabelsData.processparatrlname = UtilSql.getValue(
                        result, "PROCESSPARATRLNAME");
                objectProcessLabelsData.InitRecordNumber = Integer
    ...
    public static ProcessLabelsData[] selectOriginalParameters(
            ConnectionProvider connectionProvider, String ad_process_id)
            throws ServletException {
    ...
    public static ProcessLabelsData[] selectOriginalParameters(
        ...
        strSql = strSql + "		select "
                ...
                + "		  , processPara.name as processParaName "
                + "     , processPara.columnname as processParaColumnName "
                + "		from " + "		  ad_process_para processPara " + "		where "
    ...
    public static ProcessLabelsData[] selectTranslatedParameters(
            ConnectionProvider connectionProvider, String ad_process_id,
            String language) throws ServletException {
        return selectTranslatedParameters(connectionProvider, ad_process_id,
                language, 0, 0);
    }
