...
static Logger log4j = Logger.getLogger(FieldGroupLabelsData.class);
  ...
  public static FieldGroupLabelsData[] selectFieldGroupTrl(ConnectionProvider connectionProvider, String ad_tab_id, String language)    throws ServletException {
    return selectFieldGroupTrl(connectionProvider, ad_tab_id, language, 0, 0);
  }

  public static FieldGroupLabelsData[] selectFieldGroupTrl(ConnectionProvider connectionProvider, String ad_tab_id, String language, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(result.next() && !searchComplete) {
        ...
        objectFieldGroupLabelsData.fieldgrouptrlname = UtilSql.getValue(result, "FIELDGROUPTRLNAME");
        objectFieldGroupLabelsData.InitRecordNumber = Long.toString(initRecord);
        if (!existsKey) existsKey = (objectFieldGroupLabelsData.getField(keyName).equalsIgnoreCase(keyValue));
  ...
  public static FieldGroupLabelsData[] selectFieldGroupTrl(ConnectionProvider connectionProvider, String ad_tab_id, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "			select  " +
      "			  tab.name as tabName" +
  ...
  public static FieldGroupLabelsData[] select(ConnectionProvider connectionProvider, String ad_tab_id)    throws ServletException {
    return select(connectionProvider, ad_tab_id, 0, 0);
  }

  public static FieldGroupLabelsData[] select(ConnectionProvider connectionProvider, String ad_tab_id, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    boolean existsKey = false;
    String strSql = "";
    strSql = strSql + 
      "      select " +
  ...
  public static FieldGroupLabelsData[] select(ConnectionProvider connectionProvider, String ad_tab_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    "      select " +
    "  			tab.name as tabName" +
