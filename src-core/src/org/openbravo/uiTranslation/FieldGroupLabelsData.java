...
public class FieldGroupLabelsData implements FieldProvider {
    ...
    public static FieldGroupLabelsData[] selectFieldGroupTrl(
            ConnectionProvider connectionProvider, String ad_tab_id,
            String language) throws ServletException {
        return selectFieldGroupTrl(connectionProvider, ad_tab_id, language, 0,
                0);
    }

    public static FieldGroupLabelsData[] selectFieldGroupTrl(
            ConnectionProvider connectionProvider, String ad_tab_id,
            String language, String keyValue, String keyName,
        ...
        try {
            ...
            while (result.next() && !searchComplete) {
                ...
                objectFieldGroupLabelsData.tabname = UtilSql.getValue(result,
                        "TABNAME");
                objectFieldGroupLabelsData.fieldgroupid = UtilSql.getValue(
                        result, "FIELDGROUPID");
                objectFieldGroupLabelsData.fieldgroupname = UtilSql.getValue(
                        result, "FIELDGROUPNAME");
                objectFieldGroupLabelsData.fieldgrouptrlname = UtilSql
                        .getValue(result, "FIELDGROUPTRLNAME");
                objectFieldGroupLabelsData.InitRecordNumber = Long
                        .toString(initRecord);
                if (!existsKey)
                    existsKey = (objectFieldGroupLabelsData.getField(keyName)
        ...
        if (existsKey) {
            FieldGroupLabelsData objectFieldGroupLabelsData[] = new FieldGroupLabelsData[vector
                    .size()];
    ...
    public static FieldGroupLabelsData[] selectFieldGroupTrl(
            ConnectionProvider connectionProvider, String ad_tab_id,
            String language, int firstRegister, int numberRegisters)
        ...
        try {
            ...
            while (continueResult && result.next()) {
                ...
                objectFieldGroupLabelsData.fieldgrouptrlname = UtilSql
                        .getValue(result, "FIELDGROUPTRLNAME");
                objectFieldGroupLabelsData.InitRecordNumber = Integer
    ...
    public static FieldGroupLabelsData[] select(
            ConnectionProvider connectionProvider, String ad_tab_id)
            throws ServletException {
    ...
    public static FieldGroupLabelsData[] select(
        ...
        strSql = strSql + "      select " + "  			tab.name as tabName"
                + "  			, fgroup.ad_fieldgroup_id as fieldGroupId"
                + "  			, fgroup.name as fieldGroupName" + "			from"
                + "			  ad_tab tab" + "			  , ad_field field"
                + "			  , ad_fieldgroup fgroup" + "			where"
                + "			  tab.ad_tab_id = field.ad_tab_id"
                + "			  and field.ad_fieldgroup_id = fGroup.ad_fieldGroup_id"
                + "			  and tab.ad_tab_id = ? " + "		UNION " + "      select "
                + "  			tab.name as tabName"
                + "  			, fgroup.ad_fieldgroup_id as fieldGroupId"
                + "  			, fgroup.name as fieldGroupName" + "			from"
                + "			  ad_tab tab" + "			  , ad_fieldgroup fgroup"
                + "			where" + "			  fgroup.ad_fieldgroup_id = '1000100001' "
                + "			  and tab.ad_tab_id = ? ";
