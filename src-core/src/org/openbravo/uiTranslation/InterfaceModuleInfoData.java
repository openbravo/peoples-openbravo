...
public class InterfaceModuleInfoData implements FieldProvider {
  ...
  public static InterfaceModuleInfoData[] selectTabModuleLang(
      ConnectionProvider connectionProvider, String ad_tab_id, String keyValue, String keyName,
    ...
    try {
      ...
      while (result.next() && !searchComplete) {
        ...
        if (!existsKey)
          existsKey = (objectInterfaceModuleInfoData.getField(keyName).equalsIgnoreCase(keyValue));
  ...
  public static InterfaceModuleInfoData[] selectTabModuleLang(
      ConnectionProvider connectionProvider, String ad_tab_id, int firstRegister,
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "      SELECT "
  ...
  public static InterfaceModuleInfoData[] selectFormModuleLang(
      ConnectionProvider connectionProvider, String classname) throws ServletException {
    return selectFormModuleLang(connectionProvider, classname, 0, 0);
  }

  public static InterfaceModuleInfoData[] selectFormModuleLang(
      ConnectionProvider connectionProvider, String classname, String keyValue, String keyName,
      int numberRegisters) throws ServletException {
    boolean existsKey = false;
    String strSql = "";
    strSql = strSql
        ...
        + "	  module.ad_module_id = type.ad_module_id " + "	  and type.classname = ? ";
  ...
  public static InterfaceModuleInfoData[] selectFormModuleLang(
      ConnectionProvider connectionProvider, String classname, int firstRegister,
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "      SELECT "
