...
public class FieldLabelsData implements FieldProvider {
    ...
    public String getField(String fieldName) {
        if (fieldName.equalsIgnoreCase("AD_COLUMN_ID")
                || fieldName.equals("adColumnId"))
            return adColumnId;
        else if (fieldName.equalsIgnoreCase("COL_NAME")
                || fieldName.equals("colName"))
            return colName;
        else if (fieldName.equalsIgnoreCase("COL_COLUMNNAME")
                || fieldName.equals("colColumnname"))
            return colColumnname;
        else if (fieldName.equalsIgnoreCase("ELEMENT_NAME")
                || fieldName.equals("elementName"))
            return elementName;
            ...
            return fieldName;
        else if (fieldName.equalsIgnoreCase("FIELDTRL_NAME")
                || fieldName.equals("fieldtrlName"))
            return fieldtrlName;
        else if (fieldName.equalsIgnoreCase("ELMTTRL_NAME")
                || fieldName.equals("elmttrlName"))
            return elmttrlName;
    ...
    public static FieldLabelsData[] select(
    ...
    public static FieldLabelsData[] select(
        ...
        strSql = strSql
                ...
                + "     and tab.ad_tab_id = ? "
                + "     and tablee.ad_window_id = tab.ad_window_id "
                + "     and field.ad_tab_id = tab.ad_tab_id "
                + "     and tab.ad_table_id = tablee.ad_table_id "
                ...
                + "     colum.ad_table_id = (select tab.ad_table_id from ad_tab tab where tab.ad_tab_id = ?) "
                + "     and tab.ad_tab_id = ? "
                + "     and tablee.po_window_id = tab.ad_window_id "
                + "     and field.ad_tab_id = tab.ad_tab_id "
                + "     and tab.ad_table_id = tablee.ad_table_id "
                + "       and colum.ad_column_id = field.ad_column_id "
                + "     and colum.ad_element_id = elemnt.ad_element_id "
                ...
                + "      ad_column colum " + "      , ad_field field "
                + "    where " + "      field.ad_tab_id = ? "
                + "      and colum.ad_column_id = field.ad_column_id)";
        ...
        try {
            ...
            while (result.next() && !searchComplete) {
                ...
                objectFieldLabelsData.adColumnId = UtilSql.getValue(result,
                        "AD_COLUMN_ID");
                objectFieldLabelsData.colName = UtilSql.getValue(result,
                        "COL_NAME");
                objectFieldLabelsData.colColumnname = UtilSql.getValue(result,
                        "COL_COLUMNNAME");
                objectFieldLabelsData.elementName = UtilSql.getValue(result,
                        "ELEMENT_NAME");
                objectFieldLabelsData.elementPrintname = UtilSql.getValue(
                        result, "ELEMENT_PRINTNAME");
                objectFieldLabelsData.fieldName = UtilSql.getValue(result,
                        "FIELD_NAME");
                objectFieldLabelsData.fieldtrlName = UtilSql.getValue(result,
                        "FIELDTRL_NAME");
                objectFieldLabelsData.elmttrlName = UtilSql.getValue(result,
                        "ELMTTRL_NAME");
                objectFieldLabelsData.elmttrlPrintname = UtilSql.getValue(
                        result, "ELMTTRL_PRINTNAME");
                objectFieldLabelsData.InitRecordNumber = Long
                        .toString(initRecord);
                if (!existsKey)
                    existsKey = (objectFieldLabelsData.getField(keyName)
        ...
        if (existsKey) {
            FieldLabelsData objectFieldLabelsData[] = new FieldLabelsData[vector
                    .size()];
    ...
    public static FieldLabelsData[] select(
        ...
        try {
            ...
            while (continueResult && result.next()) {
                ...
                objectFieldLabelsData.elmttrlPrintname = UtilSql.getValue(
                        result, "ELMTTRL_PRINTNAME");
                objectFieldLabelsData.InitRecordNumber = Integer
    ...
    public static FieldLabelsData[] selectModuleFieldLabels(
            ConnectionProvider connectionProvider, String ad_tab_id)
            throws ServletException {
