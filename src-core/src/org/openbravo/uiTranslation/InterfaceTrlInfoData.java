...
class InterfaceTrlInfoData implements FieldProvider {
  ...
  public static InterfaceTrlInfoData[] selectTabTrlInfo(ConnectionProvider connectionProvider,
  ...
  public static InterfaceTrlInfoData[] selectTabTrlInfo(ConnectionProvider connectionProvider,
      String ad_tab_id, String langugae, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "    SELECT " + "      typeTrl.name, typeTrl.description, typeTrl.help "
        + "    FROM " + "      ad_tab type, ad_tab_trl typeTrl " + "    WHERE "
        + "      type.ad_tab_id = typeTrl.ad_tab_id " + "      and type.ad_tab_id = ?"
  ...
  public static InterfaceTrlInfoData[] selectFormTrlInfo(ConnectionProvider connectionProvider,
      String ad_tab_id, String langugae) throws ServletException {
  ...
  public static InterfaceTrlInfoData[] selectFormTrlInfo(ConnectionProvider connectionProvider,
    ...
    String strSql = "";
    strSql = strSql + "    SELECT " + "      typeTrl.name, typeTrl.description, typeTrl.help "
        + "    FROM " + "      ad_form type, ad_form_trl typeTrl " + "    WHERE "
        + "      type.ad_form_id = typeTrl.ad_form_id " + "      and type.classname = ?"
        + "      and typeTrl.ad_language = ? ";
