 ...
 */
  public static TextInterfacesData[] selectText(ConnectionProvider connectionProvider, String htmlFile, String language)    throws ServletException {
...
Return a listing of text values for the a page
 */
  public static TextInterfacesData[] selectText(ConnectionProvider connectionProvider, String htmlFile, String language, String keyValue, String keyName, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(result.next() && !searchComplete) {
        ...
        if (!existsKey) existsKey = (objectTextInterfacesData.getField(keyName).equalsIgnoreCase(keyValue));
...
Return a listing of text values for the a page
 */
  public static TextInterfacesData[] selectText(ConnectionProvider connectionProvider, String htmlFile, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select " +
      "		  text.filename as filename, text.text as text, text.isused as isUsed, text.ad_module_id as moduleId," +
