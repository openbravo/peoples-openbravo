...
public class TextInterfacesData implements FieldProvider {
     ...
     */
    public static TextInterfacesData[] selectText(
            ConnectionProvider connectionProvider, String htmlFile,
    ...
    public static TextInterfacesData[] selectText(
        ...
        strSql = strSql
                ...
                + "		  ad_textinterfaces_trl texttrl"
                + "		where"
                + "		  text.ad_textinterfaces_id = texttrl.ad_textinterfaces_id "
                + "		  and text.filename = '";
        strSql = strSql
                + ((htmlFile == null || htmlFile.equals("")) ? "" : htmlFile);
        ...
        strSql = strSql
                + "' as trlLang, "
                + "		  text.text as trlText, 'N' as isTranslated, 1 as orderSeq"
        ...
        try {
            ...
            while (result.next() && !searchComplete) {
                ...
                objectTextInterfacesData.filename = UtilSql.getValue(result,
                        "FILENAME");
                objectTextInterfacesData.text = UtilSql
                        .getValue(result, "TEXT");
                objectTextInterfacesData.isused = UtilSql.getValue(result,
                        "ISUSED");
                objectTextInterfacesData.moduleid = UtilSql.getValue(result,
                        "MODULEID");
                objectTextInterfacesData.trllang = UtilSql.getValue(result,
                        "TRLLANG");
                objectTextInterfacesData.trltext = UtilSql.getValue(result,
                        "TRLTEXT");
                objectTextInterfacesData.istranslated = UtilSql.getValue(
                        result, "ISTRANSLATED");
                objectTextInterfacesData.orderseq = UtilSql.getValue(result,
                        "ORDERSEQ");
                objectTextInterfacesData.InitRecordNumber = Long
                        .toString(initRecord);
                if (!existsKey)
                    existsKey = (objectTextInterfacesData.getField(keyName)
        ...
        if (existsKey) {
            TextInterfacesData objectTextInterfacesData[] = new TextInterfacesData[vector
                    .size()];
    ...
    public static TextInterfacesData[] selectText(
        ...
        try {
            ...
            while (continueResult && result.next()) {
                ...
                objectTextInterfacesData.orderseq = UtilSql.getValue(result,
                        "ORDERSEQ");
                objectTextInterfacesData.InitRecordNumber = Integer
