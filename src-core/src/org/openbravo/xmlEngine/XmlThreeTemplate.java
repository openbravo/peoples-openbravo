...
/** class for represent the structure of the value of an attribute.
 * It is used because part of the value of an attribute can be modified
 * with the value of an XmlComponent.
 * The value is represented by a three with nodes of three branchs
 *   the fist and the third branchs are another XmlThreeTemplate, a String or null
 *   the second is an XmlComponent
*/
class XmlThreeTemplate implements XmlComponentTemplate {
  ...
  public XmlThreeTemplate(String characterBegin, XmlComponentTemplate xmlComponentTemplate, String characterEnd) {
    stringBegin = characterBegin;
    stringEnd = characterEnd;
    xmlMiddle = xmlComponentTemplate;
    log4jXmlThreeTemplate.debug("constructor with stringBegin: " + stringBegin + " stringEnd: " + stringEnd);
  }
