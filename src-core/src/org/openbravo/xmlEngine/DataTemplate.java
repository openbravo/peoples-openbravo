...
/**
  A piece of a XmlTemplate with a defined data. This class manages the connection an the query
...
class DataTemplate implements XmlComponentTemplate {
  ...
  Vector<Object> vecParameterTemplate;   // vector of ParameterTemplates for the query
  Vector<Object> vecFunctionTemplateData;    // vector of functions of structure
  Vector<Object> vecFunctionTemplateOutSection;    // vector of functions out of a Section, therefore out of a Data, but need to initialize and accumulte in the data
  ...
  public FieldTemplate addField(String name, DecimalFormat formatOutput, DecimalFormat formatSimple,
    ...
    public FunctionTemplate addFunction(String strFunction, String name, DecimalFormat formatOutput, DecimalFormat formatSimple) {
    ...
    public FunctionTemplate addFunction(String strFunction, String name, DecimalFormat formatOutput, DecimalFormat formatSimple,
      ...
      if (!name.equals("*") && arg1 == null) {  // if it's * or an evaluation function then the field is not used
      ...
      if (strFunction.equals("COUNT")) {
        ...
        functionInstance = new FunctionSubtractTemplate(id, formatOutput, formatSimple, this, arg1, arg2);
      } else if (strFunction.equals("MULTIPLY")) {
        functionInstance = new FunctionMultiplyTemplate(id, formatOutput, formatSimple, this, arg1, arg2);
      } else if (strFunction.equals("DIVIDE")) {
        functionInstance = new FunctionDivideTemplate(id, formatOutput, formatSimple, this, arg1, arg2);
      } else if (strFunction.equals("MODULE")) {
        functionInstance = new FunctionModuleTemplate(id, formatOutput, formatSimple, this, arg1, arg2);
