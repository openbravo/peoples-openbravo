...
/**
 * A piece of a XmlTemplate with a defined data. This class manages the
 * connection an the query if there is not a FieldProvider[]
 **/
class DataTemplate implements XmlComponentTemplate {
    ...
    public FieldTemplate addField(String name, DecimalFormat formatOutput,
        ...
        // has been used again
        FieldTemplate field = new FieldTemplate(name, formatOutput,
                formatSimple, vecReplace); // , this); // XmlEngineNP:
    ...
    public FunctionTemplate addFunction(String strFunction, String name,
            DecimalFormat formatOutput, DecimalFormat formatSimple) {
        return addFunction(strFunction, name, formatOutput, formatSimple, null,
                null, null);
    }

    public FunctionTemplate addFunction(String strFunction, String name,
            DecimalFormat formatOutput, DecimalFormat formatSimple,
            XmlComponentTemplate arg1, XmlComponentTemplate arg2, String id) {
        FieldTemplate field = null;
        if (!name.equals("*") && arg1 == null) { // if it's * or an evaluation
                                                 // function then the field is
                                                 // not used
            log4jDataTemplate.debug("Call to addField: " + name + " "
                    + strFunction);
            field = addField(name);
            log4jDataTemplate.debug("addField returns: " + name + " "
                    + strFunction);
        }
        FunctionTemplate functionInstance = null;
        if (strFunction.equals("COUNT")) {
            functionInstance = new FunctionCountTemplate(name, field, null,
                    this);
        } else if (strFunction.equals("ORDER")) {
            functionInstance = new FunctionOrderTemplate(name, field, null,
                    this);
        } else if (strFunction.equals("SUM")) {
            functionInstance = new FunctionSumTemplate(name, field,
                    formatOutput, formatSimple, this);
        } else if (strFunction.equals("MED")) {
            functionInstance = new FunctionMedTemplate(name, field,
                    formatOutput, formatSimple, this);
        } else if (strFunction.equals("EQUAL")) {
            functionInstance = new FunctionEqualTemplate(id, formatOutput,
                    formatSimple, this, arg1);
        } else if (strFunction.equals("ADD")) {
            functionInstance = new FunctionAddTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("SUBTRACT")) {
            functionInstance = new FunctionSubtractTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("MULTIPLY")) {
            functionInstance = new FunctionMultiplyTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("DIVIDE")) {
            functionInstance = new FunctionDivideTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("MODULE")) {
            functionInstance = new FunctionModuleTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("GT")) {
            functionInstance = new FunctionGtTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("LT")) {
            functionInstance = new FunctionLtTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("MAX")) {
            functionInstance = new FunctionMaxTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else if (strFunction.equals("MIN")) {
            functionInstance = new FunctionMinTemplate(id, formatOutput,
                    formatSimple, this, arg1, arg2);
        } else {
