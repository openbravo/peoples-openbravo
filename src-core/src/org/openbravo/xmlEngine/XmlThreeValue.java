 ...
 * with the value of an HtmlComponent.
 * The value is represented by a three with nodes of three branchs
 *   the fist and the third branchs are another node or null
 *   the second is an HtmlComponent
*/
...
class XmlThreeValue implements XmlComponentValue {
  ...
  public XmlThreeValue(XmlThreeTemplate xmlThreeTemplate, XmlDocument xmlDocument) {
    ...
    if (xmlThreeTemplate.xmlMiddle != null) {
      ...
      //XmlEngineNP: remove if only it used in the log      log4jXmlThreeValue.debug("value:" + ((ParameterTemplate)(xmlThreeTemplate.xmlMiddle)).strName);
  ...
  public String print() {
    ...
    if (xmlBegin != null) strReturn = strReturn.concat(xmlBegin.print());
    else if (xmlThreeTemplate.printStringBegin() != null) strReturn = strReturn.concat(xmlThreeTemplate.printStringBegin());
    if (xmlMiddle != null) strReturn = strReturn.concat(xmlMiddle.print());
    if (xmlEnd != null) strReturn = strReturn.concat(xmlEnd.print());
    else if (xmlThreeTemplate.printStringEnd() != null) strReturn = strReturn.concat(xmlThreeTemplate.printStringEnd());
  ...
  public String printPrevious() {
    ...
    if (xmlBegin != null) strReturn = strReturn.concat(xmlBegin.printPrevious());
    else if (xmlThreeTemplate.printStringBegin() != null) strReturn = strReturn.concat(xmlThreeTemplate.printStringBegin());
    if (xmlMiddle != null) {
    ...
    if (xmlEnd != null) strReturn = strReturn.concat(xmlEnd.printPrevious());
    else if (xmlThreeTemplate.printStringEnd() != null) strReturn = strReturn.concat(xmlThreeTemplate.printStringEnd());
