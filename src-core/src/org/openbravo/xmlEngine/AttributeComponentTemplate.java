...
class AttributeComponentTemplate implements XmlComponentTemplate, IDComponent {
  ...
  static Logger log4jAttributeComponentTemplate = Logger.getLogger(AttributeComponentTemplate.class);

  public AttributeComponentTemplate(FunctionTemplate functionTemplate, String attributeName, String strReplace,
      String strBooleanAttribute, XmlComponentTemplate xmlComponentBooleanWithId) {
  ...
  public AttributeComponentTemplate(XmlComponentTemplate xmlComponent, String attributeName, String strReplace,
      String strBooleanAttribute, XmlComponentTemplate xmlComponentBooleanWithId) {
...
*/
  ...
  public XmlComponentValue createXmlComponentValue(XmlDocument xmlDocument) {
    //    log4jAttributeComponentTemplate.debug("Instanceof: " + (xmlComponentTemplate instanceof FieldTemplate) +
