...
class AttributeComponentTemplate implements XmlComponentTemplate, IDComponent {
    ...
    public AttributeComponentTemplate(FunctionTemplate functionTemplate,
            String attributeName, String strReplace,
            String strBooleanAttribute,
    ...
    public AttributeComponentTemplate(XmlComponentTemplate xmlComponent,
            String attributeName, String strReplace,
            String strBooleanAttribute,
            XmlComponentTemplate xmlComponentBooleanWithId) {
    ...
    /*
     * replaced 21/04/2002 public XmlComponentValue
     * createXmlComponentValue(XmlDocument xmlDocument) { return new
     * AttributeComponentValue(this, xmlDocument); }
     */
    ...
    public FieldValue createAttributeComponentValue(XmlDocument xmlDocument) {
        for (DataValue dataValue : xmlDocument.hasDataValue.values()) {
            for (Enumeration<Object> e2 = dataValue.vecFieldValue.elements(); e2
                    .hasMoreElements();) {
                ...
                if (fieldValue.fieldTemplate.name().equals(
                        ((FieldTemplate) xmlComponentTemplate).name())) {
                    return fieldValue;
                }
            }
        ...
        FieldValue fieldValue = new FieldValue(
                (FieldTemplate) (this.xmlComponentTemplate), xmlDocument);
        return fieldValue;
    }
    ...
    public XmlComponentValue createXmlComponentValue(XmlDocument xmlDocument) {
        ...
        if (xmlComponentTemplate instanceof FunctionTemplate) {
            return ((FunctionTemplate) xmlComponentTemplate)
                    .createFunctionValue(xmlDocument);
        } else if (xmlComponentTemplate instanceof ParameterTemplate) {
            return ((ParameterTemplate) xmlComponentTemplate)
