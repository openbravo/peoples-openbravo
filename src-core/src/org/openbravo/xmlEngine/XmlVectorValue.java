...
public class XmlVectorValue extends Vector<Object> {
  ...
  public XmlVectorValue(XmlVectorTemplate xmlVectorTemplate, XmlDocument xmlDocument) {
    if (xmlDocument != null) this.xmlDocument = xmlDocument;
  ...
  StringBuffer printStringBuffer() {
    ...
    for (Enumeration<Object> e = elements() ; e.hasMoreElements() ;) {
      ...
      String result = "";
      if (textMap != null) {
        if (xmlComponentValue.print() != null && !xmlComponentValue.print().startsWith("<") && !xmlComponentValue.print().equals("")) {
          result = xmlComponentValue.print();
          log4jXmlVectorValue.debug("printStringBuffer(HashMap<String, String> textMap) - result: " + result);
          log4jXmlVectorValue.debug("checking for existence of text in textdata: " + result);
          String translation = textMap.get(result);
          if (translation != null && !translation.equals("")) {
            log4jXmlVectorValue.debug("printStringBuffer() appending xmlComponentValue: " + xmlComponentValue.print() + ", translation: " + translation);
            result = translation;
          }
        }
      }
  ...
  private String replaceString(String originalLine, String prefix, String suffix, HashMap<String, String> textMap) {
    ...
    if (trlText != null && !trlText.equals("")) {
      log4jXmlVectorValue.debug("Found a match - ORIGINAL: " + prefixStr + text + suffixStr + ", TRANSLATION: " + prefixStr + trlText + suffixStr);
