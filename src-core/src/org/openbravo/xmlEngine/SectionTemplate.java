...
class SectionTemplate implements IDComponent {
    ...
    static Logger log4jSectionTemplate = Logger
            .getLogger(SectionTemplate.class);
    ...
    public SectionValue createSectionValue(XmlDocument xmlDocument,
            DataValue dataValue) {
        SectionValue sectionValue = new SectionValue(this, xmlDocument,
                dataValue);
        return sectionValue;
    }
}
