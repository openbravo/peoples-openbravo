...
class AttributeComponentValue implements XmlComponentValue {
  ...
  public AttributeComponentValue(AttributeComponentTemplate attributeComponentTemplate, XmlDocument xmlDocument) {
    this.attributeComponentTemplate = attributeComponentTemplate;
    if (attributeComponentTemplate.functionTemplate() != null) {
      functionValue = attributeComponentTemplate.functionTemplate().createFunctionValue(xmlDocument);
