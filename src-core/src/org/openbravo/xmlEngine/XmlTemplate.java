...
public class XmlTemplate extends DefaultHandler implements XmlComponentTemplate, IDComponent {
  ...
  Hashtable<String, ParameterTemplate> hasParameterTemplate; // contains the ParameterTemplates that not are for the SQL query
  ...
  //XmlEngineNP: make sure this functions can be addede or deleted from the constructor, because it is necessary to make clear, or also for the subreports
  public void clear() {
    /* pass to XmlDocument
  ...
  private StackElement popElement() {
    if (stcElement.isEmpty()) return null;
          ...
          if (iDComponent != null) {
            ...
            switch(iDComponent.type()) {
              ...
              case IDComponent.ATTRIBUTE:
                ...
                if (functionAttributeComponent != null) {
                  if (activeSection == null) {
                    functionAttributeComponent.dataTemplate.vecFunctionTemplateOutSection.addElement(functionAttributeComponent);  //XmlEngineNP (it had problems compiling,verify it is vecFunctionTemplateOutSection)
                  } else {
              ...
              case IDComponent.FUNCTION:
                ...
                if (activeSection == null) {
                  function.dataTemplate.vecFunctionTemplateOutSection.addElement(function);  //XmlEngineNP like the last one
                } else {
  ...
  public void endElement(java.lang.String uri,
    ...
    // the stackElement is changed once it is verified if the element could be printed
