...
class FieldValue implements XmlComponentValue {
    ...
    public void read(ResultSet result) {
        try {
            ...
            log4jFieldValue.error("SQL error in read(" + fieldTemplate.name()
                    + ": " + e);
        }
    }
    ...
    public void read(String value) {
        savePrevious(); // 04-12-2001
        log4jFieldValue.debug("Read Field: " + fieldTemplate.name()
                + " \tValue: " + fieldValue);
    ...
    public String print() {
        ...
        if (fieldValue == null || fieldValue.equals("")
            ...
            try {
                ...
                log4jFieldValue
                        .error("FieldValue.print() - Could not parse to double the string: "
                                + fieldValue + "\n" + e);
            }
    ...
    public String printSimple() {
        if (fieldValue == null || fieldValue.equals(""))
            ...
            return fieldTemplate.formatSimple.format(Double
    ...
    public String printPrevious() {
        if (previousFieldValue == null || previousFieldValue.equals(""))
            ...
            return fieldTemplate.formatOutput.format(Double
                    .parseDouble(previousFieldValue));
        } else {
