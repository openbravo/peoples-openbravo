...
class TagTemplate implements XmlComponentTemplate {
    ...
    public TagTemplate(String name, Attributes amap, String replaceWhat,
            String replaceWith, String prefix, String uri) {
        this.tag = name;
    ...
    public String replace(String initValue, String replaceWhat,
            String replaceWith) {
    ...
    public void setAttribute(
        ...
        if (attributeComponentTemplate.attributeName() != null) {
            for (AttributeItemTemplate attribute : attributeVectorTemplate) {
                if (attribute.name.equals(attributeComponentTemplate
                        .attributeName())) {
                    if (attributeComponentTemplate.replace() != null) {
                        attribute.valueTemplate
                                .replace(attributeComponentTemplate);
                    } else {
        ...
        if (attributeComponentTemplate.attributeBooleanName() != null) {
            for (AttributeItemTemplate attribute : attributeVectorTemplate) {
                if (attribute.name.equals(attributeComponentTemplate
                        .attributeBooleanName())) {
                    attribute.valueTemplate = new XmlThreeTemplate(
                            attributeComponentTemplate.xmlComponentTemplate());
                    attribute.attributeBoolean = true;
                    attribute.valueToCompareTemplate = attributeComponentTemplate
                            .booleanWithId();
                    return;
                }
            }
