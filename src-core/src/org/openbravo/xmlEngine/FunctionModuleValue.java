  ...
  public String print() {
    ...
    if (arg1Value.print().equals(XmlEngine.strTextDividedByZero) || arg2Value.print().equals(XmlEngine.strTextDividedByZero)) {
      ...
      if (Double.isInfinite(division) || Double.isNaN(division)) {
        ...
        return functionTemplate.printFormatOutput(Double.valueOf(arg1Value.printSimple()).doubleValue() - Double.valueOf(arg2Value.printSimple()).doubleValue() * Math.floor(division));
      }
    }
  }
  ...
  public String printSimple() {
    ...
    if (arg1Value.print().equals(XmlEngine.strTextDividedByZero) || arg2Value.print().equals(XmlEngine.strTextDividedByZero)) {
      ...
      if (Double.isInfinite(division) || Double.isNaN(division)) {
        ...
        return functionTemplate.printFormatSimple(Double.valueOf(arg1Value.printSimple()).doubleValue() - Double.valueOf(arg2Value.printSimple()).doubleValue() * Math.floor(division));
      }
    }
  }
}
