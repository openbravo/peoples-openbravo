...
class FunctionMaxValue extends FunctionEvaluationValue {
  ...
  public String print() {
    if (arg1Value.print().equals(XmlEngine.strTextDividedByZero) || arg2Value.print().equals(XmlEngine.strTextDividedByZero)) {
      ...
      return functionTemplate.printFormatOutput(Math.max(Double.valueOf(arg1Value.printSimple()).doubleValue(), Double.valueOf(arg2Value.printSimple()).doubleValue()));
    }
  }
  ...
  public String printSimple() {
    if (arg1Value.print().equals(XmlEngine.strTextDividedByZero) || arg2Value.print().equals(XmlEngine.strTextDividedByZero)) {
      ...
      return functionTemplate.printFormatSimple(Math.max(Double.valueOf(arg1Value.printSimple()).doubleValue(), Double.valueOf(arg2Value.printSimple()).doubleValue()));
    }
  }
