...
class FunctionMultiplyTemplate extends FunctionTemplate {
  ...
  public FunctionMultiplyTemplate(String fieldName, DecimalFormat formatOutput, DecimalFormat formatSimple,
  ...
  public FunctionValue createFunctionValue(XmlDocument xmlDocument) {
    ...
    if (functionValue == null) {
      if(log4jFunctionMultiplyTemplate.isDebugEnabled()) log4jFunctionMultiplyTemplate.debug("New FunctionMultiplyValue");
