...
public class FormatUtilities {
    ...
    public static String replaceTildes(String strIni) {
        ...
        return strIni.replace('á', 'a').replace('é', 'e').replace('í', 'i')
                .replace('ó', 'o').replace('ú', 'u').replace('Á', 'A').replace(
                        'É', 'E').replace('Í', 'I').replace('Ó', 'O').replace(
                        'Ú', 'U');
    }
    ...
    public static String encryptDecrypt(String text, boolean encrypt)
    ...
    public static String sanitizeInput(String text) {
        ...
        String[] tags = { "<[/]?applet>", "<[/]?body>", "<[/]?embed>",
                "<[/]?frame>", "<[/]?script>", "<[/]?frameset>", "<[/]?html>",
                "<[/]?iframe>", "<[/]?img>", "<[/]?style>", "<[/]?layer>",
