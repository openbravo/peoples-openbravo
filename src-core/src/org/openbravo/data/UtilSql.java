...
public class UtilSql {
    ...
    public boolean GetStringResultSet(ResultSet result, Object sqlObject) {
        ...
        try {
            ...
            for (int i = 1; i <= numColumns; ++i) {
                ...
                case 2:
                    f.set(sqlObject, Long.toString(result
                            .getLong(strNombreColumna)));
                    break;
                case 12:
                ...
                case 93:
                    ...
                    if (result.wasNull())
                        f.set(sqlObject, new java.sql.Date(System
                                .currentTimeMillis()));
                    break;
                }
    ...
    public String TransformaNombreColumna(String strColumn) {
        ...
        for (int i = 0; i < intNumCaracteres; i++) {
            if (i == 0)
                strNombreTransformado = new Character(Character
                        .toUpperCase(strColumn.charAt(i))).toString();
            else {
                if (new Character(strColumn.charAt(i)).compareTo(BarraBaja) == 0)
                    ...
                    if (blnFueBarraBaja) {
                        strNombreTransformado = strNombreTransformado
                                + new Character(Character.toUpperCase(strColumn
                                        .charAt(i))).toString();
                        blnFueBarraBaja = false;
                    } else
                        strNombreTransformado = strNombreTransformado
                                + new Character(Character.toLowerCase(strColumn
                                        .charAt(i))).toString();
                }
            }
        }
    ...
    public boolean AsignarValoresEntrada(PreparedStatement ps, int posicion,
            int tipo, String strValor) {
        try {
            if (strValor != null) {
                if (strValor.compareTo("") == 0)
                    ...
                    case 2:
                        ps
                                .setLong(posicion, Long.valueOf(strValor)
                                        .longValue());
                        break;
                    case 12:
    ...
    public static boolean setValue(PreparedStatement ps, int posicion,
            int tipo, String strDefault, String strValor) {
        try {
            if (strValor == null) {
                strValor = strDefault;
            }
    ...
    public static String getValue(ResultSet result, int pos)
            throws java.sql.SQLException {
    ...
    public static String getStringCallableStatement(CallableStatement cs,
            int intField) throws java.sql.SQLException {
